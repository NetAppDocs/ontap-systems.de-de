...
summary: Tauschen Sie das Gehäuse Ihres AFF A70 oder AFF A90 Systems aus, wenn ein Hardwaredefekt dies erfordert. Der Austauschvorgang umfasst das Entfernen der Controller und Netzteile, das Entfernen der Laufwerke, den Einbau des Ersatzgehäuses und das Wiedereinsetzen der Gehäusekomponenten. 
---
= Das Chassis in Ihrem AFF A70 oder AFF A90 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Tauschen Sie das Chassis Ihres AFF A70 oder AFF A90 -Systems aus, wenn ein Hardwaredefekt dies erfordert. Der Austauschvorgang umfasst das Entfernen der Controller und Netzteile (PSUs), das Entfernen der Laufwerke, die Installation des Ersatzgehäuses und die Neuinstallation der Gehäusekomponenten.
...
== Schritt 2: Die Controller-Module und Laufwerke entfernen
