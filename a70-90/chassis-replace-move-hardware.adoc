...
summary: Tauschen Sie das Gehäuse in Ihrem AFF A70 oder AFF A90-System aus, wenn es für einen Hardwareausfall oder ein Upgrade erforderlich ist. Beim Austausch werden die Netzteile entfernt, das vorhandene Gehäuse entfernt, das neue Gehäuse installiert und die Gehäusekomponenten wieder eingebaut. 
---
...
[role="lead"]
Tauschen Sie das Gehäuse in Ihrem AFF A70 oder AFF A90-System aus, wenn es für einen Hardwareausfall oder ein Upgrade erforderlich ist. Beim Austausch werden die Netzteile entfernt, das vorhandene Gehäuse entfernt, das neue Gehäuse installiert und die Gehäusekomponenten wieder eingebaut.
