...
summary: Ersetzen Sie das Chassis im AFF A70 oder AFF A90 System, wenn es bei einem Hardware-Ausfall oder Upgrade erforderlich ist. Bei diesem Vorgang wird das System heruntergefahren, das vorhandene Gehäuse entfernt, das neue installiert und Komponenten neu konfiguriert, um einen ordnungsgemäßen Systembetrieb zu gewährleisten. 
---
...
[role="lead"]
Ersetzen Sie das Chassis im AFF A70 oder AFF A90 System, wenn es bei einem Hardware-Ausfall oder Upgrade erforderlich ist. Bei diesem Vorgang wird das System heruntergefahren, das vorhandene Gehäuse entfernt, das neue installiert und Komponenten neu konfiguriert, um einen ordnungsgemäßen Systembetrieb zu gewährleisten.
