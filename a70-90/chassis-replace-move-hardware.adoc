...
[role="lead"]
Tauschen Sie das Chassis im AFF A70 oder AFF A90 System aus, wenn es bei einem Hardwareausfall erforderlich ist. Beim Austausch werden die Netzteile entfernt, das vorhandene Gehäuse entfernt, das neue Gehäuse installiert und die Gehäusekomponenten wieder eingebaut.
