...
summary: Fahren Sie den Controller im AFF A70 oder AFF A90 Storage-System herunter, wenn Sie die Boot-Medien austauschen müssen. Vor der Durchführung von Wartungsarbeiten oder dem Austausch von Komponenten ist es wichtig, den Controller sicher herunterzufahren, um Datenverlust zu vermeiden und die Systemstabilität sicherzustellen. 
---
...
[role="lead"]
Fahren Sie den Controller im AFF A70 oder AFF A90 Storage-System herunter, wenn Sie die Boot-Medien austauschen müssen. Vor der Durchführung von Wartungsarbeiten oder dem Austausch von Komponenten ist es wichtig, den Controller sicher herunterzufahren, um Datenverlust zu vermeiden und die Systemstabilität sicherzustellen.
