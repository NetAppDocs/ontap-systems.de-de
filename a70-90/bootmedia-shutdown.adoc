...
summary: Fahren Sie den beschädigten Controller in Ihrem AFF A70 oder AFF A90 -Speichersystem herunter, um Datenverlust zu verhindern und die Systemstabilität während des manuellen Boot-Medienwiederherstellungsprozesses aufrechtzuerhalten. 
---
= Den Controller in Ihrem AFF A70 oder AFF A90 System während des manuellen Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
