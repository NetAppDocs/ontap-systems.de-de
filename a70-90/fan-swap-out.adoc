...
summary: Ersetzen Sie ein Lüftermodul in Ihrem AFF A70 oder AFF A90-System, wenn ein Lüfter ausfällt oder nicht effizient arbeitet, was die Systemkühlung und die Gesamtleistung beeinträchtigen kann. Beim Austausch wird der beeinträchtigte Controller heruntergefahren, der Controller entfernt, der Lüfter ersetzt, der Controller neu installiert und das fehlerhafte Teil wieder an den NetApp zurückgegeben. 
---
= Ein Lüftermodul kann im laufenden Betrieb in einem AFF A70 oder AFF A90 System ausgetauscht werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
