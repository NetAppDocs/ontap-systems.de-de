...
summary: Um Datensicherheit auf Ihrem AFF A70 oder AFF A90-Speichersystem zu gewährleisten, müssen Sie die Unterstützung und den Status des Verschlüsselungsschlüssels auf Ihrem Startmedium überprüfen. Prüfen Sie, ob Ihre ONTAP Version NetApp Volume Encryption unterstützt, und stellen Sie vor dem Herunterfahren des Controllers sicher, dass der Schlüsselmanager aktiv ist. 
---
= Überprüfung der Verschlüsselungsunterstützung auf dem Startmedium in einem AFF A70 oder AFF A90 System mithilfe des manuellen Boot-Wiederherstellungsprozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um Datensicherheit auf Ihrem AFF A70 oder AFF A90-Speichersystem zu gewährleisten, müssen Sie die Unterstützung und den Status des Verschlüsselungsschlüssels auf Ihrem Startmedium überprüfen. Es sollte geprüft werden, ob Ihre ONTAP Version NetApp Volume Encryption (NVE) unterstützt. Vor dem Herunterfahren des Controllers sollte geprüft werden, ob der Schlüsselmanager aktiv ist.
