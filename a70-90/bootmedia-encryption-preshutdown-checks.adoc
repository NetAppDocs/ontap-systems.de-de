...
---
= Überprüfen Sie die Verschlüsselungsunterstützung für die manuelle Wiederherstellung von Bootmedien – AFF A70 und AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um die Datensicherheit auf Ihrem AFF A70 oder AFF A90 Storage-System zu gewährleisten, müssen Sie die Unterstützung und den Status der Verschlüsselungsschlüssel auf Ihren Boot-Medien überprüfen. Überprüfen Sie, ob Ihre ONTAP Version NetApp Volume Encryption (NVE) unterstützt und bevor Sie den Controller herunterfahren, ob der Schlüsselmanager aktiv ist.
