...
summary: 'Um die Datensicherheit in Ihrem AFF A70 und AFF A90 Storage-System sicherzustellen, müssen Sie Support und Status der Verschlüsselung überprüfen. Überprüfen Sie, ob Ihre ONTAP Version NetApp Volume Encryption (NVE) unterstützt und bevor Sie den Controller herunterfahren, ob der Schlüsselmanager aktiv ist.' 
---
= Prüfen Sie die Unterstützung und den Status der Verschlüsselungsschlüssel – AFF A70 und AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um die Datensicherheit in Ihrem AFF A70 und AFF A90 Storage-System sicherzustellen, müssen Sie Support und Status der Verschlüsselung überprüfen. Überprüfen Sie, ob Ihre ONTAP Version NetApp Volume Encryption (NVE) unterstützt und bevor Sie den Controller herunterfahren, ob der Schlüsselmanager aktiv ist.
