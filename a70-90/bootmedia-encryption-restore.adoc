...
summary: Stellen Sie die Verschlüsselung auf den Ersatz-Boot-Medien in Ihrem AFF A70- oder AFF A90-System wieder her, um eine kontinuierliche Datensicherung zu gewährleisten. Dabei werden die Schlüsselverfügbarkeit überprüft, Verschlüsselungseinstellungen neu angewendet und der sichere Zugriff auf Ihre Daten bestätigt. 
---
= Wiederherstellung der Verschlüsselung – AFF A70 und AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Stellen Sie die Verschlüsselung auf den Ersatz-Boot-Medien in Ihrem AFF A70- oder AFF A90-System wieder her, um eine kontinuierliche Datensicherung zu gewährleisten. Dabei werden die Schlüsselverfügbarkeit überprüft, Verschlüsselungseinstellungen neu angewendet und der sichere Zugriff auf Ihre Daten bestätigt.
