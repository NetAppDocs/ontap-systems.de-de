...
[role="lead"]
Beginnen Sie mit dem Austausch des Controllers im AFF A70 oder AFF A90 Storage-System, indem Sie den beeinträchtigten Controller herunterfahren, den Controller entfernen und austauschen, die Systemkonfiguration wiederherstellen und die Systemvorgänge überprüfen.
