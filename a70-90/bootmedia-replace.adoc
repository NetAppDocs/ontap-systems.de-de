...
---
= Ersetzen Sie die Startmedien - AFF A70, AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um das Startmedium zu ersetzen, müssen Sie das System Management-Modul von der Rückseite des Systems entfernen, das gestörte Startmedium entfernen, das Ersatz-Startmedium im System Management-Modul installieren und das Startabbild auf ein USB-Flash-Laufwerk übertragen.
