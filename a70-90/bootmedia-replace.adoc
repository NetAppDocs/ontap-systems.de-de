...
summary: Die Boot-Medien in Ihrem AFF A70 oder AFF A90 System speichern wichtige Firmware- und Konfigurationsdaten. Beim Austausch wird das Systemverwaltungsmodul entfernt, das gestörte Startmedium entfernt, das Ersatz-Startmedium installiert und das ONTAP-Image anschließend auf das Ersatz-Startmedium übertragen. 
---
...
[role="lead"]
Die Boot-Medien in Ihrem AFF A70 oder AFF A90 System speichern wichtige Firmware- und Konfigurationsdaten. Beim Austausch wird das Systemverwaltungsmodul entfernt, das gestörte Startmedium entfernt, das Ersatz-Startmedium installiert und das ONTAP-Image anschließend auf das Ersatz-Startmedium übertragen.
