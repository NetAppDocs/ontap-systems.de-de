...
---
= Komplette Einrichtung und Konfiguration des Storage-Systems – AFF A70, AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach der Installation der Hardware konfigurieren und verwalten Sie das Speichersystem mit der ONTAP Software.
...
+
image::../media/drw_autodiscovery_controler_select.svg[So ermitteln Sie Ihre Controller mit dem Windows File Explorer]
...
.Bevor Sie beginnen
Stellen Sie sicher, dass Ihr Laptop mit dem seriellen Konsolenport verbunden ist und die Controller eingeschaltet sind. Anweisungen finden Sie unter link:install-power-hardware.html#step-2-power-on-the-controllers["Schalten Sie die Controller ein"] .
...
NOTE: Nachdem der Cluster initialisiert wurde, laden Sie ihn herunter und führen Sie aus  https://mysupport.netapp.com/site/tools/tool-eula/activeiq-configadvisor["Active IQ Config Advisor"] , um das Setup zu bestätigen.
