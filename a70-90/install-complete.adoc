...
summary: Nachdem Sie Ihr AFF A70 oder AFF A90 Storage-System eingeschaltet haben, erkennen Sie Ihr Cluster-Netzwerk und richten ein ONTAP Cluster ein. 
---
= Vollständige Einrichtung und Konfiguration des Storage-Systems – AFF A70 und AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nachdem Sie Ihr AFF A70 oder AFF A90 Storage-System eingeschaltet haben, erkennen Sie Ihr Cluster-Netzwerk und richten ein ONTAP Cluster ein.
