...
summary: Fahren Sie den Controller in Ihrem AFF A70 oder AFF A90 Storage-System herunter, um Datenverlust zu vermeiden und beim Austausch des Controllers die Systemstabilität zu gewährleisten. 
---
= Vor dem Austausch ist der defekte Controller in Ihrem AFF A70 oder AFF A90 System herunterzufahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den Controller in Ihrem AFF A70 oder AFF A90 Storage-System herunter, um Datenverlust zu vermeiden und beim Austausch des Controllers die Systemstabilität zu gewährleisten.
