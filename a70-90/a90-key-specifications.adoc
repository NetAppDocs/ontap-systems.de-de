...
---
= Wichtigste Spezifikationen für ein AFF A90 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ausgewählte Spezifikationen des AFF A90 Speichersystems in einer Konfiguration mit einem einzelnen Hochverfügbarkeits-Paar. Die vollständigen Spezifikationen dieses Speichersystems sind im NetApp Hardware Universe (HWU) verfügbar.
