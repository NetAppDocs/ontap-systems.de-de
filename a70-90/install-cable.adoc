...
---
= Die AFF A70 oder AFF A90 Hardware für Netzwerk- und Speicherverbindungen verkabeln
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
--
Verwenden Sie das 100-GbE-Kabel, um die Ports e1a und e7a der Controller A und B mit den Cluster-Netzwerk-Switches A und B zu verbinden.
...
NOTE: Ports e1b und e7b sollten nicht für Host-Netzwerkverbindungen verwendet werden. Eine separate Host-Karte ist zu verwenden.
...
. Schließen Sie Ihre 10/25 GbE-Karten an Ihre Host-Netzwerk-Switches an.
+
...
Die folgenden Verkabelungsanweisungen zeigen, wie die Controller mit einem Storage Shelf verbunden werden. Eine der folgenden Verkabelungsoptionen, die zur jeweiligen Konfiguration passt, kann ausgewählt werden.
...
.Über diese Aufgabe
Die AFF A70 und AFF A90 Speichersysteme unterstützen NS224-Einschübe mit entweder dem NSM100 oder NSM100B Modul. Die wichtigsten Unterschiede zwischen den Modulen sind:
...
.. Port e11b mit Shelf 2, NSM A Port e0b verbinden.
+
...
Nachdem Sie die Hardware für Ihr AFF A70 oder AFF A90 System verkabelt haben, link:install-power-hardware.html["Schalten Sie das AFF A70- oder AFF A90-Speichersystem ein"].
