...
summary: Nachdem Sie die Rack-Hardware für das AFF A70 oder AFF A90 Storage-System installiert und die Kabel für die Controller und Storage Shelfs installiert haben, sollten Sie die Storage-Shelfs und Controller einschalten. 
---
...
+
image::../media/drw_a1k_70-90_power_source_icon_ieops-1700.svg[Stromanschlussdiagramm zu AFF A1K AFF A70 oder AFF A90 oder FAS70 oder FAS90]
...
Nachdem Sie Ihr AFF A70 oder AFF A90 Speichersystem eingeschaltet haben, https://docs.netapp.com/us-en/ontap/software_setup/workflow-summary.html["Richten Sie Ihren Cluster ein"] .
