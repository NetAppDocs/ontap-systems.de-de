...
---
= Installations- und Konfigurationsablauf für AFF A70 und AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Bevor die Controller eingeschaltet werden, wird jedes NS224 Shelf eingeschaltet und eine eindeutige Shelf-ID zugewiesen. Anschließend wird der Laptop oder die Konsole mit dem Controller verbunden und die Controller werden mit den Stromquellen verbunden.
