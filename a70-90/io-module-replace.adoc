...
[role="lead"]
Ersetzen Sie ein I/O-Modul in Ihrem AFF A70 oder AFF A90-System, wenn das Modul ausfällt oder ein Upgrade erfordert, um eine höhere Leistung oder zusätzliche Funktionen zu unterstützen.
