...
summary: Wenn bei einem Hardware-Ausfall oder Upgrade der Controller des AFF A70 oder AFF A90 Systems erforderlich ist, ersetzen Sie ihn. Bei diesem Vorgang wird der beeinträchtigte Controller entfernt, die Komponenten zum Ersatzcontroller verschoben, der Ersatzcontroller installiert und neu gestartet. 
---
= Ersetzen Sie das Controller-Modul – AFF A70 und AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Wenn bei einem Hardware-Ausfall oder Upgrade der Controller des AFF A70 oder AFF A90 Systems erforderlich ist, ersetzen Sie ihn. Bei diesem Vorgang wird der beeinträchtigte Controller entfernt, die Komponenten zum Ersatzcontroller verschoben, der Ersatzcontroller installiert und neu gestartet.
