...
---
= Den Controller in Ihrem AFF A70 oder AFF A90 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Das Steuergerät ist aus dem Gehäuse zu entfernen, bevor es oder eine interne Komponente ausgetauscht wird.
...
Nachdem Sie den defekten AFF A70 oder AFF A90 -Controller ausgetauscht haben, müssen Sie Folgendes tun:link:controller-replace-system-config-restore-and-verify.html["Stellen Sie die Systemkonfiguration wieder her"] Die
