...
summary: Wenn das Startmedium in Ihrem AFF A70- oder AFF A90-System beschädigt ist, können Sie das Wiederherstellungs-Image von einem USB-Laufwerk starten und die Konfiguration vom Partnerknoten wiederherstellen. 
---
...
[role="lead"]
Wenn das Startmedium in Ihrem AFF A70- oder AFF A90-System beschädigt ist, können Sie das Wiederherstellungs-Image von einem USB-Laufwerk starten und die Konfiguration vom Partnerknoten wiederherstellen.
