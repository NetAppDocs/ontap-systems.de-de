...
summary: Nach der Installation des neuen Startmediengeräts in Ihrem AFF A70- oder AFF A90-System können Sie das Wiederherstellungs-Image von einem USB-Laufwerk starten und die Konfiguration vom Partnerknoten wiederherstellen. 
---
...
[role="lead"]
Nach der Installation des neuen Startmediengeräts in Ihrem AFF A70- oder AFF A90-System können Sie das Wiederherstellungs-Image von einem USB-Laufwerk starten und die Konfiguration vom Partnerknoten wiederherstellen.
