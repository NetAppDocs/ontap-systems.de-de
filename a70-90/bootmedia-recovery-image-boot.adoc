...
summary: Wenn das Startmedium in Ihrem AFF A70- oder AFF A90-System beschädigt ist, können Sie das Wiederherstellungs-Image von einem USB-Laufwerk starten, die Konfiguration vom Partnerknoten wiederherstellen und die Umgebungsvariablen überprüfen. 
---
...
[role="lead"]
Wenn das Startmedium in Ihrem AFF A70- oder AFF A90-System beschädigt ist, können Sie das Wiederherstellungs-Image von einem USB-Laufwerk starten, die Konfiguration vom Partnerknoten wiederherstellen und die Umgebungsvariablen überprüfen.
