...
summary: Wichtige Spezifikationen des AFF A90 Speichersystems 
---
...
[role="lead"]
Nachfolgend sind ausgewählte Spezifikationen für den AFF A90 aufgeführt.  Besuchen https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) für eine vollständige Liste der AFF A90 Spezifikationen.  Diese Seite spiegelt ein einzelnes Paar mit hoher Verfügbarkeit wider.
...
* NAS: 12 HA-Paare, 79,3 PB / 70,4 PiB Rohkapazität, 24576 GB maximaler Speicher
* SAN: 6 HA-Paare, 39,7 PB / 35,2 PiB Rohkapazität, 12288 GB maximaler Speicher
* HA-Paar: 6,6 PB / 5,9 PiB Rohkapazität, 2048,0000 GB maximaler Speicher
