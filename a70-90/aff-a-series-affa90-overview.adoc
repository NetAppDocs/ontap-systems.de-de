...
[role="lead"]
Ausgewählte Spezifikationen des AFF A90-Speichersystems in einer Konfiguration mit einem einzelnen Hochverfügbarkeits-Paar. Die vollständige Liste der AFF A90-Spezifikationen ist unter https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) verfügbar.
