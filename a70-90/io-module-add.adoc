...
[role="lead"]
Sie können Ihrem AFF A70 und AFF A90 Storage-System ein I/O-Modul hinzufügen, wenn leere Steckplätze verfügbar sind oder wenn alle Steckplätze vollständig belegt sind.
