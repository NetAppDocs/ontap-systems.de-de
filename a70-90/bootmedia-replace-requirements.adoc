...
---
= Anforderungen für die manuelle Wiederherstellung von Bootmedien in einem AFF A70 oder AFF A90 System überprüfen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Wenn auf Ihrem System ONTAP 9.17.1 oder höher ausgeführt wird, ist die link:bootmedia-replace-workflow-bmr.html["automatisiertes Boot-Wiederherstellungsverfahren"] zu verwenden.
