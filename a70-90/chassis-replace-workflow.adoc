...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["Eins"]link:chassis-replace-shutdown.html["Schalten Sie den beeinträchtigten Regler aus"]
