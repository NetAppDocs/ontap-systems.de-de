...
---
= Den NVRAM in Ihrem AFF A70 oder AFF A90 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
WARNING: Das NVRAM Modul ist nicht Hot-Swap-fähig. Vor dem Austausch sollten die Laufwerke neu eingesetzt, der Node heruntergefahren, die Stromversorgung des Controllers getrennt und der Controller einige Zentimeter aus dem Gehäuse herausgezogen werden.
...
--
Um NVRAM DIMMs im NVRAM Modul auszutauschen, muss zuerst das NVRAM Modul entfernt und anschließend das Ziel-DIMM ersetzt werden.
...
+
.. Vom intakten Controller aus den Speicher des ausgetauschten Controllers zurückgeben:
+
