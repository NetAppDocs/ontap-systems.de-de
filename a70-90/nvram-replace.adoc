...
.Bevor Sie beginnen
* Stellen Sie sicher, dass Sie das Ersatzteil zur Verfügung haben. Sie müssen die fehlerhafte Komponente durch eine Austauschkomponente ersetzen, die Sie von Ihrem Anbieter erhalten haben.
...
== Schritt 3: Ersetzen Sie die NVRAM-DIMMs
