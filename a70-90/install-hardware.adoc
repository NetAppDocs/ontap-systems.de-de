...
summary: Installieren Sie nach der Vorbereitung auf die Installation des AFF A70 oder AFF A90 Storage-Systems die Hardware für das System. Installieren Sie zunächst die Schienensätze. Installieren und sichern Sie dann Ihre Plattform in einem Schrank oder einem Telco-Rack. 
---
= Die AFF A70 oder AFF A90 Hardware in einem Schrank oder Rack installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
