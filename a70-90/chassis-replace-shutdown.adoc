...
summary: Fahren Sie die Controller im AFF A70 oder AFF A90 Storage-System herunter, wenn Sie das Chassis austauschen müssen. Es ist wichtig, den Controller sicher herunterzufahren, um Datenverlust zu vermeiden und die Systemstabilität sicherzustellen. 
---
...
[role="lead"]
Fahren Sie die Controller im AFF A70 oder AFF A90 Storage-System herunter, wenn Sie das Chassis austauschen müssen. Es ist wichtig, die Controller sicher herunterzufahren, um Datenverlust zu vermeiden und die Systemstabilität sicherzustellen.
