...
summary: Fahren Sie die Controller im AFF A70 oder AFF A90 Storage-System herunter, wenn Sie das Chassis austauschen müssen. Vor der Durchführung von Wartungsarbeiten oder dem Austausch von Komponenten ist es wichtig, den Controller sicher herunterzufahren, um Datenverlust zu vermeiden und die Systemstabilität sicherzustellen. 
---
= Fahren Sie die Controller herunter - AFF A70 und AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie die Controller im AFF A70 oder AFF A90 Storage-System herunter, wenn Sie das Chassis austauschen müssen. Vor der Durchführung von Wartungsarbeiten oder dem Austausch von Komponenten ist es wichtig, den Controller sicher herunterzufahren, um Datenverlust zu vermeiden und die Systemstabilität sicherzustellen.
