...
summary: Fahren Sie die Controller in Ihrem AFF A70 oder AFF A90 Storage-System herunter, um Datenverlust zu vermeiden und beim Austausch des Chassis für Systemstabilität zu sorgen. 
---
= Die AFF A70 oder AFF A90 Controller werden heruntergefahren, um das Chassis auszutauschen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie die Controller in Ihrem AFF A70 oder AFF A90 Storage-System herunter, um Datenverlust zu vermeiden und beim Austausch des Chassis für Systemstabilität zu sorgen.
