...
---
= Zurücknehmen und Rückgeben des Controllers - AFF A70, AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Setzen Sie den Austauschvorgang fort, indem Sie den Speicher neu einbauen, die Netzwerkverbindungen herstellen und den Controller zurückgeben.
