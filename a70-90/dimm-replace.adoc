...
summary: Ersetzen Sie ein DIMM in Ihrem AFF A70- oder AFF A90-System, wenn zu viele korrigierbare oder nicht korrigierbare Fehler erkannt werden. Diese Probleme, die häufig durch einen Ausfall eines einzelnen DIMM verursacht werden, können das Booten von ONTAP durch das Storage-System verhindern. 
---
...
[role="lead"]
Ersetzen Sie ein DIMM in Ihrem AFF A70- oder AFF A90-System, wenn zu viele korrigierbare oder nicht korrigierbare Fehler erkannt werden. Diese Probleme, die häufig durch einen Ausfall eines einzelnen DIMM verursacht werden, können das Booten von ONTAP durch das Storage-System verhindern.
