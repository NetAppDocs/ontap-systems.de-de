...
---
= Ein DIMM-Modul in Ihrem AFF A70 oder AFF A90 System ersetzen, um Speicherfehler zu beheben.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Bevor Sie beginnen
* Stellen Sie sicher, dass alle anderen Komponenten im System ordnungsgemäß funktionieren. Wenn dies nicht der Fall ist, wenden Sie sich an den technischen Support.
...
Um das DIMM auszutauschen, befindet es sich im Controller, und die spezifische Reihenfolge der Schritte ist zu beachten.
