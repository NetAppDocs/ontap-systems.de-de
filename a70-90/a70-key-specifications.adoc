...
---
= Wichtigste Spezifikationen für ein AFF A70 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ausgewählte Spezifikationen des AFF A70 Speichersystems in einer Konfiguration mit einem einzelnen Hochverfügbarkeits-Paar werden dargestellt. Die vollständigen Spezifikationen dieses Speichersystems sind im NetApp Hardware Universe (HWU) verfügbar.
...
* Tiefe: 34,5 Zoll (36,6 Zoll mit Kabelmanagement-Halterung)
...
* Akustische Geräusche: Angegebene Schallleistung (LwAd): 8,6; Schalldruck (LpAm) (Positionen von Umstehenden): 71,6 dB
