...
[role="lead"]
Ersetzen Sie zunächst die Startmedien in Ihrem AFF A70 oder AFF A90 Storage-System, indem Sie die Ersatzmedien vorbereiten, sie im System installieren, das Startabbild wiederherstellen und die Systemfunktionen überprüfen.
