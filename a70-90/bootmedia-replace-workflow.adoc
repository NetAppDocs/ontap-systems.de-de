...
---
= Arbeitsablauf zum Austausch des Bootmediums für ein AFF A70 oder AFF A90 System unter Verwendung des manuellen Boot-Wiederherstellungsprozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Wenn auf Ihrem Speichersystem ONTAP 9.17.1 oder höher ausgeführt wird, verwenden Sie dielink:bootmedia-replace-workflow-bmr.html["automatisiertes Boot-Wiederherstellungsverfahren"] Die  Falls auf Ihrem System eine ältere Version von ONTAP ausgeführt wird, verwenden Sie die manuelle Boot-Wiederherstellungsprozedur.
