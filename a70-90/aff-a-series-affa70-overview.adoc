...
[role="lead"]
Ausgewählte Spezifikationen des AFF A70 Storage-Systems in einer Konfiguration mit einem einzelnen High Availability-Paar sind aufgeführt. Die vollständige Liste der AFF A70 Spezifikationen ist unter  https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) verfügbar.
