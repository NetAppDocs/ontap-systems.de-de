...
Die Systeme der AFF A-Serie und der AFF C-Serie sind mit den folgenden ONTAP Versionen kompatibel.
...
ASA r2-Systeme sind mit den folgenden ONTAP-Versionen kompatibel.
...
ASA Systeme sind mit den folgenden ONTAP Versionen kompatibel.
...
FAS Systeme sind mit den folgenden ONTAP Versionen kompatibel.
