...
summary: Der Controller im ASA A250-Speichersystem sollte heruntergefahren werden, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Bootmediums sicherzustellen. 
---
...
[role="lead"]
Das Herunterfahren des Controllers im ASA A250-Speichersystem verhindert Datenverlust und erhält die Systemstabilität während des automatisierten Wiederherstellungsprozesses des Bootmediums.
