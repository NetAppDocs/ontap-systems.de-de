...
---
= Vor dem Austausch muss der defekte Controller in einem ASA A250 System abgeschaltet werden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie den Controller in Ihrem ASA A250-Speichersystem ab, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers zu gewährleisten.
