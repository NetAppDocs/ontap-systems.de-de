...
---
= Austausch eines DIMM in einem ASA A250 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein DIMM in einem ASA A250 System wird ersetzt, wenn das System eine zunehmende Anzahl korrigierbarer ECC-Fehler meldet. Dieses Verfahren umfasst das Herunterfahren des betroffenen Controllers, das Öffnen des Controller-Moduls und das Installieren des Ersatz-DIMM, um einen Systemabsturz zu verhindern.
