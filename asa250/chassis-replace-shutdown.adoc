...
---
= Die ASA A250 Controller werden heruntergefahren, um das Chassis auszutauschen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie die Controller in Ihrem ASA A250-Speichersystem aus, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Gehäuses sicherzustellen.
