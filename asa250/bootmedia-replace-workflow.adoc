...
summary: Beginnen Sie mit dem Austausch des Bootmediums in Ihrem ASA A250-Speichersystem, indem Sie die Austauschvoraussetzungen prüfen, den Verschlüsselungsstatus kontrollieren, den Controller herunterfahren, das Bootmedium austauschen, das Wiederherstellungsimage starten, die Verschlüsselung wiederherstellen und die Systemfunktionalität überprüfen. 
---
= Arbeitsablauf zum Austausch des Bootmediums für ein ASA A250 System unter Verwendung des manuellen Boot-Wiederherstellungsprozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Beginnen Sie mit dem Austausch des Bootmediums in Ihrem ASA A250-Speichersystem, indem Sie die Austauschvoraussetzungen prüfen, den Verschlüsselungsstatus kontrollieren, den Controller herunterfahren, das Bootmedium austauschen, das Wiederherstellungsimage starten, die Verschlüsselung wiederherstellen und die Systemfunktionalität überprüfen.
