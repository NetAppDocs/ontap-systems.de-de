...
---
= Einen Lüfter in einem ASA A250 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes Lüftermodul in einem ASA A250-System wird ersetzt, indem der beeinträchtigte Controller heruntergefahren, das Controller-Modul geöffnet und der Ersatzlüfter installiert wird. Dieses Verfahren hält die Controller-Komponenten gekühlt und verhindert thermisch bedingte Systemfehler.
