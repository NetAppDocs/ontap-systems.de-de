...
summary: Übergeben Sie die Kontrolle über die Speicherressourcen wieder an den Ersatzcontroller, damit Ihr ASA A250 System den normalen Betrieb wieder aufnehmen kann. 
---
= Den Controller in einem ASA A250 System zurückgeben, damit der normale Betrieb fortgesetzt werden kann.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss der Wiederherstellung und Überprüfung der Systemkonfiguration ASA A250 müssen Sie das System neu verkabeln und die Festplatten neu zuweisen.
