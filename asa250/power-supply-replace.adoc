...
---
= Netzteil im laufenden Betrieb in einem ASA A250 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes Netzteil (PSU) in einem ASA A250 System kann im laufenden Betrieb ausgetauscht werden, ohne den Controller herunterzufahren. Die Netzteile sind redundant und auto-range-fähig, sodass der Austausch eines defekten Netzteils gegen ein passendes Modell den Systembetrieb ohne Unterbrechung aufrechterhält.
