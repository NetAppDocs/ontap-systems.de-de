...
---
= Die NVMEM-Batterie in einem ASA A250 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Eine defekte NVMEM-Batterie in einem ASA A250-System wird ersetzt, indem der beeinträchtigte Controller heruntergefahren, das Controller-Modul geöffnet und die Ersatzbatterie eingesetzt wird. Dieses Verfahren schützt zwischengespeicherte Schreibdaten vor Datenverlust durch eine beeinträchtigte Batterie.
