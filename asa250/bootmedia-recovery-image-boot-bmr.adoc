...
summary: Nach der Installation des neuen Bootmediums in Ihrem ASA A250-System können Sie den automatisierten Bootmedien-Wiederherstellungsprozess starten, um die Konfiguration vom Partner-Node wiederherzustellen. 
---
= Das Startabbild Ihres ASA A250 Systems kann mithilfe des automatisierten Startwiederherstellungsprozesses wiederhergestellt werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
