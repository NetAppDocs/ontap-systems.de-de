...
summary: Das Caching-Modul im FAS2700-System sollte ersetzt werden, wenn das System eine einzelne AutoSupport ASUP-Meldung registriert, dass das Modul offline gegangen ist. Andernfalls kommt es zu Leistungseinbußen. 
---
= Das Caching-Modul in einem FAS2700 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Caching-Modul im FAS2700-System sollte ersetzt werden, wenn das System eine einzelne AutoSupport (ASUP)-Meldung registriert, dass das Modul offline gegangen ist. Andernfalls kommt es zu Leistungseinbußen.
