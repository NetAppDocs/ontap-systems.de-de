...
summary: Den Speicher neu verkabeln, die Neuzuordnung der Festplatte bestätigen und die verbleibenden Aufgaben abschließen, damit der Controller zurückgegeben werden kann und das FAS2700 System wieder vollständig betriebsbereit ist. 
---
= Den Controller in Ihrem FAS2700 System zurückgeben, damit der normale Betrieb fortgesetzt werden kann.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Den Speicher neu verkabeln, die Neuzuordnung der Festplatte bestätigen und die verbleibenden Aufgaben abschließen, damit der Controller zurückgegeben werden kann und das FAS2700 System wieder vollständig betriebsbereit ist.
