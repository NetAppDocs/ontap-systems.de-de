...
summary: Um Ihr FAS2700 System wieder voll funktionsfähig zu machen, muss die NetApp Storage Encryption Konfiguration wiederhergestellt, Lizenzen für den neuen Controller installiert und das defekte Teil an NetApp zurückgesendet werden. 
---
= Den Controller-Austausch für ein FAS2700 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um Ihr FAS2700-System wieder voll funktionsfähig zu machen, müssen die NetApp Storage Encryption-Konfiguration (falls erforderlich) wiederhergestellt, Lizenzen für den neuen Controller installiert und das defekte Teil an NetApp zurückgesendet werden, wie in den mit dem Kit gelieferten RMA-Anweisungen beschrieben.
