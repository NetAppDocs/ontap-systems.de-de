...
summary: Der Controller in Ihrem FAS2700-System wird ersetzt, indem der defekte Controller entfernt, die FRU-Komponenten in das Ersatz-Controllermodul übertragen, dieses in das Gehäuse eingesetzt und in den Wartungsmodus gebootet wird. 
---
= Den Controller in einem FAS2700 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller in Ihrem FAS2700-System wird ersetzt, indem der defekte Controller entfernt, die FRU-Komponenten in das Ersatz-Controllermodul übertragen, dieses in das Gehäuse eingesetzt und in den Wartungsmodus gebootet wird.
