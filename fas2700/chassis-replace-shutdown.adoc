...
summary: Die Steuerungen im FAS2700 System sollten mit dem für die jeweilige Konfiguration passenden Verfahren heruntergefahren werden, bevor das Chassis ausgetauscht wird. 
---
= Die FAS2700 Controller werden heruntergefahren, um das Chassis auszutauschen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Steuerungen im FAS2700 System sollten mit dem für die jeweilige Konfiguration passenden Verfahren heruntergefahren werden, bevor das Chassis ausgetauscht wird.
