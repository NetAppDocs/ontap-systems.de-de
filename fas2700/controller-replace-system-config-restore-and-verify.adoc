...
summary: Nach Abschluss des Hardwareaustauschs und dem Booten in den Wartungsmodus wird die Controller-Konfiguration in Ihrem FAS2700-System wiederhergestellt und überprüft. 
---
= Wiederherstellung und Überprüfung der Controller-Konfiguration in einem FAS2700 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss des Hardwareaustauschs und dem Booten in den Wartungsmodus wird die Controller-Konfiguration in Ihrem FAS2700-System wiederhergestellt und überprüft.
