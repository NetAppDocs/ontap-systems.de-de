...
summary: Die Verschlüsselung auf dem Ersatz-Bootmedium wiederherstellen. Das FAS2700-System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. Die automatische Wiederherstellung über Bootmedien wird nicht unterstützt. 
---
= Wiederherstellung der Verschlüsselung auf dem Bootmedium in einem FAS2700 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Verschlüsselung auf dem Ersatz-Bootmedium wiederherstellen. Das FAS2700-System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. Die automatische Wiederherstellung über Bootmedien wird nicht unterstützt.
