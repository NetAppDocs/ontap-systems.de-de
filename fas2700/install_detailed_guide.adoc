...
---
= Detaillierter Leitfaden – AFF A220 und FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um Ihr FAS2700 oder AFF A220 System zu installieren, müssen Sie auf der NetApp Support Site ein Konto erstellen, Ihr System registrieren und die Lizenzschlüssel abrufen. Außerdem müssen Sie die entsprechende Anzahl und den entsprechenden Kabeltyp für Ihr System inventarisieren und bestimmte Netzwerkinformationen erfassen.
...
|===
. Informationen zum Kabelanschluss des Speichers finden Sie unter link:install_detailed_guide.md#["Verkabelung der Controller mit Laufwerk-Shelfs"]
...
+
link:../com.netapp.doc.hw-ds-sas3-icg/home.html["Installation und Verkabelung"]
