...
summary: Ein Laufwerk in Ihrem FAS2700 System sollte im laufenden Betrieb ausgetauscht werden, wenn die Plattform eine Warnmeldung an die Systemkonsole ausgibt, die auf einen Laufwerksausfall hinweist. Sowohl die Fehler-LED auf dem Bedienerdisplay als auch die Fehler-LED am ausgefallenen Laufwerk leuchten. 
---
= Ein Laufwerk im laufenden Betrieb in einem FAS2700 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein Laufwerk in Ihrem FAS2700 System sollte im laufenden Betrieb ausgetauscht werden, wenn die Plattform eine Warnmeldung an die Systemkonsole ausgibt, die auf einen Laufwerksausfall hinweist. Sowohl die Fehler-LED auf dem Bedienerdisplay als auch die Fehler-LED am ausgefallenen Laufwerk leuchten.
