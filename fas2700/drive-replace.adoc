...
summary: Ein Laufwerk in Ihrem FAS2700 System wird ersetzt, wenn die Plattform eine Warnmeldung auf der Systemkonsole protokolliert, die auf einen Laufwerksausfall hinweist. Sowohl die Fehler-LED auf dem Bedienerdisplay als auch die Fehler-LED am ausgefallenen Laufwerk leuchten. 
---
= Ein Laufwerk in Ihrem FAS2700 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein Laufwerk in Ihrem FAS2700 System wird ersetzt, wenn die Plattform eine Warnmeldung auf der Systemkonsole protokolliert, die auf einen Laufwerksausfall hinweist. Sowohl die Fehler-LED auf dem Bedienerdisplay als auch die Fehler-LED am ausgefallenen Laufwerk leuchten.
