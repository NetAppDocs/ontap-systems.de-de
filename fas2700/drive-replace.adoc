...
[role="lead"]
Ein ausgefallenes Laufwerk in Ihrem FAS2700 System kann im laufenden Betrieb ausgetauscht werden, während I/O-Vorgänge fortgesetzt werden, um die Speicherkapazität und Leistung wiederherzustellen.
