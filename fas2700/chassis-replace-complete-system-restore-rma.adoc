...
summary: Schließen Sie den Chassis-Austausch für Ihr FAS2700-System ab, indem Sie den HA-Status des Chassis überprüfen und die defekte Komponente an NetApp zurücksenden. 
---
= Den Chassis-Austausch für ein FAS2700 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schließen Sie den Chassis-Austausch für Ihr FAS2700-System ab, indem Sie den HA-Status des Chassis überprüfen und die defekte Komponente an NetApp zurücksenden.
