...
summary: Diese Seite enthält eine detaillierte Schritt-für-Schritt-Anleitung zur Installation Ihres FAS2700 Systems. 
---
= Installieren Sie Ihr FAS2700 System anhand der detaillierten Anleitung.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Detaillierte Schritt-für-Schritt-Anleitungen zur Installation Ihres FAS2700 Systems, von der Vorbereitung der Installation bis zur Erstkonfiguration.
...
+
drw_autodiscensation_controller_select_ieops-1849.svg[ONTAP-Symbol auswählen]
