...
** Wenn <lno-DARE> nicht in der Befehlsausgabe angezeigt wird und auf dem System ONTAP 9.5 ausgeführt wird, fahren Sie mit fort  1: Checking NVE or NSE on systems running ONTAP 9.5 and earlier.
** Wenn <lno-DARE> nicht in der Befehlsausgabe angezeigt wird und auf dem System ONTAP 9.6 oder höher ausgeführt wird, fahren Sie mit fort  2: Checking NVE or NSE on systems running ONTAP 9.6 and later.
