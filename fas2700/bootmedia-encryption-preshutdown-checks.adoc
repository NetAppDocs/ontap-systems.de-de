...
summary: Überprüfen Sie die Unterstützung und den Status des Verschlüsselungsschlüssels, bevor Sie den betroffenen Controller auf einem FAS2700-System herunterfahren. Das FAS2700-System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. Die automatische Wiederherstellung über Bootmedien wird nicht unterstützt. 
---
= Die Verschlüsselungsunterstützung auf dem Bootmedium in einem FAS2700 System prüfen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
