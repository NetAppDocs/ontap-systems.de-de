...
summary: Vor dem Austausch ist der defekte Controller in Ihrem FAS2700 System herunterzufahren, indem er übernommen und bis zur LOADER-Eingabeaufforderung angehalten wird. 
---
= Vor dem Austausch muss der defekte Controller in einem FAS2700 System abgeschaltet werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vor dem Austausch ist der defekte Controller in Ihrem FAS2700 System herunterzufahren, indem er übernommen und bis zur LOADER-Eingabeaufforderung angehalten wird.
