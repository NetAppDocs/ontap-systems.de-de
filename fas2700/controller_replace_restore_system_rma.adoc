...
---
= Vollständige Systemwiederherstellung - AFF A220 und FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Schritte
. Wenn Sie neue Lizenzschlüssel benötigen, holen Sie sich die Ersatzlizenz auf dem https://["NetApp Support Website"] Im Abschnitt „My Support“ unter „Software-Lizenzen“.
+
...
** Wenn AutoSupport nicht aktiviert ist, rufen Sie an https://["NetApp Support"] Um die Seriennummer zu registrieren.
