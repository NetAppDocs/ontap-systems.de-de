...
summary: Die Netzteile, Laufwerke und Controller-Module werden vom defekten Gehäuse in das Ersatzgehäuse umgesetzt, und das alte Gehäuse im Geräteschrank oder Systemschrank wird durch das neue Gehäuse desselben Modells ersetzt. 
---
= Das Chassis in einem FAS2700 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Netzteile, Laufwerke und Controller-Module werden vom defekten Gehäuse in das Ersatzgehäuse Ihres FAS2700 Systems übertragen, anschließend wird das alte Gehäuse im Geräteschrank oder Systemschrank gegen das neue Gehäuse desselben Modells ausgetauscht.
...
Nachdem Sie das Controller-Modul und alle anderen Komponenten in das neue Gehäuse installiert haben, starten Sie es.
