...
summary: Beginnen Sie mit dem Austausch der Startmedien in Ihrem AFF C80-Speichersystem, indem Sie die Ersatzmedien vorbereiten, im System installieren, das Startabbild wiederherstellen und die Systemfunktionalität überprüfen. 
---
= Schnellstart für den Austausch von Boot-Medien – AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Beginnen Sie mit dem Austausch der Startmedien in Ihrem AFF C80-Speichersystem, indem Sie die Ersatzmedien vorbereiten, im System installieren, das Startabbild wiederherstellen und die Systemfunktionalität überprüfen.
