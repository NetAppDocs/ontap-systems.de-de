...
---
= Wartung von AFF C80-Speichersystemen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Bei den Wartungsverfahren wird davon ausgegangen, dass die AFF C80-Systeme bereits als Storage-Node in der ONTAP-Umgebung implementiert wurden.
