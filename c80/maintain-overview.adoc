...
---
= Informationen zur Wartung eines AFF C80 Storage-Systems
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:system-management-replace.html["System Management-Modul"]
 a| 
Das Systemverwaltungsmodul stellt die Schnittstelle zwischen dem Controller und einer Konsole oder einem Laptop für Controller- oder Systemwartungszwecke bereit.  Das Systemverwaltungsmodul enthält das Startmedium und speichert die Systemseriennummer (SSN).
