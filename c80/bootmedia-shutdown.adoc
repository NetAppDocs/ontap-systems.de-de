...
summary: Fahren Sie den beeinträchtigten Controller in Ihrem AFF C80-Speichersystem herunter, um Datenverlust zu verhindern und die Systemstabilität während des manuellen Boot-Medienwiederherstellungsprozesses aufrechtzuerhalten. 
---
= Fahren Sie den Controller für die manuelle Wiederherstellung des Bootmediums herunter - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den beeinträchtigten Controller in Ihrem AFF C80-Speichersystem herunter, um Datenverlust zu verhindern und die Systemstabilität während des manuellen Boot-Medienwiederherstellungsprozesses aufrechtzuerhalten.
