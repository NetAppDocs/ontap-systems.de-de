...
---
= Fahren Sie den Controller herunter, um das Startmedium - AFF C80 - zu ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den Controller in Ihrem AFF C80-Speichersystem herunter, wenn Sie die Startmedien austauschen müssen. Vor der Durchführung von Wartungsarbeiten oder dem Austausch von Komponenten ist es wichtig, den Controller sicher herunterzufahren, um Datenverlust zu vermeiden und die Systemstabilität sicherzustellen.
