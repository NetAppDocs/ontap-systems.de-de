...
summary: Sie können Hot-Swap ein Ethernet-IO-Modul in Ihrem AFF C80-Speichersystem austauschen, wenn ein Modul ausfällt und Ihr Speichersystem alle ONTAP-Versionanforderungen erfüllt. 
---
= Ein I/O-Modul im laufenden Betrieb in Ihrem AFF C80 Storage-System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können ein Ethernet-E/A-Modul in Ihrem AFF C80-Speichersystem per Hot-Swap austauschen, wenn ein Modul ausfällt und Ihr Speichersystem alle ONTAP-Versionanforderungen erfüllt.
