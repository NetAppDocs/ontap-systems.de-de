...
summary: Sie können ein Ethernet-E/A-Modul in Ihrem AFF C80-Speichersystem per Hot-Swap austauschen, wenn ein Modul ausfällt und Ihr Speichersystem alle ONTAP-Versionanforderungen erfüllt. 
---
= Hot-Swap eines E/A-Moduls - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
