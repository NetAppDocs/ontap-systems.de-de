...
summary: Tauschen Sie das Gehäuse in Ihrem AFF C80-System aus, wenn ein Hardwarefehler dies erfordert. Beim Austausch werden die Netzteile entfernt, das vorhandene Gehäuse entfernt, das neue Gehäuse installiert und die Gehäusekomponenten wieder eingebaut. 
---
...
[role="lead"]
Tauschen Sie das Gehäuse in Ihrem AFF C80-System aus, wenn ein Hardwarefehler dies erfordert. Beim Austausch werden die Netzteile entfernt, das vorhandene Gehäuse entfernt, das neue Gehäuse installiert und die Gehäusekomponenten wieder eingebaut.
