...
summary: Starten Sie die Controller neu, überprüfen Sie den Systemzustand und senden Sie das fehlerhafte Teil an NetApp zurück, um den letzten Schritt im AFF C80 Chassis Replacement Workflow abzuschließen. 
---
...
[role="lead"]
Starten Sie die Controller neu, überprüfen Sie den Systemzustand und senden Sie das fehlerhafte Teil an NetApp zurück, um den letzten Schritt im AFF C80 Chassis Replacement Workflow abzuschließen.
