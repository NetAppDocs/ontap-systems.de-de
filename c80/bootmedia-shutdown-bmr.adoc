...
summary: Der Controller im AFF C80-Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität während des automatisierten Wiederherstellungsprozesses des Bootmediums zu gewährleisten. 
---
...
[role="lead"]
Der Controller im AFF C80-Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität während des automatisierten Wiederherstellungsprozesses des Bootmediums zu gewährleisten.
