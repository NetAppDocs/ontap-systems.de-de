...
summary: Stellen Sie die Verschlüsselung auf den Ersatz-Startmedien in Ihrem AFF C80-System wieder her, um eine dauerhafte Datensicherheit zu gewährleisten. Dabei werden die Schlüsselverfügbarkeit überprüft, Verschlüsselungseinstellungen neu angewendet und der sichere Zugriff auf Ihre Daten bestätigt. 
---
= Wiederherstellung der Verschlüsselung – AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Stellen Sie die Verschlüsselung auf den Ersatz-Startmedien in Ihrem AFF C80-System wieder her, um eine dauerhafte Datensicherheit zu gewährleisten. Dabei werden die Schlüsselverfügbarkeit überprüft, Verschlüsselungseinstellungen neu angewendet und der sichere Zugriff auf Ihre Daten bestätigt.
