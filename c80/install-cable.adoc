...
---
= Die AFF C80 Hardware für Netzwerk- und Speicherverbindungen verkabeln
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Über diese Aufgabe
Das AFF C80 Speichersystem unterstützt NS224 Shelves mit entweder dem NSM100 oder dem NSM100B Modul. Die wichtigsten Unterschiede zwischen den Modulen sind:
