...
--
Verwenden Sie das 100-GbE-Kabel, um die Ports e1a und e7a der Controller A und B mit den Cluster-Netzwerk-Switches A und B zu verbinden. .Schritte . Verbinden Sie Port e1a auf Controller A und Port e1a auf Controller B mit Cluster-Netzwerk-Switch A. . Verbinden Sie Port e7a auf Controller A und Port e7a auf Controller B mit Cluster-Netzwerk-Switch B.
...
NOTE: Verwenden Sie die Ports e1b und e7b nicht für Host-Netzwerkverbindungen. Verwenden Sie eine separate Hostkarte.
