...
[role="lead"]
Ersetzen Sie ein I/O-Modul in Ihrem AFF C80-System, wenn das Modul ausfällt oder ein Upgrade erfordert, um höhere Leistung oder zusätzliche Funktionen zu unterstützen.
