...
---
= Den Controller in Ihrem AFF C80 Storage-System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nachdem Sie den defekten AFF C80-Controller ausgetauscht haben, müssen Sie Folgendes tun:link:controller-replace-system-config-restore-and-verify.html["Stellen Sie die Systemkonfiguration wieder her"] Die
