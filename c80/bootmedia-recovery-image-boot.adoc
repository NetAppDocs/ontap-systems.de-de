...
[role="lead"]
Nach der Installation des neuen Startmediums in Ihrem AFF C80-System können Sie das Wiederherstellungs-Image von einem USB-Laufwerk starten und die Konfiguration vom Partnerknoten wiederherstellen.
