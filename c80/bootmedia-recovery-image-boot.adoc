...
summary: Wenn das Startmedium in Ihrem AFF C80-System beschädigt ist, können Sie das Wiederherstellungs-Image von einem USB-Laufwerk starten, die Konfiguration vom Partnerknoten wiederherstellen und die Umgebungsvariablen überprüfen 
---
= Starten Sie das Wiederherstellungs-Image - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Wenn das Startmedium in Ihrem AFF C80-System beschädigt ist, können Sie das Wiederherstellungs-Image von einem USB-Laufwerk starten, die Konfiguration vom Partnerknoten wiederherstellen und die Umgebungsvariablen überprüfen.
