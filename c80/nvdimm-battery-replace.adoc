...
summary: Tauschen Sie die NV-Batterie in Ihrem AFF C80-System aus, wenn die Batterie anfängt, den Akku zu laden oder ausfällt, da sie für die Aufbewahrung wichtiger Systemdaten bei Stromausfällen verantwortlich ist. 
---
= Die NV-Batterie im AFF C80-Speichersystem ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Tauschen Sie die NV-Batterie in Ihrem AFF C80-System aus, wenn die Batterie anfängt, den Akku zu laden oder ausfällt, da sie für die Aufbewahrung wichtiger Systemdaten bei Stromausfällen verantwortlich ist. Beim Austausch wird der Controller heruntergefahren, das Controller-Modul entfernt, die NV-Batterie ersetzt, das Controller-Modul wieder eingebaut und das fehlerhafte Teil wieder an den NetApp zurückgegeben.
