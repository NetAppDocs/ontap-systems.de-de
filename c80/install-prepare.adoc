...
---
= Vorbereitung der Installation eines AFF C80 Storage-Systems
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nachdem Sie die Installation Ihrer AFF C80 Hardware vorbereitet haben, link:install-hardware.html["Installieren Sie die Hardware für Ihr AFF C80-Speichersystem"].
