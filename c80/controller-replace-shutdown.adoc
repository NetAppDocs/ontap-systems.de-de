...
summary: Fahren Sie den Controller in Ihrem AFF C80-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Controllers zu gewährleisten. 
---
= Vor dem Austausch ist der defekte Controller in Ihrem AFF C80-Speichersystem herunterzufahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den Controller in Ihrem AFF C80-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Controllers zu gewährleisten.
