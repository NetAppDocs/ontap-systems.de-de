...
summary: Sie müssen ein Laufwerk ersetzen, wenn das Speichersystem eine Warnmeldung an die Systemkonsole meldet, die angibt, dass ein Laufwerk ausgefallen ist. Darüber hinaus leuchten die Fehler-LED auf der Bedieneranzeige und die Fehler-LED am ausgefallenen Laufwerk. 
---
