...
summary: In Ihrem AFF C80-System kann ein Laufwerk im laufenden Betrieb ausgetauscht werden, wenn ein Laufwerk ausfällt oder ein Upgrade erforderlich ist. Dabei werden das fehlerhafte Laufwerk identifiziert, sicher entfernt und ein neues Laufwerk installiert, um den fortlaufenden Datenzugriff und die Systemleistung zu gewährleisten. 
---
= Hot-Swap eines SSD-Laufwerks in einem AFF C80 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
In Ihrem AFF C80-System kann ein Laufwerk im laufenden Betrieb ausgetauscht werden, wenn ein Laufwerk ausfällt oder ein Upgrade erforderlich ist. Dabei werden das fehlerhafte Laufwerk identifiziert, sicher entfernt und ein neues Laufwerk installiert, um den fortlaufenden Datenzugriff und die Systemleistung zu gewährleisten.
