...
summary: Ersetzen Sie ein DIMM in Ihrem AFF C80-System, wenn zu viele korrigierbare oder nicht korrigierbare Speicherfehler festgestellt werden. Derartige Fehler können das Booten von ONTAP durch das Storage-System verhindern. 
---
= Ein DIMM im AFF C80 Storage-System wird ersetzt, um Speicherfehler zu beheben.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
