...
summary: Der Austausch des AFF C80-Controllers umfasst Schritte zum Herunterfahren des Controllers, Entfernen und Austauschen des Controllers, Neukonfigurieren der Systemeinstellungen und Überprüfen der Systemvorgänge. 
---
...
[role="lead"]
Der Austausch des AFF C80-Controllers umfasst Schritte zum Herunterfahren des Controllers, Entfernen und Austauschen des Controllers, Neukonfigurieren der Systemeinstellungen und Überprüfen der Systemvorgänge.
