...
summary: Auf dem Boot-Medium Ihres AFF C80-Systems werden wichtige Firmware- und Konfigurationsdaten gespeichert. Wenn das Startmedium fehlschlägt, müssen Sie das Controller-Modul trennen, das System Management-Modul entfernen, das gestörte Startmedium entfernen und das Startmedium im System Management-Modul austauschen. 
---
...
[role="lead"]
Auf dem Boot-Medium Ihres AFF C80-Systems werden wichtige Firmware- und Konfigurationsdaten gespeichert. Wenn das Startmedium fehlschlägt, müssen Sie das Controller-Modul trennen, das System Management-Modul entfernen, das gestörte Startmedium entfernen und das Startmedium im System Management-Modul austauschen.
