...
+
https://docs.netapp.com/us-en/ontap-systems/platform-supplemental/superrail-install.html["Installieren von SuperRail in einem Vierpolige-Rack"^]
...
+
image::../media/drw_asac800_weight_caution.png[drw asac800 Gewicht Vorsicht]

. Schließen Sie Kabelmanagement-Geräte (wie abgebildet) an.
+
image::../media/drw_asac800_install_cable_mgmt.png[drw asac800-Installationskabel managen]
...
image:../media/oie_legend_icon_3_lp.png[""]
 a| 
Verkabeln Sie die Management-Ports mit den Management-Netzwerk-Switches    image:../media/drw_asac800_mgmt_cabling.png["Abbildung zeigt die Position der Management-Ports auf der Rückseite des Systems"]
...
1
 a| 
Verkabeln Sie die Ports 2a bis 2d mit den FC-Host-Switches.image:../media/drw_asac800_fc_host_cabling.png[""]
...
1
 a| 
Verkabeln Sie die Ports e4a über e4d mit den 10 GbE Host Netzwerk-Switches.image:../media/drw_asac800_10gbe_host_cabling.png[""]
...
image:../media/oie_legend_icon_1_mb.png[""]
 a| 
Controller A am Shelf verkabeln:    image:../media/drw_asac800_1shelf_cabling_a.png[""]
...
image:../media/oie_legend_icon_2_lo.png[""]
 a| 
Controller B am Shelf verkabeln:    image:../media/drw_asac800_1shelf_cabling_b.png[""]
...
image:../media/oie_legend_icon_1_mb.png[""]
 a| 
Verbinden Sie Controller A mit den Shelfs:    image:../media/drw_asac800_2shelf_cabling_a.png[""]
...
image:../media/oie_legend_icon_2_lo.png[""]
 a| 
Controller B mit den Shelfs verkabeln:    image:../media/drw_asac800_2shelf_cabling_b.png[""]
...
+
image::../media/drw_console_connect_asac800.png[drw-Konsole verbinden asac800]

.. Verbinden Sie den Laptop oder die Konsole mit dem Switch im Management-Subnetz.
+
image::../media/drw_client_mgmt_subnet_asac800.png[drw-Client-Management-Subnetz asac800]
