...
summary: Zum Austausch des Chassis müssen die Controller heruntergefahren werden. 
---
= Die FAS500f Controller werden heruntergefahren, um das Chassis auszutauschen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie die Controller in Ihrem FAS500f-Speichersystem aus, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Gehäuses sicherzustellen.
