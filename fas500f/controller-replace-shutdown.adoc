...
---
= Vor dem Austausch muss der defekte Controller in einem FAS500f System abgeschaltet werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie den Controller in Ihrem FAS500f-Speichersystem aus, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers zu gewährleisten.
