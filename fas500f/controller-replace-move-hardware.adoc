...
---
= Den Controller in einem FAS500f System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Tauschen Sie den Controller in Ihrem FAS500f-System aus, wenn ein Hardwaredefekt dies erfordert. Der Austauschvorgang umfasst das Entfernen des defekten Controllers, das Umsetzen der Komponenten auf den Ersatzcontroller, den Einbau des Ersatzcontrollers und dessen Neustart.
...
Nachdem Sie den defekten FAS500f Controller ausgetauscht haben, müssen Sie link:controller-replace-system-config-restore-and-verify.html["Systemkonfiguration wiederherstellen und verifizieren"].
