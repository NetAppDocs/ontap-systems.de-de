...
---
= Das Chassis in einem FAS500f System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Tauschen Sie das Gehäuse Ihres FAS500f Systems aus, wenn ein Hardwaredefekt dies erfordert. Der Austauschvorgang umfasst das Entfernen der Controller und Netzteile (PSUs), das Entfernen der Laufwerke, den Einbau des Ersatzgehäuses und das Wiedereinbauen der Gehäusekomponenten.
...
Nachdem Sie das defekte FAS500f Chassis ausgetauscht und die Komponenten wieder eingebaut haben, müssen Sie link:chassis-replace-complete-system-restore-rma.html["Schließen Sie den Austausch des Gehäuses ab"]
