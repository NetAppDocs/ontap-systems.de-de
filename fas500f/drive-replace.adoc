...
summary: Ein defektes Laufwerk im FAS500f Speichersystem kann unterbrechungsfrei ausgetauscht werden, während I/O-Vorgänge laufen. Die Plattform protokolliert eine Warnmeldung und aktiviert die Fehler-LEDs, wenn ein Laufwerk ausfällt. Das Austauschverfahren unterscheidet sich geringfügig, je nachdem, ob das Laufwerk eine SSD oder eine HDD ist. 
---
= Ein Laufwerk im laufenden Betrieb in Ihrem FAS500f System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes Laufwerk im FAS500f Speichersystem kann unterbrechungsfrei ausgetauscht werden, während I/O-Vorgänge laufen. Die Plattform protokolliert eine Warnmeldung und aktiviert die Fehler-LEDs, wenn ein Laufwerk ausfällt. Das Austauschverfahren unterscheidet sich geringfügig, je nachdem, ob das Laufwerk eine SSD oder eine HDD ist.
