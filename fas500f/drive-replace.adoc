...
summary: Ein defektes Laufwerk in Ihrem FAS500f Speichersystem kann ohne Unterbrechung im laufenden Betrieb ausgetauscht werden, während I/O Vorgänge stattfinden. Die Plattform protokolliert eine Warnmeldung und lässt die Fehler-LEDs aufleuchten, wenn ein Laufwerk ausfällt, und das Austauschverfahren unterscheidet sich geringfügig, je nachdem, ob das Laufwerk eine SSD oder eine HDD ist. 
---
= Laufwerk im laufenden Betrieb in einem FAS500f System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes Laufwerk in Ihrem FAS500f Speichersystem kann ohne Unterbrechung im laufenden Betrieb ausgetauscht werden, während I/O Vorgänge stattfinden. Die Plattform protokolliert eine Warnmeldung und lässt die Fehler-LEDs aufleuchten, wenn ein Laufwerk ausfällt, und das Austauschverfahren unterscheidet sich geringfügig, je nachdem, ob das Laufwerk eine SSD oder eine HDD ist.
