...
summary: Das DIMM in einem FAS500f-System ist auszutauschen, wenn das System über Health Monitor-Warnmeldungen übermäßig viele korrigierbare oder nicht korrigierbare ECC-Speicherfehler meldet. Ein defektes DIMM kann verhindern, dass das Speichersystem ONTAP startet, daher wird durch den Austausch der stabile Betrieb wiederhergestellt. Dieses Verfahren umfasst das Herunterfahren des betroffenen Controllers, den Austausch des DIMM und die Rücksendung des defekten Bauteils an NetApp. 
---
= Austausch eines DIMM in einem FAS500f System zur Behebung von Speicherfehlern
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das DIMM in einem FAS500f-System ist auszutauschen, wenn das System über Health Monitor-Warnmeldungen übermäßig viele korrigierbare oder nicht korrigierbare ECC-Speicherfehler meldet. Ein defektes DIMM kann verhindern, dass das Speichersystem ONTAP startet, daher wird durch den Austausch der stabile Betrieb wiederhergestellt. Dieses Verfahren umfasst das Herunterfahren des betroffenen Controllers, den Austausch des DIMM und die Rücksendung des defekten Bauteils an NetApp.
...
|===
. Das Controllermodul mit beiden Händen greifen und vorsichtig aus dem Gehäuse herausziehen, anschließend auf eine ebene, stabile Oberfläche legen.
...
+
Die DIMMs müssen fest im Sockel sitzen. Falls ein DIMM nicht fest sitzt, sollte es erneut eingesetzt werden, um es richtig im Sockel auszurichten.
...
+
.. Es sollte überprüft werden, ob die Verriegelungsarme des Verriegelungsmechanismus in der vollständig ausgefahrenen Position eingerastet sind.
.. Mit beiden Händen das Steuermodul ausrichten und vorsichtig in die Verriegelungsarme des Arretiermechanismus schieben, bis es stoppt.
