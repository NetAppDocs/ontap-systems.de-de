...
---
= Ein FAS500f System mit detaillierten Schritt-für-Schritt-Anweisungen installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:../media/icon_square_1_green.png["Schritt 1"]
 a| 
Verbinden Sie die Cluster-Interconnect-Ports mit dem 25-GbE-Cluster-Interconnect-Kabel.
...
.. Im linken Bereich *Netzwerk* auswählen.
