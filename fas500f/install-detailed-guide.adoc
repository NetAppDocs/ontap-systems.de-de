...
image::../media/drw_affa250_mgmt_cabling.png[drw affa250-Management-Kabel]
 ...
 a| 
image::../media/oie_legend_icon_attn_symbol.png[oie-Legende Symbol attn Symbol]
 a| 
Schließen Sie die Stromkabel AN dieser Stelle NICHT an.
...
image::../media/drw_affa250_fc_host_cabling.png[drw affa250 fc-Hostkabel]
...
image::../media/drw_affa250_25gbe_host_cabling.png[drw affa250 25-gbe-Hostkabel]
