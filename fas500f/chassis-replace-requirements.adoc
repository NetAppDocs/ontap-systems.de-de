...
summary: Bevor Sie das Chassis Ihres FAS500f Systems austauschen, stellen Sie sicher, dass Sie die notwendigen Anforderungen für einen erfolgreichen Austausch erfüllen. Dazu gehört die Überprüfung, dass alle anderen Komponenten im System ordnungsgemäß funktionieren, dass Sie lokale Administratoranmeldedaten für ONTAP, das richtige Ersatzchassis und die erforderlichen Werkzeuge haben. 
---
= Anforderungen für den Austausch des Chassis - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bevor Sie das Chassis Ihres FAS500f Systems austauschen, stellen Sie sicher, dass Sie die notwendigen Anforderungen für einen erfolgreichen Austausch erfüllen. Dazu gehört die Überprüfung, dass alle anderen Komponenten im System ordnungsgemäß funktionieren, dass Sie lokale Administratoranmeldedaten für ONTAP, das richtige Ersatzchassis und die erforderlichen Werkzeuge haben.
