...
summary: Bevor das Chassis im FAS500f System ersetzt wird, sollte überprüft werden, ob alle notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sind. Dazu zählt die Bestätigung, dass alle anderen Komponenten im System ordnungsgemäß funktionieren, dass lokale Administratoranmeldedaten für ONTAP vorliegen, das korrekte Ersatzchassis vorhanden ist und die erforderlichen Werkzeuge bereitstehen. 
---
= Die Anforderungen für den Austausch eines Chassis in einem FAS500f System werden hier aufgeführt.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bevor das Chassis im FAS500f System ersetzt wird, sollte überprüft werden, ob alle notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sind. Dazu zählt die Bestätigung, dass alle anderen Komponenten im System ordnungsgemäß funktionieren, dass lokale Administratoranmeldedaten für ONTAP vorliegen, das korrekte Ersatzchassis vorhanden ist und die erforderlichen Werkzeuge bereitstehen.
