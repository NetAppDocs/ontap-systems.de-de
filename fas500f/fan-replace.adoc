...
---
= Das Lüftermodul in einem FAS500f System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein Lüfter muss durch ein neues Lüftermodul ersetzt werden, wenn er ausfällt.
...
Sie können den Lüfter mithilfe des folgenden Videos oder der tabellarischen Schritte ersetzen:
