...
---
= Arbeitsablauf zum Austausch des Bootmediums für ein FAS500f System unter Verwendung des automatisierten Boot-Wiederherstellungsprozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die automatische Wiederherstellung des Startabbilds beinhaltet das automatische Erkennen und Auswählen der passenden Startmenüoption durch das System. Dabei wird das Startabbild auf dem Partnerknoten verwendet, um ONTAP auf dem Ersatzstartmedium in Ihrem FAS500f Speichersystem neu zu installieren.
