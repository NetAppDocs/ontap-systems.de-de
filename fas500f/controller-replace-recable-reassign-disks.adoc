...
summary: Die Kontrolle über die Speicherressourcen wird an den Ersatzcontroller zurückgegeben, sodass Ihr FAS500f System den normalen Betrieb wieder aufnehmen kann. 
---
= Den Controller in einem FAS500f System zurückgeben, damit der normale Betrieb fortgesetzt werden kann.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Kontrolle über die Speicherressourcen wird an den Ersatzcontroller zurückgegeben, sodass Ihr FAS500f System den normalen Betrieb wieder aufnehmen kann. Nachdem die Systemkonfiguration wiederhergestellt und überprüft wurde, werden das System erneut verkabelt und die Festplatten neu zugewiesen.
...
Nachdem Sie das System neu verkabelt und die Festplatten neu zugewiesen haben, müssen Sie link:controller-replace-restore-system-rma.html["Schließen Sie den Controller-Austausch ab"].
