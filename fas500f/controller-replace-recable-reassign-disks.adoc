...
---
= Das System neu zuordnen und Festplatten neu zuweisen - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss der Wiederherstellung und Überprüfung der Systemkonfiguration FAS500f system müssen Sie das System neu verkabeln und die Festplatten neu zuweisen.
