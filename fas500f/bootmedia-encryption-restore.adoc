...
summary: Nach der Überprüfung der Umgebungsvariablen sind Schritte erforderlich, die speziell für Systeme gelten, bei denen Onboard Key Manager OKM, NetApp Storage Encryption NSE oder NetApp Volume Encryption NVE aktiviert sind. 
---
= Wiederherstellung der Verschlüsselung auf dem Bootmedium in einem FAS500f System nach dem manuellen Boot-Wiederherstellungsprozess
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach dem Austausch des Bootmediums sollte die Verschlüsselung wiederhergestellt werden, wenn Ihr FAS500f System Onboard Key Manager, NetApp Storage Encryption oder NetApp Volume Encryption zum Schutz Ihrer Daten verwendet.
