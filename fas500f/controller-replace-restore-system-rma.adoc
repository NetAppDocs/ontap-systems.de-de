...
summary: Um den Controller-Austausch für Ihr FAS500f-System abzuschließen, stellen Sie gegebenenfalls die NetApp Storage Encryption-Konfiguration wieder her, installieren Sie Lizenzen für den neuen Controller und senden Sie das defekte Teil an NetApp zurück. 
---
= Den Controller-Austausch für ein FAS500f System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um den Controller-Austausch für Ihr FAS500f System abzuschließen, wird die NetApp Storage Encryption-Konfiguration (falls erforderlich) wiederhergestellt, Lizenzen für den neuen Controller installiert und das defekte Teil an NetApp entsprechend den mit dem Kit gelieferten RMA-Anweisungen zurückgesendet.
