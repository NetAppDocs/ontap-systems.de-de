...
---
= Netzteil im laufenden Betrieb in Ihrem FAS500f System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Den Nockengriff drehen, um das Netzteil aus dem Controller-Modul zu ziehen, während gleichzeitig die Verriegelungslasche gedrückt wird.
+
[CAUTION]
====
...
+
Die Netzteile greifen in den internen Anschluss ein und verriegeln sich nur in einer Richtung.
