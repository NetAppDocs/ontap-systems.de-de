...
---
= Den defekten Controller in Ihrem FAS500f System während des manuellen Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss der NVE- oder NSE-Aufgaben wird der betroffene Controller mithilfe des für Ihre Konfiguration geeigneten Verfahrens heruntergefahren oder übernommen.
