...
---
= Wiederherstellung und Überprüfung der Controller Konfiguration in einem FAS500f System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss des Hardwareaustauschs und dem Hochfahren Ihres FAS500f Systems im Wartungsmodus ist die Systemkonfiguration auf niedriger Ebene des Ersatzcontrollers zu überprüfen und die Systemeinstellungen gegebenenfalls neu zu konfigurieren.
