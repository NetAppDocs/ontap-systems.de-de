...
[role="lead"]
Nach Abschluss des Hardwareaustauschs und dem Hochfahren Ihres FAS500f Systems in den Wartungsmodus müssen Sie die Low-Level-Systemkonfiguration des Ersatzcontrollers überprüfen und die Systemeinstellungen bei Bedarf neu konfigurieren.
