...
[role="lead"]
Nachfolgend finden Sie ausgewählte Spezifikationen für das FAS500f. Besuchen Sie https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) für eine vollständige Liste der FAS500f-Spezifikationen. Diese Seite bezieht sich auf ein einzelnes hochverfügbares Paar.
