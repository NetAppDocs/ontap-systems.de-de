...
summary: Wichtigste Spezifikationen für das FAS500f Speichersystem 
---
= Wichtigste Spezifikationen für ein FAS500f System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ausgewählte Spezifikationen des FAS500f Storage-Systems, die ein einzelnes Hochverfügbarkeitspaar widerspiegeln. Besuchen Sie https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) für die vollständige Liste der FAS500f Spezifikationen.



[[key-specifications-for-fas500f]]
=== Wichtige Spezifikationen für FAS500f

Plattformkonfiguration: FAS500f Single Chassis HA Pair
