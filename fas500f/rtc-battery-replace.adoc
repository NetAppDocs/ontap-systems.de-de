...
summary: Sie tauschen die Echtzeit-Batterie im Steuermodul aus, damit die Dienste und Anwendungen Ihres Systems, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin funktionieren. 
---
= Die Echtzeit Batterie der Echtzeituhr im FAS500f System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Alle anderen Systemkomponenten müssen ordnungsgemäß funktionieren. Falls dies nicht der Fall ist, ist der technische Support zu kontaktieren.
...
+
image::../media/drw_a250_remove_rtc_batt.png[Entfernen der RTC-Batterie]
...
+
image::../media/drw_a250_install_rtc_batt.png[Einsetzen der RTC-Batterie]
...
|===
 ...
 a| 
image:../media/icon_round_1.png["Legende Nummer 1"]
| Die Batterie mit dem Pluspol nach oben unter die Lasche des Akkugehäuses schieben. 
...
+
.. Es ist zu prüfen, ob die Verriegelungsarme des Verriegelungsmechanismus in der vollständig ausgefahrenen Position verriegelt sind.
