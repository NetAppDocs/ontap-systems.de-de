...
summary: Das Bootmedium in Ihrem FAS500f System speichert wichtige Firmware- und Konfigurationsdaten. Der Austausch umfasst das Entfernen des Controllermoduls, das Entfernen des defekten Bootmediums, das Einsetzen des Ersatz-Bootmediums und das erneute Installieren des Controllermoduls. 
---
= Das Bootmedium im FAS500f System kann mithilfe des automatisierten Boot-Wiederherstellungsprozesses ersetzt werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Bootmedium in Ihrem FAS500f System speichert wichtige Firmware- und Konfigurationsdaten. Der Austausch umfasst das Entfernen des Controllermoduls, das Entfernen des defekten Bootmediums, das Einsetzen des Ersatz-Bootmediums und das erneute Installieren des Controllermoduls.
