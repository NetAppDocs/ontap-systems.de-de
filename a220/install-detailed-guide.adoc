...
---
= Ein AFF A220 Storage-System mit detaillierten Schritten installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das AFF A220 Speichersystem lässt sich anhand detaillierter Schritt-für-Schritt-Anleitungen installieren, von der Montage und Verkabelung bis zur ersten Inbetriebnahme des Systems.
