...
---
= Die Anforderungen für den Austausch eines Chassis in einem AFF A220 System werden dargestellt.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vor dem Austausch des Gehäuses in Ihrem AFF A220 System sollten die Anforderungen für einen erfolgreichen Austausch geprüft werden. Beim Austausch des Gehäuses werden alle Netzteile, Laufwerke und Controller-Module vom defekten Gehäuse in das Ersatzgehäuse übertragen, und der Vorgang ist mit einer Unterbrechung verbunden.
