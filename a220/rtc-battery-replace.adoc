...
summary: Tauschen Sie die Echtzeituhr-Batterie in Ihrem AFF A220-Controllermodul aus, um sicherzustellen, dass Dienste und Anwendungen, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin funktionieren. 
---
= Die Batterie der Echtzeituhr in einem AFF A220 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Echtzeit Batterie (RTC) in Ihrem AFF A220-System sollte ersetzt werden, damit Dienste und Anwendungen, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin funktionieren.
