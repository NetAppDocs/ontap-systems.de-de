...
summary: Tauschen Sie das DIMM in Ihrem AFF A220 Controller-Modul aus, sobald Ihr System eine zunehmende Anzahl korrigierbarer Fehlerkorrekturcodes oder nicht korrigierbarer ECC-Fehler registriert. Wird ein defektes DIMM nicht ausgetauscht, kann dies zu einem Systemabsturz führen. 
---
= Austausch eines DIMM in Ihrem AFF A220 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein DIMM in Ihrem AFF A220 System ist auszutauschen, wenn das Speichersystem auf übermäßig viele korrigierbare ECC-Fehler oder einen nicht korrigierbaren ECC-Fehler stößt, was typischerweise durch den Ausfall eines einzelnen DIMM verursacht wird.
