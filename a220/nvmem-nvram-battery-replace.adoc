...
---
= Die NVMEM-Batterie in einem AFF A220 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die NVMEM Batterie in Ihrem AFF A220 System wird ersetzt, indem das Controller-Modul entfernt, die Batterie ausgetauscht und das Controller-Modul wieder eingesetzt wird.
