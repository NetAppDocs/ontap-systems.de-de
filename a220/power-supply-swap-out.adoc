...
---
= Netzteil im laufenden Betrieb in einem AFF A220 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Netzteil in Ihrem AFF A220 System kann im laufenden Betrieb ausgetauscht werden, indem das defekte Netzteil ausgeschaltet, vom Stromnetz getrennt und entfernt wird, bevor das Ersatznetzteil installiert und wieder angeschlossen wird.
