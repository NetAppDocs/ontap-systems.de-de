...
---
= Ein Laufwerk in Ihrem AFF A220 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes Laufwerk in Ihrem AFF A220 System kann ausgetauscht werden, ohne die I/O zu unterbrechen. Das AFF A220 unterstützt sowohl SSDs als auch HDDs, jeweils mit einem eigenen Austauschverfahren.
