...
summary: Das Bootmedium speichert einen primären und einen sekundären Satz von Systemdateien, die das System beim Start verwendet. Das AFF A220 System unterstützt nur manuelle Bootmedium-Wiederherstellungsverfahren. 
---
= Informationen zum Austausch des Bootmediums in einem AFF A220 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
