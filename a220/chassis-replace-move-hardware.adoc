...
---
= Das Chassis in einem AFF A220 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Chassis im AFF A220 System wird ersetzt, indem die Netzteile, Festplatten und Controller-Module vom defekten Chassis in das Ersatzchassis umgesetzt werden.
