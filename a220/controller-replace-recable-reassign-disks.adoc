...
---
= Das System wird neu verkabelt und die Datenträger in Ihrem AFF A220 System werden neu zugewiesen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller-Austausch für Ihr AFF A220 System wird abgeschlossen, indem die Speicherkabel neu angeschlossen und die Neuzuordnung der Festplatten bestätigt wird.
