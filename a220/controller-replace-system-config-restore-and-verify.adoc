...
---
= Die Controller-Konfiguration in Ihrem AFF A220 System wird wiederhergestellt und überprüft.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss des Hardware-Austauschs und dem Booten in den Wartungsmodus wird die Controller-Konfiguration in Ihrem AFF A220 System wiederhergestellt und überprüft.
