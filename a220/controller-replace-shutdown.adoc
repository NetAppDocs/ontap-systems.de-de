...
---
= Vor dem Austausch muss der defekte Controller in einem AFF A220-System heruntergefahren werden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der defekte Controller in Ihrem AFF A220 System wird vor dem Austausch heruntergefahren, indem er übernommen und bis zur LOADER-Eingabeaufforderung angehalten wird.
