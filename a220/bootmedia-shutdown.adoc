...
summary: Der Controller im AFF A220 Speichersystem sollte heruntergefahren werden, um Datenverlust zu vermeiden und die Systemstabilität während des manuellen Bootmedien-Wiederherstellungsprozesses zu gewährleisten. 
---
= Den Controller in Ihrem AFF A220 System herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller im AFF A220 Speichersystem sollte heruntergefahren werden, um Datenverlust zu vermeiden und die Systemstabilität während des manuellen Bootmedien-Wiederherstellungsprozesses zu gewährleisten.
