...
summary: Sie müssen das ONTAP Image vom USB-Laufwerk starten, das Dateisystem wiederherstellen und die Umgebungsvariablen überprüfen. Das AFF A220 -System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. 
---
= Das Wiederherstellungsimage auf Ihrem AFF A220 System starten
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das ONTAP Wiederherstellungsimage wird vom USB-Laufwerk auf Ihrem AFF A220 System gebootet, um das Boot-Medium mithilfe des manuellen Boot-Wiederherstellungsprozesses wiederherzustellen.
