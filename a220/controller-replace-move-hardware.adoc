...
---
= Den Controller in Ihrem AFF A220 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller in Ihrem AFF A220 System wird ersetzt, indem der defekte Controller entfernt, die FRU-Komponenten in das Ersatz-Controllermodul übertragen, dieses in das Gehäuse eingesetzt und in den Wartungsmodus gebootet wird.
