...
summary: 'Um Ihr FAS8200 System wieder voll funktionsfähig zu machen, die NetApp Storage Encryption Konfiguration (falls erforderlich) wiederherstellen, Lizenzen für den neuen Controller installieren und das defekte Teil an NetApp gemäß den mit dem Kit gelieferten RMA-Anweisungen zurücksenden.' 
---
= Den Controller-Austausch für ein FAS8200 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um Ihr FAS8200 System wieder voll funktionsfähig zu machen, die NetApp Storage Encryption Konfiguration (falls erforderlich) wiederherstellen, Lizenzen für den neuen Controller installieren und das defekte Teil an NetApp gemäß den mit dem Kit gelieferten RMA-Anweisungen zurücksenden.
