...
summary: Ein defektes Lüftermodul in Ihrem FAS8200 System kann im laufenden Betrieb ausgetauscht werden, ohne den Service zu unterbrechen. Der Austausch sollte innerhalb von zwei Minuten abgeschlossen werden, um eine Überhitzung des Controllers zu vermeiden. 
---
= Ein Lüfter im laufenden Betrieb in Ihrem FAS8200 System kann ausgetauscht werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes Lüftermodul in Ihrem FAS8200 System kann im laufenden Betrieb ausgetauscht werden, ohne den Service zu unterbrechen. Der Austausch sollte innerhalb von zwei Minuten abgeschlossen werden, um eine Überhitzung des Controllers zu vermeiden.
...
+
Das Lüftermodul bewegt sich ein wenig vom Gehäuse weg.
...
|===
. Ziehen Sie das Lüftermodul gerade aus dem Gehäuse heraus. Stützen Sie es mit der freien Hand ab, damit es nicht aus dem Gehäuse schwingt.
+
...
. Den Nockenhebel nach oben in die geschlossene Position schwenken, bis die Entriegelungssperre des Nockenhebels in die verriegelte Position einrastet.
+
