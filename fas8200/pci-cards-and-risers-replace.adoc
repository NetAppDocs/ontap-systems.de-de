...
summary: Um eine PCIe-Karte auszutauschen, müssen Sie das Controllermodul aus dem System entfernen, die Seitenabdeckung öffnen, die defekte Karte entfernen, die Ersatzkarte einsetzen und anschließend das Controllermodul wieder einbauen. 
---
= Austausch einer PCIe Karte in einem FAS8200 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um eine PCIe-Karte auszutauschen, müssen Sie das Controllermodul aus dem System entfernen, die Seitenabdeckung öffnen, die defekte Karte entfernen, die Ersatzkarte einsetzen und anschließend das Controllermodul wieder einbauen.

* Sie können dieses Verfahren bei allen Versionen von ONTAP verwenden, die von Ihrem System unterstützt werden
* Alle anderen Systemkomponenten müssen ordnungsgemäß funktionieren; falls dies nicht der Fall ist, müssen Sie den technischen Support kontaktieren.
