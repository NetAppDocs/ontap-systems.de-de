...
---
= Den Controller in einem FAS8200-System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_rxl_boot_media.png[Entfernen des Startmediums]
...
+
Der DIMM sitzt fest im Steckplatz, sollte sich aber leicht einsetzen lassen. Falls dies nicht der Fall ist, den DIMM am Steckplatz neu ausrichten und erneut einsetzen.
...
+
image::../media/drw_rxl_fcache.png[Entfernen Sie das Caching-Modul, und ersetzen Sie es]
...
.. Bei geöffnetem Nockenhebel das Controller-Modul fest hineindrücken, bis es an der Mittelebene anliegt und vollständig sitzt, und dann den Nockenhebel in die verriegelte Position bringen. Die Rändelschraube am Nockenhebel auf der Rückseite des Controller-Moduls festziehen.
+
