...
summary: Bevor Sie das Chassis austauschen können, müssen Sie den defekten Controller in Ihrem FAS8200 System herunterfahren. 
---
= Die FAS8200 Controller werden heruntergefahren, um das Chassis auszutauschen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bevor Sie das Chassis austauschen können, müssen Sie den defekten Controller in Ihrem FAS8200 System herunterfahren.
