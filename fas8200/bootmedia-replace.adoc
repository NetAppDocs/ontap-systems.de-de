...
---
= Das Bootmedium in einem FAS8200 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Die tar.gz-Datei muss auf einer FAT32-formatierten Partition mit mindestens 4GB abgelegt werden. FAT32-Partitionen können bis zu 2TB groß sein, jedoch können die in Windows integrierten Tools (zum Beispiel DiskPart) keine FAT32-Partitionen größer als 32GB formatieren.
...
+
Das System implementiert die Änderungen beim Systemstart.
