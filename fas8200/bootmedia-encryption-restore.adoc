...
summary: Wiederherstellung der Verschlüsselungskonfiguration auf dem Ersatz-Bootmedium für ein FAS8200 -System. Das FAS8200 -System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. Die automatische Wiederherstellung über Bootmedien wird nicht unterstützt. 
---
= Wiederherstellung der Verschlüsselung auf dem Startmedium in einem FAS8200 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Wiederherstellung der Verschlüsselungskonfiguration auf dem Ersatz-Bootmedium für ein FAS8200 -System. Dieses Verfahren umfasst die Durchführung von Nachbearbeitungsschritten für Systeme, bei denen Onboard Key Manager (OKM), NetApp Storage Encryption (NSE) oder NetApp Volume Encryption (NVE) aktiviert ist, um einen sicheren Datenzugriff und einen ordnungsgemäßen Systembetrieb zu gewährleisten.
