...
summary: 'Ein DIMM im Controller-Modul ist auszutauschen, wenn das Speichersystem übermäßig viele korrigierbare Fehlerkorrekturcode-Fehler (CECC) meldet, die durch Health Monitor-Warnungen identifiziert werden, oder wenn nicht korrigierbare ECC-Fehler durch einen einzelnen DIMM-Ausfall verursacht werden, der das Starten von ONTAP im Speichersystem verhindert.' 
---
= Ein DIMM im FAS8200 System ersetzen, um Speicherfehler zu beheben
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein DIMM im Controller-Modul ist auszutauschen, wenn das Speichersystem übermäßig viele korrigierbare Fehlerkorrekturcode-Fehler (CECC) meldet, die durch Health Monitor-Warnungen identifiziert werden, oder wenn nicht korrigierbare ECC-Fehler durch einen einzelnen DIMM-Ausfall verursacht werden, der das Starten von ONTAP im Speichersystem verhindert.
