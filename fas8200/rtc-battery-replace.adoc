...
summary: Sie tauschen die Echtzeit-Batterie im Controller-Modul aus, damit Ihre Dienste und Anwendungen, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin funktionieren. 
---
= Die Echtzeit-Batterie der Echtzeituhr im FAS8200 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_rxl_rtc_battery.png[Entfernen und ersetzen Sie die RTC-Batterie]
...
== Schritt 4: Das Controller-Modul wird nach dem Austausch der RTC-Batterie wieder eingebaut und Zeit sowie Datum werden zurückgesetzt.
