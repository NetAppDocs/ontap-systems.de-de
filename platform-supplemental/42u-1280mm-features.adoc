...
---
= ONTAP Hardware-Systemschrankeigenschaften
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der ONTAP Hardware Systemschrank besteht aus Seitenwänden, Vorder- und Rücktüren, einem optionalen Befestigungssatz, einem optionalen Verbindungssatz, PDUs für Ihre Geräte und einem integrierten Kabelmanagementsystem.
