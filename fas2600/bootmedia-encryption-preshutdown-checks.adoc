...
summary: Überprüfen Sie die Unterstützung und den Status des Verschlüsselungsschlüssels, bevor Sie den betroffenen Controller auf einem FAS2600-System herunterfahren. Dieses Verfahren beinhaltet die Überprüfung der ONTAP Versionskompatibilität. Das FAS2600-System unterstützt nur manuelle Wiederherstellungsverfahren über Bootmedien. Die automatische Wiederherstellung über Bootmedien wird nicht unterstützt. 
---
= Überprüfung der Verschlüsselungsunterstützung auf dem Bootmedium in einem FAS2600 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
