...
summary: 'Wiederherstellung der Verschlüsselungskonfiguration auf dem Ersatz-Bootmedium für ein FAS2600-System. Dieses Verfahren umfasst die Durchführung von Nachbearbeitungsschritten für Systeme, bei denen Onboard Key Manager (OKM), NetApp Storage Encryption (NSE) oder NetApp Volume Encryption (NVE) aktiviert ist, um einen sicheren Datenzugriff und einen ordnungsgemäßen Systembetrieb zu gewährleisten.' 
---
