...
summary: Stellen Sie die Verschlüsselungskonfiguration auf dem Ersatz-Bootmedium für ein FAS2600-System wieder her. Dieses Verfahren umfasst die Durchführung der Schritte nach dem Austausch für Systeme mit aktiviertem Onboard Key Manager, NetApp Storage Encryption oder NetApp Volume Encryption, um einen sicheren Datenzugriff und den ordnungsgemäßen Systembetrieb zu gewährleisten. 
---
= Wiederherstellung der Verschlüsselung auf dem Bootmedium in einem FAS2600 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Wiederherstellung der Verschlüsselungskonfiguration auf dem Ersatz-Bootmedium für ein FAS2600-System. Dieses Verfahren umfasst die Durchführung von Nachbearbeitungsschritten für Systeme, bei denen Onboard Key Manager (OKM), NetApp Storage Encryption (NSE) oder NetApp Volume Encryption (NVE) aktiviert ist, um einen sicheren Datenzugriff und einen ordnungsgemäßen Systembetrieb zu gewährleisten.
