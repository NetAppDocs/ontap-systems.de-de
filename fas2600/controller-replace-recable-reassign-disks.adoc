...
summary: Den Speicher wieder anschließen, die Neuzuordnung der Festplatte bestätigen und die restlichen Aufgaben abschließen, damit der Controller zurückgegeben werden kann und das FAS2600 System wieder voll funktionsfähig ist. 
---
= Den Controller in einem FAS2600 System zurückgeben, damit der normale Betrieb fortgesetzt werden kann.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Den Speicher wieder anschließen, die Neuzuordnung der Festplatte bestätigen und die restlichen Aufgaben abschließen, damit der Controller zurückgegeben werden kann und das FAS2600 System wieder voll funktionsfähig ist.
