...
summary: Das Caching-Modul in Ihrem FAS2600-System sollte ersetzt werden, wenn Ihr System eine einzelne AutoSupport-Meldung registriert, dass das Modul offline gegangen ist. Andernfalls kommt es zu Leistungseinbußen. 
---
= Das Caching-Modul in einem FAS2600 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Caching-Modul in Ihrem FAS2600-System ist auszutauschen, wenn Ihr System eine einzelne AutoSupport (ASUP) Meldung registriert, dass das Modul offline gegangen ist. Andernfalls kommt es zu Leistungseinbußen.

* Sie müssen die fehlerhafte Komponente durch eine vom Anbieter empfangene Ersatz-FRU-Komponente ersetzen.


link:https://youtu.be/LaMzvnAwM_I["Video zum Austausch des AFF FAS2600 Caching-Moduls"^]
...
Das Caching-Modul wird auf dem Controller-Etikett als M.2 PCIe-Karte bezeichnet. Im Controller befindet sich ein Steckplatz, dem diese Schrittfolge zugeordnet ist.
