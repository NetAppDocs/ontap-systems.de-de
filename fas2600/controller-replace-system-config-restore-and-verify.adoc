...
summary: Nach Abschluss des Hardwareaustauschs und dem Booten in den Wartungsmodus erfolgt die Wiederherstellung und Überprüfung der Controller-Konfiguration in Ihrem FAS2600-System. 
---
= Wiederherstellen und Überprüfen der Controller-Konfiguration in einem FAS2600 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss des Hardwareaustauschs und dem Booten in den Wartungsmodus werden die Controller-Konfiguration in Ihrem FAS2600 System wiederhergestellt und überprüft, die Low-Level-Systemkonfiguration des Ersatzcontrollers verifiziert und die Systemeinstellungen bei Bedarf neu konfiguriert.
