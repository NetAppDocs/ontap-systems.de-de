...
[role="lead"]
Ein ausgefallenes Laufwerk in Ihrem FAS2600 System kann während laufender I/O-Vorgänge unterbrechungsfrei ausgetauscht werden, um die Speicherkapazität und Leistung wiederherzustellen.
