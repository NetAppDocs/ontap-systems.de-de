...
summary: Die Netzteile, Festplatten und Controller-Module werden vom defekten Gehäuse in das Ersatzgehäuse Ihres FAS2600 Systems umgesetzt, anschließend wird das alte Gehäuse im Geräteschrank oder Systemschrank gegen das neue Gehäuse desselben Modells ausgetauscht. 
---
= Das Chassis in einem FAS2600 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Netzteile, Festplatten und Controller-Module werden vom defekten Gehäuse in das Ersatzgehäuse Ihres FAS2600 Systems umgesetzt, anschließend wird das alte Gehäuse im Geräteschrank oder Systemschrank gegen das neue Gehäuse desselben Modells ausgetauscht.



[[step-1-move-the-power-supply]]
== Schritt 1: Das Netzteil bewegen
...
Bewegen Sie die Laufwerke von jeder Schachtöffnung im alten Gehäuse in die gleiche Schachtöffnung im neuen Gehäuse.
...
Entfernen Sie das vorhandene Chassis aus dem Rack oder dem Systemschrank, bevor Sie das Ersatzgehäuse installieren können.
...
Bei HA-Paaren mit zwei Controller-Modulen im selben Chassis ist die Installationsreihenfolge wichtig, da jeder Controller neu startet, sobald er vollständig im Chassis sitzt.
