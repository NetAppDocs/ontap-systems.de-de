...
summary: Vor dem Austausch des defekten Controllers in Ihrem FAS2600-System sollte dessen Status ermittelt und der Controller gegebenenfalls übernommen werden, damit der intakte Controller weiterhin Daten bereitstellt. 
---
= Vor dem Austausch muss der defekte Controller in einem FAS2600 System abgeschaltet werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vor dem Austausch des defekten Controllers in Ihrem FAS2600-System wird dessen Status ermittelt und er bei Bedarf übernommen, sodass der intakte Controller weiterhin Daten aus dem Speicher des defekten Controllers bereitstellt.
