...
summary: Um den vollständigen Betrieb Ihres FAS2600-Systems wiederherzustellen, müssen die NetApp Storage Encryption-Konfiguration wiederhergestellt, Lizenzen für den neuen Controller installiert und das defekte Teil an NetApp zurückgesendet werden. 
---
= Den Controller-Austausch für ein FAS2600 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um Ihr FAS2600-System wieder voll funktionsfähig zu machen, müssen Sie die NetApp Storage Encryption-Konfiguration (falls erforderlich) wiederherstellen, Lizenzen für den neuen Controller installieren und das defekte Teil an NetApp zurücksenden, wie in den mit dem Kit gelieferten RMA-Anweisungen beschrieben.
