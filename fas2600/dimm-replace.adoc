...
summary: Das DIMM in Ihrem FAS2600 System ist zu ersetzen, wenn das Speichersystem basierend auf Health Monitor-Warnungen übermäßig viele korrigierbare ECC-Fehler feststellt oder wenn nicht korrigierbare ECC-Fehler durch einen einzelnen DIMM-Ausfall verursacht werden, der das System am Starten von ONTAP hindert. 
---
= Austausch eines DIMM in einem FAS2600 System zur Behebung von Speicherfehlern
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das DIMM in Ihrem FAS2600-System sollte ersetzt werden, wenn das Speichersystem aufgrund von Health Monitor-Warnungen übermäßig viele CECC-Fehler (Correctable Error Correction Codes) oder nicht korrigierbare ECC-Fehler feststellt, was typischerweise durch einen einzelnen DIMM-Ausfall verursacht wird, der das Speichersystem am Starten von ONTAP hindert.

Wenn eine andere Komponente nicht ordnungsgemäß funktioniert, den technischen Support kontaktieren.

Sie müssen die fehlerhafte Komponente durch eine vom Anbieter empfangene Ersatz-FRU-Komponente ersetzen.

link:https://youtu.be/ywwsMltvuXg["Video zum Austausch des AFF FAS2600 DIMM"^]
