...
summary: 'Sie können ein beschädigtes NVMe-Shelf-Modul (NSM) unterbrechungsfrei in einem eingeschalteten NX224-Laufwerks-Shelf austauschen, während ein E/A-Vorgang läuft.' 
---
= Ersetzen Sie ein NSM in einem NX224-Gehäuse
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
CAUTION: Bevor Sie die defekte NSM-Abdeckung schließen, vergewissern Sie sich, dass die Auswurfklappen an allen leeren DIMM-Steckplätzen vollständig in die verriegelte Position zurückgekehrt sind.
