...
summary: Um die Datensicherheit auf Ihrem AFF C30- oder AFF C60-Speichersystem zu gewährleisten, müssen Sie die Unterstützung und den Status des Verschlüsselungsschlüssels auf Ihrem Bootmedium überprüfen. Prüfen Sie, ob Ihre ONTAP Version NetApp Volume Encryption unterstützt, und prüfen Sie vor dem Herunterfahren des Controllers, ob der Schlüsselmanager aktiv ist. 
---
= Die Verschlüsselungsunterstützung auf dem Startmedium im AFF C30 oder AFF C60 Storage-System prüfen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um die Datensicherheit auf Ihrem AFF C30 oder AFF C60 Storage-System zu gewährleisten, ist die Unterstützung und der Status des Verschlüsselungsschlüssels auf Ihrem Boot-Medium zu überprüfen. Es sollte geprüft werden, ob Ihre ONTAP Version NetApp Volume Encryption (NVE) unterstützt. Vor dem Herunterfahren des Controllers ist zu prüfen, ob der Schlüsselmanager aktiv ist.
...
Vor dem Herunterfahren des Controllers mit dem beschädigten Bootmedium sollte die Konfiguration des Schlüsselmanagers überprüft und die notwendigen Informationen gesichert werden.
