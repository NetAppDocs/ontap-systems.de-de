...
---
= Installations- und Konfigurationsablauf für AFF C30 und AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Ihr Speichersystem muss die Installationsvoraussetzungen erfüllen, bevor es installiert wird.
...
[role="quick-margin-para"]
Zur Vorbereitung der Installation wird der Standort vorbereitet, die Umgebungs- und Stromanforderungen werden überprüft und es wird sichergestellt, dass ausreichend Rackplatz vorhanden ist. Anschließend werden die Geräte entpackt, der Inhalt mit dem Lieferschein verglichen und die Hardware registriert, um Supportleistungen zu erhalten.
