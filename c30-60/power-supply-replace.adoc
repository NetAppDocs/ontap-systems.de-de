...
summary: Ein AC- oder DC-Netzteil in Ihrem AFF C30 oder AFF C60 Storage-System wird ersetzt, wenn es ausfällt oder fehlerhaft ist, damit Ihr System weiterhin die erforderliche Stromversorgung für einen stabilen Betrieb erhält. Der Austauschprozess umfasst das Trennen des defekten Netzteils von der Stromquelle, das Abziehen des Netzkabels, das Ersetzen des defekten Netzteils und das erneute Anschließen an die Stromquelle. 
---
...
[role="lead"]
Ein AC- oder DC-Netzteil (PSU) im AFF C30 oder AFF C60 Storage-System wird bei Ausfall oder Defekt ersetzt, damit das System weiterhin die erforderliche Stromversorgung für einen stabilen Betrieb erhält. Der Austauschprozess umfasst das Trennen des defekten Netzteils von der Stromquelle, das Abziehen des Netzkabels, das Ersetzen des defekten Netzteils und das erneute Anschließen an die Stromquelle.
