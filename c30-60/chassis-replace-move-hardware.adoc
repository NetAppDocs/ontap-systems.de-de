...
[role="lead"]
Tauschen Sie das Gehäuse des AFF C30- oder AFF C60-Systems aus, wenn es aufgrund eines Hardwarefehlers erforderlich ist. Der Austauschvorgang umfasst das Entfernen der Controller, das Entfernen der Laufwerke, die Installation des Ersatzgehäuses und die Neuinstallation der Gehäusekomponenten.
