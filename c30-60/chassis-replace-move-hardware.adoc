...
summary: Tauschen Sie das Gehäuse in Ihrem AFF C30- oder AFF C60-System aus, wenn ein Hardwarefehler erforderlich ist. Beim Austausch werden der Controller und die Netzteile entfernt, die Laufwerke aus dem Gehäuse für beeinträchtigte Störung entfernt, das Ersatzgehäuse installiert und die Gehäusekomponenten wieder eingebaut. 
---
...
[role="lead"]
Tauschen Sie das Gehäuse in Ihrem AFF C30- oder AFF C60-System aus, wenn ein Hardwarefehler erforderlich ist. Beim Austausch werden der Controller und die Netzteileinheiten (PSUs) entfernt, die Laufwerke aus dem Gehäuse für beeinträchtigte Störungen entfernt, das Ersatzgehäuse installiert und die Gehäusekomponenten neu installiert.
