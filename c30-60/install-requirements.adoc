...
summary: Die Anforderungen für die Installation Ihres AFF C30 oder AFF C60 Storage-Systems, einschließlich der benötigten Ausrüstung, Vorsichtsmaßnahmen beim Heben und Standortvorgaben, werden dargestellt, damit die Installation reibungslos verläuft. 
---
= Überprüfung der Anforderungen für die Installation eines AFF C30 oder AFF C60 Storage-Systems
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Anforderungen für die Installation Ihres AFF C30 oder AFF C60 Storage-Systems, einschließlich der benötigten Ausrüstung, Vorsichtsmaßnahmen beim Heben und Standortvorgaben, werden dargestellt, damit die Installation reibungslos verläuft.
