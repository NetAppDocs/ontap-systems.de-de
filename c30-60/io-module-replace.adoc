...
[role="lead"]
Ersetzen Sie ein E/A-Modul in Ihrem AFF C30- oder AFF C60-Speichersystem, wenn das Modul ausfällt oder ein Upgrade benötigt, um eine höhere Leistung oder zusätzliche Funktionen zu unterstützen. Der Austauschprozess umfasst das Herunterfahren des Controllers, den Austausch des ausgefallenen I/O-Moduls, den Neustart des Controllers und die Rücksendung des ausgefallenen Moduls an NetApp.
...
== Schritt 1: Den Controller mit dem defekten E/A-Modul herunterfahren

Den Controller mit dem beeinträchtigten E/A-Modul mithilfe einer der folgenden Optionen herunterfahren oder übernehmen.
