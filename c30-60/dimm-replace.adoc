...
summary: Ersetzen Sie ein DIMM im Controller-Modul, wenn Ihr System eine steigende Anzahl korrigierbarer ECC-Codes registriert. Andernfalls entsteht eine Systempanik. 
---
= Ersetzen Sie ein DIMM-Modul – AFF C30 und AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
