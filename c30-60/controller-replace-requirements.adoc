...
---
= Voraussetzung für den Austausch des Controllers - AFF C30 und AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nachdem Sie die Anforderungen überprüft haben, um Ihren AFF C30 oder AFF C60 Controller zu ersetzen, müssen Sie link:controller-replace-shutdown.html["Schalten Sie den außer Betrieb genommenen Controller aus"].
