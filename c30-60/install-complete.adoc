...
summary: Nachdem Sie Ihr AFF C30- oder AFF C60-Speichersystem eingeschaltet haben, können Sie das Cluster-Netzwerk erkennen und ein ONTAP-Cluster einrichten. 
---
= Vollständige Einrichtung und Konfiguration des Storage-Systems – AFF C30 und AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nachdem Sie Ihr AFF C30- oder AFF C60-Speichersystem eingeschaltet haben, können Sie das Cluster-Netzwerk erkennen und ein ONTAP-Cluster einrichten.
