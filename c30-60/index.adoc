...
---
= Wartung von AFF C30 und AFF C60 Hardware
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bei den Speichersystemen AFF C30 oder AFF C60 können Sie Wartungsverfahren für die folgenden Komponenten durchführen.
