...
summary: Fahren Sie den außer Betrieb genommenen Controller in Ihrem AFF C30- oder AFF C60-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Controllers sicherzustellen. 
---
= Vor dem Austausch ist der ausgefallene Controller in Ihrem AFF C30 oder AFF C60 Storage-System herunterzufahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den außer Betrieb genommenen Controller in Ihrem AFF C30- oder AFF C60-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Controllers sicherzustellen.
