...
summary: Ersetzen Sie ein Laufwerk in Ihrem AFF C30- oder AFF C60-Speichersystem, wenn ein Laufwerk ausfällt oder ein Upgrade erforderlich ist.  Der Austauschvorgang umfasst die Identifizierung des fehlerhaften Laufwerks, dessen sichere Entfernung und die Installation eines neuen Laufwerks, um einen kontinuierlichen Datenzugriff und eine kontinuierliche Systemleistung sicherzustellen. 
---
= Ein Laufwerk im AFF C30 oder AFF C60 Speichersystem austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ersetzen Sie ein Laufwerk in Ihrem AFF C30- oder AFF C60-Speichersystem, wenn ein Laufwerk ausfällt oder ein Upgrade erforderlich ist.  Der Austauschvorgang umfasst die Identifizierung des fehlerhaften Laufwerks, dessen sichere Entfernung und die Installation eines neuen Laufwerks, um einen kontinuierlichen Datenzugriff und eine kontinuierliche Systemleistung sicherzustellen.
