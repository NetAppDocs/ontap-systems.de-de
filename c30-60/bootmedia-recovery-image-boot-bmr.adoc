...
summary: Nach dem Einbau des neuen Bootmediums in Ihr AFF C30 oder AFF C60 Speichersystem kann der automatisierte Bootmedien-Wiederherstellungsprozess gestartet werden, um die Konfiguration vom Partnerknoten wiederherzustellen. Während des Wiederherstellungsprozesses prüft das System, ob die Verschlüsselung aktiviert ist und ermittelt den verwendeten Typ der Schlüsselverschlüsselung. Wenn die Schlüsselverschlüsselung aktiviert ist, führt das System durch die entsprechenden Schritte zur Wiederherstellung. 
---
= Das Boot-Image auf dem AFF C30 oder AFF C60 Storage-System kann mit dem automatisierten Boot-Wiederherstellungsprozess wiederhergestellt werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach dem Einbau des neuen Bootmediums in Ihr AFF C30 oder AFF C60 Speichersystem kann der automatisierte Bootmedien-Wiederherstellungsprozess gestartet werden, um die Konfiguration vom Partnerknoten wiederherzustellen. Während des Wiederherstellungsprozesses prüft das System, ob die Verschlüsselung aktiviert ist und ermittelt den verwendeten Typ der Schlüsselverschlüsselung. Wenn die Schlüsselverschlüsselung aktiviert ist, führt das System durch die entsprechenden Schritte zur Wiederherstellung.
