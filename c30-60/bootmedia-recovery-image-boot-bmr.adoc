...
summary: Nachdem Sie das neue Bootmediengerät in Ihrem AFF C30- und AFF C80-Speichersystem installiert haben, können Sie den automatisierten Bootmedienwiederherstellungsprozess starten, um die Konfiguration vom Partnerknoten wiederherzustellen. 
---
