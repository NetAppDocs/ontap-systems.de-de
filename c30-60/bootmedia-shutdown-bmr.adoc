...
summary: Fahren Sie den beschädigten Controller in Ihrem AFF C30- oder AFF C60-Speichersystem herunter, um Datenverlust zu verhindern und die Systemstabilität während des automatischen Boot-Medienwiederherstellungsprozesses aufrechtzuerhalten. 
---
= Den Controller im AFF C30 oder AFF C60 Storage-System während des automatisierten Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den beschädigten Controller in Ihrem AFF C30- oder AFF C60-Speichersystem herunter, um Datenverlust zu verhindern und die Systemstabilität während des automatischen Boot-Medienwiederherstellungsprozesses aufrechtzuerhalten.
