...
summary: Warten Sie die Hardware Ihres AFF C30- oder AFF C60-Speichersystems, um langfristige Zuverlässigkeit und optimale Leistung zu gewährleisten. Führen Sie regelmäßige Wartungsarbeiten durch, z. B. den Austausch defekter Komponenten, um Ausfallzeiten und Datenverlust zu vermeiden. 
---
= Informationen zur Wartung eines AFF C30 oder AFF C60 Storage-Systems
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
