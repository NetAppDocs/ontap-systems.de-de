...
summary: Das Herunterfahren des Controllers im AFF C30 oder AFF C60 Speichersystem verhindert Datenverlust und erhält die Systemstabilität während des manuellen Bootmedien-Wiederherstellungsprozesses. 
---
= Den Controller im AFF C30 oder AFF C60 Speichersystem während des manuellen Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Herunterfahren des Controllers im AFF C30 oder AFF C60 Speichersystem verhindert Datenverlust und erhält die Systemstabilität während des manuellen Bootmedien-Wiederherstellungsprozesses.
