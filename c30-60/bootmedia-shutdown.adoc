...
summary: Fahren Sie den außer Betrieb genommenen Controller in Ihrem AFF C30- oder AFF C60-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Startmediums sicherzustellen. 
---
= Schalten Sie den Controller für beeinträchtigten Betrieb aus - AFF C30 und AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den außer Betrieb genommenen Controller in Ihrem AFF C30- oder AFF C60-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Startmediums sicherzustellen.
