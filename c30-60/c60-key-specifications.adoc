...
[role="lead"]
Im Folgenden finden Sie ausgewählte Spezifikationen für das AFF C60-Speichersystem in einem einzelnen Hochverfügbarkeitspaar.  Die vollständigen Spezifikationen für dieses Speichersystem finden Sie im NetApp Hardware Universe (HWU).
