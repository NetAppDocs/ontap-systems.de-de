...
summary: Wichtige Spezifikationen für AFF C60 
---
= Wichtigste Spezifikationen für ein AFF C60 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dies sind ausgewählte Spezifikationen für das AFF C60 Speichersystem in einem einzelnen Hochverfügbarkeitspaar. Die vollständigen Spezifikationen für dieses Speichersystem sind im NetApp Hardware Universe (HWU) verfügbar.



[[aff-c60-specifications-at-a-glance]]
== AFF C60 Spezifikationen im Überblick
...
* Typ: NAS; HA-Paare: 4; Rohkapazität: 29,5 PB / 26,2 PiB; Max. Speicher: 512 GB
* Typ: SAN; HA-Paare: 4; Rohkapazität: 29,5 PB / 26,2 PiB; Max. Speicher: 512 GB
* Typ: HA-Paar; Rohkapazität: 7,4 PB / 6,5 PiB; Max. Speicher: 128.0000
