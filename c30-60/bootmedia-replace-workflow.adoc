...
---
= Ablauf für den Austausch des Bootmediums bei einem AFF C30 oder AFF C60 System unter Verwendung des manuellen Boot-Wiederherstellungsprozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Das defekte Bootmedium wird aus dem Controller entfernt, das Ersatz-Bootmedium installiert und anschließend ein ONTAP Image mithilfe eines USB-Sticks übertragen.
