...
summary: Stellen Sie die Verschlüsselung auf den Ersatz-Startmedien in Ihrem AFF C30- oder AFF C60-System wieder her, um einen kontinuierlichen Datenschutz zu gewährleisten. Der Austauschprozess umfasst die Überprüfung der Schlüsselverfügbarkeit, die Anwendung von Verschlüsselungseinstellungen und die Bestätigung des sicheren Zugriffs auf Ihre Daten. 
---
= Stellen Sie die Verschlüsselung auf dem Boot-Medium wieder her – AFF C30 und AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Stellen Sie die Verschlüsselung auf den Ersatz-Startmedien in Ihrem AFF C30- oder AFF C60-System wieder her, um einen kontinuierlichen Datenschutz zu gewährleisten. Der Austauschprozess umfasst die Überprüfung der Schlüsselverfügbarkeit, die Anwendung von Verschlüsselungseinstellungen und die Bestätigung des sicheren Zugriffs auf Ihre Daten.
