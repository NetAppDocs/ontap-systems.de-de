...
summary: Sie können ein Ethernet-E/A-Modul in Ihrem AFF C30 oder AFF C60-Speichersystem per Hot-Swap austauschen, wenn ein Modul ausfällt und Ihr Speichersystem alle ONTAP-Versionserfordernisse erfüllt. 
---
= Ein E/A-Modul im laufenden Betrieb in Ihrem AFF C30 oder AFF C60 Storage-System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können ein Ethernet-E/A-Modul in Ihrem AFF C30 oder AFF C60-Speichersystem per Hot-Swap austauschen, wenn ein Modul ausfällt und Ihr Speichersystem alle ONTAP-Versionserfordernisse erfüllt.
...
+
** Der _Controller mit dem defekten E/A-Modul_ ist der Controller, bei dem das E/A-Modul im laufenden Betrieb ausgetauscht wird.
** Der _gesunde Controller_ ist der HA-Partner des Controllers mit dem beeinträchtigten E/A-Modul.
...
== Schritt 1: Überprüfung, ob das Speichersystem die Verfahrensanforderungen erfüllt
