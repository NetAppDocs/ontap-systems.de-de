...
summary: Bereiten Sie die Installation Ihres AFF C30- oder AFF C60-Speichersystems vor, indem Sie den Standort vorbereiten, die Kartons auspacken, den Inhalt der Kartons mit dem Packzettel vergleichen und das Storage-System registrieren, um auf Support-Vorteile zugreifen zu können. 
---
= Vorbereitung für die Installation Ihres AFF C30 und AFF C60 Storage-Systems
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bereiten Sie die Installation Ihres AFF C30- oder AFF C60-Speichersystems vor, indem Sie den Standort vorbereiten, die Kartons auspacken, den Inhalt der Kartons mit dem Packzettel vergleichen und das Storage-System registrieren, um auf Support-Vorteile zugreifen zu können.
