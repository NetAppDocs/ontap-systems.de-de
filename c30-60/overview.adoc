...
summary: Wichtigste Spezifikationen für die AFF C30 und AFF C60 Speichersysteme in einem einzigen Hochverfügbarkeitspaar 
---
= Wichtigste Spezifikationen für AFF C30 und AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nachfolgend sind ausgewählte Spezifikationen der AFF C30 und AFF C60 Speichersysteme in einem einzelnen Hochverfügbarkeits-Paar aufgeführt. Die vollständigen Spezifikationen dieser Speichersysteme sind unter  https://hwu.netapp.com["NetApp Hardware Universe"^] verfügbar.
