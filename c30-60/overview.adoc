...
[role="lead"]
Dies sind ausgewählte Spezifikationen für die AFF C30 und AFF C60 Speichersysteme in einem einzelnen Hochverfügbarkeits-Paar. Besuchen Sie  https://hwu.netapp.com["NetApp Hardware Universe"^] für die vollständigen Spezifikationen dieser Speichersysteme.
