...
---
= Wichtigste Spezifikationen für ein AFF C30 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dies sind ausgewählte Spezifikationen für das AFF C30 Storage-System in einem einzelnen High-Availability-Paar. Die vollständigen Spezifikationen für dieses Storage-System sind im NetApp Hardware Universe (HWU) verfügbar.
