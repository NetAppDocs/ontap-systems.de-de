...
summary: Nachdem Sie die Controller mit dem Netzwerk und den Shelfs im AFF C30- oder AFF C60-Storage-System verkabeln, schalten Sie die Shelfs und Controller ein. 
---
= Einschalten eines AFF C30 oder AFF C60 Storage-Systems
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
