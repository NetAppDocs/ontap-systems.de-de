...
summary: Nach der Installation des neuen Startmediengeräts in Ihrem AFF C30- oder AFF C60-System können Sie das Wiederherstellungs-Image von einem USB-Laufwerk starten und die Konfiguration vom Partnerknoten wiederherstellen. 
---
= Starten Sie das Wiederherstellungs-Image - AFF C30 und AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach der Installation des neuen Startmediengeräts in Ihrem AFF C30- oder AFF C60-System können Sie das Wiederherstellungs-Image von einem USB-Laufwerk starten und die Konfiguration vom Partnerknoten wiederherstellen.
