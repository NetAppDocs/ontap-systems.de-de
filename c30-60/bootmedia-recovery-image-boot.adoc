...
summary: Nachdem Sie das neue Boot-Mediengerät in Ihrem AFF C30- oder AFF C60-System installiert haben, können Sie das Wiederherstellungsimage manuell von einem USB-Laufwerk booten, um die Konfiguration vom Partnerknoten wiederherzustellen. 
---
