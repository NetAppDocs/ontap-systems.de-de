...
summary: Bevor Sie das Bootmedium in Ihrem AFF C30- oder AFF C60-Speichersystem austauschen, stellen Sie sicher, dass die notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sind. Dazu gehört die Überprüfung, ob Sie über das richtige Ersatz-Bootmedium verfügen, die Bestätigung, dass der e0M-Schraubenschlüsselanschluss am beeinträchtigten Controller ordnungsgemäß funktioniert, und die Feststellung, ob Onboard Key Manager OKM oder External Key Manager EKM aktiviert ist. 
---
