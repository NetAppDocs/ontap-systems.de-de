...
---
= Den Chassis-Austausch für Ihr AFF C190 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Chassis-Austausch für Ihr AFF C190-System wird abgeschlossen, indem der HA-Status des Chassis überprüft und die defekte Komponente an NetApp zurückgesendet wird.
