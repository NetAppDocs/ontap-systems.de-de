...
---
= Die Anforderungen für den Austausch eines Controllers in einem AFF C190 System werden hier aufgeführt.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bevor der Controller in Ihrem AFF C190 System ausgetauscht wird, sollten die Voraussetzungen für das Austauschverfahren geprüft und das passende Verfahren für Ihre Version des ONTAP Betriebssystems ausgewählt werden.
