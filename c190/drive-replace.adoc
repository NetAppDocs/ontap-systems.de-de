...
---
= Laufwerk im laufenden Betrieb in einem AFF C190 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein ausgefallenes Laufwerk in Ihrem AFF C190 System kann im laufenden Betrieb ausgetauscht werden, ohne dass die I/O unterbrochen wird. Das AFF C190 unterstützt sowohl SSD-Laufwerke als auch HDDs, jeweils mit einem eigenen Austauschverfahren.
