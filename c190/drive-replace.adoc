...
---
= Ein Laufwerk in Ihrem AFF C190 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein ausgefallenes Laufwerk im AFF C190-System kann ohne Unterbrechung der I/O ersetzt werden. Das AFF C190 unterstützt sowohl SSD-Laufwerke als auch HDDs, jeweils mit einem eigenen Austauschverfahren.
