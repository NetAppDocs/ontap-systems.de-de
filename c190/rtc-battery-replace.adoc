...
---
= Die Batterie der Echtzeituhr in einem AFF C190 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Um den RTC-Akku zu ersetzen, müssen Sie ihn im Controller-Modul finden und anschließend die einzelnen Schritte befolgen.

. Suchen Sie den RTC-Akku.
+
image::../media/drw_2600_rtc_battery.gif[Ersetzen Sie die RTC-Batterie]
