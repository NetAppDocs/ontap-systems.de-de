...
summary: Tauschen Sie das defekte Bootmedium auf einem AFF C190 Controller-Modul aus. Das AFF C190 -System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. Die automatische Wiederherstellung über Bootmedien wird nicht unterstützt. 
---
= Das Bootmedium in einem AFF C190 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
