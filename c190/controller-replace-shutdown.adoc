...
---
= Vor dem Austausch muss der defekte Controller in einem AFF C190 System abgeschaltet werden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der defekte Controller in einem AFF C190-System sollte heruntergefahren werden, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers zu gewährleisten.
