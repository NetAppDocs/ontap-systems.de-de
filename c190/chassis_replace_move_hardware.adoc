...
---
= Hardware verschieben und ersetzen – AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nach der Installation des Controller-Moduls und anderer Komponenten im neuen Chassis müssen Sie es in einen Zustand booten, in dem Sie den Interconnect-Diagnosetest ausführen können.
