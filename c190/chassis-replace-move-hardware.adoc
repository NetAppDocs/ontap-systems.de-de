...
---
= Das Chassis in einem AFF C190 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nachdem Sie das Controller-Modul und alle anderen Komponenten im neuen Gehäuse installiert haben, müssen Sie es booten.
