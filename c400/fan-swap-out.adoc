...
---
= Ein Lüftermodul im laufenden Betrieb in Ihrem AFF C400 Storage-System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein Lüftermodul in Ihrem AFF C400-Speichersystem kann im laufenden Betrieb ausgetauscht werden, sodass der ordnungsgemäße Luftstrom und die Systemkühlung erhalten bleiben, ohne den Service zu unterbrechen.
