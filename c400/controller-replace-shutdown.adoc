...
summary: Schalten Sie den Controller Ihres AFF C400-Speichersystems ab, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers zu gewährleisten. 
---
= Vor dem Austausch ist der defekte Controller in Ihrem AFF C400 Storage-System herunterzufahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie den Controller Ihres AFF C400-Speichersystems ab, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers zu gewährleisten.
...
Nachdem Sie den AFF C400 Controller heruntergefahren haben, müssen Sie link:controller-replace-move-hardware.html["Ersetzen Sie den Controller"].
