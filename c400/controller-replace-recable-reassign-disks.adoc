...
summary: Übergeben Sie die Kontrolle über die Speicherressourcen wieder an den Ersatzcontroller, damit Ihr AFF C400 System den normalen Betrieb wieder aufnehmen kann. 
---
= Der Controller in Ihrem AFF C400 Storage-System wird zurückgegeben, damit der normale Betrieb fortgesetzt werden kann.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Übergeben Sie die Kontrolle über die Speicherressourcen wieder an den Ersatzcontroller, damit Ihr AFF C400 System den normalen Betrieb wieder aufnehmen kann.
