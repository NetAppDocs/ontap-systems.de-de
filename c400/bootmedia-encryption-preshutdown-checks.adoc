...
---
= Die Verschlüsselungsunterstützung auf dem Startmedium im AFF C400 Storage-System prüfen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vor dem Herunterfahren des beeinträchtigten Controllers ist die Verschlüsselungsunterstützung Ihres Bootmediums im AFF C400-Speichersystem zu überprüfen. Dies umfasst die Überprüfung der ONTAP-Version auf Kompatibilität mit NetApp Volume Encryption (NVE) sowie die Bestätigung der Konfiguration des Schlüsselmanagers.
