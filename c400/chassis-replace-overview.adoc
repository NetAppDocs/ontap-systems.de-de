...
---
= Informationen zum Austausch des Chassis in Ihrem AFF C400 Speichersystem
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Informationen zum Austausch des Gehäuses in Ihrem AFF C400 Storage-System. Das Verfahren zum Austausch des Gehäuses umfasst das Überführen aller Komponenten vom defekten Gehäuse in das Ersatzgehäuse und ist mit einer Unterbrechung verbunden.
