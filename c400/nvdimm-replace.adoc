...
summary: Sie müssen das NVDIMM im Controllermodul austauschen, wenn Ihr System erkennt, dass die Lebensdauer des Flash-Speichers fast abgelaufen ist oder dass das identifizierte NVDIMM generell nicht in Ordnung ist, oder ein Versäumnis dies zu tun eine Systempanik verursacht. 
---
= Ein NVDIMM in Ihrem AFF C400 Storage-System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein NVDIMM in Ihrem AFF C400 Speichersystem sollte ersetzt werden, wenn das System übermäßig viele korrigierbare ECC-Fehler oder einen nicht korrigierbaren ECC-Fehler registriert, was typischerweise durch einen einzelnen NVDIMM-Ausfall verursacht wird.
