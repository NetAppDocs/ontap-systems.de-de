...
---
= Ein AFF C400 System mit detaillierten Anweisungen installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das AFF C400 Speichersystem lässt sich mit einer Schritt-für-Schritt-Anleitung von der Montage und Verkabelung bis zur ersten Inbetriebnahme einrichten und konfigurieren.
