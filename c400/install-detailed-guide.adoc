...
---
= Das AFF C400 Storage-System lässt sich mit der detaillierten Anleitung installieren und einrichten.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das AFF C400 Speichersystem kann mithilfe der detaillierten Anleitung installiert und eingerichtet werden, die Schritt-für-Schritt-Anweisungen vom Einbau und der Verkabelung bis zur ersten Inbetriebnahme des Systems enthält.
