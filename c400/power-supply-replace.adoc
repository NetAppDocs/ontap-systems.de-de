...
---
= Netzteil im AFF C400-Speichersystem im laufenden Betrieb austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Netzteil in Ihrem AFF C400-Speichersystem kann im laufenden Betrieb ausgetauscht werden, sodass die kontinuierliche Stromversorgung ohne Unterbrechung des Dienstes erhalten bleibt.
