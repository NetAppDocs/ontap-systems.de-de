...
---
= Die Chassis-Hardware im AFF C400 Storage-System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Gehäusehardware im AFF C400 Storage-System wird ersetzt, indem die Lüfter, Festplatten und Controllermodule vom defekten Gehäuse in das Ersatzgehäuse umgesetzt werden.
