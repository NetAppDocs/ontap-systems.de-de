...
sidebar: sidebar 
summary: Wichtige Spezifikationen für die C400-Plattformgruppe 
---
...
[role="lead"]
Im Folgenden finden Sie ausgewählte Spezifikationen für das AFF C400 Speichersystem in einem einzelnen Hochverfügbarkeitspaar.  Die vollständigen Spezifikationen für dieses Speichersystem finden Sie im NetApp Hardware Universe (HWU).
...
* Typ: NAS; HA-Paare: 12; Rohkapazität: 35,4 PB / 31,4 PiB; Max. Speicher: 3072 GB
