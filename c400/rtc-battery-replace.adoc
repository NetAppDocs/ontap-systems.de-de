...
---
= Die Batterie der Echtzeituhr in einem AFF C400 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Echtzeituhrbatterie (RTC) in Ihrem AFF C400 Speichersystem sollte ausgetauscht werden, damit Dienste und Anwendungen, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin funktionieren.
