...
image:../media/drw_A400_Replace-PCIe-cards_IEOPS-1008.svg["Breite=500 px"]
...
image::../media/drw_A400_Replace-mezz-card_IEOPS-1006.svg[drw A400 Ersetzen sie die mezz-Karte IEOPS 1006]
