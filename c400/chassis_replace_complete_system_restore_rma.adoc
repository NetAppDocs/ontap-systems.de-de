...
---
= Schließen Sie den Wiederherstellungs- und Austauschprozess ab – AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Wenn der Node, der gewartet werden soll, nicht an der LOADER-Eingabeaufforderung angezeigt wird, booten Sie den Node neu: `system node halt -node node_name`
+
