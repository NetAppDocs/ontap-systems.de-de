...
summary: Nach der Installation des neuen Bootmediums in Ihrem AFF C400 -System können Sie den automatisierten Bootmedium-Wiederherstellungsprozess starten, um die Konfiguration vom Partnerknoten wiederherzustellen. 
---
= Das Boot-Image auf Ihrem AFF C400 Storage-System kann mit dem automatisierten Boot-Wiederherstellungsprozess wiederhergestellt werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach der Installation des neuen Bootmediums in Ihrem AFF C400 -System können Sie den automatisierten Bootmedium-Wiederherstellungsprozess starten, um die Konfiguration vom Partnerknoten wiederherzustellen.
