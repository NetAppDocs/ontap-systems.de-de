...
---
= Den Chassis-Austausch für Ihr AFF C400-Speichersystem abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Den Chassis-Austausch für Ihr AFF C400 Speichersystem abschließen, indem der HA-Status des Chassis überprüft und die defekte Komponente an NetApp zurückgesendet wird.
