...
summary: Fahren Sie den beeinträchtigten Controller in Ihrem AFF C400 Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Bootmediums sicherzustellen. 
---
= Den Controller im AFF C400 Storage-System während des automatisierten Boot-Recovery-Prozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den beeinträchtigten Controller in Ihrem AFF C400 Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Bootmediums sicherzustellen.
