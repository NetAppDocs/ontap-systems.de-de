...
summary: Stellen Sie die Verschlüsselung auf dem Ersatz-Startmedium wieder her. 
---
= Die Verschlüsselung auf dem Bootmedium des AFF C400 Storage-Systems wird nach dem manuellen Boot-Wiederherstellungsprozess wiederhergestellt.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Verschlüsselung auf dem Ersatz-Bootmedium in Ihrem AFF C400-Speichersystem wird wiederhergestellt, um sicheren Datenzugriff und ordnungsgemäßen Systembetrieb zu gewährleisten.
