...
---
= Die NVDIMM-Batterie im AFF C400 Storage-System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die NVDIMM-Batterie im AFF C400-Speichersystem wird ersetzt, indem das Controller-Modul entfernt, die Batterie ausgetauscht und das Controller-Modul wieder eingesetzt wird.
