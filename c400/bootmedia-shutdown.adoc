...
[role="lead"]
Der defekte Controller in Ihrem AFF C400 Storage-System wird nach Abschluss der Verschlüsselungsprüfungen und vor dem Austausch des Bootmediums heruntergefahren.
