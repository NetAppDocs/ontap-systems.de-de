...
---
= Das Bootmedium im AFF C400-Speichersystem kann mithilfe des manuellen Boot-Wiederherstellungsprozesses ersetzt werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Bootmedium in Ihrem AFF C400 Speichersystem wird ersetzt, indem das defekte Controllermodul entfernt, das Ersatz-Bootmedium installiert und das Boot-Image mithilfe eines USB-Sticks übertragen wird.
