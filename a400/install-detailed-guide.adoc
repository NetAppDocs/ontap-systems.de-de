...
---
= Das AFF A400-System kann anhand detaillierter Schritt-für-Schritt-Anleitungen installiert werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das AFF A400 Speichersystem kann anhand dieser detaillierten Schritt-für-Schritt-Anleitung installiert werden, von der Vorbereitung des Standorts bis zur Inbetriebnahme des ONTAP Clusters.
...
NOTE: Sind die Portbezeichnungen auf der Karte nicht sichtbar, sollte die Einbaurichtung der Karte überprüft werden. Der PCIe-Anschluss befindet sich bei den Modellen A400 und FAS8300/8700 auf der linken Seite des Kartensteckplatzes. Anschließend kann die Karte anhand der Teilenummer im  https://hwu.netapp.com["NetApp Hardware Universe"^] für eine Abbildung der Blende mit den Portbezeichnungen nachgeschlagen werden. Die Teilenummer der Karte lässt sich mit dem  `sysconfig -a` Befehl oder auf der Systemverpackung finden.
...
Es können entweder NS224 oder SAS Shelves an das System angeschlossen werden.
