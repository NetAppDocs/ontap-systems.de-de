...
summary: Um Ihr AFF A400-System wieder voll funktionsfähig zu machen, stellen Sie die NetApp Storage Encryption-Konfiguration gegebenenfalls wieder her, installieren Sie Lizenzen für den neuen Controller und senden Sie das defekte Teil zurück an NetApp. 
---
