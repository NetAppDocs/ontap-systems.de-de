...
summary: 'Schließen Sie den Controller-Austausch für Ihr AFF A400-System ab. Installieren Sie die Lizenzen für den Ersatzcontroller, überprüfen Sie, ob die logischen Schnittstellen (LIFs) an ihren Home-Ports melden, und führen Sie eine Cluster-Integritätsprüfung durch. Senden Sie das defekte Bauteil anschließend an NetApp zurück.' 
---
= Den Controller-Austausch für ein AFF A400 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schließen Sie den Controller-Austausch für Ihr AFF A400-System ab. Installieren Sie die Lizenzen für den Ersatzcontroller, überprüfen Sie, ob die logischen Schnittstellen (LIFs) an ihren Home-Ports melden, und führen Sie eine Cluster-Integritätsprüfung durch. Senden Sie das defekte Bauteil anschließend an NetApp zurück.
