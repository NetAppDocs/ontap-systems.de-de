...
---
= Anforderungen für den Austausch des Bootmediums in einem AFF A400 System prüfen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bevor das Bootmedium in Ihrem AFF A400 System ausgetauscht wird, sollte sichergestellt sein, dass die notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sind. Dazu gehört ein mit FAT32 formatierter USB-Stick mit ausreichend Speicherplatz für das ONTAP Recovery-Image sowie die Feststellung, ob der Austausch unterbrechungsfrei oder unterbrechungsbehaftet erfolgt.
