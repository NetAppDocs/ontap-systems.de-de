...
summary: Das Bootmedium speichert einen primären und einen sekundären Satz von Systemdateien, die das System beim Start verwendet. 
---
= Anforderungen für den Austausch des Bootmediums in Ihrem AFF A400 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bevor das Bootmedium in Ihrem AFF A400 System ausgetauscht wird, sollten die notwendigen Voraussetzungen für eine erfolgreiche Entfernung erfüllt sein. Dazu gehört ein mit FAT32 formatierter USB-Stick mit ausreichend Speicherplatz für das ONTAP Recovery-Image sowie die Kenntnis darüber, ob eine unterbrechungsfreie oder eine unterbrechende Entfernung durchgeführt wird.
