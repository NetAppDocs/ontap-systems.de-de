...
---
= Installation eines AFF A400 Systems mithilfe der kurzen grafischen Anleitung
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das AFF A400 Speichersystem lässt sich mithilfe der kurzen grafischen Anleitung installieren und verkabeln.
