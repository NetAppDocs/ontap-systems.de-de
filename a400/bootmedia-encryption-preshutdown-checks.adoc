...
---
= Die Verschlüsselungsunterstützung auf Ihrem Bootmedium im AFF A400 System prüfen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um die Datensicherheit auf Ihrem AFF A400 Storage-System zu gewährleisten, muss die Unterstützung und der Status des Verschlüsselungsschlüssels auf Ihrem Boot-Medium überprüft werden. Es sollte geprüft werden, ob Ihre ONTAP Version NetApp Volume Encryption (NVE) unterstützt, und vor dem Herunterfahren des Controllers sollte überprüft werden, ob der Key Manager aktiv ist.
