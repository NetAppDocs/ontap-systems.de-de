...
[role="lead"]
Um die Datensicherheit auf Ihrem AFF A400 Storage-System zu gewährleisten, sollte die Unterstützung und der Status des Verschlüsselungsschlüssels auf Ihrem Boot-Medium vor dem Herunterfahren des Controllers überprüft werden. Es ist zu prüfen, ob Ihre ONTAP Version NetApp Volume Encryption (NVE) unterstützt und ob der Schlüsselmanager aktiv ist.
