...
summary: Tauschen Sie die Echtzeituhr-Batterie in Ihrem AFF A400-Controllermodul aus, um sicherzustellen, dass Dienste und Anwendungen, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin funktionieren. 
---
= Die Echtzeit-Batterie der Echtzeituhr in Ihrem AFF A400 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Echtzeitbatterie (RTC) in Ihrem AFF A400-System sollte ersetzt werden, damit Dienste und Anwendungen, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin funktionieren.
...
image::../media/drw_A400_rtc-batt.png[Entfernen und ersetzen Sie die RTC-Batterie]
