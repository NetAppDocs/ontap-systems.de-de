...
summary: Tauschen Sie ein DIMM in Ihrem AFF A400 Controller-Modul aus, wenn das System eine zunehmende Anzahl von korrigierbaren Fehlerkorrekturcodes oder nicht korrigierbaren ECC-Fehlern registriert. Wenn ein defektes DIMM nicht ersetzt wird, kann dies zu einem Systemabsturz führen. 
---
= Ein DIMM in Ihrem AFF A400 System wird ersetzt, um Speicherfehler zu beheben.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein DIMM in Ihrem AFF A400-System sollte ersetzt werden, wenn das Speichersystem eine übermäßige Anzahl korrigierbarer (CECC) oder nicht korrigierbarer Speicherfehler feststellt. Solche Fehler können verhindern, dass das Speichersystem ONTAP startet.
