...
. Gehen Sie zu  4: Cable controllers to drive shelves Anleitung zur Verkabelung des Festplatten-Shelf
...
. Gehen Sie zu  5: Complete system setup and configuration Zum Abschließen der Einrichtung und Konfiguration des Systems.
