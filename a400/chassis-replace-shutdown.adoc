...
---
= Die AFF A400 Controller werden heruntergefahren, um das Chassis auszutauschen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Herunterfahren der Controller im AFF A400-Speichersystem verhindert Datenverlust und gewährleistet die Systemstabilität beim Austausch des Gehäuses.
