...
summary: Übergeben Sie die Kontrolle über die Speicherressourcen wieder an den Ersatzcontroller, damit Ihr AFF A400-System den normalen Betrieb wieder aufnehmen kann. 
---
= Das System wird neu verkabelt und die Datenträger in Ihrem AFF A400 System werden neu zugewiesen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Übergeben Sie die Kontrolle über die Speicherressourcen wieder an den Ersatzcontroller, damit Ihr AFF A400-System den normalen Betrieb wieder aufnehmen kann.
