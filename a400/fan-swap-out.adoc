...
---
= Lüftermodul im laufenden Betrieb in einem AFF A400 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Hot-Swap-fähige Lüftermodul im AFF A400 System sorgt für eine ordnungsgemäße Kühlung. Das Lüftermodul muss innerhalb von zwei Minuten nach der Entfernung ersetzt werden, um eine Überhitzung zu verhindern.
