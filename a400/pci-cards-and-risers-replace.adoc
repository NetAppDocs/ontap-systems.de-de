...
---
= Austausch einer PCIe- oder Mezzanine-Karte in einem AFF A400 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Eine PCIe- oder Mezzanine-Karte in Ihrem AFF A400 System wird ersetzt, wenn die Karte defekt ist oder ein Upgrade erforderlich ist. Der Austauschvorgang umfasst das Trennen der Kabel und der SFP- oder QSFP-Module, das Ersetzen der Karte und das erneute Verkabeln.
