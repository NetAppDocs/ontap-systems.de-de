...
summary: Schalten Sie den Controller Ihres AFF A400-Speichersystems ab, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers zu gewährleisten. 
---
= Vor dem Austausch ist der defekte Controller in einem AFF A400-System herunterzufahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie den Controller Ihres AFF A400-Speichersystems ab, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers zu gewährleisten.
...
Nachdem Sie den AFF A400-Controller heruntergefahren haben, müssen Sie link:controller-replace-move-hardware.html["Ersetzen Sie den Controller"].
