...
. Rufen Sie an der EINGABEAUFFORDERUNG DES LOADERS die speziellen Treiber auf, die speziell für die Diagnose entwickelt wurden, um ordnungsgemäß zu funktionieren: `boot_diags`
