...
---
= Die NVDIMM-Batterie in Ihrem AFF A400 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die NVDIMM-Batterie in Ihrem AFF A400 System sollte ersetzt werden, wenn sie an Ladung verliert oder ausfällt. Der Austauschvorgang umfasst die Entfernung des Controller-Moduls, den Austausch der Batterie und die erneute Installation des Controller-Moduls.
