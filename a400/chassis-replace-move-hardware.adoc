...
---
= Das Chassis in einem AFF A400 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Gehäuse Ihres AFF A400 Systems wird ersetzt, wenn ein Hardwarefehler dies erforderlich macht. Beim Austausch werden die Lüfter, SSD-Laufwerke und Controller-Module vom defekten Gehäuse in das Ersatzgehäuse umgesetzt.
