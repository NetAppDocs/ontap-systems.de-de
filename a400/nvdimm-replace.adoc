...
summary: Ersetzen Sie das NVDIMM in Ihrem AFF A400 Controllermodul, wenn das System meldet, dass die Lebensdauer des Flash-Speichers fast abgelaufen ist oder das identifizierte NVDIMM nicht funktionsfähig ist. Wenn ein fehlerhaftes NVDIMM nicht ersetzt wird, kann dies zu einem Systemabsturz führen. 
---
= Das NVDIMM in Ihrem AFF A400 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das NVDIMM in Ihrem AFF A400 System sollte ersetzt werden, wenn das System meldet, dass die Lebensdauer des Flash-Speichers fast abgelaufen ist oder das NVDIMM nicht funktionsfähig ist. Ein unterlassener Austausch kann zu einem Systemabsturz führen.
