...
summary: Tauschen Sie den Controller in Ihrem AFF A400-System aus, wenn ein Hardwaredefekt dies erfordert. Entfernen Sie den ausgefallenen Controller, übertragen Sie dessen Komponenten auf den Ersatzcontroller, installieren Sie den neuen Controller und starten Sie ihn neu. 
---
= Den Controller in Ihrem AFF A400 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Tauschen Sie den Controller in Ihrem AFF A400-System aus, wenn ein Hardwaredefekt dies erfordert. Entfernen Sie den ausgefallenen Controller, übertragen Sie dessen Komponenten auf den Ersatzcontroller, installieren Sie den neuen Controller und starten Sie ihn neu.
...
Nachdem Sie den defekten AFF A400 Controller ausgetauscht haben, müssen Sie link:controller-replace-system-config-restore-and-verify.html["Stellen Sie die Systemkonfiguration wieder her"].
