...
---
= Das System wird neu verkabelt und die Datenträger in Ihrem ASA C250 System werden neu zugewiesen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss der Wiederherstellung und Überprüfung der Systemkonfiguration ASA C250 müssen Sie das System neu verkabeln und die Festplatten neu zuweisen.
