...
summary: Um den Controller-Austausch für Ihr ASA C250-System vollständig abzuschließen, müssen Sie die NetApp Storage Encryption-Konfiguration nach Bedarf wiederherstellen, Lizenzen für den neuen Controller installieren und das defekte Teil an NetApp zurücksenden, wie in den mit dem Kit gelieferten RMA-Anweisungen beschrieben. 
---
= Den Controller-Austausch für ein ASA C250 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
