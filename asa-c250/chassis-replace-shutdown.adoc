...
---
= Die ASA C250 Controller werden heruntergefahren, um das Chassis auszutauschen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie die Controller in Ihrem AFF ASA C250-Speichersystem aus, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Gehäuses zu gewährleisten.
...
Nachdem Sie den Controller heruntergefahren haben, müssen Sie link:chassis-replace-move-hardware.html["Hardware in das neue Gehäuse verschieben"]
