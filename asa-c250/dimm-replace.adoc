...
summary: Ein DIMM in einem ASA C250 System ist auszutauschen, wenn das System eine zunehmende Anzahl korrigierbarer Fehlerkorrekturcodes oder nicht korrigierbarer ECC-Fehler registriert. Das Nichtaustauschen eines defekten DIMM kann zu einem Systemabsturz führen. 
---
= Ein DIMM in einem ASA C250 System ersetzen, um Speicherfehler zu beheben
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein DIMM in einem ASA C250 System ist auszutauschen, wenn das System eine zunehmende Anzahl korrigierbarer Fehlerkorrekturcodes oder nicht korrigierbarer ECC-Fehler registriert. Das Nichtaustauschen eines defekten DIMM kann zu einem Systemabsturz führen.
