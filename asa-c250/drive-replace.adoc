...
summary: Ein Laufwerk in Ihrem ASA C250 System kann im laufenden Betrieb ausgetauscht werden, wenn die Plattform eine Warnmeldung an die Systemkonsole ausgibt, die auf einen Laufwerksausfall hinweist. Zudem leuchten sowohl die Fehler-LED auf dem Bedienerdisplay als auch die Fehler-LED am ausgefallenen Laufwerk. 
---
= Laufwerk im laufenden Betrieb in einem ASA C250 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
In Ihrem ASA C250-System kann eine Festplatte im laufenden Betrieb ausgetauscht werden, wenn eine Festplatte ausfällt. Der Austauschprozess umfasst die Identifizierung der defekten Festplatte, deren sichere Entfernung und die Installation einer neuen Festplatte, um den fortlaufenden Datenzugriff und die Systemleistung sicherzustellen.
