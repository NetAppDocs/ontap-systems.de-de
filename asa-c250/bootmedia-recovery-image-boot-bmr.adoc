...
summary: Nach der Installation des neuen Bootmediums in Ihrem ASA C250 System können Sie den automatisierten Bootmedien-Wiederherstellungsprozess starten, um die Konfiguration vom Partnerknoten wiederherzustellen. 
---
= Automatisierte Wiederherstellung des Bootmediums vom Partnerknoten - ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
