...
summary: Tauschen Sie die Echtzeit-Uhr-Batterie in Ihrem ASA C250-Controllermodul aus, um sicherzustellen, dass Dienste und Anwendungen, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin funktionieren. 
---
= Die Batterie der Echtzeituhr in einem ASA C250 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Echtzeitbatterie (RTC) in Ihrem ASA C250 System sollte ersetzt werden, damit Dienste und Anwendungen, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin funktionieren.
