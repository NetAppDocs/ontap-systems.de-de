...
summary: Tauschen Sie das Gehäuse Ihres ASA C250 Systems aus, wenn ein Hardwaredefekt dies erfordert. Der Austauschvorgang umfasst das Entfernen der Controller und Netzteile, das Entfernen der Laufwerke, den Einbau des Ersatzgehäuses und das Wiedereinsetzen der Gehäusekomponenten. 
---
= Das Chassis in Ihrem ASA C250 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Tauschen Sie das Gehäuse Ihres ASA C250 Systems aus, wenn ein Hardwaredefekt dies erfordert. Der Austauschvorgang umfasst das Entfernen der Controller und Netzteile (PSUs), das Entfernen der Laufwerke, den Einbau des Ersatzgehäuses und das Wiedereinsetzen der Gehäusekomponenten.
...
Nachdem Sie das defekte ASA C250-Chassis ausgetauscht und die Komponenten wieder eingebaut haben, müssen Sie link:chassis-replace-complete-system-restore-rma.html["Schließen Sie den Austausch des Gehäuses ab"]
