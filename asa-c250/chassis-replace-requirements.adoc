...
summary: Bevor Sie das Chassis Ihres ASA C250 Systems austauschen, stellen Sie sicher, dass Sie die notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllen. Dazu gehört die Überprüfung, dass alle anderen Komponenten im System ordnungsgemäß funktionieren, dass Sie lokale Administratoranmeldedaten für ONTAP, das richtige Ersatzchassis und die erforderlichen Werkzeuge haben. 
---
= Anforderungen sollten vor dem Austausch des Chassis in einem ASA C250 System überprüft werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bevor Sie das Chassis Ihres ASA C250 Systems austauschen, stellen Sie sicher, dass Sie die notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllen. Dazu gehört die Überprüfung, dass alle anderen Komponenten im System ordnungsgemäß funktionieren, dass Sie lokale Administratoranmeldedaten für ONTAP, das richtige Ersatzchassis und die erforderlichen Werkzeuge haben.
