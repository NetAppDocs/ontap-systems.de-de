...
summary: Ein ASA C250 Speichersystem kann mit detaillierten Schritt-für-Schritt-Anweisungen installiert werden, die die Montage, Verkabelung und die erste Inbetriebnahme des Systems abdecken. 
---
= Ein ASA C250 Storage-System mit detaillierten Schritten installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein ASA C250 Speichersystem kann mit detaillierten Schritt-für-Schritt-Anweisungen installiert werden, die die Montage, Verkabelung und die erste Inbetriebnahme des Systems abdecken.
...
NOTE: link:https://hwu.netapp.com["NetApp Hardware Universe"^] Die Priorität für Host-Netzwerkkarten (Fibre Channel oder 25 GbE) ist Steckplatz 2. Wenn jedoch beide Karten vorhanden sind, kommt die Fibre-Channel-Karte in Steckplatz 2 und die 25-GbE-Karte in Steckplatz 1 (wie in den untenstehenden Optionen gezeigt). Wenn Sie ein externes Shelf haben, kommt die Speicherkarte in Steckplatz 1, dem einzigen unterstützten Steckplatz für Shelves.
...
--
.Option 2: Kabelverbindung zu 25-GbE-Daten- oder Hostnetzwerk
--
25-GbE-Ports an den Controllern sind mit 25-GbE-Daten- oder Host-Netzwerk-Switches verbunden.
