...
summary: Schalten Sie den defekten Controller in Ihrem ASA C250-Speichersystem ab, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Bootmediums zu gewährleisten. 
---
= Der Controller im ASA C250 System wird während des automatisierten Boot-Wiederherstellungsprozesses heruntergefahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie den defekten Controller in Ihrem ASA C250-Speichersystem ab, um Datenverlust zu verhindern und die Systemstabilität während des automatisierten Bootmedien-Wiederherstellungsprozesses aufrechtzuerhalten.
