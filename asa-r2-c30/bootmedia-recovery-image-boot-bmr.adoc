...
summary: Nachdem Sie das neue Boot-Mediengerät in Ihrem ASA C30-Speichersystem installiert haben, können Sie den automatisierten Boot-Medienwiederherstellungsprozess starten, um die Konfiguration vom fehlerfreien Knoten wiederherzustellen. 
---
= Das Startabbild Ihres ASA C30 Systems kann mithilfe des automatisierten Startwiederherstellungsprozesses wiederhergestellt werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nachdem Sie das neue Boot-Mediengerät in Ihrem ASA C30-Speichersystem installiert haben, können Sie den automatisierten Boot-Medienwiederherstellungsprozess starten, um die Konfiguration vom fehlerfreien Knoten wiederherzustellen.
