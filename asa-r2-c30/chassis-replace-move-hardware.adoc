...
[role="lead"]
Ersetzen Sie das Gehäuse Ihres ASA C30-Speichersystems, wenn ein Hardwarefehler dies erfordert. Beim Austausch werden die Controller und Netzteile (PSUs) entfernt, die Laufwerke entfernt, das Ersatzgehäuse installiert und die Gehäusekomponenten wieder eingebaut.
