...
summary: Ersetzen Sie das Gehäuse Ihres ASA C30-Speichersystems, wenn ein Hardwarefehler dies erfordert. Der Austauschvorgang umfasst das Entfernen der Controller, das Entfernen der Laufwerke, die Installation des Ersatzgehäuses und die Neuinstallation der Gehäusekomponenten. 
---
= Das Chassis in einem ASA C30 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
