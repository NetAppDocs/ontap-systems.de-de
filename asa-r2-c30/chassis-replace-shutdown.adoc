...
summary: Fahren Sie die Controller in Ihrem ASA C30-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Gehäuses sicherzustellen. 
---
= Die ASA C30 Controller werden heruntergefahren, um das Chassis auszutauschen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie die Controller in Ihrem ASA C30-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Gehäuses sicherzustellen.
