...
summary: Fahren Sie den beschädigten Controller in Ihrem ASA C30-Speichersystem herunter, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers sicherzustellen. 
---
= Vor dem Austausch muss der defekte Controller in einem ASA C30 System abgeschaltet werden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den beschädigten Controller in Ihrem ASA C30-Speichersystem herunter, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers sicherzustellen.
