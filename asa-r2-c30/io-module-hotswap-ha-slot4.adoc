...
summary: Das Cluster- und HA-E/A-Modul unterstützt Interconnects für Clustering und Hochverfügbarkeit. Bei einem Modulausfall können Sie das Modul in Ihrem ASA C30-Speichersystem im laufenden Betrieb austauschen. 
---
