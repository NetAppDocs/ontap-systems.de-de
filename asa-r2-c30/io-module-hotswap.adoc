...
summary: Sie können ein Ethernet-E/A-Modul in Ihrem ASA C30-Speichersystem per Hot-Swap austauschen, wenn ein Modul ausfällt und Ihr Speichersystem alle ONTAP-Versionanforderungen erfüllt. 
---
= Ein E/A-Modul kann in Ihrem ASA C30 System Hot-Swap-fähig ausgetauscht werden, ohne dass ein Herunterfahren erforderlich ist.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können ein Ethernet-E/A-Modul in Ihrem ASA C30-Speichersystem per Hot-Swap austauschen, wenn ein Modul ausfällt und Ihr Speichersystem alle ONTAP-Versionanforderungen erfüllt.
