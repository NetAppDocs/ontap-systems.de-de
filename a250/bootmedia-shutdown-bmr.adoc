...
summary: Schalten Sie den defekten Controller in Ihrem AFF A250-Speichersystem ab, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Bootmediums zu gewährleisten. 
---
= Den Controller im AFF A250 System während des automatisierten Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
