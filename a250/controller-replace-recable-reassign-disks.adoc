...
---
= Das System wird neu verkabelt und die Datenträger in Ihrem AFF A250 System werden neu zugewiesen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Den Speicher neu anschließen, die Neuzuordnung der Festplatte bestätigen und NetApp Storage Encryption wiederherstellen, damit das AFF A250 System wieder vollständig betriebsbereit ist.
