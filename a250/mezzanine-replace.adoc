...
---
= Eine Mezzanine-Karte in einem AFF A250 System ersetzen oder installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Eine defekte Mezzanine-Karte in Ihrem AFF A250 System kann ersetzt oder eine neue installiert werden, um die Anschlussmöglichkeiten zu erweitern. Der Austauschvorgang umfasst das Entfernen der Kabel und SFP- oder QSFP-Module, das Ersetzen der Karte und das erneute Verkabeln.
