...
---
= Wichtigste Spezifikationen für ein AFF A250 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ausgewählte Spezifikationen des AFF A250 Speichersystems, die ein einzelnes Hochverfügbarkeitspaar widerspiegeln. Die vollständige Liste der AFF A250 Spezifikationen ist unter  https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) verfügbar.
