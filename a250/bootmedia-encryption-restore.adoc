...
summary: Stellen Sie die Verschlüsselung auf dem Ersatz-Bootmedium in Ihrem AFF A250-System wieder her. Führen Sie die spezifischen Schritte für Systeme durch, bei denen Onboard Key Manager, NetApp Storage Encryption oder NetApp Volume Encryption aktiviert ist. 
---
= Wiederherstellung der Verschlüsselung auf dem Bootmedium in einem AFF A250 System nach dem manuellen Boot-Wiederherstellungsprozess
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Stellen Sie die Verschlüsselung auf dem Ersatz-Bootmedium in Ihrem AFF A250 System wieder her, um den fortlaufenden Datenschutz zu gewährleisten. Der Austauschvorgang umfasst die Überprüfung der Schlüsselverfügbarkeit, die erneute Anwendung der Verschlüsselungseinstellungen und die Bestätigung des sicheren Zugriffs auf Ihre Daten.
...
Nach der Wiederherstellung der Verschlüsselung auf dem Bootmedium, link:bootmedia-complete-rma.html["Geben Sie das fehlerhafte Teil an NetApp zurück"].
