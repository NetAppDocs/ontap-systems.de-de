...
---
= Die Controller-Konfiguration in Ihrem AFF A250 System wird wiederhergestellt und überprüft.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss des Hardwareaustauschs und dem Start im Wartungsmodus sollte die Systemkonfiguration auf niedriger Ebene des Ersatzcontrollers überprüft und die Systemeinstellungen bei Bedarf neu konfiguriert werden.
