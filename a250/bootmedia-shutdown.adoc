...
summary: Der Controller im AFF A250-Speichersystem sollte heruntergefahren werden, um Datenverlust zu vermeiden und die Systemstabilität während des manuellen Boot-Medien-Wiederherstellungsprozesses zu gewährleisten. 
---
= Den Controller in einem AFF A250 System während des manuellen Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller im AFF A250-Speichersystem sollte heruntergefahren werden, um Datenverlust zu vermeiden und die Systemstabilität während des manuellen Boot-Medien-Wiederherstellungsprozesses zu gewährleisten.
