...
---
= Controller für manuelle Wiederherstellung des Startmediums herunterfahren - AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie den defekten Controller in Ihrem AFF A250-Speichersystem ab, um Datenverlust zu verhindern und die Systemstabilität während des automatisierten Bootmedien-Wiederherstellungsprozesses aufrechtzuerhalten.
