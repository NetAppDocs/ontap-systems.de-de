...
---
= Einen Lüfter im laufenden Betrieb in Ihrem AFF A250 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes Lüftermodul in Ihrem AFF A250 System sollte ersetzt werden, um eine ordnungsgemäße Kühlung aufrechtzuerhalten und Leistungsprobleme zu vermeiden. Lüftermodule sind Hot-Swap-fähig und können ohne Herunterfahren des Systems ersetzt werden.
