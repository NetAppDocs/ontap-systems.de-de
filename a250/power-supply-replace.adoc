...
summary: Ersetzen Sie ein Netzteil in Ihrem AFF A250-System, indem Sie das Zielnetzteil von der Stromquelle trennen, das Netzkabel abziehen, das alte Netzteil entfernen, das Ersatznetzteil installieren und es dann wieder an die Stromquelle anschließen. 
---
= Netzteil im laufenden Betrieb in einem AFF A250 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Netzteil im AFF A250 System sollte ersetzt werden, wenn es ausfällt oder fehlerhaft ist. Die Netzteile sind redundant und Hot-Swap-fähig, daher ist ein Herunterfahren des Controllers für diesen Austausch nicht erforderlich.
...
--
Um ein AC-Netzteil im laufenden Betrieb auszutauschen, führen Sie die folgenden Schritte aus.
