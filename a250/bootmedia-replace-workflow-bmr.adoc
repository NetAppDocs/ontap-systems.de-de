...
summary: Beginnen Sie mit dem Austausch des Bootmediums in Ihrem AFF A250 Storage System, indem Sie die Austauschvoraussetzungen überprüfen, den Controller herunterfahren, das Bootmedium austauschen, das Image auf dem Bootmedium wiederherstellen und die Systemfunktionalität überprüfen. 
---
= Arbeitsablauf zum Austausch des Bootmediums für ein AFF A250 System unter Verwendung des automatisierten Boot-Wiederherstellungsprozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die automatische Wiederherstellung des Startabbilds beinhaltet das automatische Erkennen und Auswählen der passenden Startmenüoption durch das System. Es verwendet das Startabbild auf dem Partnerknoten, um ONTAP auf dem Ersatzstartmedium in Ihrem AFF A250 Storage System neu zu installieren.
