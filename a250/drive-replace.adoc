...
---
= Laufwerk im laufenden Betrieb in einem AFF A250 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein ausgefallenes Laufwerk in Ihrem AFF A250 System kann im laufenden Betrieb ausgetauscht werden, während I/O aktiv ist, um die Speicherkapazität und Leistung wiederherzustellen.
