...
---
= Ein Laufwerk in Ihrem AFF A250 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes Laufwerk in Ihrem AFF A250 System kann während laufender E/A-Vorgänge unterbrechungsfrei ersetzt werden, um die Speicherkapazität und Leistung wiederherzustellen.
