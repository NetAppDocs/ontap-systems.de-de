...
summary: Nach der Installation des neuen Bootmediengeräts in Ihrem AFF A250-System können Sie den automatisierten Bootmedien-Wiederherstellungsprozess starten, um die Konfiguration vom Partnerknoten wiederherzustellen. 
---
= Das Wiederherstellungsimage auf Ihrem AFF A250 System wird mithilfe des automatisierten Boot-Wiederherstellungsprozesses gestartet.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
