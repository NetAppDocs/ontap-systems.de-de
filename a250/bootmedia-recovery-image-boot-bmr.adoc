...
summary: Nach der Installation des neuen Bootmediums in Ihrem AFF A250-System können Sie den automatisierten Bootmedien-Wiederherstellungsprozess starten, um die Konfiguration vom Partner-Node wiederherzustellen. 
---
= Automatisierte Wiederherstellung des Bootmediums vom Partnerknoten - AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
