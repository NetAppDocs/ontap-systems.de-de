...
summary: Um den Controller-Austausch für Ihr AFF A250-System abzuschließen, stellen Sie die NetApp Storage Encryption-Konfiguration gegebenenfalls wieder her, installieren Sie Lizenzen für den neuen Controller und senden Sie das defekte Teil an NetApp zurück. 
---
= Den Controller-Austausch für ein AFF A250 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um den Controller-Austausch für Ihr AFF A250 System abzuschließen, die NetApp Storage Encryption-Konfiguration (falls erforderlich) wiederherstellen, bestätigen, dass die logischen Schnittstellen (LIFs) an ihren Home-Ports melden, eine Cluster-Integritätsprüfung durchführen und das defekte Teil an NetApp zurücksenden.
