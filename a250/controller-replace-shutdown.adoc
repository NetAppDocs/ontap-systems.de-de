...
---
= Vor dem Austausch muss der defekte Controller in einem AFF A250 System abgeschaltet werden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie den Controller in Ihrem AFF A250-Speichersystem aus, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers sicherzustellen.
