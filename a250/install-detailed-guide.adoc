...
---
= Das AFF A250 System kann anhand detaillierter Schritt-für-Schritt-Anleitungen installiert werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das AFF A250 Speichersystem kann anhand dieser detaillierten Schritt-für-Schritt-Anleitung installiert werden, von der Vorbereitung des Standorts bis zur Inbetriebnahme des ONTAP Clusters.
...
.Schritte
. Das 25 GbE Cluster-Interconnect-Kabel dient dazu, die Cluster-Interconnect-Ports e0c mit e0c und e0d mit e0d zu verbinden.
+
