...
summary: Die Echtzeit-Uhr-Batterie in Ihrem AFF A200 System sollte ersetzt werden, damit Dienste und Anwendungen, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin funktionieren. 
---
= Die Batterie der Echtzeituhr in einem AFF A200 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Echtzeitbatterie (RTC) in Ihrem AFF A200-System sollte ersetzt werden, damit Dienste und Anwendungen, die auf eine genaue Zeitsynchronisierung angewiesen sind, weiterhin funktionieren.
