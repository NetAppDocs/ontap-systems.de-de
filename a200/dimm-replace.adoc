...
---
= Austausch eines DIMM in einem AFF A200 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein DIMM in Ihrem AFF A200 System sollte ersetzt werden, wenn das Speichersystem auf übermäßig viele korrigierbare ECC-Fehler oder einen nicht korrigierbaren ECC-Fehler stößt, was typischerweise durch den Ausfall eines einzelnen DIMM verursacht wird.
