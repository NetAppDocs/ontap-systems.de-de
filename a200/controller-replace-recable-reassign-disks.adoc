...
---
= Das System neu zuordnen und Festplatten neu zuweisen - AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Setzen Sie das Verfahren zum Austausch fort, indem Sie den Speicher neu verkabeln und die Neuzuweisung von Festplatten bestätigen.
