...
---
= Das System wird neu verkabelt und die Datenträger in Ihrem AFF A200 System werden neu zugewiesen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller-Austausch für Ihr AFF A200 System wird abgeschlossen, indem der Speicher neu verkabelt und die Neuzuordnung der Festplatten bestätigt wird.



[[step-1-re-cable-the-system]]
== Schritt 1: Das System erneut verkabeln
