...
---
= Das Bootmedium in einem AFF A200 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um das Bootmedium zu ersetzen, müssen Sie das defekte Controllermodul ausbauen, das Ersatz-Bootmedium installieren und das Boot-Image auf einen USB-Stick übertragen. Das AFF A200 -System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. Die automatische Wiederherstellung über Bootmedien wird nicht unterstützt.
