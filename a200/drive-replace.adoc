...
---
= Laufwerk im laufenden Betrieb in einem AFF A200 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein ausgefallenes Laufwerk in Ihrem AFF A200 System kann im laufenden Betrieb ausgetauscht werden, ohne dass die I/O unterbrochen wird. Das AFF A200 unterstützt sowohl SSDs als auch HDDs, jeweils mit einem eigenen Austauschverfahren.
