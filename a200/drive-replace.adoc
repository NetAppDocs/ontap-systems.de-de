...
---
= Ein Laufwerk in Ihrem AFF A200 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes Laufwerk in Ihrem AFF A200 System kann ohne Unterbrechung der I/O ausgetauscht werden. Das AFF A200 unterstützt sowohl SSDs als auch HDDs, jeweils mit einem eigenen Austauschverfahren.
