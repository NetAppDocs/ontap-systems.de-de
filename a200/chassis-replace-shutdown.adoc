...
---
= Die AFF A200 Controller werden heruntergefahren, um das Chassis auszutauschen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Beide Controller im AFF A200 System sind vor dem Austausch des Chassis herunterzufahren.
