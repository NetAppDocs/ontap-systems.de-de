...
---
= Den Controller-Austausch für ein AFF A200 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Austausch des Controllers für Ihr AFF A200-System wird abgeschlossen, indem die NetApp Storage Encryption-Konfiguration (falls erforderlich) wiederhergestellt, Lizenzen für den neuen Controller installiert und das defekte Teil an NetApp zurückgesendet werden.
