...
---
= Die NVMEM-Batterie in einem AFF A200 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die NVMEM Batterie in Ihrem AFF A200 System wird ersetzt, indem das Controller-Modul entfernt, geöffnet, die Batterie ausgetauscht und das Controller-Modul wieder eingesetzt wird.
