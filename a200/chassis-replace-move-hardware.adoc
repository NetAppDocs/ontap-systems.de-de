...
---
= Das Chassis in Ihrem AFF A200 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Gehäuse im AFF A200 System wird ersetzt, indem die Netzteile, Festplatten und Controller-Module vom defekten Gehäuse in das Ersatzgehäuse übertragen werden.
...
Stellen Sie das Netzteil vom alten Gehäuse zum Ersatzgehäuse.
...
CAUTION: Beim Einschieben des Netzteils in das System keine übermäßige Kraft verwenden. Sie können den Anschluss beschädigen.
