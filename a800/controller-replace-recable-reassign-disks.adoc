...
---
= Das System wird neu verkabelt und die Datenträger in Ihrem AFF A800 System werden neu zugewiesen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verkabeln Sie Ihr AFF A800-System nach einem Controller-Austausch neu und weisen Sie die Festplatten dem Ersatz-Controller zu. Befindet sich Ihr System in einem HA-Paar, weist der Rückgabeprozess den Festplatten automatisch die System-ID zu; die genauen Schritte hängen davon ab, ob Ihr System keine Verschlüsselung oder Onboard Key Manager (OKM)-Verschlüsselung verwendet.
...
Befindet sich das Speichersystem in einem HA-Paar, wird die System-ID des neuen Controller-Moduls den Festplatten automatisch zugewiesen, sobald die Rückgabe am Ende des Vorgangs erfolgt. Die Änderung der System-ID muss beim Starten des _Ersatzcontrollers_ bestätigt und anschließend überprüft werden, ob das System die Änderung übernommen hat.

Dieser Schritt gilt nur für Systeme, auf denen ONTAP in einem HA-Paar ausgeführt wird.
