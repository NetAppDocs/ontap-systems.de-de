...
---
= Informationen zur Wartung Ihres AFF A800 Storage-Systems
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Hardware des AFF A800 Storage-Systems wird gepflegt, um langfristige Zuverlässigkeit und optimale Leistung zu unterstützen. Regelmäßige Wartungsaufgaben wie der Austausch fehlerhafter Komponenten tragen dazu bei, Ausfallzeiten und Datenverlust zu vermeiden.
