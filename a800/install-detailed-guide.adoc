...
---
= Das AFF A800 System kann anhand detaillierter Schritt-für-Schritt-Anleitungen installiert werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das AFF A800 Speichersystem kann mit diesen detaillierten Schritt-für-Schritt-Anweisungen installiert werden, von der Vorbereitung des Standorts bis zur Inbetriebnahme des ONTAP Clusters.
...
Für den Cluster Ihrer Plattform ist eine Verkabelung erforderlich, entweder im Zwei-Knoten Cluster ohne Switches Verfahren oder über das Cluster-Interconnect-Netzwerk. Optional kann eine Verkabelung zu Fibre Channel- oder iSCSI-Hostnetzwerken oder direkt angeschlossenem Speicher erfolgen. Diese Verkabelung schließt sich nicht aus, es kann sowohl eine Verkabelung zu einem Hostnetzwerk als auch zu Speicher vorhanden sein.
...
.. Im linken Bereich *Netzwerk* auswählen, mit der rechten Maustaste klicken und *Aktualisieren* wählen.
