...
---
= Wichtigste Spezifikationen für ein AFF A800 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dies sind ausgewählte Spezifikationen des AFF A800 Speichersystems in einem einzelnen Hochverfügbarkeits-Paar. Besuchen Sie  https://hwu.netapp.com["NetApp Hardware Universe"^] für die vollständigen Spezifikationen dieses Speichersystems.
