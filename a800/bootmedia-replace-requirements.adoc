...
summary: Bevor Sie das Bootmedium in Ihrem AFF A800 System austauschen, sollte überprüft werden, ob alle notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sind. Dazu zählt, dass ein USB-Flash-Laufwerk mit ausreichender Speicherkapazität vorhanden ist und das korrekte Ersatz-Bootmedium bereitliegt. 
---
= Anforderungen für die manuelle Wiederherstellung von Bootmedien in einem AFF A800 System prüfen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
