...
[role="lead"]
Verwenden Sie  https://review.docs.netapp.com/us-en/ontap-systems_jackie-hotfix/media/PDF/Jan_2024_Rev3_AFFA800_ISI_IEOPS-1497.pdf["AFF A800 Installation und Setup-Anweisungen"^], wenn Sie mit der Installation von NetApp Systemen vertraut sind.
