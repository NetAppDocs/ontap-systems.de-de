...
[role="lead"]
In diesem Handbuch finden Sie eine grafische Anleitung für eine typische Installation Ihres Systems, von Rack und Verkabelung bis zur Inbetriebnahme des Systems. Verwenden Sie die link:../media/PDF/215-13082_2023-09_us-en_AFFA800_ISI.pdf["Installations- und Setup-Anleitung für die AFF A800"^] Wenn Sie mit der Installation von NetApp Systemen vertraut sind.
