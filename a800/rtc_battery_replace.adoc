...
== Schritt 3: Entfernen Sie die PCIe Riser

Sie müssen einen oder mehrere PCIe-Riser entfernen, wenn Sie bestimmte Hardwarekomponenten im Controller-Modul ersetzen.
...
== Schritt 5: Installieren Sie die PCIe Riser

Sie installieren die PCIe Riser neu, nachdem Sie die Hardwarekomponenten in der beeinträchtigten Steuerung ausgetauscht haben.
...
== Schritt 6: Setzen Sie das Controller-Modul wieder ein und setzen Sie Zeit/Datum nach dem RTC-Batterieaustausch ein
