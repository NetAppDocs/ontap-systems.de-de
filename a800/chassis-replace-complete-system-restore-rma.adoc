...
---
= Schließen Sie den Wiederherstellungs- und Ersatzprozess ab - AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Starten Sie die Controller neu, überprüfen Sie den Systemzustand und senden Sie das defekte Teil an NetApp zurück, um den letzten Schritt im AFF A800 -Chassis-Austauschverfahren abzuschließen.
