...
summary: Bevor das Chassis im AFF A800 System ersetzt wird, sollte geprüft werden, ob alle notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sind. Dazu gehört die Überprüfung, dass alle anderen Komponenten im System ordnungsgemäß funktionieren, dass lokale Administratoranmeldedaten für ONTAP vorhanden sind, das korrekte Ersatzchassis bereitliegt und die erforderlichen Werkzeuge vorhanden sind. 
---
= Die Anforderungen für den Austausch eines Chassis in einem AFF A800 System werden dargestellt
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bevor das Chassis im AFF A800 System ersetzt wird, sollte geprüft werden, ob alle notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sind. Dazu gehört die Überprüfung, dass alle anderen Komponenten im System ordnungsgemäß funktionieren, dass lokale Administratoranmeldedaten für ONTAP vorhanden sind, das korrekte Ersatzchassis bereitliegt und die erforderlichen Werkzeuge vorhanden sind.
