...
summary: Tauschen Sie die Echtzeituhr-Batterie in Ihrem AFF A800-Controllermodul aus, um sicherzustellen, dass Dienste und Anwendungen, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin funktionieren. 
---
= Die Batterie der Echtzeituhr in einem AFF A800 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Echtzeitbatterie (RTC) in Ihrem AFF A800 System sollte ersetzt werden, damit Dienste und Anwendungen, die auf eine präzise Zeitsynchronisation angewiesen sind, weiterhin funktionieren.

.Bevor Sie beginnen
* Sie können dieses Verfahren bei allen Versionen von ONTAP verwenden, die von Ihrem System unterstützt werden.
* Stellen Sie sicher, dass alle anderen Systemkomponenten ordnungsgemäß funktionieren. Falls nicht, wenden Sie sich an den technischen Support.
