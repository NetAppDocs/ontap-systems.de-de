...
---
= Die AFF A800 Controller werden heruntergefahren, um das Chassis auszutauschen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie die Controller Ihres AFF A800 -Speichersystems ab, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Gehäuses zu gewährleisten.
