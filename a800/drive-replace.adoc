...
summary: Ein Laufwerk ist im laufenden Betrieb auszutauschen, wenn die Plattform eine Warnmeldung auf der Systemkonsole protokolliert, die auf einen Laufwerksausfall hinweist. Zusätzlich leuchten sowohl die Fehler-LED auf dem Bedienerdisplay als auch die Fehler-LED am ausgefallenen Laufwerk. 
---
= Laufwerk im laufenden Betrieb in einem AFF A800 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
