...
---
= Netzteil im laufenden Betrieb in einem AFF A800 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Netzteil im AFF A800 System sollte ersetzt werden, wenn es ausfällt oder fehlerhaft ist. Die Netzteile sind redundant und Hot-Swap-fähig, daher ist ein Herunterfahren des Controllers für diesen Austausch nicht erforderlich.
