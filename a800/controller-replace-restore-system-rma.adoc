...
summary: Um Ihr AFF A800-System wieder voll funktionsfähig zu machen, stellen Sie die NetApp Storage Encryption-Konfiguration gegebenenfalls wieder her, installieren Sie Lizenzen für den neuen Controller und senden Sie das defekte Teil an NetApp zurück. 
---
= Den Controller-Austausch für ein AFF A800 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Zum Abschluss des Controller-Austauschs für Ihr AFF A800 System wird die NetApp Storage Encryption-Konfiguration (falls erforderlich) wiederhergestellt, bestätigt, dass die logischen Schnittstellen (LIFs) an ihren Home-Ports melden, eine Cluster-Integritätsprüfung durchgeführt und das defekte Teil an NetApp zurückgesendet.
