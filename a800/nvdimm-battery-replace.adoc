...
---
= Die NVDIMM-Batterie in einem AFF A800 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die NVDIMM-Batterie in Ihrem AFF A800 System sollte ersetzt werden, wenn sie an Ladung verliert oder ausfällt, da sie wichtige Systemdaten bei Stromausfällen erhält. Der Austauschvorgang umfasst das Entfernen des Controller-Moduls, das Ersetzen der Batterie und das Wiedereinsetzen des Controller-Moduls.
