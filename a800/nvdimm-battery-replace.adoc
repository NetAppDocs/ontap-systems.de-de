...
---
= Die NVDIMM-Batterie in Ihrem AFF A800 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die NV-Batterie im AFF A800 System sollte ersetzt werden, wenn sie an Ladung verliert oder ausfällt, da sie kritische Systemdaten bei Stromausfällen bewahrt. Der Austauschprozess umfasst das Entfernen des Controller-Moduls, das Ersetzen der Batterie und das erneute Einsetzen des Controller-Moduls.
