...
summary: Nach der Installation des neuen Bootmediums in Ihrem AFF A800 System kann der automatisierte Bootmedien-Wiederherstellungsprozess gestartet werden, um die Konfiguration vom Partnerknoten wiederherzustellen. 
---
= Das Wiederherstellungsimage auf Ihrem AFF A800 System wird mithilfe des automatisierten Startwiederherstellungsprozesses gestartet.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
