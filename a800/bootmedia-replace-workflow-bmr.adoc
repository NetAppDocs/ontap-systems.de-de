...
---
= Arbeitsablauf zum Austausch des Bootmediums für ein AFF A800 System unter Verwendung des automatisierten Boot-Wiederherstellungsprozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die automatische Wiederherstellung des Startabbilds beinhaltet das automatische Erkennen und Auswählen der passenden Startmenüoption durch das System. Es verwendet das Startabbild auf dem Partnerknoten, um ONTAP auf dem Ersatzstartmedium in Ihrem AFF A800 Speichersystem neu zu installieren.
...
Um zu beginnen, die Austauschvoraussetzungen prüfen, den Controller herunterfahren, das Bootmedium austauschen, das Image wiederherstellen und die Systemfunktionalität überprüfen.
