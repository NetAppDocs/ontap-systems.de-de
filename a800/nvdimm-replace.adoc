...
summary: Ersetzen Sie das NVDIMM in Ihrem AFF A800 Controller-Modul, wenn das System registriert, dass die Lebensdauer des Flash-Speichers fast abgelaufen ist oder dass das identifizierte NVDIMM nicht funktionsfähig ist. Das Versäumnis, ein fehlerhaftes NVDIMM zu ersetzen, kann zu einem System-Panic führen. 
---
= Das NVDIMM in Ihrem AFF A800 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das NVDIMM in Ihrem AFF A800 System sollte ersetzt werden, wenn das System meldet, dass die Lebensdauer des Flash-Speichers fast abgelaufen ist oder das identifizierte NVDIMM nicht funktionsfähig ist. Das Nicht-Ersetzen eines fehlerhaften NVDIMM führt zu einem Systemabsturz.

.Bevor Sie beginnen
* Stellen Sie sicher, dass Sie das Ersatz-NVDIMM, das Sie von NetApp erhalten haben, besitzen und dass es mit Ihrem AFF A800 System kompatibel ist.
* Stellen Sie sicher, dass alle anderen Komponenten des Speichersystems ordnungsgemäß funktionieren. Falls dies nicht der Fall ist, wenden Sie sich an den NetApp Support.
