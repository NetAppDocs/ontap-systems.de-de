...
[role="lead"]
Tauschen Sie das NVDIMM in Ihrem AFF A800 -System aus, wenn Ihr System erkennt, dass die Lebensdauer des Flash-Speichers fast erreicht ist oder dass das identifizierte NVDIMM generell nicht in Ordnung ist; andernfalls kommt es zu einem Systemabsturz.

.Bevor Sie beginnen
* Stellen Sie sicher, dass Sie das von NetApp erhaltene Ersatz-NVDIMM-Modul besitzen und dass es mit Ihrem AFF A800 -System kompatibel ist.
