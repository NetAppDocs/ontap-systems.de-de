...
---
= Einen Lüfter in einem AFF A800 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein Lüftermodul in Ihrem AFF A800 System sollte ersetzt werden, wenn ein Lüfter ausfällt oder nicht effizient arbeitet, damit eine ordnungsgemäße Kühlung aufrechterhalten und Systemleistungsprobleme vermieden werden.
