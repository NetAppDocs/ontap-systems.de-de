...
---
= Den Controller in einem AFF A800 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Die System-DIMMs werden in das Ersatz-Controllermodul eingesetzt.
...
Die NVDIMMs in das Ersatz-Controllermodul einsetzen.
