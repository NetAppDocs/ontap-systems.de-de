...
summary: Wenn Sie die automatische Laufwerkszuweisung deaktiviert haben, weisen Sie die Laufwerkszuordnung manuell zu und aktivieren Sie die automatische Laufwerkszuweisung für Ihr ASA System wieder. 
---
= Die Hot-Add-Erweiterung des NS224 Shelfs für ein ASA System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
