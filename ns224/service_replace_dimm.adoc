...
* Sie können das folgende Video oder die geschriebenen Schritte verwenden, um ein DIMM zu ersetzen.
+
...
+
Wenn ein DIMM fehlerhaft ist, meldet das System eine Warnmeldung an die Systemkonsole und gibt an, welches DIMM defekt ist. Außerdem leuchtet die LED für DIMM-Warnung (gelb) auf der Platine neben dem DIMM-Steckplatz auf.

+

NOTE: Nach dem Entfernen des NSM-Moduls aus dem Shelf leuchtet die LED für das fehlerhafte DIMM 10 Minuten lang.
