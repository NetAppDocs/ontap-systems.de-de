...
summary: Installieren Sie das NS224-Regal in einem Schrank oder einem Telco-Rack, schließen Sie die Netzkabel an und stellen Sie die Regal-ID für Ihr AFF-System ein. 
---
= Installieren Sie ein NS224-Regal in Ihrem AFF System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installieren Sie das NS224-Regal in einem Schrank oder einem Telco-Rack, schließen Sie die Netzkabel an und stellen Sie die Regal-ID für Ihr AFF-System ein.
...
Nach der Installation Ihres Regals, link:hot-add-aff-cable-overview.html["Verkabeln Sie Ihr Regal"].
