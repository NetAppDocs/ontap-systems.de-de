...
summary: Sie können fehlerhafte Startmedien in einem NS224-Shelf ersetzen. Der Austausch der Boot-Medien kann unterbrechungsfrei durchgeführt werden, während das Festplatten-Shelf eingeschaltet ist und I/O gerade läuft. 
---
= Ersetzen Sie das NS224-Bootmedium.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
