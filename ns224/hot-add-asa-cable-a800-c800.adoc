...
summary: Verbinden Sie Ihr NS224-Shelf per Kabel mit Ihrem ASA A800 oder ASA C800 System, sodass jedes Shelf über zwei Verbindungen zu jedem Controller im HA-Paar verfügt. 
---
= Verbinden Sie ein NS224-Regal per Kabel mit Ihrem ASA A800 oder ASA C800 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verbinden Sie Ihr NS224-Shelf per Kabel mit Ihrem ASA A800 oder ASA C800 System, sodass jedes Shelf über zwei Verbindungen zu jedem Controller im HA-Paar verfügt.
