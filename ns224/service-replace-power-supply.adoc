...
* Wenn Sie ein Wechselstromnetzteil für ein NS224-Shelf durch NSM100-Module ersetzen, können Sie sich die folgende Animation ansehen, um sich mit dem Verfahren vertraut zu machen, bevor Sie beginnen.
+
.Ersetzen Sie das Wechselstromnetzteil für NS224 durch NSM100-Module
[%collapsible]
====
