...
summary: Installieren Sie das NS224-Regal in einem Schrank oder einem Telekommunikationsrack, schließen Sie die Netzkabel an und legen Sie die Regal-ID für Ihr End-of-Availability-System fest. 
---
= Installieren Sie ein NS224-Regal in Ihrem End-of-Availability-System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installieren Sie das NS224-Regal in einem Schrank oder einem Telekommunikationsrack, schließen Sie die Netzkabel an und legen Sie die Regal-ID für Ihr End-of-Availability-System fest.

.Bevor Sie beginnen
* Halten Sie eine Büroklammer bereit, bei der eine Seite geradegebogen ist, oder einen Kugelschreiber mit schmaler Spitze.
+
...
Nach der Installation Ihres Regals, link:hot-add-eoa-cable-overview.html["Verkabeln Sie Ihr Regal"].
