...
summary: 'Sie können ein NS224-Festplatten-Shelf im Betrieb entfernen, bei dem die Aggregate von den Laufwerken entfernt wurden, in einem HA-Paar, das noch Daten bereitstellt (I/O wird gerade ausgeführt).' 
---
= NS224 Shelf im laufenden Betrieb entfernen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Wenn Sie mehr als ein Regalbrett entfernen, wiederholen Sie die vorhergehenden Schritte.
+
