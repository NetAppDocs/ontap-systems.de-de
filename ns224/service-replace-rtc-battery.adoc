...
summary: 'Sie können eine fehlerhafte Echtzeitbatterie (RTC) in einem NS224-Laufwerk-Shelf, das eingeschaltet ist, unterbrechungsfrei austauschen und während I/O-Vorgänge ausgeführt werden.' 
---
= Ersetzen Sie die Echtzeit-Batterie der NS224-Echtzeituhr.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
