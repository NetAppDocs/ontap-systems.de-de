...
summary: Installieren Sie das NS224-Regal in einem Schrank oder einem Telekommunikationsrack, schließen Sie die Netzkabel an und stellen Sie die Regal-ID für Ihr ASA System ein. 
---
= Installieren Sie ein NS224-Regal in Ihrem ASA System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installieren Sie das NS224-Regal in einem Schrank oder einem Telekommunikationsrack, schließen Sie die Netzkabel an und stellen Sie die Regal-ID für Ihr ASA System ein.
...
Nach der Installation Ihres Regals, link:hot-add-asa-cable-overview.html["Verkabeln Sie Ihr Regal"].
