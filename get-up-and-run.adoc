...
* link:https://docs.netapp.com/us-en/ontap-systems-switches/afx/index.html["AFX-Schalter"^]
* link:https://review.docs.netapp.com/us-en/ontap-systems-switches/cluster/index.html["Cluster-Switches"^]
* link:https://review.docs.netapp.com/us-en/ontap-systems-switches/storage/index.html["Speicherschalter"^]
* link:https://docs.netapp.com/us-en/ontap-systems-switches/switch-cisco-9336c-fx2-shared/install-9336c-shared.html["Gemeinsam genutzte Switches"^]
...
[role="quick-margin-list"]
* link:aff-aseries/index.html["Systeme der AFF A-Series"]
* link:aff-cseries/index.html["Systeme der AFF C-Serie"]
* link:allsan-landing/index.html["ASA Systeme"]
* link:https://docs.netapp.com/us-en/ontap-afx/install-setup/install-setup-workflow.html["AFX-Systeme"]
* https://docs.netapp.com/us-en/asa-r2/install-setup/install-setup-workflow.html["ASA r2-Systeme"]
...
[role="quick-margin-list"]
* Informationen zu ONTAP -Bereitstellungen finden Sie unter https://docs.netapp.com/us-en/ontap/task_configure_ontap.html["Konfigurieren Sie ONTAP"^] .
* Informationen zu ONTAP mit MetroCluster -Bereitstellungen finden Sie unter https://docs.netapp.com/us-en/ontap-metrocluster/["Konfigurieren Sie MetroCluster mit ONTAP"^] .
