...
summary: Fahren Sie den Controller in Ihrem AFF A1K Storage-System herunter, um Datenverlust zu vermeiden und beim Austausch des Controllers die Systemstabilität zu gewährleisten. 
---
= Vor dem Austausch muss der defekte Controller in einem AFF A1K System abgeschaltet werden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den Controller in Ihrem AFF A1K Storage-System herunter, um Datenverlust zu vermeiden und beim Austausch des Controllers die Systemstabilität zu gewährleisten.
