...
---
= Vorbereitung auf den Austausch eines AFF A1K Chassis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bereiten Sie den Austausch des beschädigten Gehäuses in Ihrem AFF A1K -System vor, indem Sie das beschädigte Gehäuse identifizieren, die Ersatzkomponenten überprüfen und die Kabel und Controllermodule beschriften.
