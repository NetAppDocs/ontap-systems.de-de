...
summary: Die Boot-Medien in Ihrem AFF A1K-System speichern wichtige Firmware- und Konfigurationsdaten. Wenn das Startmedium fehlschlägt, müssen Sie das Controller-Modul trennen, das System Management-Modul entfernen, das gestörte Startmedium entfernen und das Ersatz-Startmedium im System Management-Modul installieren. 
---
...
[role="lead"]
Die Boot-Medien in Ihrem AFF A1K-System speichern wichtige Firmware- und Konfigurationsdaten. Wenn das Startmedium fehlschlägt, müssen Sie das Controller-Modul trennen, das System Management-Modul entfernen, das gestörte Startmedium entfernen und das Ersatz-Startmedium im System Management-Modul installieren.
