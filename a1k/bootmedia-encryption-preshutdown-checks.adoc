...
summary: Um die Datensicherheit auf Ihrem AFF A1K Speichersystem zu gewährleisten, ist die Unterstützung und der Status des Verschlüsselungsschlüssels auf Ihrem Boot-Medium zu überprüfen. Es sollte geprüft werden, ob Ihre ONTAP Version NetApp Volume Encryption unterstützt, und vor dem Herunterfahren des Controllers, ob der Schlüsselmanager aktiv ist. 
---
= Überprüfung der Verschlüsselungsunterstützung auf dem Bootmedium in einem AFF A1K System mithilfe des manuellen Boot-Wiederherstellungsprozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um die Datensicherheit auf Ihrem AFF A1K Storage-System zu gewährleisten, ist die Unterstützung und der Status des Verschlüsselungsschlüssels auf Ihrem Boot-Medium zu überprüfen. Es sollte geprüft werden, ob Ihre ONTAP Version NetApp Volume Encryption (NVE) unterstützt, und vor dem Herunterfahren des Controllers ist zu prüfen, ob der Key Manager aktiv ist.
