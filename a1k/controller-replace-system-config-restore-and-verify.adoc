...
summary: Überprüfen Sie, ob die HA-Konfiguration des Controllers im AFF A1K Storage-System aktiv ist und ordnungsgemäß funktioniert, und vergewissern Sie sich, dass die Systemadapter alle Pfade zu den Festplatten auflisten. 
---
= Wiederherstellung und Überprüfung der Controller-Konfiguration in einem AFF A1K System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Überprüfen Sie, ob die HA-Konfiguration des Controllers im AFF A1K Storage-System aktiv ist und ordnungsgemäß funktioniert, und vergewissern Sie sich, dass die Systemadapter alle Pfade zu den Festplatten auflisten.
...
Nachdem Sie die Systemkonfiguration für Ihr AFF A1K-System wiederhergestellt und verifiziert haben, müssen Sie link:controller-replace-recable-reassign-disks.html["Geben Sie den Controller zurück"].
