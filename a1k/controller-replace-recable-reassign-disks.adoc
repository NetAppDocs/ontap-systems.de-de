...
---
= Den Controller in Ihrem AFF A1K System zurückgeben
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Kontrolle über die Speicherressourcen wird an den Ersatzcontroller zurückgegeben, sodass Ihr AFF A1K System den normalen Betrieb wieder aufnehmen kann. Das Rückgabeverfahren variiert je nach Verschlüsselungstyp des Systems: keine Verschlüsselung oder Onboard Key Manager (OKM) Verschlüsselung.
