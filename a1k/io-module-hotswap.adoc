...
summary: Sie können ein Ethernet-E/A-Modul in Ihrem AFF A1K-Speichersystem per Hot-Swap austauschen, wenn ein Modul ausfällt und Ihr Speichersystem alle ONTAP-Versionserfordernisse erfüllt. 
---
= Ein E/A-Modul kann in Ihrem AFF A1K System Hot-Swap-fähig ausgetauscht werden, ohne dass ein Herunterfahren erforderlich ist.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können ein Ethernet-E/A-Modul in Ihrem AFF A1K-Speichersystem per Hot-Swap austauschen, wenn ein Modul ausfällt und Ihr Speichersystem alle ONTAP-Versionserfordernisse erfüllt.

Um ein E/A-Modul im Hot-Swap-Verfahren auszutauschen, ist zu überprüfen, dass auf Ihrem Speichersystem ONTAP 9.18.1 GA oder höher ausgeführt wird. Anschließend werden das Speichersystem und das E/A-Modul vorbereitet, das ausgefallene Modul im Hot-Swap-Verfahren ersetzt, das Ersatzmodul online gebracht, der Normalbetrieb wiederhergestellt und das ausgefallene Modul an NetApp zurückgegeben.
