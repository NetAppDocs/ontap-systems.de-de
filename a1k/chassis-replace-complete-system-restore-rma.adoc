...
---
= Der Chassis-Austausch für Ihr AFF A1K System ist abgeschlossen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Starten Sie den Controller neu, überprüfen Sie den Systemzustand und senden Sie das defekte Teil an NetApp zurück, um den letzten Schritt beim Gehäuseaustausch Ihres AFF A1K Systems abzuschließen.
...
Nach dem Neustart der Controller werden ONTAP gestartet, die Controller zurückgegeben und der Systemzustand überprüft.
