...
summary: Das Systemmanagement-Modul in Ihrem AFF A1K System ist auszutauschen, wenn es defekt ist oder seine Firmware beschädigt ist. Der Austauschprozess umfasst das Herunterfahren des Controllers, den Austausch des defekten Systemmanagement-Moduls, den Neustart des Controllers, die Aktualisierung der Lizenzschlüssel und die Rücksendung des defekten Teils an NetApp. 
---
= Das Systemmanagement-Modul in einem AFF A1K System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Systemmanagement-Modul in Ihrem AFF A1K System sollte ersetzt werden, wenn es defekt ist oder seine Firmware beschädigt ist. Der Austauschprozess umfasst das Herunterfahren des Controllers, das Ersetzen des ausgefallenen Systemmanagement-Moduls, den Neustart des Controllers, die Aktualisierung der Lizenzschlüssel und die Rücksendung des defekten Teils an NetApp.
