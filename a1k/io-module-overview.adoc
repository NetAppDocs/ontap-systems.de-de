...
---
= Informationen zum Hinzufügen und Ersetzen von E/A-Modulen in Ihrem AFF A1K System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Die I/O-Steckplätze des AFF A1K-Controllers werden wie in der folgenden Abbildung dargestellt mit 1 bis 11 nummeriert.
