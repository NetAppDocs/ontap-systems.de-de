...
[role="lead"]
Überprüfen Sie, ob die logischen Schnittstellen (LIFs) an ihren Home Port berichten, führen Sie eine Cluster-Zustandsprüfung durch und senden Sie das fehlerhafte Teil anschließend an NetApp zurück, um den letzten Schritt beim Austausch des AFF A1K-Controllers abzuschließen.
