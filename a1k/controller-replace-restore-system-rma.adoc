...
summary: Um den Controller-Austausch für Ihr AFF A1K-System abzuschließen, stellen Sie die NetApp Storage Encryption-Konfiguration wieder her, vergewissern Sie sich, dass die logischen Schnittstellen an ihren Home-Ports melden, führen Sie einen Cluster-Integritätscheck durch und senden Sie das defekte Teil zurück an NetApp. 
---
= Den Controller-Austausch für Ihr AFF A1K System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
