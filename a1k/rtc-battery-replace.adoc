...
summary: Tauschen Sie die Echtzeituhr-Batterie, die üblicherweise als Knopfzelle bezeichnet wird, in Ihrem AFF A1K-System aus, um sicherzustellen, dass Dienste und Anwendungen, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin betriebsbereit bleiben. 
---
= Die Batterie der Echtzeituhr in einem AFF A1K System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
