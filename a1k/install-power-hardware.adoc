...
---
= Einschalten eines AFF A1K Storage-Systems
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach der Installation der Rack-Hardware und der Kabel für Ihr AFF A1K-Speichersystem werden die Speicherregale und Controller eingeschaltet.
...
Nachdem Sie Ihr AFF A1K Speichersystem eingeschaltet haben, https://docs.netapp.com/us-en/ontap/software_setup/workflow-summary.html["Richten Sie Ihren Cluster ein"] .
