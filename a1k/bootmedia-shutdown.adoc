...
---
= Fahren Sie den Controller herunter, um das Boot-Medium AFF A1K zu ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den außer Betrieb genommenen Controller in Ihrem AFF A1K-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Startmediums sicherzustellen.
