...
summary: Fahren Sie den beschädigten Controller in Ihrem AFF A1K Speichersystem herunter, um Datenverlust zu verhindern und die Systemstabilität während des manuellen Boot-Medienwiederherstellungsprozesses aufrechtzuerhalten. 
---
= Fahren Sie den Controller für die manuelle Wiederherstellung des Bootmediums herunter - AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
