...
summary: Der Controller im AFF A1K Storage-System sollte heruntergefahren werden, um Datenverlust zu vermeiden und die Systemstabilität während des manuellen Boot-Medien-Wiederherstellungsprozesses zu gewährleisten. 
---
...
[role="lead"]
Der Controller im AFF A1K Storage-System sollte heruntergefahren werden, um Datenverlust zu vermeiden und die Systemstabilität während des manuellen Boot-Medien-Wiederherstellungsprozesses zu gewährleisten.
