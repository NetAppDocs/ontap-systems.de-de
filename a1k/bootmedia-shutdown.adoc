...
summary: Der defekte Controller in Ihrem AFF A1K Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität während des manuellen Boot-Wiederherstellungsprozesses aufrechtzuerhalten. 
---
= Der Controller in Ihrem AFF A1K System wird während des manuellen Boot-Wiederherstellungsprozesses heruntergefahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der defekte Controller in Ihrem AFF A1K Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität während des manuellen Boot-Wiederherstellungsprozesses aufrechtzuerhalten.
