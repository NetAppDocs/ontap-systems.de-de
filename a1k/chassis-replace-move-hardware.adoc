...
summary: Tauschen Sie das Gehäuse Ihres AFF A1K-Systems aus, wenn ein Hardwaredefekt dies erfordert. Der Austauschvorgang umfasst das Entfernen des Controllers, der E/A-Karten, des NVRAM12-Moduls, des Systemmanagement-Moduls und der Netzteile, den Einbau des Ersatzgehäuses und die Wiedermontage der Gehäusekomponenten. 
---
= Das Chassis in einem AFF A1K System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
