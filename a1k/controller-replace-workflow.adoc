...
summary: Beginnen Sie mit dem Austausch des Controllers im AFF A1K Storage-System, indem Sie den beeinträchtigten Controller herunterfahren, den Controller entfernen und austauschen, die Systemeinstellungen neu konfigurieren und die Systemvorgänge überprüfen. 
---
= AFF A1K Arbeitsablauf zum Austausch des AFF A1K Controllers
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Beginnen Sie mit dem Austausch des Controllers im AFF A1K Storage-System, indem Sie den beeinträchtigten Controller herunterfahren, den Controller entfernen und austauschen, die Systemkonfiguration wiederherstellen und die Kontrolle über die Speicherressourcen an den Ersatz-Controller zurückgeben.
