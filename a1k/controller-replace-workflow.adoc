...
---
= Schnellstart für den Controller-Austausch – AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Beginnen Sie mit dem Austausch des Controllers im AFF A1K Storage-System, indem Sie den beeinträchtigten Controller herunterfahren, den Controller entfernen und austauschen, die Systemkonfiguration wiederherstellen und die Systemvorgänge überprüfen.
