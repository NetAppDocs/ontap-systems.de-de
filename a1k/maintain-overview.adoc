...
---
= Informationen zur Wartung eines AFF A1K Storage-Systems
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:chassis-replace-workflow.html["Chassis"]
 a| 
Im Gehäuse befinden sich die Lüfter, der Controller, die Netzteile, NVRAM, das Systemmanagement-Modul, die I/O-Karten und die Abdeckmodule.
