...
summary: Das Bootmedium in Ihrem AFF A1K System speichert wichtige Firmware- und Konfigurationsdaten. Der Austausch umfasst das Entfernen des Systemmanagement-Moduls, das Entfernen des defekten Bootmediums, das Einsetzen des Ersatz-Bootmediums und das erneute Installieren des Moduls. 
---
= Das Bootmedium in Ihrem AFF A1K System kann mithilfe des automatisierten Boot-Wiederherstellungsprozesses ersetzt werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Bootmedium in Ihrem AFF A1K System speichert wichtige Firmware- und Konfigurationsdaten. Der Austausch umfasst das Entfernen des Systemmanagement-Moduls, das Entfernen des defekten Bootmediums, das Einsetzen des Ersatz-Bootmediums und das erneute Installieren des Moduls.
