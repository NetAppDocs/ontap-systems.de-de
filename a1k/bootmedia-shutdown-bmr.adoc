...
summary: Der Controller im AFF A1K Speichersystem sollte heruntergefahren werden, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Bootmediums sicherzustellen. 
---
...
[role="lead"]
Der Controller im AFF A1K Storage-System sollte heruntergefahren werden, um Datenverlust zu verhindern und die Systemstabilität während des automatisierten Bootmedien-Wiederherstellungsprozesses zu gewährleisten.
