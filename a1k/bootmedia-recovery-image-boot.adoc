...
[role="lead"]
Nach der Installation des neuen Startmediengeräts in Ihrem AFF A1K-System können Sie das Wiederherstellungs-Image von einem USB-Laufwerk starten und die Konfiguration vom Partnerknoten wiederherstellen.
