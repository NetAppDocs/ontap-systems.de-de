...
summary: Fügen Sie Ihrem AFF A1K-System ein I/O-Modul hinzu, um die Netzwerkkonnektivität zu verbessern und die Fähigkeit Ihres Systems zur Bewältigung des Datenverkehrs zu erweitern. 
---
= Ein E/A-Modul in einem AFF A1K System hinzufügen, um die Netzwerkkonnektivität zu verbessern
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fügen Sie Ihrem AFF A1K-System ein I/O-Modul hinzu, um die Netzwerkkonnektivität zu verbessern und die Fähigkeit Ihres Systems zur Bewältigung des Datenverkehrs zu erweitern.
