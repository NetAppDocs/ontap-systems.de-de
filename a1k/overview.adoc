...
[role="lead"]
Nachfolgend sind ausgewählte Spezifikationen für das AFF A1K Speichersystem in einem einzelnen Hochverfügbarkeitspaar aufgeführt. Besuchen https://hwu.netapp.com["NetApp Hardware Universe"^] Die vollständigen Spezifikationen für dieses Speichersystem finden Sie hier.
