...
summary: Das Cluster- und HA-E/A-Modul unterstützt Interconnects für Clustering und Hochverfügbarkeit. Sie können das Modul in Ihrem AFF A20-, AFF A30- oder AFF A50-Speichersystem im laufenden Betrieb austauschen, wenn das Modul ausfällt und Ihr Speichersystem bestimmte Anforderungen erfüllt. 
---
