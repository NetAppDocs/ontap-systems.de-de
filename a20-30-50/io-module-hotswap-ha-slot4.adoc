...
summary: Das Cluster- und HA-E/A-Modul unterstützt Interconnects für Clustering und Hochverfügbarkeit. Bei einem Modulausfall können Sie das Modul in Ihrem AFF A20-, AFF A30- oder AFF A50-Speichersystem im laufenden Betrieb austauschen. 
---
