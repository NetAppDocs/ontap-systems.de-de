...
summary: Nachdem Sie die Controller mit dem Netzwerk und den Shelfs im AFF Storage-System A20, AFF A30 oder AFF A50 verkabeln, schalten Sie die Shelfs und Controller ein. 
---
= Einschalten eines AFF A20, AFF A30 oder AFF A50 Storage-Systems
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
