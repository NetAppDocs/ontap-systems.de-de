...
** Die Shelf-ID-Anzeige an der Vorderseite des System-Chassis leuchtet nicht. Die interne Shelf-ID des Systems ist fest mit 00 festgelegt.


. Sichern Sie die Netzkabel mit dem Sicherungsgerät an jedem Netzteil. :a20-30-50!:
