...
---
= Überprüfung der Verschlüsselungsunterstützung auf dem Bootmedium in einem AFF A20, AFF A30 oder AFF A50 System mithilfe des manuellen Boot-Wiederherstellungsprozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um die Datensicherheit auf Ihrem AFF A20, AFF A30 oder AFF A50 Storage-System zu gewährleisten, sollte die Unterstützung und der Status des Verschlüsselungsschlüssels auf dem Boot-Medium überprüft werden. Es ist zu prüfen, ob Ihre ONTAP Version NetApp Volume Encryption (NVE) unterstützt. Vor dem Herunterfahren des Controllers ist zu prüfen, ob der Key Manager aktiv ist.
