...
summary: Fahren Sie den außer Betrieb genommenen Controller des Speichersystems AFF A20, AFF A30 oder AFF A50 herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Controllers sicherzustellen. 
---
= Vor dem Austausch muss die defekte Steuerung in einem AFF A20, AFF A30 oder AFF A50 System heruntergefahren werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den außer Betrieb genommenen Controller des Speichersystems AFF A20, AFF A30 oder AFF A50 herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Controllers sicherzustellen.
