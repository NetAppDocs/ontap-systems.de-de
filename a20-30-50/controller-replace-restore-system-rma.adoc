...
summary: Um den Controller-Austausch für Ihr AFF A20, AFF A30 oder AFF A50 Speichersystem abzuschließen, stellen Sie die NetApp Storage Encryption-Konfiguration wieder her und installieren Sie die erforderlichen Lizenzen auf dem neuen Controller. Stellen Sie sicher, dass die logischen Schnittstellen auf ihre Home-Ports melden, und führen Sie eine Cluster-Integritätsprüfung durch. Registrieren Sie die Seriennummer des neuen Controllers und senden Sie das defekte Teil an NetApp zurück. 
---
= Den Controller-Austausch für ein AFF A20, AFF A30 oder AFF A50 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
