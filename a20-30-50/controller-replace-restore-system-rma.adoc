...
summary: Um den vollen Betrieb des AFF A20, AFF A30 oder AFF A50-Systems wiederherzustellen, installieren Sie die erforderlichen Lizenzen auf dem neuen Controller, vergewissern Sie sich, dass die logischen Schnittstellen ihren Home Ports Bericht erstatten und führen Sie eine Cluster-Integritätsprüfung durch. Registrieren Sie abschließend die Seriennummer des neuen Controllers und senden Sie das ausgefallene Teil an NetApp zurück. 
---
...
[role="lead"]
Um den Controller-Austausch für Ihr AFF A20-, AFF A30- oder AFF A50-System abzuschließen, stellen Sie zuerst die NetApp-Speicherverschlüsselungskonfiguration (falls erforderlich) wieder her und installieren Sie die erforderlichen Lizenzen auf dem neuen Controller. Vergewissern Sie sich als nächstes, dass die logischen Schnittstellen (LIFs) ihren Home Ports berichten und eine Cluster-Zustandsprüfung durchführen. Registrieren Sie abschließend die Seriennummer des neuen Controllers und senden Sie das ausgefallene Teil an NetApp zurück.
