...
summary: Nachdem Sie das neue Bootmediengerät in Ihrem AFF A20-, AFF A30- oder AFF A50-Speichersystem installiert haben, können Sie den automatisierten Bootmedienwiederherstellungsprozess starten, um die Konfiguration vom Partnerknoten wiederherzustellen. 
---
