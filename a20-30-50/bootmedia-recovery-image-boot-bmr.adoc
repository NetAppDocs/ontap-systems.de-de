...
summary: Nach der Installation des neuen Bootmediums in Ihrem AFF A20-, AFF A30- oder AFF A50-Speichersystem können Sie den automatisierten Bootmedium-Wiederherstellungsprozess starten, um die Konfiguration vom Partnerknoten wiederherzustellen. Während des Wiederherstellungsprozesses prüft das System, ob die Verschlüsselung aktiviert ist und ermittelt den verwendeten Schlüsselverschlüsselungstyp. Wenn die Schlüsselverschlüsselung aktiviert ist, führt Sie das System durch die entsprechenden Schritte zur Wiederherstellung. 
---
= Das Boot-Image auf Ihrem AFF A20, AFF A30 oder AFF A50 System kann mit dem automatisierten Boot-Wiederherstellungsprozess wiederhergestellt werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach der Installation des neuen Bootmediums in Ihrem AFF A20-, AFF A30- oder AFF A50-Speichersystem können Sie den automatisierten Bootmedium-Wiederherstellungsprozess starten, um die Konfiguration vom Partnerknoten wiederherzustellen. Während des Wiederherstellungsprozesses prüft das System, ob die Verschlüsselung aktiviert ist und ermittelt den verwendeten Schlüsselverschlüsselungstyp. Wenn die Schlüsselverschlüsselung aktiviert ist, führt Sie das System durch die entsprechenden Schritte zur Wiederherstellung.
