...
summary: Bei der manuellen Wiederherstellung des Boot-Images wird ONTAP mithilfe eines USB-Laufwerks auf dem Ersatz-Boot-Medium des Speichersystems AFF A20, AFF A30 oder AFF A50 neu installiert. Laden Sie das entsprechende ONTAP Wiederherstellungsimage von der NetApp Support-Website herunter und kopieren Sie es auf ein USB-Laufwerk. Dieses vorbereitete USB-Laufwerk wird dann verwendet, um die Wiederherstellung durchzuführen und das System wieder betriebsbereit zu machen. 
---
= Arbeitsablauf zum Austausch des Bootmediums für ein AFF A20, AFF A30 oder AFF A50 System unter Verwendung des manuellen Boot-Wiederherstellungsprozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Wenn auf Ihrem System ONTAP 9.17.1 oder höher ausgeführt wird, die link:bootmedia-replace-workflow-bmr.html["automatische Boot-Wiederherstellung"] verwenden.
