...
summary: Installieren Sie nach der Vorbereitung auf die Installation des Speichersystems AFF A20, AFF A30 oder AFF A50 die Hardware für das Speichersystem. Installieren Sie zunächst die Schienensätze. Installieren und sichern Sie dann Ihr Speichersystem in einem Schrank oder einem Telco-Rack. 
---
= Die AFF A20, AFF A30 oder AFF A50 Hardware in einem Schrank oder Rack installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
