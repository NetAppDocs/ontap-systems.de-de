...
summary: Bevor das Chassis Ihres AFF A20, AFF A30 oder AFF A50 Storage-Systems ersetzt wird, sollte überprüft werden, ob alle notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sind. Dazu gehört die Überprüfung, dass alle anderen Komponenten im System ordnungsgemäß funktionieren, dass das richtige Ersatz-Chassis vorhanden ist und dass die erforderlichen Werkzeuge bereitstehen. 
---
= Die Anforderungen für den Austausch eines Chassis in einem AFF A20, AFF A30 oder AFF A50 System werden dargestellt.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bevor das Chassis Ihres AFF A20, AFF A30 oder AFF A50 Storage-Systems ersetzt wird, sollte überprüft werden, ob alle notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sind. Dazu gehört die Überprüfung, dass alle anderen Komponenten im System ordnungsgemäß funktionieren, dass das richtige Ersatz-Chassis vorhanden ist und dass die erforderlichen Werkzeuge bereitstehen.
