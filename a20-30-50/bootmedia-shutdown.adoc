...
summary: Fahren Sie den außer Betrieb genommenen Controller des Speichersystems AFF A20, AFF A30 oder AFF A50 herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Startmediums sicherzustellen. 
---
= Fahren Sie den Controller herunter, um die Startmedien zu ersetzen – AFF A20, AFF A30 und AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den außer Betrieb genommenen Controller des Speichersystems AFF A20, AFF A30 oder AFF A50 herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Startmediums sicherzustellen.
