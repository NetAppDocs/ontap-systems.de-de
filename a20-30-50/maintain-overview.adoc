...
summary: Wartung der Hardware AFF A20, AFF A30 und AFF A50 
---
...
[role="lead"]
Möglicherweise müssen Sie Wartungsverfahren für Ihre Hardware durchführen. In diesem Abschnitt finden Sie Verfahren zur Wartung der Systemkomponenten AFF A20, AFF A30 und AFF A50.

Bei den Verfahren in diesem Abschnitt wird davon ausgegangen, dass die Storage-Systeme AFF A20, AFF A30 oder AFF A50 bereits als Storage-Nodes in der ONTAP-Umgebung implementiert wurden.
