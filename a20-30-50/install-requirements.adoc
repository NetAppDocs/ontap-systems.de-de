...
summary: Lesen Sie die Anforderungen für Ihr Speichersystem AFF A20, AFF A30 oder AFF A50. 
---
= Anforderungen für die Installation Ihres AFF A20, AFF A30 oder AFF A50 Storage-Systems prüfen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
