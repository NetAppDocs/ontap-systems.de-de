...
summary: Auf dem Startmedium Ihres AFF A20-, AFF A30- oder AFF A50-Systems werden wichtige Firmware- und Konfigurationsdaten gespeichert. Beim Austausch wird das Controller-Modul entfernt, das gestörte Boot-Medium entfernt, das Ersatz-Boot-Medium installiert und das ONTAP-Image anschließend auf das Ersatz-Boot-Medium übertragen. 
---
= Ersetzen Sie die Startmedien – AFF A20, AFF A30 und AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Auf dem Startmedium Ihres AFF A20-, AFF A30- oder AFF A50-Systems werden wichtige Firmware- und Konfigurationsdaten gespeichert. Beim Austausch wird das Controller-Modul entfernt, das gestörte Boot-Medium entfernt, das Ersatz-Boot-Medium installiert und das ONTAP-Image anschließend auf das Ersatz-Boot-Medium übertragen.
