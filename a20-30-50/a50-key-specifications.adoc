...
---
= Wichtigste Spezifikationen für ein AFF A50 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Diese ausgewählten Spezifikationen beschreiben das AFF A50 Storage-System, das in einem einzelnen Hochverfügbarkeitspaar konfiguriert ist. Die vollständigen Spezifikationen für dieses System sind im NetApp Hardware Universe (HWU) verfügbar.
