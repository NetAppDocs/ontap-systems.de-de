...
summary: In Ihrem AFF A20, AFF A30 oder AFF A50 Storage-System kann ein Laufwerk im laufenden Betrieb ausgetauscht werden, wenn ein Laufwerk ausfällt oder ein Upgrade erforderlich ist. Der Austauschvorgang umfasst die Identifizierung des defekten Laufwerks, dessen sichere Entfernung und die Installation eines neuen Laufwerks, um den fortlaufenden Datenzugriff und die Systemleistung sicherzustellen. 
---
= Ein Laufwerk im laufenden Betrieb in einem AFF A20, AFF A30 oder AFF A50 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
In Ihrem AFF A20, AFF A30 oder AFF A50 Storage-System kann ein Laufwerk im laufenden Betrieb ausgetauscht werden, wenn ein Laufwerk ausfällt oder ein Upgrade erforderlich ist. Der Austauschvorgang umfasst die Identifizierung des defekten Laufwerks, dessen sichere Entfernung und die Installation eines neuen Laufwerks, um den fortlaufenden Datenzugriff und die Systemleistung sicherzustellen.
