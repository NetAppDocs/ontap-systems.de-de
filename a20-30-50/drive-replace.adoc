...
summary: Ersetzen Sie ein Laufwerk in Ihrem AFF A20-, AFF A30- oder AFF A50-Speichersystem, wenn ein Laufwerk ausfällt oder ein Upgrade erforderlich ist.  Der Austauschvorgang umfasst die Identifizierung des fehlerhaften Laufwerks, dessen sichere Entfernung und die Installation eines neuen Laufwerks, um einen kontinuierlichen Datenzugriff und eine kontinuierliche Systemleistung sicherzustellen. 
---
= Ein Laufwerk in einem AFF A20, AFF A30 oder AFF A50 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ersetzen Sie ein Laufwerk in Ihrem AFF A20-, AFF A30- oder AFF A50-Speichersystem, wenn ein Laufwerk ausfällt oder ein Upgrade erforderlich ist.  Der Austauschvorgang umfasst die Identifizierung des fehlerhaften Laufwerks, dessen sichere Entfernung und die Installation eines neuen Laufwerks, um einen kontinuierlichen Datenzugriff und eine kontinuierliche Systemleistung sicherzustellen.
