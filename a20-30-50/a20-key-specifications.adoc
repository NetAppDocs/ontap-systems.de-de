...
---
= Wichtigste Spezifikationen für ein AFF A20 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Diese ausgewählten Spezifikationen beschreiben das AFF A20 Speichersystem, das in einem einzelnen Hochverfügbarkeitspaar konfiguriert ist. Die vollständigen Spezifikationen für dieses System sind im NetApp Hardware Universe (HWU) verfügbar.
