...
summary: Für die Speichersysteme AFF A20, AFF A30 oder AFF A50 können Sie Wartungsverfahren für die folgenden Komponenten durchführen. 
---
= Wartung von AFF A20, AFF A30 und AFF A50 Hardware
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Für die Speichersysteme AFF A20, AFF A30 oder AFF A50 können Sie Wartungsverfahren für die folgenden Komponenten durchführen.
