...
summary: Ersetzen Sie ein I/O-Modul in Ihrem AFF A20-, AFF A30- oder AFF A50-Speichersystem, wenn das Modul ausfällt oder ein Upgrade für höhere Leistung oder zusätzliche Funktionen benötigt. Der Austauschprozess umfasst das Herunterfahren des Controllers, den Austausch des ausgefallenen I/O-Moduls, den Neustart des Controllers und die Rücksendung des ausgefallenen Moduls an NetApp. 
---
= Ein E/A-Modul in einem AFF A20, AFF A30 oder AFF A50 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Tauschen Sie ein E/A-Modul in Ihrem AFF A20, AFF A30 oder AFF A50 Storage-System aus, wenn das Modul ausfällt oder ein Upgrade benötigt, um höhere Performance oder zusätzliche Features zu unterstützen.

Der Austauschprozess umfasst das Herunterfahren des Controllers, den Austausch des defekten E/A-Moduls, den Neustart des Controllers und die Rücksendung des defekten Teils an NetApp.
