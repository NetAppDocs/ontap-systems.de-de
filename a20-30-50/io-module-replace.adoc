...
[role="lead"]
Ersetzen Sie ein I/O-Modul in Ihrem AFF A20-, AFF A30- oder AFF A50-Speichersystem, wenn das Modul ausfällt oder ein Upgrade für höhere Leistung oder zusätzliche Funktionen benötigt. Der Austauschprozess umfasst das Herunterfahren des Controllers, den Austausch des ausgefallenen I/O-Moduls, den Neustart des Controllers und die Rücksendung des ausgefallenen Moduls an NetApp.
