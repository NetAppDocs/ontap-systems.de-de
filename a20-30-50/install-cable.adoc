...
summary: Nachdem Sie die Storage-System-Hardware des AFF A20, AFF A30 oder AFF A50 installiert haben, verkabeln Sie die Controller mit dem Netzwerk und den Shelfs. 
---
= Die Hardware AFF A20, AFF A30 oder AFF A50 für Netzwerk- und Speicherverbindungen verkabeln
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:../media/drw_isi_a20_switched_2p_25gbe_cabling_ieops-2019.svg["a20-Switched-Cluster-Verkabelungsdiagramm mit einem 25-GbE-I/O-Modul"]
...
.AFF A20, AFF A30 oder AFF A50 mit einem 4-Port 10/25 GbE I/O-Modul
...
.AFF A20, AFF A30 oder AFF A50 mit einem 4-Port 64 Gb/s FC I/O-Modul
