...
---
= Ein E/A-Modul kann zu Ihrem AFF A20, AFF A30 oder AFF A50 System hinzugefügt werden, um die Netzwerkverbindung zu verbessern.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Der Hinzufügevorgang umfasst das Herunterfahren eines Controllers, das Hinzufügen des neuen E/A-Moduls, das Neustarten des Controllers, das Herunterfahren des anderen Controllers, das Hinzufügen des neuen E/A-Moduls und das Neustarten des Controllers.
