...
---
= Ein E/A-Modul zu einem AFF A20, AFF A30 oder AFF A50 System hinzufügen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Das Hinzufügen des E/A-Moduls umfasst das Herunterfahren eines Controllers, das Hinzufügen des Moduls und dessen Neustart, anschließend werden diese Schritte für den anderen Controller wiederholt.

.Über diese Aufgabe
* Sie können ein E/A-Modul zu Ihren Speichersystemen hinzufügen, wenn Steckplätze verfügbar sind oder wenn alle Steckplätze vollständig belegt sind.
