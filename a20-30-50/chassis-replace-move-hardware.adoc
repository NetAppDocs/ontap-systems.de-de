...
[role="lead"]
Tauschen Sie das Gehäuse des AFF A20-, AFF A30- oder AFF A50-Systems aus, wenn es aufgrund eines Hardwarefehlers erforderlich ist. Der Austauschvorgang umfasst das Entfernen der Controller, das Entfernen der Laufwerke, die Installation des Ersatzgehäuses und die Neuinstallation der Gehäusekomponenten.
