...
summary: Der Controller im AFF A20, AFF A30 oder AFF A50 Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität während des automatisierten Wiederherstellungsprozesses des Bootmediums zu gewährleisten. 
---
= Den Controller in einem AFF A20, AFF A30 oder AFF A50 System während des automatisierten Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller im AFF A20, AFF A30 oder AFF A50 Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität während des automatisierten Wiederherstellungsprozesses des Bootmediums zu gewährleisten.
...
.Wie es weiter geht
Nachdem Sie den Controller heruntergefahren haben, link:bootmedia-replace-bmr.html["Ersetzen Sie das Startmedium"].
