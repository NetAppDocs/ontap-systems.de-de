...
summary: Sie müssen das Bootmedium im Controllermodul lokalisieren und dann die Anweisungen zum Austausch befolgen. Das AFF A320 -System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. Die automatische Wiederherstellung über Bootmedien wird nicht unterstützt. 
---
= Informationen zum Austausch des Bootmediums in Ihrem AFF A320 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das AFF A320 -System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien.
