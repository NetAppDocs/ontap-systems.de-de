...
image::../media/drw_a320_boot_media_move_animated_gif.png[drw a320-Startmedien bewegen animiert gif]
...
image::../media/drw_a320_dimm_move_animated_gif.png[drw a320 dimm Move animiert gif]
...
image::../media/drw_a320_pci_riser_move_animated_gif.png[drw a320 pci Riser Move animiert gif]
