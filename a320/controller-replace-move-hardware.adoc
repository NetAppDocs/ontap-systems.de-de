...
---
= Den Controller in einem AFF A320 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Den Controller in Ihrem AFF A320 System ersetzen, indem der defekte Controller entfernt, die FRU-Komponenten in das Ersatzmodul übertragen, dieses in das Gehäuse eingesetzt und in den Wartungsmodus gebootet werden.
