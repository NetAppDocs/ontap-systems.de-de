...
---
= Austausch einer PCIe-Karte in einem AFF A320 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Eine PCIe-Karte im AFF A320-System wird ersetzt, indem Kabel und SFP/QSFP-Module getrennt, der Riser entfernt, die Karte ausgetauscht und die Verkabelung wiederhergestellt werden.
