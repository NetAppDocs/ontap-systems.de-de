...
summary: Ersetzen Sie ein Netzteil in Ihrem AFF A320-System, indem Sie das Zielnetzteil von der Stromquelle trennen, das Netzkabel abziehen, das alte Netzteil entfernen, das Ersatznetzteil installieren und dann das Ersatznetzteil wieder an die Stromquelle anschließen. 
---
= Netzteil im laufenden Betrieb in einem AFF A320 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Netzteil in Ihrem AFF A320 System kann im laufenden Betrieb ausgetauscht werden, indem das defekte Netzteil abgeklemmt, entfernt und ersetzt wird, anschließend wird es wieder angeschlossen, um die Stromversorgung wiederherzustellen.
