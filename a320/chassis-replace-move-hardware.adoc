...
---
= Das Chassis in Ihrem AFF A320 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Gehäuse im AFF A320 System wird ersetzt, indem die Lüfter, Festplatten und Controller-Module vom defekten Gehäuse in das Ersatzgehäuse übertragen werden.
