...
---
= Vor dem Austausch ist der defekte Controller in Ihrem AFF A320 System herunterzufahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vor dem Austausch ist der defekte Controller in Ihrem AFF A320 System herunterzufahren, indem er übernommen und bis zur LOADER-Eingabeaufforderung angehalten wird.
