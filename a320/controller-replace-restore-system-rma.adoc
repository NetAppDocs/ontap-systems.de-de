...
summary: Um Ihr AFF A320-System wieder voll funktionsfähig zu machen, stellen Sie die NetApp Storage Encryption-Konfiguration gegebenenfalls wieder her, installieren Sie Lizenzen für den neuen Controller und senden Sie das defekte Teil zurück an NetApp. 
---
= Den Controller-Austausch für ein AFF A320 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller-Austausch für Ihr AFF A320-System wird abgeschlossen, indem die NetApp Storage Encryption-Konfiguration (falls erforderlich) wiederhergestellt, Lizenzen für den neuen Controller installiert und das defekte Teil an NetApp zurückgesendet werden.
