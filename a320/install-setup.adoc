...
---
= Installation und Einrichtung eines AFF A320-Speichersystems
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das AFF A320 Speichersystem kann installiert und eingerichtet werden, indem je nach Präferenz aus verschiedenen Inhaltsformaten gewählt wird.

* link:../a320/install-quick-guide.html["Schnelle Schritte"]
+
Eine druckbare PDF-Datei mit Schritt-für-Schritt-Anweisungen mit Live-Links zu zusätzlichen Inhalten.

* link:../a320/install-videos.html["Videoschritte"]
+
Video Schritt-für-Schritt-Anleitungen.

* link:../a320/install-detailed-guide.html["Detaillierte Schritte"]
+
