...
summary: Das Bootmedium speichert einen primären und einen sekundären Satz von Boot-Image-Dateien, die das System beim Start verwendet. Das AFF A320 -System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. 
---
= Das Bootmedium in einem AFF A320 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um das Bootmedium zu ersetzen, müssen Sie das defekte Controllermodul ausbauen, das Ersatz-Bootmedium installieren und das Boot-Image auf einen USB-Stick übertragen. Das AFF A320 -System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. Die automatische Wiederherstellung über Bootmedien wird nicht unterstützt.
...
== Schritt 3: Übertragen Sie das Boot-Image mithilfe eines USB-Sticks
