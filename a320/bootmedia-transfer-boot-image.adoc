...
summary: Das von Ihnen installierte Ersatz-Bootmedium enthält kein Boot-Image. Daher müssen Sie ein Boot-Image mithilfe eines USB-Sticks übertragen. Das AFF A320 -System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. Die automatische Wiederherstellung über Bootmedien wird nicht unterstützt. 
---
= Das Boot-Image wird mithilfe eines USB-Sticks auf das Bootmedium in einem AFF A320-System übertragen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das von Ihnen installierte Ersatz-Bootmedium enthält kein Boot-Image. Daher müssen Sie ein Boot-Image mithilfe eines USB-Sticks übertragen. Das AFF A320 -System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. Die automatische Wiederherstellung über Bootmedien wird nicht unterstützt.
