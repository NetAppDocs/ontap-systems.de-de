...
---
= Anforderungen sollten vor dem Austausch des Controllers in einem AFF A320 System überprüft werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vor dem Austausch des Controllers in Ihrem AFF A320 System sollten die Voraussetzungen für das Austauschverfahren geprüft und das passende Verfahren für Ihre Version von ONTAP ausgewählt werden.
