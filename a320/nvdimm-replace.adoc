...
summary: Tauschen Sie das NVDIMM in Ihrem AFF A320 Controller-Modul aus, wenn das System registriert, dass die Lebensdauer des Flash-Speichers fast abgelaufen ist oder das identifizierte NVDIMM nicht gesund ist. Wenn ein fehlerhaftes NVDIMM nicht ersetzt wird, kann dies zu einem System-Panic führen. 
---
= Ein NVDIMM in einem AFF A320 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein NVDIMM in Ihrem AFF A320 System ist auszutauschen, wenn das System meldet, dass die Lebensdauer des Flash-Speichers fast abgelaufen ist oder der identifizierte NVDIMM nicht funktionsfähig ist. Das Nichtaustauschen eines fehlerhaften NVDIMM kann zu einem Systemabsturz führen.
