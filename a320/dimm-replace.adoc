...
summary: Tauschen Sie ein DIMM in Ihrem AFF A320 Controller-Modul aus, wenn das System eine zunehmende Anzahl von korrigierbaren Fehlerkorrekturcodes oder nicht korrigierbaren ECC-Fehlern registriert. Wenn ein fehlerhaftes DIMM nicht ersetzt wird, kann dies zu einem System-Panic führen. 
---
= Austausch eines DIMM in einem AFF A320 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein DIMM in Ihrem AFF A320 System ist auszutauschen, wenn das Speichersystem auf übermäßig viele korrigierbare ECC-Fehler oder einen nicht korrigierbaren ECC-Fehler stößt, was typischerweise durch den Ausfall eines einzelnen DIMM verursacht wird.
