...
---
= Die NVDIMM-Batterie in einem AFF A320 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die NVDIMM-Batterie in Ihrem AFF A320 System wird ersetzt, indem das Controller-Modul entfernt, die Batterie ausgetauscht und das Controller-Modul wieder eingesetzt wird.
