...
summary: Fahren Sie den beeinträchtigten Controller in Ihrem ASA A800 Speichersystem herunter, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Startmediums sicherzustellen. 
---
= Der Controller im ASA A800 System wird während des automatisierten Boot-Wiederherstellungsprozesses heruntergefahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den beeinträchtigten Controller in Ihrem ASA A800 Speichersystem herunter, um Datenverlust zu verhindern und die Systemstabilität während des automatischen Wiederherstellungsprozesses des Bootmediums aufrechtzuerhalten.
