...
summary: Der Controller im ASA A800-Speichersystem sollte heruntergefahren werden, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Bootmediums sicherzustellen. 
---
...
[role="lead"]
Der Controller im ASA A800-Speichersystem wird heruntergefahren, um Datenverlust zu vermeiden und die Systemstabilität während des automatisierten Wiederherstellungsprozesses des Bootmediums zu gewährleisten.
