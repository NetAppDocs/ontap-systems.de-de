...
summary: Der Controller im ASA A800-Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität während des manuellen Bootmedien-Wiederherstellungsprozesses zu gewährleisten. 
---
= Den Controller in einem ASA A800 System während des manuellen Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller im ASA A800-Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität während des manuellen Bootmedien-Wiederherstellungsprozesses zu gewährleisten.
