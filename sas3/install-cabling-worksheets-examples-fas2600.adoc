...
image::../media/drw_fas2800_noshelf_mpha_IEOPS-954.svg[FAS2800 Multipath HA ohne externe Shelfs]
...
image::../media/drw_fas2800_worksheet_IEOPS-948.svg[FAS2800 Arbeitsblatt für die HA-Verkabelung mit drei Pfaden, die Port-Paare für Stack 1 zeigen]

image::../media/drw_fas2800_withshelves_tpha_IEOPS-949.svg[FAS2800 HA-Verkabelung von drei Pfaden zu einem Stack]
