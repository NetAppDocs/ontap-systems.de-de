...
---
= Verkabelungsübersicht für eine DS212C, DS224C oder DS460C Quad-Path-HA-Konfiguration mit zwei qtree Port SAS-HBAs
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das ausgefüllte Arbeitsblatt zur Controller-zu-Stack-Verkabelung und das Verkabelungsbeispiel ermöglichen die Verkabelung einer Quad-Path-HA-Konfiguration mit zwei quad-port SAS-HBAs. Dies gilt für Shelves mit IOM12, IOM12B oder IOM12C Modulen.
