...
summary: 'Beim Austausch einer Laufwerksschublade in einem Regal kann entweder das gesamte Speichersystem (HA-Paar) angehalten werden oder das HA-Paar bleibt in Betrieb.' 
---
= Austausch einer DS460C-Laufwerksschublade
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Über diese Aufgabe
* Dieses Verfahren gilt für Regale mit DCM Laufwerksschubladen und/oder DCM2 oder DCM3 Laufwerksschubladen. (Die Regale verfügen außerdem über zwei IOM12 Module, zwei IOM12B Module oder zwei IOM12C Module.)
+
...
[NOTE]
====
Wenn ein defekter Laufwerksschacht durch einen neueren DCM2 oder DCM3 Laufwerksschacht ersetzt wird, ist sicherzustellen, dass die ONTAP Software und die Firmware des IOM12, IOM12B oder IOM12C Moduls die Mindestversionen ausführen, die zur Unterstützung von DCM2 oder DCM3 Laufwerksschächten erforderlich sind.

Das Firmware-Upgrade für IOM12, IOM12B oder IOM12C kann vor oder nach dem Austausch einer Laufwerksschublade erfolgen. In diesem Verfahren wird das Firmware-Upgrade als Teil der Vorbereitung für den Austausch der Schublade durchgeführt.
...
. Wenn Ihr Shelf eine Kombination aus IOM12-, IOM12B- oder IOM12C-Modulen mit einer beliebigen Anzahl von DCM3-Laufwerksschächten enthält, muss Ihr System mindestens die folgenden Versionen von ONTAP ausführen:
+
** ONTAP 9.17.1RC1
** ONTAP 9.16.1P3
** ONTAP 9.15.1P11
