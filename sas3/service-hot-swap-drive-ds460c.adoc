...
---
= Hot-Swap eines Festplattenlaufwerks in einem DS460C Shelf
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können ein defektes Festplattenlaufwerk in einem DS460C Festplattengehäuse mit IOM12, IOM12B oder IOM12C Modulen im laufenden Betrieb austauschen.
