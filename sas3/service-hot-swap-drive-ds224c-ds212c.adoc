...
---
= Ein Festplattenlaufwerk in einem DS212C oder DS224C Shelf im laufenden Betrieb austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes Festplattenlaufwerk in einem DS224C oder DS212C Festplattengehäuse mit IOM12, IOM12B oder IOM12C Modulen kann im laufenden Betrieb ausgetauscht werden.
