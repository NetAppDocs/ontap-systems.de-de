...
summary: Falls Ihr neues System nicht in einem Schrank installiert ist, müssen die Festplattengehäuse in einem Rack installiert und verkabelt werden. 
---
= Ein DS212C, DS224C oder DS460C Shelf installieren und verkabeln
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Über diese Aufgabe
* Disk Shelves mit IOM12, IOM12B oder IOM12C Modulen werden mit auf 00 voreingestellten Shelf-IDs ausgeliefert.
+
...
* Wenn das System bei der Einrichtung und Konfiguration nicht für die automatische Zuweisung der Festplattenbesitzrechte konfiguriert wird, ist eine manuelle Zuweisung der Festplattenbesitzrechte erforderlich.
