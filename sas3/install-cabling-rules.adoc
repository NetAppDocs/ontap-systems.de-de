...
summary: 'Disk Shelves mit IOM12, IOM12B oder IOM12C Modulen können in HA-Paar- und Einzelcontroller-Konfigurationen verkabelt werden (für unterstützte Plattformen).' 
---
= SAS-Verkabelungsregeln und Konzepte für DS212C, DS224C oder DS460C Shelves
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
DS212C, DS224C und DS460C Shelves mit IOM12, IOM12B oder IOM12C Modulen können in HA Pair und Single-Controller Konfigurationen (für unterstützte Plattformen) durch Anwendung der SAS-Verkabelungsregeln verbunden werden: Konfigurationsregeln, Controller-Slot-Nummerierungsregeln, Shelf-zu-Shelf-Verbindungsregeln, Controller-zu-Stack-Verbindungsregeln und, falls zutreffend, Mini-SAS HD SAS-Optikkabelregeln.


NOTE: Die in diesem Leitfaden beschriebenen SAS-Verkabelungsregeln bezüglich Controller-Steckplatznummerierung, Shelf-zu-Shelf-Verbindungen und Controller-zu-Stack-Verbindungen gelten für alle SAS Disk Shelfs, unabhängig davon, ob sie IOM12, IOM12B oder IOM12C Module verwenden. Die Informationen in diesem Leitfaden beziehen sich jedoch speziell auf die besonderen Eigenschaften von Disk Shelfs mit IOM12, IOM12B oder IOM12C Modulen und deren Verwendung in unterstützten Konfigurationen.

Die in diesem Leitfaden beschriebenen SAS-Verkabelungsregeln bezüglich Konfigurationsregeln und mini-SAS HD SAS-Lichtwellenleiterregeln gelten speziell für Festplattengehäuse mit IOM12, IOM12B oder IOM12C Modulen.
...
Disk Shelfs mit IOM12, IOM12B oder IOM12C Modulen werden auf bestimmten HA Pair und Einzelcontroller Konfigurationen unterstützt.
