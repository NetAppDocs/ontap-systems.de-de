...
* In der folgenden Abbildung können Sie IOM12/IOM12B Shelfs in einer Bridge-Attached MetroCluster-Konfiguration mit einem IOM6 Shelf-Stack verbinden. image:../media/hot_adding_iom12_shelves_to_iom6_stack_in_bridge_attached_config.png["Heterogene Stack-Verkabelung in Bridge-Attached-Konfiguration"]
