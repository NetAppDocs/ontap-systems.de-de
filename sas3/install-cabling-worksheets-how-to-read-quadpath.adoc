...
summary: Dieses Beispiel dient als Orientierung beim Lesen und Anwenden eines ausgefüllten Arbeitsblatts auf Kabelstapel von Festplattengehäusen für quad-pathing Konnektivität. 
---
= Ein Arbeitsblatt zu den Controller-zu-Stack-Verbindungen für DS212C, DS224C oder DS460C mit quad-pathed Konnektivität
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dieses Beispiel zeigt, wie ein ausgefülltes Arbeitsblatt verwendet werden kann, um Kabelstapel von Festplattengehäusen mit IOM12, IOM12B oder IOM12C Modulen für quad-pathing Konnektivität zu lesen und anzuwenden.
