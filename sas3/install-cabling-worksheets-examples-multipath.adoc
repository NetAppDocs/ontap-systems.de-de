...
summary: Die Arbeitsblätter und Beispiele zur Verkabelung von Controller zu Stack ermöglichen die Verkabelung Ihres HA-Paars als Multipath HA Konfiguration. 
---
= Verkabelungsarbeitsblätter für DS212C, DS224C oder DS460C Multipath HA-Konfigurationen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Dies gilt für Regale mit IOM12, IOM12B oder IOM12C Modulen.
