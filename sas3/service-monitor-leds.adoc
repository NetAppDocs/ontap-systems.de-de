...
image::../media/drw_diskdrive_ds224c.gif[Vertikale Anordnung des Antriebsträgers]
...
image::../media/drw_diskdrive_ds212c.gif[Horizontale Anordnung des Antriebsträgers]
