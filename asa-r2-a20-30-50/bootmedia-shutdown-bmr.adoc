...
summary: Der Controller im ASA A20, ASA A30 oder ASA A50-Speichersystem wird heruntergefahren, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Bootmediums zu gewährleisten. 
---
= Den Controller in einem ASA A20, ASA A30 oder ASA A50 System während des automatisierten Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller im ASA A20, ASA A30 oder ASA A50-Speichersystem wird heruntergefahren, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Bootmediums zu gewährleisten.
