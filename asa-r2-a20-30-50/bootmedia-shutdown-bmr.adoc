...
summary: Fahren Sie den außer Betrieb genommenen Controller des Speichersystems ASA A20, ASA A30 oder ASA A50 herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Startmediums sicherzustellen. 
---
= Den Controller im ASA A20, ASA A30 oder ASA A50 System während des automatisierten Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den außer Betrieb genommenen Controller des Speichersystems ASA A20, ASA A30 oder ASA A50 herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Startmediums sicherzustellen.
