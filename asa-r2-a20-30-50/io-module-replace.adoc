...
summary: Ersetzen Sie ein I/O-Modul in Ihrem ASA A20-, ASA A30- oder ASA A50-Speichersystem, wenn das Modul ausfällt oder ein Upgrade für höhere Leistung oder zusätzliche Funktionen benötigt. Der Austauschprozess umfasst das Herunterfahren des Controllers, den Austausch des ausgefallenen I/O-Moduls, den Neustart des Controllers und die Rücksendung des ausgefallenen Moduls an NetApp. 
---
= Ein E/A-Modul in einem ASA A20, ASA A30 oder ASA A50 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ersetzen Sie ein I/O-Modul in Ihrem ASA A20-, ASA A30- oder ASA A50-Speichersystem, wenn das Modul ausfällt oder ein Upgrade für höhere Leistung oder zusätzliche Funktionen benötigt. Der Austauschprozess umfasst das Herunterfahren des Controllers, den Austausch des ausgefallenen I/O-Moduls, den Neustart des Controllers und die Rücksendung des ausgefallenen Moduls an NetApp.
