...
[role="lead"]
Tauschen Sie das Gehäuse des ASA A20-, ASA A30- oder ASA A50-Systems aus, wenn es aufgrund eines Hardwarefehlers erforderlich ist. Der Austauschvorgang umfasst das Entfernen der Controller, das Entfernen der Laufwerke, die Installation des Ersatzgehäuses und die Neuinstallation der Gehäusekomponenten.
