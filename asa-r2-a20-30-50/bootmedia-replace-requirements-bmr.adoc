...
---
= Anforderungen – AFF A20, AFF A30 und AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Wie es weiter geht
Nachdem Sie die Anforderungen für die Startmedien überprüft haben, link:bootmedia-shutdown-bmr.html["Schalten Sie den außer Betrieb genommenen Controller aus"].
