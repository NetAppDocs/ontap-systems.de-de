...
summary: Beginnen Sie mit dem Austausch der Startmedien in Ihrem ASA A30, ASA A20 und ASA A50 Speichersystem, indem Sie die Austauschanforderungen überprüfen, den außer Betrieb genommenen Controller herunterfahren, das Startmedium austauschen, das Image auf dem Startmedium wiederherstellen und die Systemfunktionalität überprüfen. 
---
