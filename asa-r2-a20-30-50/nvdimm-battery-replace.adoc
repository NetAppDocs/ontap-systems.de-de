...
summary: Tauschen Sie die NV-Batterie in Ihrem ASA A20, ASA A30 oder ASA A50-System aus, wenn der Akku anfängt, aufgeladen zu werden oder ausfällt, da sie für die Aufbewahrung wichtiger Systemdaten bei Stromausfällen verantwortlich ist. 
---
...
[role="lead"]
Tauschen Sie die NV-Batterie in Ihrem ASA A20, ASA A30 oder ASA A50-System aus, wenn der Akku anfängt, aufgeladen zu werden oder ausfällt, da sie für die Aufbewahrung wichtiger Systemdaten bei Stromausfällen verantwortlich ist. Beim Austausch wird der Controller heruntergefahren, das Controller-Modul entfernt, die NV-Batterie ersetzt, das Controller-Modul wieder eingebaut und das fehlerhafte Teil wieder an den NetApp zurückgegeben.
