...
summary: Fahren Sie die Controller in Ihrem ASA A20-, ASA A30- oder ASA A50-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Gehäuses sicherzustellen. 
---
= Die ASA A20, ASA A30 oder ASA A50 Controller werden heruntergefahren, um das Chassis auszutauschen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie die Controller in Ihrem ASA A20-, ASA A30- oder ASA A50-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Gehäuses sicherzustellen.
