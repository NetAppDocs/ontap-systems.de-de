...
[role="lead"]
Zum Austauschen des Startmediums müssen Sie den Controller für beeinträchtigte Störungen entfernen, das Startmedium für beeinträchtigte Störungen entfernen und das Ersatz-Startmedium in den Controller für beeinträchtigte Störungen einsetzen.
