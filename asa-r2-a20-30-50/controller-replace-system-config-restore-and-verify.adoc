...
summary: Überprüfen Sie beim ASA A20, ASA A30 oder ASA A50 Storage-System, ob die HA-Konfiguration des Controllers aktiv ist und ordnungsgemäß funktioniert, und vergewissern Sie sich, dass alle Pfade zu den Festplatten von den Systemadaptern aufgelistet sind. 
---
= Die Controller-Konfiguration in Ihrem ASA A20, ASA A30 oder ASA A50 System wird wiederhergestellt und überprüft.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
