...
summary: Sie können Hot-Swap ein Ethernet-E/A-Modul in Ihrem ASA A20, ASA A30 oder ASA A50-Speichersystem austauschen, wenn ein Modul ausfällt und Ihr Speichersystem alle ONTAP Versionserfordernisse erfüllt. 
---
= Ein I/O-Modul kann in Ihrem ASA A20, ASA A30 oder ASA A50 System Hot-Swap-fähig ausgetauscht werden, ohne dass ein Herunterfahren erforderlich ist.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können Hot-Swap ein Ethernet-E/A-Modul in Ihrem ASA A20, ASA A30 oder ASA A50-Speichersystem austauschen, wenn ein Modul ausfällt und Ihr Speichersystem alle ONTAP Versionserfordernisse erfüllt.
