...
[role="lead"]
Möglicherweise müssen Sie Wartungsverfahren für Ihre Hardware durchführen. In diesem Abschnitt finden Sie Verfahren zur Wartung der Systemkomponenten ASA A20, ASA A30 und ASA A50.

Bei den Verfahren in diesem Abschnitt wird davon ausgegangen, dass die Storage-Systeme ASA A20, ASA A30 oder ASA A50 bereits als Storage-Nodes in der ONTAP-Umgebung implementiert wurden.
