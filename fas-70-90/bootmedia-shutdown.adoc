...
summary: Fahren Sie den beschädigten Controller in Ihrem FAS70- oder FAS90-Speichersystem herunter, um Datenverlust zu verhindern und die Systemstabilität während des manuellen Wiederherstellungsprozesses des Bootmediums aufrechtzuerhalten. 
---
= Der defekte Controller in Ihrem FAS70 oder FAS90 System wird während des manuellen Boot-Wiederherstellungsprozesses heruntergefahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den beschädigten Controller in Ihrem FAS70- oder FAS90-Speichersystem herunter, um Datenverlust zu verhindern und die Systemstabilität während des manuellen Wiederherstellungsprozesses des Bootmediums aufrechtzuerhalten.
