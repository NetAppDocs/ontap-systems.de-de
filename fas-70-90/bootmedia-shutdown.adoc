...
---
= Fahren Sie den Controller herunter, um die Boot-Medien FAS70 und FAS90 zu ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den außer Betrieb genommenen Controller in Ihrem FAS70- oder FAS90-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch der Boot-Medien sicherzustellen.
