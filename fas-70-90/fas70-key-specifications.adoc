...
---
= Wichtigste Spezifikationen für ein FAS70 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dies sind ausgewählte Spezifikationen für das FAS70 Speichersystem in einem einzelnen Hochverfügbarkeits-Paar. Die vollständigen Spezifikationen für dieses Speichersystem sind im NetApp Hardware Universe (HWU) verfügbar.
