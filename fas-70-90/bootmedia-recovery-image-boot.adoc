...
[role="lead"]
Nach der Installation des neuen Boot-Medium-Gerät in Ihrem FAS70 oder FAS90-System, können Sie das Recovery-Image von einem USB-Laufwerk starten und die Konfiguration vom Partner-Knoten wiederherstellen.
