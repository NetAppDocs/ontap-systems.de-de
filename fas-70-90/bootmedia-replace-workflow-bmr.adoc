...
summary: Die automatische Wiederherstellung des Startabbilds beinhaltet das automatische Erkennen und Auswählen der passenden Startmenüoption durch das System. Es verwendet das Startabbild auf dem Partnerknoten, um ONTAP auf dem Ersatzstartmedium in Ihrem FAS70 oder FAS90 Speichersystem neu zu installieren. 
---
= Arbeitsablauf zum Austausch des Bootmediums für ein FAS70 oder FAS90 System unter Verwendung des automatisierten Boot-Wiederherstellungsprozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die automatische Wiederherstellung des Startabbilds beinhaltet das automatische Erkennen und Auswählen der passenden Startmenüoption durch das System. Es verwendet das Startabbild auf dem Partnerknoten, um ONTAP auf dem Ersatzstartmedium in Ihrem FAS70 oder FAS90 Speichersystem neu zu installieren.
