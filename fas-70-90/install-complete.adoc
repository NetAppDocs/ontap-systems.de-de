...
---
= Komplette Einrichtung und Konfiguration von Storage-Systemen – FAS70 und FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nachdem Sie Ihr FAS70 oder FAS90 Storage-System eingeschaltet haben, können Sie Ihr Cluster-Netzwerk erkennen und einen ONTAP Cluster einrichten.
