...
[role="lead"]
Möglicherweise müssen Sie Wartungsverfahren für Ihre Hardware durchführen. In diesem Abschnitt finden Sie spezifische Verfahren zur Wartung Ihrer FAS70- und FAS90-Systemkomponenten.

Bei den Verfahren in diesem Abschnitt wird vorausgesetzt, dass das FAS70 und FAS90 System bereits als Storage Node in der ONTAP Umgebung implementiert wurde.
