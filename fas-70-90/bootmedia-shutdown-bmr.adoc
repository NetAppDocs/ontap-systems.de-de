...
summary: Fahren Sie den außer Betrieb genommenen Controller in Ihrem FAS70- oder FAS90-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch der Boot-Medien sicherzustellen. 
---
= Der defekte Controller in Ihrem FAS70 oder FAS90 System wird während des automatisierten Boot-Wiederherstellungsprozesses heruntergefahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der defekte Controller in Ihrem FAS70 oder FAS90 Storage-System sollte heruntergefahren werden, um Datenverlust zu verhindern und die Systemstabilität während des automatisierten Boot-Medien-Wiederherstellungsprozesses zu gewährleisten.
