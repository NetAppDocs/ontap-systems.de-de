...
summary: Der Controller im FAS70 oder FAS90 Storage-System wird heruntergefahren, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Bootmediums sicherzustellen. 
---
= Den Controller in einem FAS70 oder FAS90 System während des automatisierten Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller im FAS70 oder FAS90 Storage-System wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität während des automatisierten Boot-Medien-Wiederherstellungsprozesses zu gewährleisten.
