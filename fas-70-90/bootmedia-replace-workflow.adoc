...
summary: Dieser Workflow verwendet ein USB-Laufwerk, um ONTAP auf dem Ersatz-Bootmedium Ihres FAS70 oder FAS90 Systems neu zu installieren. Das passende ONTAP Recovery-Image kann von der NetApp Support Site heruntergeladen, auf das USB-Laufwerk kopiert und zur Wiederherstellung des Systems in den Betriebszustand verwendet werden. 
---
= Arbeitsablauf zum Austausch des Bootmediums für ein FAS70 oder FAS90 System unter Verwendung des manuellen Boot-Wiederherstellungsprozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dieser Workflow verwendet ein USB-Laufwerk, um ONTAP auf dem Ersatz-Bootmedium Ihres FAS70 oder FAS90 Systems neu zu installieren. Das passende ONTAP Recovery-Image kann von der NetApp Support Site heruntergeladen, auf das USB-Laufwerk kopiert und zur Wiederherstellung des Systems in den Betriebszustand verwendet werden.
