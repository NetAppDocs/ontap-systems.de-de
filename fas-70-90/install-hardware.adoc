...
summary: Das Speichersystem wird in einem Schrank oder einem Telco-Rack installiert. 
---
= Die FAS70 oder FAS90 Hardware in einem Schrank oder Rack installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nachdem Sie die Hardware für Ihr FAS70 oder FAS90 Speichersystem installiert haben, link:install-cable.html["Die Hardware für Ihr FAS70 oder FAS90 Storage-System verkabeln"].
