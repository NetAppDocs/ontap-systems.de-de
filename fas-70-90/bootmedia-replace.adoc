...
summary: 'Konfigurationsdaten: Wenn das Startmedium fehlschlägt, müssen Sie das Controller-Modul trennen, das System Management-Modul entfernen, das gestörte Startmedium entfernen und das Ersatz-Startmedium im System Management-Modul installieren.' 
---
= Ersetzen Sie die Boot-Medien FAS70 und FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Boot-Medien in Ihrem FAS70- oder FAS90-System speichern wichtige Firmware- und Konfigurationsdaten. Wenn das Startmedium fehlschlägt, müssen Sie das Controller-Modul trennen, das System Management-Modul entfernen, das gestörte Startmedium entfernen und das Ersatz-Startmedium im System Management-Modul installieren.

Sie müssen das Controller-Modul trennen, das System-Management-Modul von der Rückseite des Systems entfernen, das gestörte Startmedium entfernen und das Ersatz-Startmedium im System-Management-Modul installieren.
