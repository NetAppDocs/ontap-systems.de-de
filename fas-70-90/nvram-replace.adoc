...
---
= Den NVRAM in Ihrem FAS70 oder FAS90 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nachdem Sie die FRU ausgetauscht haben, müssen Sie das Controllermodul neu starten, indem Sie die Stromkabel wieder an das Netzteil anschließen.
