...
---
= Einschalten eines FAS70 oder FAS90 Storage-Systems
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nachdem Sie die Rack-Hardware für Ihr FAS70 oder FAS90 Speichersystem installiert und die Kabel für die Controller und Storage Shelves angeschlossen haben, sollten die Storage Shelves und Controller eingeschaltet werden.
...
Nachdem Sie Ihr FAS70- oder FAS90-Speichersystem eingeschaltet haben, https://docs.netapp.com/us-en/ontap/software_setup/workflow-summary.html["Richten Sie Ihren Cluster ein"] .
