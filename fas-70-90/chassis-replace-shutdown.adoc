...
summary: Der Controller im FAS70 oder FAS90 Storage-System sollte heruntergefahren werden, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Gehäuses zu gewährleisten. 
---
= Die FAS70 oder FAS90 Controller werden heruntergefahren, um das Chassis zu ersetzen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller im FAS70 oder FAS90 Storage-System sollte heruntergefahren werden, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Gehäuses zu gewährleisten.
