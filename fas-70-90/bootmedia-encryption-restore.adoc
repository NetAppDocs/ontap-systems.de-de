...
summary: Stellen Sie die Verschlüsselung auf den Ersatz-Boot-Medien in Ihrem FAS70- oder FAS90-System wieder her, um einen kontinuierlichen Datenschutz zu gewährleisten. Der Austauschprozess umfasst die Überprüfung der Schlüsselverfügbarkeit, die Anwendung von Verschlüsselungseinstellungen und die Bestätigung des sicheren Zugriffs auf Ihre Daten. 
---
= Wiederherstellung der Verschlüsselung auf dem Startmedium eines FAS70 oder FAS90 Systems nach dem manuellen Boot-Wiederherstellungsprozess
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Stellen Sie die Verschlüsselung auf den Ersatz-Boot-Medien in Ihrem FAS70- oder FAS90-System wieder her, um einen kontinuierlichen Datenschutz zu gewährleisten. Der Austauschprozess umfasst die Überprüfung der Schlüsselverfügbarkeit, die Anwendung von Verschlüsselungseinstellungen und die Bestätigung des sicheren Zugriffs auf Ihre Daten.
