...
summary: Bereiten Sie sich auf die Installation Ihrer FAS70 und FAS90 Plattform vor. 
---
= Vorbereitung der Installation eines FAS70 oder FAS90 Storage-Systems
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bereiten Sie die Installation Ihres FAS70- oder FAS90-Speichersystems vor, indem Sie den Standort vorbereiten, die Kartons auspacken, den Inhalt der Kartons mit dem Packzettel vergleichen und das System registrieren, um auf Support-Vorteile zuzugreifen.
...
Nachdem Sie die Installation Ihrer FAS70 oder FAS90 Hardware vorbereitet haben, link:install-hardware.html["Installieren Sie die Hardware für Ihr FAS70 oder FAS90 Storage-System"].
