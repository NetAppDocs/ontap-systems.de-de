...
---
= Installation vorbereiten - FAS70 und FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nachdem Sie sich darauf vorbereitet haben, Ihre FAS70 oder FAS90 Hardware zu installieren, Sie link:install-hardware.html["Installieren Sie die Hardware für Ihr FAS70 oder FAS90 Storage-System"].
