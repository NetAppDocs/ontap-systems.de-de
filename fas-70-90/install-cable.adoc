...
---
= Die FAS70 oder FAS90 Hardware für Netzwerk- und Speicher-Konnektivität verkabeln
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Über diese Aufgabe
Die FAS70 und FAS90 Speichersysteme unterstützen DS212C, DS224C, DS460C und NS224 Shelves mit entweder dem NSM100 oder NSM100B Modul.
