...
summary: Ein Ethernet-E/A-Modul kann per Hot-Swap in Ihrem FAS70 oder FAS90 Speichersystem ausgetauscht werden, wenn ein Modul ausfällt und Ihr Speichersystem alle ONTAP Versionsanforderungen erfüllt. 
---
= Ein I/O-Modul kann in Ihrem FAS70 oder FAS90 System im Hot-Swap-Verfahren ausgetauscht werden, ohne dass das System heruntergefahren werden muss.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein Ethernet-E/A-Modul kann per Hot-Swap in Ihrem FAS70 oder FAS90 Speichersystem ausgetauscht werden, wenn ein Modul ausfällt und Ihr Speichersystem alle ONTAP Versionsanforderungen erfüllt.
...
* Stellen Sie sicher, dass die Befehle während des Hot-Swap dem richtigen Controller und E/A-Steckplatz zugeordnet werden:
+
