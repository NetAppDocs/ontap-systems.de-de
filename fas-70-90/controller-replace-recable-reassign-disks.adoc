...
---
= Den Controller in Ihrem FAS70 oder FAS90 System zurückgeben, damit der normale Betrieb fortgesetzt werden kann.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Geben Sie die Kontrolle über die Speicherressourcen an den Ersatz-Controller zurück, damit Ihr FAS70 oder FAS90 System den normalen Betrieb wieder aufnehmen kann. Das Rückgabeverfahren variiert je nach dem von Ihrem System verwendeten Verschlüsselungstyp: keine Verschlüsselung oder Onboard Key Manager (OKM)-Verschlüsselung.
