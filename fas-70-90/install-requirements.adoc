...
---
= Anforderungen für die Installation Ihres FAS70 oder FAS90 Storage-Systems prüfen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Ein DS460C-Regal kann bis zu 260,4 lbs (118,1 kg) wiegen. Zum Anheben des Storage-Regals sind möglicherweise bis zu fünf Personen oder ein hydraulischer Hubwagen erforderlich. Alle Komponenten sollten sich im Storage-Regal befinden (sowohl vorne als auch hinten), um ein Ungleichgewicht des Regalgewichts zu vermeiden.
