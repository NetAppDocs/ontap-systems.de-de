...
summary: Nachdem Sie das neue Boot-Mediengerät in Ihrem FAS70- oder FAS90-Speichersystem installiert haben, können Sie den automatisierten Boot-Medien-Wiederherstellungsprozess starten, um die Konfiguration vom Partnerknoten wiederherzustellen. 
---
= Das Wiederherstellungsimage auf Ihrem FAS70 oder FAS90 System wird mithilfe des automatisierten Boot-Recovery-Prozesses gestartet.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
