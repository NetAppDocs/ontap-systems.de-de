...
summary: Fahren Sie den Controller in Ihrem FAS70 oder FAS90 Storage-System herunter, wenn er außer Betrieb ist. Vor der Durchführung von Wartungsarbeiten oder dem Austausch von Komponenten ist es wichtig, den Controller sicher herunterzufahren, um Datenverlust zu vermeiden und die Systemstabilität sicherzustellen. 
---
...
[role="lead"]
Fahren Sie den Controller in Ihrem FAS70 oder FAS90 Storage-System herunter, wenn er außer Betrieb ist. Vor der Durchführung von Wartungsarbeiten oder dem Austausch von Komponenten ist es wichtig, den Controller sicher herunterzufahren, um Datenverlust zu vermeiden und die Systemstabilität sicherzustellen.
