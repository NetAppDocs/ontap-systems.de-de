...
summary: Ein E/A-Modul kann zu Ihrem FAS70 oder FAS90 System hinzugefügt werden, um die Netzwerkverbindungen zu verbessern und die Fähigkeit Ihres Systems zur Verarbeitung von Datenverkehr zu erweitern. 
---
= Ein E/A-Modul zu einem FAS70 oder FAS90 System hinzufügen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein E/A-Modul kann dem FAS70 oder FAS90 System hinzugefügt werden, um die Netzwerkverbindungen zu verbessern und die Fähigkeit des Systems zur Verarbeitung von Datenverkehr zu erweitern.

Sie können Ihrem FAS70 oder FAS90 Speichersystem ein E/A-Modul hinzufügen, wenn freie Steckplätze verfügbar sind oder wenn alle Steckplätze vollständig belegt sind.
