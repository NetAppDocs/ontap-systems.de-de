...
summary: Ergänzen Sie Ihr FAS70- und FAS90-System um ein IO-Modul, um die Netzwerkkonnektivität zu verbessern und die Fähigkeit Ihres Systems zur Verarbeitung von Datenverkehr zu erweitern. 
---
= Fügen Sie ein E/A-Modul hinzu – FAS70 und FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Erweitern Sie Ihr FAS70 und FAS90 System um ein I/O-Modul, um die Netzwerkkonnektivität zu verbessern und die Fähigkeit Ihres Systems zu erweitern, den Datenverkehr zu bewältigen.
