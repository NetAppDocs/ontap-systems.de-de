...
summary: Das DIMM in Ihrem FAS70 oder FAS90 System ist auszutauschen, wenn zu viele korrigierbare oder nicht korrigierbare Speicherfehler erkannt werden. Solche Fehler können verhindern, dass das Speichersystem ONTAP startet. Der Austauschprozess umfasst das Herunterfahren des beeinträchtigten Controllers, dessen Ausbau, den Austausch des DIMM, den Wiedereinbau des Controllers und anschließend die Rücksendung des defekten Teils an NetApp. 
---
= Ein DIMM in einem FAS70 oder FAS90 System ersetzen, um Speicherfehler zu beheben
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das DIMM in Ihrem FAS70 oder FAS90 System ist auszutauschen, wenn zu viele korrigierbare oder nicht korrigierbare Speicherfehler erkannt werden. Solche Fehler können verhindern, dass das Speichersystem ONTAP startet. Der Austauschprozess umfasst das Herunterfahren des beeinträchtigten Controllers, dessen Ausbau, den Austausch des DIMM, den Wiedereinbau des Controllers und anschließend die Rücksendung des defekten Teils an NetApp.
...
+
Die DIMMs sind abhängig vom Systemmodell:
...
| FAS70 | Steckplätze 3, 10, 19, 26 


| FAS90 | Steckplätze 3, 7, 10, 14, 19, 23, 26, 30 
|===
