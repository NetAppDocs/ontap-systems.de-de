...
summary: Ein X91148A Modul kann in einen leeren Modulsteckplatz in einem FAS9000 System als entweder 100GbE NIC oder als Speichermodul für NS224 Storage Shelves eingesetzt werden. 
---
= Ein X91148A-Modul kann über einen freien Steckplatz zu einem FAS9000 System hinzugefügt werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein X91148A Modul kann in einen leeren Modulsteckplatz in einem FAS9000 System als entweder 100GbE NIC oder als Speichermodul für NS224 Storage Shelves eingesetzt werden.
