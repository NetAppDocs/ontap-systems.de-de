...
summary: Ein DIMM in einem FAS9000-System wird ersetzt, wenn das System über Health Monitor-Warnmeldungen übermäßig viele korrigierbare ECC-Speicherfehler oder nicht korrigierbare ECC-Fehler meldet. Ein fehlerhaftes DIMM kann verhindern, dass das Speichersystem ONTAP startet, daher stellt der Austausch den stabilen Betrieb wieder her. 
---
= Austausch eines DIMM in einem FAS9000 System zur Behebung von Speicherfehlern
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein DIMM in einem FAS9000-System wird ersetzt, wenn das System über Health Monitor-Warnmeldungen übermäßig viele korrigierbare ECC-Speicherfehler oder nicht korrigierbare ECC-Fehler meldet. Ein fehlerhaftes DIMM kann verhindern, dass das Speichersystem ONTAP startet, daher stellt der Austausch den stabilen Betrieb wieder her.
