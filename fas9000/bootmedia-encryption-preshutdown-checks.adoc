...
summary: Bevor der Status des betroffenen Controllers überprüft, die automatische Rückgabe deaktiviert und die auf dem System ausgeführte ONTAP-Version geprüft wird, sollten der betroffene Controller heruntergefahren und der Status der integrierten Verschlüsselungsschlüssel kontrolliert werden. Das FAS9000 System unterstützt ausschließlich manuelle Bootmedien-Wiederherstellungsverfahren. 
---
= Die Verschlüsselungsunterstützung auf dem Bootmedium in einem FAS9000 System prüfen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um die Datensicherheit auf Ihrem Speichersystem zu gewährleisten, sollten die Unterstützung und der Status des Verschlüsselungsschlüssels auf Ihrem Boot-Medium überprüft werden. Es sollte geprüft werden, ob Ihre ONTAP Version NetApp Volume Encryption (NVE) unterstützt, und vor dem Herunterfahren des Controllers sollte überprüft werden, ob der Key Manager aktiv ist. Das FAS9000 System unterstützt nur manuelle Boot-Medium-Wiederherstellungsverfahren.
