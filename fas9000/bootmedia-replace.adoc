...
summary: Das Bootmedium in einem FAS9000 System wird ersetzt, indem das defekte Controller-Modul entfernt, das Ersatz-Bootmedium installiert und das Boot-Image auf einen USB-Stick übertragen wird. 
---
= Das Bootmedium in einem FAS9000-System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Bootmedium in einem FAS9000 System wird ersetzt, indem das defekte Controllermodul entfernt, das Ersatz-Bootmedium installiert und das Boot-Image auf ein USB-Flash-Laufwerk übertragen wird. Das FAS9000 System unterstützt nur die manuelle Wiederherstellung des Bootmediums, eine automatisierte Wiederherstellung des Bootmediums wird nicht unterstützt.
