...
summary: Das Chassis in einem FAS9000-System wird ersetzt, indem die Lüfter, Festplatten und das oder die Controller-Module aus dem defekten Chassis in ein neues Chassis desselben Modells umgebaut werden. Anschließend erfolgt der Austausch des defekten Chassis aus dem Geräteschrank oder Systemschrank. 
---
= Das Chassis in einem FAS9000 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Chassis in einem FAS9000-System wird ersetzt, indem die Lüfter, Festplatten und das oder die Controller-Module aus dem defekten Chassis in ein neues Chassis desselben Modells umgebaut werden. Anschließend erfolgt der Austausch des defekten Chassis aus dem Geräteschrank oder Systemschrank.
...
+
image::../media/drw_9000_remove_install_psu_module.gif[Entfernen des Netzteils (PSU)]
...
+
image::../media/drw_9000_remove_install_fan.png[Entfernen Sie die Lüfter]
...
.Schritte
Um I/O-Module aus dem alten Chassis, einschließlich der NVRAM-Module, zu entfernen, befolgen Sie die spezifischen Abfolge von Schritten. Sie müssen das Flash Cache Modul nicht aus dem NVRAM Modul entfernen, wenn Sie es in ein neues Gehäuse verschieben.
...
+
image::../media/drw_9000_remove_pcie_module.png[Entfernen Sie ein PCIe-Modul]
...
+
image::../media/drw_9000_remove_nv_battery.png[Entfernen Sie die NV-Batterie]
...
.Schritte
Um I/O-Module, einschließlich der NVRAM/Flash Cache Module aus dem alten Chassis zu installieren, folgen Sie den spezifischen Schritten.
