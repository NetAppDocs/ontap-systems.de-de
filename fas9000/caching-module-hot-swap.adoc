...
summary: Im laufenden Betrieb kann das Caching-Modul in einem FAS9000 System ausgetauscht werden. Ab ONTAP 9.4 kann das NVMe SSD Flash Cache Modul, das sich vor dem NVRAM10 Modul in Steckplatz 6 befindet, im laufenden Betrieb gegen ein Caching-Modul gleicher Kapazität vom selben oder einem anderen unterstützten Hersteller ausgetauscht werden. 
---
= Hot-Swap eines Caching-Moduls in einem FAS9000 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Im laufenden Betrieb kann das Caching-Modul in einem FAS9000 System ausgetauscht werden. Ab ONTAP 9.4 kann das NVMe SSD Flash Cache Modul, das sich vor dem NVRAM10 Modul in Steckplatz 6 befindet, im laufenden Betrieb gegen ein Caching-Modul gleicher Kapazität vom selben oder einem anderen unterstützten Hersteller ausgetauscht werden.
