...
summary: Die Hardware des Controllermoduls in einem FAS9000-System ersetzen. Dieses Verfahren umfasst die Entfernung des defekten Node, das Umsetzen der FRU-Komponenten in das Ersatz-Controllermodul, den Einbau des Ersatz-Controllermoduls in das Gehäuse und das Booten des Systems im Wartungsmodus. 
---
= Den Controller in einem FAS9000 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Hardware des Controllermoduls in einem FAS9000-System ersetzen. Dieses Verfahren umfasst die Entfernung des defekten Node, das Umsetzen der FRU-Komponenten in das Ersatz-Controllermodul, den Einbau des Ersatz-Controllermoduls in das Gehäuse und das Booten des Systems im Wartungsmodus.
