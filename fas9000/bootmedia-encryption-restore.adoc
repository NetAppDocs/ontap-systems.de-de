...
summary: 'Sobald die Umgebungsvariablen überprüft sind, müssen Sie Schritte durchführen, die speziell für Systeme gelten, bei denen Onboard Key Manager (OKM), NetApp Storage Encryption (NSE) oder NetApp Volume Encryption (NVE) aktiviert ist. Das FAS9000 System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien.' 
---
= Wiederherstellung der Verschlüsselung – FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Verschlüsselung auf dem Ersatz-Bootmedium wiederherstellen. Das FAS9000 System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. Die automatische Wiederherstellung über Bootmedien wird nicht unterstützt.
