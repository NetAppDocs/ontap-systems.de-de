...
summary: 'Nachdem die Umgebungsvariablen geprüft wurden, müssen Sie die spezifischen Schritte für Systeme mit Onboard Key Manager (OKM), NetApp Storage Encryption (NSE) oder NetApp Volume Encryption (NVE) durchführen. Das FAS9000 System unterstützt ausschließlich manuelle Bootmedien-Wiederherstellungsverfahren.' 
---
= Stellen Sie die Verschlüsselung auf dem Bootmedium in einem FAS9000 System wieder her
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Verschlüsselung auf dem Ersatz-Bootmedium in Ihrem FAS9000 System kann wiederhergestellt werden, indem die Schritte für den jeweiligen Schlüsselmanager-Typ, wie zum Beispiel den Onboard Key Manager (OKM), abgeschlossen werden. Das FAS9000 System unterstützt ausschließlich manuelle Bootmedien-Wiederherstellungsverfahren.
