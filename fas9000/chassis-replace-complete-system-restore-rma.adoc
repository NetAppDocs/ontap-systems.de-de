...
summary: Den Chassis-Austausch in einem FAS9000-System schließen Sie ab, indem der HA-Status des Chassis überprüft und das defekte Teil an NetApp zurückgesendet wird, wie in den mit dem Kit gelieferten RMA-Anweisungen beschrieben. 
---
= Den Chassis-Austausch für ein FAS9000 System abschließen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Den Chassis-Austausch in einem FAS9000-System schließen Sie ab, indem der HA-Status des Chassis überprüft und das defekte Teil an NetApp zurückgesendet wird, wie in den mit dem Kit gelieferten RMA-Anweisungen beschrieben.
...
+
Der Wert für `HA-state` Kann einer der folgenden sein:
