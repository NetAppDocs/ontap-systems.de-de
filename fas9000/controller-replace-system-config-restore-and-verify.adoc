...
summary: Nach Abschluss des Hardwareaustauschs der Steuerung und dem Hochfahren in den Wartungsmodus in einem FAS9000-System sollte die Systemkonfiguration auf niedriger Ebene der Ersatzsteuerung überprüft und die Systemeinstellungen bei Bedarf neu konfiguriert werden. 
---
= Wiederherstellung und Überprüfung der Controller-Konfiguration in einem FAS9000-System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss des Hardwareaustauschs der Steuerung und dem Hochfahren in den Wartungsmodus in einem FAS9000-System sollte die Systemkonfiguration auf niedriger Ebene der Ersatzsteuerung überprüft und die Systemeinstellungen bei Bedarf neu konfiguriert werden.
