...
---
= Das System kann neu zugewiesen werden und Festplatten können neu zugewiesen werden – AFF A700 und FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
http://["Finden Sie den Hochverfügbarkeits-Leitfaden für Ihre Version von ONTAP 9"]
...
+
https://["Änderungen am Festplattenbesitz während HA Takeover und MetroCluster Switchover in einer MetroCluster Konfiguration mit vier Nodes"]
