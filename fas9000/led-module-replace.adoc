...
summary: Ein LED-USB-Modul in einem FAS9000-System kann ausgetauscht werden, ohne den Betrieb zu unterbrechen. Das Modul stellt die Verbindung zu den Konsolenports und zum Systemstatus her und kann ohne Werkzeuge ersetzt werden. 
---
= Ein LED-USB-Modul im laufenden Betrieb in einem FAS9000 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein LED-USB-Modul in einem FAS9000-System kann ausgetauscht werden, ohne den Betrieb zu unterbrechen. Das Modul stellt die Verbindung zu den Konsolenports und zum Systemstatus her und kann ohne Werkzeuge ersetzt werden.
