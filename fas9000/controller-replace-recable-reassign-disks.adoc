...
summary: Die Verkabelung des Speichers muss wiederhergestellt und die Festplattenzuordnung auf einem FAS9000 System bestätigt werden, damit der Ersatzcontroller den normalen Betrieb wieder aufnehmen kann. 
---
= Der Controller in einem FAS9000 System wird zurückgegeben, damit der normale Betrieb fortgesetzt werden kann.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Verkabelung des Speichers muss wiederhergestellt und die Festplattenzuordnung auf einem FAS9000 System bestätigt werden, damit der Ersatzcontroller den normalen Betrieb wieder aufnehmen kann.
...
Das von Ihnen verwendete Verfahren hängt von der Redundanzkonfiguration Ihres Controllers ab.

[role="tabbed-block"]
====
.Option 1: HA-Paar
--
=== Überprüfen Sie die Änderung der System-ID auf einem HA-System
...
--
.Option 2: MetroCluster mit zwei Knoten
--
=== Manuelle Neuzuweisung der System-ID auf Systemen in einer MetroCluster -Konfiguration mit zwei Knoten
