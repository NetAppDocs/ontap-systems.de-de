...
---
= Ein FAS9000 Speichersystem mit detaillierten Schritten installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Diese detaillierte Schritt-für-Schritt-Anleitung führt Sie durch die Installation Ihres FAS9000 Systems, von der Montage und Verkabelung bis zur Ersteinrichtung. Diese Schritte bieten eine ausführlichere Installationsanleitung als die Kurzanleitung.
...
Sie können Ihr neues System an DS212C, DS224C oder NS224 Shelves anschließen, je nachdem, ob es sich um ein AFF oder FAS System handelt.
...
Jeder Controller ist mit den NSM-Modulen auf dem NS224-Laufwerksshelf eines AFF A700 oder ASA AFF A700 Systems zu verkabeln, das mit ONTAP 9.8 oder höher betrieben wird.

* Dieser Vorgang gilt nur für ASA AFF A700 mit ONTAP 9.8 oder höher.
* Die Systeme müssen mindestens ein X91148A-Modul in Steckplatz 3 oder 7 für jeden Controller installiert haben. Die Animation oder die Abbildungen zeigen dieses Modul in beiden Steckplätzen 3 und 7.
...
Jeder Controller ist mit den NSM-Modulen auf den NS224-Laufwerksgehäusen eines AFF A700 oder ASA AFF A700 Systems zu verkabeln, das unter ONTAP 9.8 oder höher läuft.
...
+
Wenn Ihr System über NS224-Laufwerksschächte verfügt, sind diese standardmäßig auf die Schacht-IDs 00 und 01 voreingestellt. Wenn die Schacht-IDs geändert werden sollen, ist ein Werkzeug anzufertigen, das in die Öffnung eingeführt wird, in der sich der Knopf befindet.
...
.. Im linken Bereich *Netzwerk* auswählen, mit der rechten Maustaste auf *Netzwerk* klicken und anschließend *Aktualisieren* auswählen.
.. Doppelklicken Sie auf das ONTAP-Symbol, und akzeptieren Sie alle auf dem Bildschirm angezeigten Zertifikate.
+

NOTE: Der angezeigte Wert ist die Systemseriennummer des Zielknotens.
