...
summary: Ein defektes NVRAM-Modul oder die DIMMs im NVRAM-Modul in einem FAS9000 System ersetzen. Da die System-ID vom NVRAM-Modul abgeleitet wird, führt der Austausch des Moduls dazu, dass die zum System gehörenden Festplatten der neuen System-ID zugewiesen werden. 
---
= Das NVRAM Modul oder die NVRAM DIMMs in einem FAS9000 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes NVRAM-Modul oder die DIMMs im NVRAM-Modul in einem FAS9000 System ersetzen. Da die System-ID vom NVRAM-Modul abgeleitet wird, führt der Austausch des Moduls dazu, dass die zum System gehörenden Festplatten der neuen System-ID zugewiesen werden.
