...
summary: Um den Austauschvorgang abzuschließen und Ihr System wieder voll funktionsfähig zu machen, müssen Sie den Speicher neu verkabeln, die NetApp Storage Encryption-Konfiguration gegebenenfalls wiederherstellen und Lizenzen für den neuen Controller installieren. 
---
= Den Controller-Austausch für ein FAS9000 System abschließen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um den Controller-Austausch für Ihr FAS9000 System abzuschließen, den Speicher neu verkabeln, die NetApp Storage Encryption Konfiguration gegebenenfalls wiederherstellen und Lizenzen für den neuen Controller installieren.
...
== Schritt 3 (MetroCluster nur): Aggregate in einer Zwei-Knoten MetroCluster Konfiguration zurückwechseln
