...
summary: Der beeinträchtigte Controller in einem FAS9000 System wird gemäß der für die jeweilige Konfiguration geeigneten Vorgehensweise heruntergefahren oder übernommen, sodass der intakte Node weiterhin Daten aus dem Speicher des beeinträchtigten Node bereitstellt. 
---
= Vor dem Austausch muss der defekte Controller in einem FAS9000-System abgeschaltet werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Den beeinträchtigten Controller in einem FAS9000-System mithilfe des für die jeweilige Konfiguration geeigneten Verfahrens herunterfahren oder übernehmen.
