...
summary: Das Lüftermodul in einem FAS9000 System kann unterbrechungsfrei ausgetauscht werden. Das Lüftermodul muss innerhalb von zwei Minuten nach der Entfernung ersetzt werden, um eine Beeinträchtigung des Luftstroms im System zu vermeiden. 
---
= Ein Lüftermodul im laufenden Betrieb in einem FAS9000 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Lüftermodul in einem FAS9000 System kann unterbrechungsfrei ausgetauscht werden. Das Lüftermodul muss innerhalb von zwei Minuten nach der Entfernung ersetzt werden, um eine Beeinträchtigung des Luftstroms im System zu vermeiden.
