...
---
= Die FAS9000 Controller werden heruntergefahren, um das Chassis auszutauschen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bevor Sie das Chassis austauschen können, müssen Sie den defekten Controller in Ihrem FAS9000 System herunterfahren.
