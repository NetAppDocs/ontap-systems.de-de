...
summary: Ein ausgefallenes DCPM-Modul in einem FAS9000-System ersetzen. Das Modul muss innerhalb von fünf Minuten nach der Entfernung im Chassis ersetzt werden, da sich sonst der zugehörige Controller abschaltet. 
---
= Das DCPM-Modul in einem FAS9000 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein ausgefallenes DCPM-Modul in einem FAS9000-System ersetzen. Das Modul muss innerhalb von fünf Minuten nach der Entfernung im Chassis ersetzt werden, da sich sonst der zugehörige Controller abschaltet.
