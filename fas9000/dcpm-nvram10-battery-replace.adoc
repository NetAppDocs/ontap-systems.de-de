...
summary: 'Um ein De-Stage-Controller-Leistungsmodul (DCPM), das die NVRAM10-Batterie enthält, im Hot-Swap-Verfahren auszutauschen, müssen Sie das defekte DCPM-Modul lokalisieren, es aus dem Gehäuse ausbauen und das Ersatz-DCPM-Modul einbauen.' 
---
= Ein DCPM-Modul im laufenden Betrieb in Ihrem FAS9000 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
