...
summary: 'Das De-Stage-Controller-Power-Modul (DCPM), das die NVRAM10-Batterie enthält, kann in einem FAS9000 System unterbrechungsfrei ausgetauscht werden.' 
---
= Ein DCPM-Modul im laufenden Betrieb in einem FAS9000 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das De-Stage-Controller-Power-Modul (DCPM), das die NVRAM10-Batterie enthält, kann in einem FAS9000 System unterbrechungsfrei ausgetauscht werden.
