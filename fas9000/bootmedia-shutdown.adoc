...
summary: Der Controller im FAS9000 Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität während des manuellen Bootmedien-Wiederherstellungsprozesses zu gewährleisten. 
---
= Den Controller in einem FAS9000-System während des manuellen Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller im FAS9000 Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität während des manuellen Bootmedien-Wiederherstellungsprozesses zu gewährleisten.
...
Nach Abschluss der NVE- oder NSE-Aufgaben wird der Knoten heruntergefahren. HINWEIS: Dieses Verfahren ist nicht anzuwenden, wenn das System in einer Zwei-Knoten MetroCluster Konfiguration betrieben wird.
...
Nach Abschluss der NVE- oder NSE-Aufgaben den Knoten herunterfahren.
