...
summary: Die Echtzeit-Uhr-Batterie im Controller-Modul eines FAS9000-Systems wird ersetzt, damit Dienste und Anwendungen, die auf eine genaue Zeitsynchronisierung angewiesen sind, weiterhin funktionieren. 
---
= Die Echtzeit-Uhr-Batterie in einem FAS9000 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Echtzeitbatterie (RTC) im Controller-Modul eines FAS9000-Systems wird ersetzt, damit Dienste und Anwendungen, die auf eine genaue Zeitsynchronisierung angewiesen sind, weiterhin funktionieren.
