...
summary: Installieren Sie nach der Vorbereitung auf die Installation Ihres FAS50-Speichersystems die Hardware für das Speichersystem. Installieren Sie zunächst die Schienensätze. Installieren und sichern Sie dann Ihr Speichersystem in einem Schrank oder einem Telco-Rack. 
---
= Die FAS50 Hardware in einem Schrank oder Rack installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
