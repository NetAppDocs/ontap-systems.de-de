...
---
= Informationen zur Wartung eines FAS50 Storage-Systems
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:caching-module-hot-swap.html["Caching-Modul"]
 a| 
Ein Caching-Modul (Flash Cache Modul) nutzt Hochgeschwindigkeits-SSDs, um häufig abgerufene Daten für einen schnelleren Abruf zu speichern.
