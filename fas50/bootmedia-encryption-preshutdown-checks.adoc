...
summary: 'Um die Datensicherheit auf Ihrem FAS50-Speichersystem zu gewährleisten, müssen Sie die Unterstützung und den Status der Verschlüsselungsschlüssel auf Ihren Boot-Medien überprüfen. Überprüfen Sie, ob Ihre ONTAP Version NetApp Volume Encryption (NVE) unterstützt und bevor Sie den Controller herunterfahren, ob der Schlüsselmanager aktiv ist.' 
---
= Überprüfung der Verschlüsselungsunterstützung auf dem Bootmedium in einem FAS50 System mithilfe des manuellen Boot-Wiederherstellungsprozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um die Datensicherheit auf Ihrem FAS50-Speichersystem zu gewährleisten, ist die Unterstützung und der Status des Verschlüsselungsschlüssels auf Ihrem Boot-Medium zu überprüfen. Es sollte geprüft werden, ob Ihre ONTAP Version NetApp Volume Encryption (NVE) unterstützt, und vor dem Herunterfahren des Controllers ist zu prüfen, ob der Schlüsselmanager aktiv ist.
