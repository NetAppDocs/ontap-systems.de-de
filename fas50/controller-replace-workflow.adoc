...
---
= Ablauf für den Austausch des FAS50 Controllers
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Der Austausch des Controllers umfasst das Entfernen des defekten Controllers, das Umsetzen der FRU-Komponenten auf den Ersatzcontroller, den Einbau des Ersatzcontrollers, das Einstellen von Uhrzeit und Datum sowie das Neuverkabeln.
