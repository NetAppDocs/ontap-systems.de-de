...
summary: Bereiten Sie die Installation Ihres FAS50-Speichersystems vor, indem Sie den Standort vorbereiten, die Kartons auspacken, den Inhalt der Kartons mit dem Packzettel vergleichen und das Speichersystem registrieren, um auf die Supportvorteile zugreifen zu können. 
---
= Vorbereitung der Installation eines FAS50 Storage-Systems
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bereiten Sie die Installation Ihres FAS50-Speichersystems vor, indem Sie den Standort vorbereiten, die Kartons auspacken, den Inhalt der Kartons mit dem Packzettel vergleichen und das Speichersystem registrieren, um auf die Supportvorteile zugreifen zu können.
