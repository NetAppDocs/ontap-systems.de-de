...
summary: Fahren Sie den außer Betrieb genommenen Controller in Ihrem FAS50-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch der Startmedien sicherzustellen. 
---
= Fahren Sie den Controller herunter, um die Boot-Medien - FAS50 - auszutauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den außer Betrieb genommenen Controller in Ihrem FAS50-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch der Startmedien sicherzustellen.
