...
summary: Bevor das Chassis Ihres FAS50 Storage-Systems ersetzt wird, sollte überprüft werden, ob alle notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sind. Dazu zählt die Überprüfung, dass alle anderen Komponenten im System ordnungsgemäß funktionieren und dass das korrekte Ersatzchassis sowie die erforderlichen Werkzeuge vorhanden sind. 
---
= Die Anforderungen für den Austausch eines Chassis in einem FAS50 System werden im Folgenden dargestellt.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bevor das Chassis Ihres FAS50 Storage-Systems ersetzt wird, sollte überprüft werden, ob alle notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sind. Dazu zählt die Überprüfung, dass alle anderen Komponenten im System ordnungsgemäß funktionieren und dass das korrekte Ersatzchassis sowie die erforderlichen Werkzeuge vorhanden sind.
