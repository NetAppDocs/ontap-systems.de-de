...
summary: 'Tauschen Sie das Chassis Ihres FAS50 Storage-Systems aus, wenn dies bei einem Hardwareausfall erforderlich ist. Beim Austausch werden die Controller und Netzteile (PSUs) entfernt, Caching-Module entfernt, das Ersatzgehäuse installiert und die Gehäusekomponenten neu installiert.' 
---
