...
summary: 'Tauschen Sie das Gehäuse Ihres FAS50-Systems aus, wenn dies bei einem Hardwareausfall erforderlich ist. Beim Austausch werden die Controller und Netzteile (PSUs) entfernt, Caching-Module entfernt, das Ersatzgehäuse installiert und die Gehäusekomponenten neu installiert.' 
---
...
[role="lead"]
Tauschen Sie das Gehäuse Ihres FAS50-Systems aus, wenn dies bei einem Hardwareausfall erforderlich ist. Beim Austausch werden die Controller und Netzteile (PSUs) entfernt, Caching-Module entfernt, das Ersatzgehäuse installiert und die Gehäusekomponenten neu installiert.
