...
[role="lead"]
Das Bootmedium in Ihrem FAS50-System speichert wichtige Firmware- und Konfigurationsdaten. Der Austauschvorgang umfasst das Entfernen des Controllermoduls, das Entfernen des beschädigten Bootmediums, die Installation des Ersatz-Bootmediums und die manuelle Übertragung des ONTAP Images mithilfe eines USB-Sticks auf das Ersatz-Bootmedium.
