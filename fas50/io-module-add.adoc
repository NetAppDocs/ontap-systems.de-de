...
summary: Erweitern Sie Ihr FAS50 Storage-System um ein I/O-Modul, um die Netzwerkkonnektivität zu verbessern und die Fähigkeit Ihres Systems, den Datenverkehr zu bewältigen. 
---
= Ein E/A-Modul zu einem FAS50 System hinzufügen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
