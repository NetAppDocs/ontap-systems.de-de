...
[role="lead"]
Fügen Sie Ihrem FAS50-System ein I/O-Modul hinzu, um die Netzwerkkonnektivität zu verbessern und die Fähigkeit Ihres Systems zu erweitern, den Datenverkehr zu bewältigen.

Sie können Ihren FAS50 Storage-Systemen ein I/O-Modul hinzufügen, wenn freie Steckplätze vorhanden sind oder wenn alle Steckplätze vollständig belegt sind.
