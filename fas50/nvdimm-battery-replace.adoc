...
[role="lead"]
Ersetzen Sie die NV-Batterie in Ihrem FAS50-Speichersystem, wenn die Batterie an Ladung verliert oder ausfällt, da sie für die Erhaltung kritischer Systemdaten bei Stromausfällen verantwortlich ist.  Der Austauschvorgang umfasst das Herunterfahren des beschädigten Controllers, das Entfernen des Controllermoduls, das Ersetzen der NV-Batterie, das Neuinstallieren des Controllermoduls und die Rücksendung des defekten Teils an NetApp.
