...
---
= Wichtigste Spezifikationen für ein FAS50 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Diese Spezifikationen für das FAS50 beziehen sich auf ein einzelnes Hochverfügbarkeitspaar. Besuchen Sie  https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) für eine vollständige Liste der FAS50-Spezifikationen.
