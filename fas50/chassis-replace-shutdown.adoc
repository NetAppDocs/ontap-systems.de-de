...
summary: Fahren Sie die Controller in Ihrem FAS50 Storage-System herunter, um Datenverlust zu vermeiden und beim Austausch des Chassis für Systemstabilität zu sorgen. 
---
= Die FAS50 Controller werden heruntergefahren, um das Chassis auszutauschen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie die Controller in Ihrem FAS50 Storage-System herunter, um Datenverlust zu vermeiden und beim Austausch des Chassis für Systemstabilität zu sorgen.
