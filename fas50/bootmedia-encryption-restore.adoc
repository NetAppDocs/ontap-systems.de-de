...
summary: Stellen Sie die Verschlüsselung auf dem Ersatz-Bootmedium in Ihrem FAS50-Speichersystem wieder her, um den Datenschutz kontinuierlich zu gewährleisten. Der Austauschprozess umfasst die Überprüfung der Schlüsselverfügbarkeit, die erneute Anwendung der Verschlüsselungseinstellungen und die Bestätigung des sicheren Zugriffs auf Ihre Daten. 
---
= Die Verschlüsselung auf dem Bootmedium eines FAS50 Systems mithilfe des manuellen Boot-Wiederherstellungsprozesses wiederherstellen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Stellen Sie die Verschlüsselung auf dem Ersatz-Bootmedium in Ihrem FAS50-Speichersystem wieder her, um den Datenschutz kontinuierlich zu gewährleisten. Der Austauschprozess umfasst die Überprüfung der Schlüsselverfügbarkeit, die erneute Anwendung der Verschlüsselungseinstellungen und die Bestätigung des sicheren Zugriffs auf Ihre Daten.
