...
summary: Das Cluster- und HA-E/A-Modul unterstützt Interconnects für Clustering und Hochverfügbarkeit. Sie können das Modul in Ihrem FAS50-Speichersystem im laufenden Betrieb austauschen, wenn es ausfällt und Ihr Speichersystem bestimmte Anforderungen erfüllt. 
---
