...
summary: Das DIMM in Ihrem FAS50-Speichersystem ist auszutauschen, wenn zu viele korrigierbare oder nicht korrigierbare Speicherfehler festgestellt werden. Solche Fehler können verhindern, dass das Speichersystem ONTAP startet. Der Austauschvorgang umfasst das Herunterfahren des betroffenen Controllers, dessen Ausbau, den Austausch des DIMM, den Wiedereinbau des Controllers und anschließend die Rücksendung des defekten Bauteils an NetApp. 
---
= Ein DIMM in einem FAS50 System ersetzen, um Speicherfehler zu beheben
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das DIMM in Ihrem FAS50-Speichersystem ist auszutauschen, wenn zu viele korrigierbare oder nicht korrigierbare Speicherfehler festgestellt werden. Solche Fehler können verhindern, dass das Speichersystem ONTAP startet. Der Austauschvorgang umfasst das Herunterfahren des betroffenen Controllers, dessen Ausbau, den Austausch des DIMM, den Wiedereinbau des Controllers und anschließend die Rücksendung des defekten Bauteils an NetApp.
