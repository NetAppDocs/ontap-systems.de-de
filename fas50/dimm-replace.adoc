...
summary: Ersetzen Sie ein DIMM in Ihrem FAS50-Speichersystem, wenn zu viele korrigierbare oder nicht korrigierbare Speicherfehler erkannt werden.  Solche Fehler können verhindern, dass das Speichersystem ONTAP bootet.  Der Austauschvorgang umfasst das Herunterfahren des beschädigten Controllers, dessen Entfernung, den Austausch des DIMM, die Neuinstallation des Controllers und die anschließende Rücksendung des defekten Teils an NetApp. 
---
= Ein DIMM in Ihrem FAS50 System wird ersetzt, um Speicherfehler zu beheben.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ersetzen Sie ein DIMM in Ihrem FAS50-Speichersystem, wenn zu viele korrigierbare oder nicht korrigierbare Speicherfehler erkannt werden.  Solche Fehler können verhindern, dass das Speichersystem ONTAP bootet.  Der Austauschvorgang umfasst das Herunterfahren des beschädigten Controllers, dessen Entfernung, den Austausch des DIMM, die Neuinstallation des Controllers und die anschließende Rücksendung des defekten Teils an NetApp.
