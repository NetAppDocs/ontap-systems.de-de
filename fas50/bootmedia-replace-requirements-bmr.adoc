...
summary: 'Vor dem Austausch des Bootmediums in Ihrem FAS50-Speichersystem sollte sichergestellt sein, dass die notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sind. Dazu zählt die Überprüfung, ob das korrekte Ersatz-Bootmedium vorhanden ist, ob der e0M (Schraubenschlüssel) Port am betroffenen Controller ordnungsgemäß funktioniert und ob Onboard Key Manager (OKM) oder External Key Manager (EKM) aktiviert ist.' 
---
= Die Anforderungen für die automatisierte Wiederherstellung von Bootmedien in einem FAS50 System werden dargestellt.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vor dem Austausch des Bootmediums in Ihrem FAS50-Speichersystem sollte sichergestellt sein, dass die notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sind. Dazu zählt die Überprüfung, ob das korrekte Ersatz-Bootmedium vorhanden ist, ob der e0M (Schraubenschlüssel) Port am betroffenen Controller ordnungsgemäß funktioniert und ob Onboard Key Manager (OKM) oder External Key Manager (EKM) aktiviert ist.
