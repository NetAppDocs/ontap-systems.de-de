...
summary: 'Ersetzen Sie ein AC- oder DC-Netzteil (PSU) in Ihrem FAS50-System, wenn es ausfällt oder fehlerhaft wird, und stellen Sie sicher, dass Ihr System weiterhin die erforderliche Stromversorgung erhält, um einen stabilen Betrieb zu gewährleisten. Beim Austausch wird das fehlerhafte Netzteil von der Stromquelle getrennt, das Netzkabel abgezogen, das fehlerhafte Netzteil ersetzt und dann wieder an die Stromquelle angeschlossen.' 
---
...
[role="lead"]
Ersetzen Sie ein AC- oder DC-Netzteil (PSU) in Ihrem FAS50-System, wenn es ausfällt oder fehlerhaft wird, und stellen Sie sicher, dass Ihr System weiterhin die erforderliche Stromversorgung erhält, um einen stabilen Betrieb zu gewährleisten. Beim Austausch wird das fehlerhafte Netzteil von der Stromquelle getrennt, das Netzkabel abgezogen, das fehlerhafte Netzteil ersetzt und dann wieder an die Stromquelle angeschlossen.
