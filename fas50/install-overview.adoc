...
---
= FAS50 Installation und Konfiguration Workflow
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Zur Vorbereitung der Installation wird der Standort vorbereitet, die Umgebungs- und Stromanforderungen werden überprüft und es wird sichergestellt, dass ausreichend Rackplatz vorhanden ist. Anschließend werden die Geräte entpackt, der Inhalt mit dem Lieferschein verglichen und die Hardware registriert, um Zugang zu Supportleistungen zu erhalten.
