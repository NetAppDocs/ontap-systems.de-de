...
summary: Der Controller im FAS50-Speichersystem wird heruntergefahren, um Datenverlust zu vermeiden und die Systemstabilität während des automatisierten Bootmedien-Wiederherstellungsprozesses zu gewährleisten. 
---
= Den Controller in Ihrem FAS50 System während des automatisierten Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller im FAS50-Speichersystem wird heruntergefahren, um Datenverlust zu vermeiden und die Systemstabilität während des automatisierten Bootmedien-Wiederherstellungsprozesses zu gewährleisten.
