...
---
= Wählen Sie aus, wie Ihr ASA A150 Speichersystem installiert wird.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Wählen Sie Ihr bevorzugtes Format für die Installation Ihres ASA A150 Storage Systems: detaillierte Schritt-für-Schritt-Anleitung, grafische Kurzanleitung oder Videoanleitung.

* link:../asa150/install-quick-guide.html["Schnelle Schritte"]
+
Eine druckbare PDF-Datei mit Schritt-für-Schritt-Anweisungen mit Live-Links zu zusätzlichen Inhalten.

* link:../asa150/install-videos.html["Videoschritte"]
+
Video Schritt-für-Schritt-Anleitungen.

* link:../asa150/install-detailed-guide.html["Detaillierte Schritte"]
+
