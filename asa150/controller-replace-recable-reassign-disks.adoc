...
summary: Übergeben Sie die Kontrolle über die Speicherressourcen wieder an den Ersatzcontroller, damit Ihr ASA A150 System den normalen Betrieb wieder aufnehmen kann. 
---
= Den Controller in einem ASA A150 System zurückgeben, damit der normale Betrieb fortgesetzt werden kann.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
