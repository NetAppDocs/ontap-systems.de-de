...
summary: Um Ihr System wieder voll funktionsfähig zu machen, müssen Sie die NetApp Storage Encryption-Konfiguration wiederherstellen, Lizenzen für den neuen Controller installieren und das defekte Teil an NetApp zurücksenden. 
---
= Den Controller-Austausch für ein ASA A150 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
