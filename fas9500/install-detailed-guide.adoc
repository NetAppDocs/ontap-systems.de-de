...
sidebar: sidebar 
keywords: FAS9500 
summary: Diese Seite enthält eine detaillierte Schritt-für-Schritt-Anleitung zur Installation Ihres FAS9500 Systems. 
---
= Ein FAS9500 Speichersystem mithilfe detaillierter Anweisungen installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Diese Seite enthält eine detaillierte Schritt-für-Schritt-Anleitung zur Installation Ihres FAS9500 Systems. Diese Anleitung ist zu verwenden, wenn detailliertere Installationsanweisungen gewünscht werden.
...
X66033A (112-00438), 3 m
 a| 
image::../media/oie_cable_mini_sas_hd_to_mini_sas_hd.png[Mini-SAS-Anschluss]
 a| 
Storage
...
Die Host-seitigen b-Ports in Slot A4 und B4 (e4b) sowie in Slot A8 und B8 (e8b) werden mit dem Host-Switch verbunden.
...
** Die Stromkabel werden an die Netzteile angeschlossen und mit verschiedenen Stromquellen verbunden (nicht abgebildet). PSU1 und PSU3 versorgen alle Komponenten auf Seite A mit Strom, während PSU2 und PSU4 alle Komponenten auf Seite B mit Strom versorgen.
...
* Achten Sie auf den Pfeil in der Abbildung, um die korrekte Ausrichtung der Zuglaschen am Kabelanschluss zu überprüfen. Die Zuglaschen am Kabel der Speichermodule zeigen nach oben, während die Zuglaschen an den Shelves nach unten zeigen.
...
.Schritte
. Verwenden Sie die folgende Animation oder die Zeichnungen, um Ihre Controller mit drei DS224C-Laufwerksshelfs zu verkabeln (ein Stapel mit einem Laufwerksshelf und ein Stapel mit zwei Laufwerksshelfs).
+
...
+
image::../media/drw_a900_power-on_IEOPS-941.svg[Schalten Sie das System ein]
