...
summary: Tauschen Sie die Echtzeituhr-Batterie im Controllermodul aus. 
---
= Die Echtzeit-Batterie der Echtzeituhr in Ihrem FAS9500 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nach dem Austausch der RTC-Batterie muss das Steuermodul wieder eingebaut werden. Wenn die RTC-Batterie länger als 10 Minuten aus dem Steuermodul entfernt war, müssen Datum und Uhrzeit möglicherweise neu eingestellt werden.
