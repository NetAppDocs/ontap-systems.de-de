...
---
= Wichtigste Spezifikationen für ein FAS9500 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ausgewählte Spezifikationen für das FAS9500 Storage System in einem einzelnen Hochverfügbarkeitspaar (HA) sowie eine vollständige Liste der FAS9500 Spezifikationen sind unter  https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) verfügbar.
...
* Betriebstemperatur/Höhe/Luftfeuchtigkeit: 10 °C bis 35 °C (50 °F bis 95 °F) bis zu einer Höhe von 3048 m (10000 ft); 8 % bis 90 % relative Luftfeuchtigkeit, nicht kondensierend
...
* Akustische Geräusche: Angegebene Schallleistung (LwAd): 7,4; Schalldruck (LpAm) (Positionen von Umstehenden): 65,0 dB
