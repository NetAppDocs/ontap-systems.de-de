...
+
image::../media/drw_autodiscovery_controler_select_ieops-1849.svg[drw AutoDiscovery Controller wählen ieops 1849]

+
.. Öffnen Sie Den Datei-Explorer.
.. Klicken Sie im linken Fensterbereich auf Netzwerk, klicken Sie mit der rechten Maustaste, und wählen Sie Aktualisieren aus.
