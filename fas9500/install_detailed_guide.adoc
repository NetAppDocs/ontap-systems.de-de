...
Sie müssen Zugriff auf die haben https://["NetApp Hardware Universe"^] Weitere Informationen zu Standortanforderungen sowie zusätzliche Informationen zu Ihrem konfigurierten System.

.Was Sie brauchen
Möglicherweise möchten Sie auch Zugriff auf den haben http://["Versionshinweise zu ONTAP 9"^] Für Ihre Version von ONTAP finden Sie weitere Informationen zu diesem System.
...
|===
. Überprüfen Sie die https://["ONTAP Konfigurationsleitfaden"^] Und sammeln Sie die in diesem Handbuch aufgeführten erforderlichen Informationen.
...
NOTE: Weitere Informationen zur SAS-Verkabelung und Arbeitsblätter finden Sie unter https://["SAS-Verkabelungsregeln, Arbeitsblätter und Beispiele – Regale mit IOM12-Modulen"^]

.Bevor Sie beginnen
* Füllen Sie das SAS-Verkabelungsarbeitsblatt für Ihr System aus. Siehe https://["SAS-Verkabelungsregeln, Arbeitsblätter und Beispiele – Regale mit IOM12-Modulen"^].
...
. Konfigurieren Sie das System mithilfe von System Manager geführten Setups anhand der Daten, die Sie im erfasst haben https://["ONTAP Konfigurationsleitfaden"^].
