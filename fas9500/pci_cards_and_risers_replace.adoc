...
---
= Austausch eines E/A-Moduls in einem FAS9500 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um ein E/A-Modul in Ihrem FAS9500 System auszutauschen, muss der betroffene Node heruntergefahren, das E/A-Modul entfernt und installiert und anschließend der Node neu gestartet werden.
