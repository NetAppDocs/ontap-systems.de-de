...
---
= Die Controller-Konfiguration in Ihrem FAS9500 System wird wiederhergestellt und überprüft.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss des Hardwareaustauschs wird die Systemkonfiguration auf niedriger Ebene des Ersatzcontrollers, einschließlich der Systemzeit und des HA-Status, überprüft und die Systemeinstellungen bei Bedarf neu konfiguriert.
