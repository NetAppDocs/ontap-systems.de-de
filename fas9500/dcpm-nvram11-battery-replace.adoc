...
sidebar: sidebar 
keywords: FAS9500 
summary: 'Um ein Destage-Controller-Leistungsmodul (DCPM), das die NVRAM11-Batterie enthält, per Hot-Swap auszutauschen, müssen Sie das defekte DCPM-Modul lokalisieren, es aus dem Gehäuse entfernen und das Ersatz-DCPM-Modul installieren.' 
---
= Ein DCPM-Modul im laufenden Betrieb in einem FAS9500-System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Sie müssen ein Ersatz-DCPM-Modul bereithalten, bevor Sie das defekte Modul aus dem Gehäuse entfernen. Es muss innerhalb von fünf Minuten nach der Entfernung ersetzt werden. Nach dem Entfernen des DCPM-Moduls aus dem Gehäuse besteht kein Abschaltschutz mehr für das Controller-Modul, dem das DCPM-Modul zugeordnet ist, außer dem Failover auf das andere Controller-Modul.
...
+
image::../media/drw_a900_remove_NV_battery.svg[Ersetzen Sie die NV-Batterie (DCPM)]
