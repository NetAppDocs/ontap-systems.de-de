...
---
= Einen Lüfter im laufenden Betrieb in Ihrem FAS9500 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um in Ihrem FAS9500 System ein Lüftermodul im laufenden Betrieb auszutauschen, muss eine bestimmte Abfolge von Schritten durchgeführt werden, ohne den Betrieb zu unterbrechen.


IMPORTANT: Es empfiehlt sich, das Lüftermodul innerhalb von zwei Minuten nach dem Ausbau aus dem Gehäuse zu ersetzen. Das System funktioniert weiterhin, aber ONTAP sendet Meldungen über das defekte Lüftermodul an die Konsole, bis das Lüftermodul ersetzt ist.
