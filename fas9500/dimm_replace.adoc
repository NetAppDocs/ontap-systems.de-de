...
summary: Das DIMM in einem FAS9500-System ist auszutauschen, wenn das System über Health Monitor-Warnmeldungen übermäßig viele korrigierbare ECC-Speicherfehler oder nicht korrigierbare ECC-Fehler meldet. Ein defektes DIMM kann verhindern, dass das Speichersystem ONTAP startet, daher stellt der Austausch den stabilen Betrieb wieder her. 
---
= Austausch eines DIMM in einem FAS9500 System zur Behebung von Speicherfehlern
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das DIMM in einem FAS9500-System ist auszutauschen, wenn das System über Health Monitor-Warnmeldungen übermäßig viele korrigierbare ECC-Speicherfehler oder nicht korrigierbare ECC-Fehler meldet. Ein defektes DIMM kann verhindern, dass das Speichersystem ONTAP startet, daher stellt der Austausch den stabilen Betrieb wieder her.
