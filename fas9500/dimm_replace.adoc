...
summary: Sie müssen ein DIMM im Controller austauschen, wenn in Ihrem Speichersystem Fehler auftreten, wie z. B. übermäßige CECC-Fehler, die auf Health Monitor-Warnungen basieren, oder nicht korrigierbare ECC-Fehler, die typischerweise durch einen einzelnen DIMM-Ausfall verursacht werden, der das Speichersystem am Booten von ONTAP hindert. 
---
= Ein DIMM im FAS9500 System ersetzen, um Speicherfehler zu beheben
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein DIMM im Controller ist auszutauschen, wenn das Speichersystem Fehler wie übermäßige CECC-Fehler (Correctable Error Correction Codes) basierend auf Health Monitor-Warnmeldungen oder nicht korrigierbare ECC-Fehler aufweist. Solche Fehler werden typischerweise durch einen einzelnen DIMM-Ausfall verursacht, der das Booten von ONTAP im Speichersystem verhindert.

.Bevor Sie beginnen
Alle anderen Systemkomponenten müssen ordnungsgemäß funktionieren; falls eine Komponente nicht ordnungsgemäß funktioniert, ist der technische Support zu kontaktieren.
...
+
image::../media/drw_9500_DIMM_map.svg[System-DIMM-Zuordnung]
...
+
image::../media/drw_9500_replace_PCM_dimms.svg[Ersetzen Sie die DIMMs]
...
+
image::../media/drw_9500_PCM_open.svg[Schließen Sie den Controller]
...
+
image::../media/drw_9500_remove_PCM.svg[Entfernen oder Installieren des Controllers]
