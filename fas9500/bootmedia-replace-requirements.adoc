...
[role="lead"]
Bevor das Bootmedium in Ihrem FAS9500 System ersetzt wird, sollte überprüft werden, ob die notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sind. Dazu zählt, dass ein USB-Flash-Laufwerk mit ausreichender Speicherkapazität vorhanden ist und dass das korrekte Ersatz-Bootmedium vorliegt.
