...
summary: Nachdem Sie das neue Boot-Mediengerät in Ihrem FAS9500 System installiert haben, können Sie den automatisierten Boot-Medien-Wiederherstellungsprozess starten, um die Konfiguration vom Partnerknoten wiederherzustellen. 
---
= Das Wiederherstellungsimage auf Ihrem FAS9500 System wird mithilfe des automatisierten Startwiederherstellungsprozesses gestartet.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
