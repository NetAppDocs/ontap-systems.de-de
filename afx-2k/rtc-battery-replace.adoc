...
summary: Der Austausch der Echtzeit-Batterie in Ihrem afx 2k Speichersystem stellt sicher, dass Dienste und Anwendungen, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin funktionsfähig bleiben. 
---
= Austausch der Echtzeit-Uhr-Batterie – AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
