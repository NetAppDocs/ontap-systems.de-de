...
summary: Bereiten Sie den Austausch des defekten Chassis in Ihrem AFX 2K Storage System vor, indem das defekte Chassis identifiziert, die Ersatzkomponenten überprüft und die Kabel sowie die Controller-Module gekennzeichnet werden. 
---
= Vorbereitung auf den Austausch eines AFX 2K Gehäuses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
