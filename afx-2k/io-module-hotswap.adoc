...
summary: Ein Ethernet-E/A-Modul kann im Hot-Swap-Verfahren in Ihrem afx 2k Storage System ausgetauscht werden, wenn ein Modul ausfällt und Ihr Storage System alle ONTAP Versionsanforderungen erfüllt. 
---
= Hot-Swap eines I/O-Moduls - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
