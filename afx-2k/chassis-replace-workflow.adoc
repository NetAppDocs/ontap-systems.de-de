...
summary: Der Austausch des Gehäuses Ihres AFX 2K-Speichersystems beginnt mit der Überprüfung der Austauschvoraussetzungen, dem Herunterfahren des Controllers, dem Austausch des Gehäuses und der Überprüfung der Systemfunktionen. 
---
= Arbeitsablauf für den Austausch des AFX 2K Gehäuses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Austausch des Gehäuses Ihres AFX 2K-Speichersystems beginnt mit der Überprüfung der Austauschvoraussetzungen, dem Herunterfahren des Controllers, dem Austausch des Gehäuses und der Überprüfung der Systemfunktionen.
