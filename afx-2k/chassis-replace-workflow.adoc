...
summary: Der Austausch des Gehäuses Ihres afx 2k Speichersystems umfasst das Prüfen der Austauschvoraussetzungen, das Herunterfahren des Controllers, den Austausch des Gehäuses und die Überprüfung des Systembetriebs. 
---
= Arbeitsablauf beim Gehäuseaustausch, AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
