...
summary: Die Kontrolle über die Speicherressourcen wird an den Ersatzcontroller zurückgegeben, sodass Ihr AFX 2K Storage System den normalen Betrieb wieder aufnehmen kann. 
---
= Der Controller in Ihrem AFX 2K-Speichersystem wird zurückgegeben, damit der normale Betrieb fortgesetzt werden kann.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Kontrolle über die Speicherressourcen wird an den Ersatzcontroller zurückgegeben, sodass Ihr AFX 2K Storage System den normalen Betrieb wieder aufnehmen kann. Das Rückgabeverfahren variiert je nach dem von Ihrem System verwendeten Verschlüsselungstyp: keine Verschlüsselung oder Onboard Key Manager (OKM) Verschlüsselung.
