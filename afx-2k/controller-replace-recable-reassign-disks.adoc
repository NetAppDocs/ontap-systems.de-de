...
summary: Die Kontrolle über die Speicherressourcen wird an den Ersatzcontroller zurückgegeben, sodass Ihr afx 2k Speichersystem den normalen Betrieb wieder aufnehmen kann. 
---
= Den Controller zurückgeben, AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
