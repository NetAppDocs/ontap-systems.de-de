...
summary: Das afx 2k Speichersystem bietet Flexibilität beim Erweitern oder Austauschen von E/A-Modulen zur Verbesserung der Netzwerkkonnektivität und Performance. Das Hinzufügen oder Austauschen eines E/A-Moduls ist erforderlich, wenn Netzwerkfunktionen erweitert oder ein ausgefallenes Modul ersetzt werden muss. 
---
= Übersicht zum Hinzufügen und Ersetzen des E/A-Moduls, AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
