...
summary: Der Austausch des Controllers in Ihrem AFX 2K Storage-System beginnt mit dem Herunterfahren des defekten Controllers, dem Entfernen und Ersetzen des Controllers, der Neukonfiguration der Systemeinstellungen und der Überprüfung der Systemfunktionen. 
---
= Workflow zum Austausch des AFX 2K Controllers
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
