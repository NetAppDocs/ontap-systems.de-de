...
summary: Es sollte sichergestellt sein, dass die HA-Konfiguration des Controllers in Ihrem AFX 2K-Speichersystem aktiv ist und ordnungsgemäß funktioniert, und dass die Adapter des Systems alle Pfade zu den Festplatten auflisten. 
---
= Die Controller-Konfiguration in Ihrem AFX 2K Speichersystem wird wiederhergestellt und überprüft.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
