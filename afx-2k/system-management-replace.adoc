...
summary: Das Systemmanagementmodul im afx 2k Storage-System wird ersetzt, wenn es defekt ist oder seine Firmware beschädigt ist. Der Austauschprozess umfasst das Herunterfahren des Controllers, das Ersetzen des ausgefallenen Systemmanagementmoduls, das Neustarten des Controllers, das Aktualisieren der Lizenzschlüssel und die Rücksendung des defekten Teils an NetApp. 
---
= Systemmanagement-Modul austauschen – AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Systemmanagement-Modul im AFX 2K Storage-System ist auszutauschen, wenn es defekt ist oder seine Firmware beschädigt ist. Der Austauschprozess umfasst das Herunterfahren des Controllers, den Austausch des ausgefallenen Systemmanagement-Moduls, den Neustart des Controllers, die Aktualisierung der Lizenzschlüssel und die Rücksendung des ausgefallenen Teils an NetApp.

Das Systemmanagement-Modul, das sich an der Rückseite des Controllers links neben Steckplatz 8 befindet, enthält integrierte Komponenten für das Systemmanagement sowie Ports für das externe Management. Der Zielcontroller muss heruntergefahren und ausgeschaltet sein, um ein defektes Systemmanagement-Modul oder das Bootmedium auszutauschen.
...
+
image::../media/drw_afx_2k_sys_mgmt_remove_replace_ieops-2880.svg[Ersetzen Sie das System Management-Modul]
...
+
image::../media/drw_afx_2k_boot_media_remove_replace_ieops-2877.svg[Boot-Medium ersetzen]
