...
summary: Fahren Sie den Controller in Ihrem AFX 2K Storage System herunter, wenn er beeinträchtigt ist. Vor Wartungsarbeiten oder dem Austausch von Komponenten ist es entscheidend, den Controller sicher herunterzufahren, um Datenverlust zu verhindern und die Systemstabilität zu gewährleisten. 
---
= Vor dem Austausch ist der defekte Controller in Ihrem AFX 2K Storage-System herunterzufahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
