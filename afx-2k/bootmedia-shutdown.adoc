...
summary: Der defekte Controller in Ihrem AFX 2K Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Bootmediums sicherzustellen. 
---
= Der Controller im AFX 2K-Speichersystem wird während des automatisierten Boot-Wiederherstellungsprozesses heruntergefahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
