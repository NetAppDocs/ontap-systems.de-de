...
summary: Nach der Installation des neuen Bootmediums in Ihrem AFX 2K Speichersystem kann der automatisierte Bootmedien-Wiederherstellungsprozess gestartet werden, um die Konfiguration vom Partnerknoten wiederherzustellen. 
---
= Das Wiederherstellungsimage auf Ihrem AFX 2K Storage-System wird mithilfe des automatisierten Boot-Wiederherstellungsprozesses gestartet.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach der Installation des neuen Bootmediums in Ihrem AFX 2K Speichersystem kann der automatisierte Bootmedien-Wiederherstellungsprozess gestartet werden, um die Konfiguration vom Partnerknoten wiederherzustellen.
...
Nachdem Sie das ONTAP -Image wiederhergestellt haben und der Knoten aktiv ist und Daten bereitstellt, müssen Sielink:bootmedia-complete-rma.html["Geben Sie das fehlerhafte Teil an NetApp zurück"] .
