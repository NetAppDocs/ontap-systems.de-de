...
summary: Ein DIMM in Ihrem afx 2k Speichersystem sollte ersetzt werden, wenn zu viele korrigierbare oder nicht korrigierbare Speicherfehler erkannt werden. Solche Fehler können das Starten von ONTAP auf dem Speichersystem verhindern. Der Austauschprozess umfasst das Herunterfahren des betroffenen Controllers, dessen Ausbau, den Austausch des DIMM, den Wiedereinbau des Controllers und anschließend die Rücksendung des defekten Bauteils an NetApp. 
---
= DIMM austauschen – AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein DIMM in Ihrem AFX 2K Speichersystem sollte ersetzt werden, wenn übermäßige korrigierbare oder nicht korrigierbare Speicherfehler erkannt werden. Solche Fehler können verhindern, dass das Speichersystem ONTAP startet. Der Austauschprozess umfasst das Herunterfahren des beeinträchtigten Controllers, dessen Ausbau, den Austausch des DIMM, den Wiedereinbau des Controllers und anschließend die Rücksendung des defekten Teils an NetApp.
