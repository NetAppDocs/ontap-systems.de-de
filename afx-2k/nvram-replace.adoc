...
summary: Der NVRAM in Ihrem AFX 2K Speichersystem wird ersetzt, wenn der nichtflüchtige Speicher defekt ist oder ein Upgrade erforderlich ist. 
---
= Den NVRAM in Ihrem AFX 2K Speichersystem ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der NVRAM in Ihrem AFX 2K Speichersystem wird ersetzt, wenn der nichtflüchtige Speicher defekt ist oder ein Upgrade erforderlich ist. Der Austauschprozess umfasst das Herunterfahren des betroffenen Controllers, das Ersetzen des NVRAM Moduls oder des NVRAM DIMM sowie die Rücksendung des defekten Teils an NetApp.
...
+
image::../media/drw_afx_2k_nvram_remove_replace_ieops-2881.svg[Entfernen Sie das NVRAM12-Modul und die DIMMs]
...
+
image::../media/drw_afx_2k_nvram_remove_replace_ieops-2881.svg[Entfernen Sie das NVRAM 12-Modul und die DIMMs]
...
NOTE: Die Override-System-ID wird nur für den Austausch des NVRAM-Moduls benötigt und nicht für den Austausch des NVRAM-DIMM.
...
+
.. Vom intakten Controller aus den Speicher des ersetzten Controllers zurückgeben: `_storage failover giveback -ofnode impaired_node_name_`
+
