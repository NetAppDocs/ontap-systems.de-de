...
summary: Der Controller im afx 2k Storage-System sollte heruntergefahren werden, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Gehäuses sicherzustellen. 
---
= Controller zum Austausch des Chassis herunterfahren, AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
