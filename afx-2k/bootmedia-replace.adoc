...
summary: Das Bootmedium Ihres afx 2k Speichersystems enthält wichtige Firmware- und Konfigurationsdaten. Der Austauschvorgang umfasst das Entfernen des Systemmanagement-Moduls, das Entfernen des beschädigten Bootmediums, das Einsetzen des Ersatz-Bootmediums in das Systemmanagement-Modul und anschließend das Wiedereinsetzen des Systemmanagement-Moduls. 
---
= Bootmedium austauschen, AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Bootmedium in Ihrem AFX 2K-Speichersystem speichert wichtige Firmware- und Konfigurationsdaten. Der Austauschvorgang umfasst das Entfernen des Systemmanagement-Moduls, das Entfernen des defekten Bootmediums, das Einsetzen des Ersatz-Bootmediums in das Systemmanagement-Modul und anschließend das Wiedereinsetzen des Systemmanagement-Moduls.
...
+
.. Entfernen Sie die Kabel vom Systemverwaltungsmodul und beschriften Sie sie, um bei der Neuinstallation einen korrekten Anschluss sicherzustellen.
...
Nach dem Austausch des Bootmediumslink:bootmedia-recovery-image-boot.html["Stellen Sie das ONTAP-Image vom Partner-Node wieder her"] .
