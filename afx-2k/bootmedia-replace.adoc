...
summary: Das Bootmedium in Ihrem AFX 2K-Speichersystem speichert wichtige Firmware- und Konfigurationsdaten. Der Austauschvorgang umfasst das Entfernen des Systemmanagement-Moduls, das Entfernen des defekten Bootmediums, das Einsetzen des Ersatz-Bootmediums in das Systemmanagement-Modul und anschließend das Wiedereinsetzen des Systemmanagement-Moduls. 
---
= Das Startmedium im AFX 2K-Speichersystem kann mithilfe des automatisierten Startwiederherstellungsprozesses ersetzt werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
