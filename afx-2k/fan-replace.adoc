...
summary: Ein ausgefallenes oder fehlerhaftes Lüftermodul in Ihrem AFX 2K-System wird ersetzt, um eine ordnungsgemäße Kühlung aufrechtzuerhalten und Systemleistungsprobleme zu vermeiden. Die Lüfter sind Hot-Swap-fähig und können ohne Herunterfahren des Systems ausgetauscht werden. 
---
= Einen Lüfter im laufenden Betrieb in Ihrem AFX 2K Speichersystem austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein ausgefallenes oder fehlerhaftes Lüftermodul in Ihrem AFX 2K-System wird ersetzt, um eine ordnungsgemäße Kühlung aufrechtzuerhalten und Systemleistungsprobleme zu vermeiden. Die Lüfter sind Hot-Swap-fähig und können ohne Herunterfahren des Systems ausgetauscht werden. Dieses Verfahren umfasst die Identifizierung des fehlerhaften Lüfters anhand von Konsolenfehlermeldungen und LED-Anzeigen, das Entfernen der Blende, den Austausch des Lüftermoduls und die Rücksendung des defekten Teils an NetApp.
