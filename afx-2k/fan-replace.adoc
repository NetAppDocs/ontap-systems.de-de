...
summary: Ein ausgefallenes oder fehlerhaftes Lüftermodul in Ihrem afx 2k System kann ersetzt werden, um eine ordnungsgemäße Kühlung aufrechtzuerhalten und Systemleistungsprobleme zu vermeiden. Die Lüfter sind Hot-Swap-fähig und können ohne Abschalten des Systems ausgetauscht werden. 
---
= Lüfter austauschen – AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
