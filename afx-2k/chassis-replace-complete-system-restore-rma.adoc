...
summary: Starten Sie den Controller neu, überprüfen Sie den Systemzustand und senden Sie das defekte Teil an NetApp zurück, um den letzten Schritt im AFX 2K Gehäuseaustauschverfahren abzuschließen. 
---
= Der Gehäuseaustausch für Ihr AFX 2K Speichersystem ist abgeschlossen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Starten Sie den Controller neu, überprüfen Sie den Systemzustand und senden Sie das defekte Teil an NetApp zurück, um den letzten Schritt im AFX 2K Gehäuseaustauschverfahren abzuschließen.
