...
summary: Der Controller im AFX 2K Storage-System wird ersetzt, wenn ein Hardwarefehler dies erforderlich macht. Der Austauschprozess umfasst das Entfernen des defekten Controllers, das Übertragen der Komponenten auf den Ersatzcontroller, das Installieren des Ersatzcontrollers und dessen Neustart. 
---
= Den Controller im AFX 2K Speichersystem ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller im AFX 2K Storage-System wird ersetzt, wenn ein Hardwarefehler dies erforderlich macht. Der Austauschprozess umfasst das Entfernen des defekten Controllers, das Übertragen der Komponenten auf den Ersatzcontroller, das Installieren des Ersatzcontrollers und dessen Neustart.
...
Nach dem Austausch des defekten AFX 2K Controllers, link:controller-replace-system-config-restore-and-verify.html["Stellen Sie die Systemeinstellungen wieder her"].
