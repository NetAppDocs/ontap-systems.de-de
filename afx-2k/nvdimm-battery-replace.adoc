...
summary: Die NV-Batterie in Ihrem afx 2k-Speichersystem sollte ersetzt werden, wenn die Batterie an Ladung verliert oder ausfällt, da sie für die Sicherung kritischer Systemdaten bei Stromausfällen verantwortlich ist. Der Austauschprozess umfasst das Herunterfahren des beeinträchtigten Controllers, das Entfernen des Controller-Moduls, das Ersetzen der NV-Batterie, das Wiedereinsetzen des Controller-Moduls und die Rücksendung des defekten Teils an NetApp. 
---
= NV-Batterie ersetzen – AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die NV-Batterie in Ihrem AFX 2K Storage-System sollte ersetzt werden, wenn die Batterie an Ladung verliert oder ausfällt, da sie für die Sicherung kritischer Systemdaten bei Stromausfällen verantwortlich ist. Der Austauschprozess umfasst das Herunterfahren des beeinträchtigten Controllers, das Entfernen des Controller-Moduls, das Ersetzen der NV-Batterie, das Wiedereinsetzen des Controller-Moduls und die Rücksendung des defekten Teils an NetApp.

.Über diese Aufgabe
Dieses Verfahren gilt für den Austausch einer defekten NV-Batterie für das NVRAM Modul in den Steckplätzen 4 und 5 des AFX 2K Controllers. Informationen zum Austausch der NV-Batterie für das NVRAM12-EX Modul in den Steckplätzen 6 und 7 des AFX 2K Controllers sind unter link:../install-setup/nv12l-replace.html#step-2-replace-the-nvram12-ex-module-nvram-dimm-or-nvram-battery["Die NV-Batterie für den NVRAM12-EX ersetzen"] zu finden.
