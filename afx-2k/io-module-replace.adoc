...
summary: Ein E/A-Modul im afx 2k Storage-System wird ersetzt, wenn das Modul ausgefallen ist oder ein Upgrade für höhere Leistung oder zusätzliche Funktionen erforderlich ist. Der Austauschprozess umfasst das Herunterfahren des Controllers, das Ersetzen des ausgefallenen E/A-Moduls, den Neustart des Controllers und die Rücksendung des defekten Teils an NetApp. 
---
= Austausch des E/A-Moduls AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
