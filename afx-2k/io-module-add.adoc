...
summary: Ein I/O-Modul kann dem afx 2k Speichersystem hinzugefügt werden, um die Netzwerkkonnektivität zu verbessern und die Fähigkeit des Systems zur Verarbeitung von Datenverkehr zu erweitern. 
---
= I/O-Modul hinzufügen AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
