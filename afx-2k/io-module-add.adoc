...
summary: Ein E/A-Modul kann dem AFX 2K Speichersystem hinzugefügt werden, um die Netzwerkkonnektivität zu verbessern und die Fähigkeit des Systems zur Verarbeitung von Datenverkehr zu erweitern. 
---
= Ein E/A-Modul kann zu einem AFX 2K-System hinzugefügt werden, um die Netzwerk-Konnektivität zu verbessern.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein E/A-Modul kann dem AFX 2K Speichersystem hinzugefügt werden, um die Netzwerkkonnektivität zu verbessern und die Fähigkeit des Systems zur Verarbeitung von Datenverkehr zu erweitern.

Sie können Ihrem AFX 2K Speichersystem ein E/A-Modul hinzufügen, wenn freie Steckplätze verfügbar sind oder wenn alle Steckplätze vollständig belegt sind.
