...
summary: Tauschen Sie ein DIMM in Ihrem ASA C400 Controller-Modul aus, wenn das System eine zunehmende Anzahl korrigierbarer Fehlerkorrekturcodes oder nicht korrigierbarer ECC-Fehler registriert. Wenn ein fehlerhaftes DIMM nicht ersetzt wird, kann dies zu einem Systemabsturz führen. 
---
= Ein DIMM in einem ASA C400 System ersetzen, um Speicherfehler zu beheben
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein DIMM in Ihrem ASA C400 System sollte ersetzt werden, wenn das Speichersystem auf übermäßig viele korrigierbare Fehlerkorrekturcode-(ECC)-Fehler oder einen nicht korrigierbaren ECC-Fehler stößt, was typischerweise durch den Ausfall eines einzelnen DIMM verursacht wird.
