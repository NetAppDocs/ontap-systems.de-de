...
---
= Den Chassis-Austausch für ein ASA C400 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Chassis-Austausch für ein ASA C400 System wird abgeschlossen, indem der HA-Status überprüft, die Aggregate zurückgeschaltet werden, falls sich das System in einer Zwei-Knoten MetroCluster Konfiguration befindet, und das defekte Chassis an NetApp zurückgesendet wird.
...
+
Der Wert für _HA-State_ kann einer der folgenden Werte sein:
