...
summary: Der Controller im ASA C400-Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität während des manuellen Bootmedien-Wiederherstellungsprozesses aufrechtzuerhalten. 
---
= Den Controller in einem ASA C400 System während des manuellen Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller im ASA C400-Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität während des manuellen Bootmedien-Wiederherstellungsprozesses aufrechtzuerhalten.
