...
summary: Tauschen Sie die Echtzeituhr-Batterie in Ihrem ASA C400-Controllermodul aus, um sicherzustellen, dass Dienste und Anwendungen, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin funktionieren. 
---
= Die RTC-Batterie in einem ASA C400 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die genaue Zeitsynchronisation auf einem ASA C400 System wird durch den Austausch der RTC-Batterie im Controller-Modul wiederhergestellt.
...
+
image::../media/drw_c400_remove_controller_IEOPS-1216.svg[Entfernen Sie das Controller-Modul]
...
image::../media/drw_c400_rtc_batt_IEOPS-1239.svg[Entfernen Sie die RTC-Batterie]
