...
summary: Das Startmedium speichert einen primären und sekundären Satz von Boot-Image-Dateien, die das System beim Booten verwendet. 
---
= Informationen zum Austausch des Bootmediums in einem ASA C400 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Informationen darüber, welche Funktion das Bootmedium hat und was vor dem Austausch in einem ASA C400 System zu beachten ist, einschließlich der Anforderungen an USB-Flash-Laufwerk und Netzwerk.
