...
---
= Austausch einer PCIe- oder Mezzanine-Karte in einem ASA C400 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Eine defekte PCIe- oder Mezzanine-Karte im Controller-Modul eines ASA C400 Systems entfernen und austauschen.
