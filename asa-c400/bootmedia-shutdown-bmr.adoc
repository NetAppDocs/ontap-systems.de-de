...
summary: Der Controller im ASA C400 Storage-System sollte heruntergefahren werden, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Bootmediums sicherzustellen. 
---
...
[role="lead"]
Der Controller im ASA C400 Storage-System wird heruntergefahren, um Datenverlust zu vermeiden und die Systemstabilität während des automatisierten Boot-Medien-Wiederherstellungsprozesses zu gewährleisten.
