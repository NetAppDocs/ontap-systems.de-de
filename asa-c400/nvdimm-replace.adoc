...
summary: Sie müssen das NVDIMM im Controllermodul austauschen, sobald Ihr System erkennt, dass die Lebensdauer des Flash-Speichers fast abgelaufen ist oder das identifizierte NVDIMM allgemein nicht in Ordnung ist. Andernfalls kommt es zu einem Systemabsturz. 
---
= Ein NVDIMM in einem ASA C400 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein NVDIMM in Ihrem ASA C400 System sollte ersetzt werden, wenn das Speichersystem übermäßig viele korrigierbare ECC-Fehler oder nicht korrigierbare ECC-Fehler feststellt, die typischerweise durch einen einzelnen NVDIMM-Ausfall verursacht werden.
...
image::../media/drw_A400_Replace-NVDIMM-DIMM_IEOPS-1009.svg[Ersetzen Sie das NVDIMM]
