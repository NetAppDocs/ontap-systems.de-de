...
---
= Die NVDIMM-Batterie in einem ASA C400 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die NVDIMM-Batterie in Ihrem ASA C400 System kann durch Entfernen des Controller-Moduls, Austausch der Batterie und erneutes Einsetzen des Controller-Moduls ersetzt werden.
