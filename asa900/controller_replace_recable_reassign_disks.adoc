...
summary: Die Speicher- und Netzwerkkonfigurationen werden neu verkabelt, die Neuzuordnung der Festplatten bestätigt und die Kontrolle über die Speicherressourcen an den Ersatzcontroller zurückgegeben, sodass Ihr ASA A900 System den normalen Betrieb wieder aufnehmen kann. 
---
= Den Controller in Ihrem ASA A900 System zurückgeben, damit der normale Betrieb fortgesetzt werden kann.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
