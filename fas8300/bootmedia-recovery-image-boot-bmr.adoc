...
summary: Nachdem Sie das neue Boot-Mediengerät in Ihrem FAS8300 oder FAS8700 System installiert haben, können Sie den automatisierten Boot-Medienwiederherstellungsprozess starten, um die Konfiguration vom Partnerknoten wiederherzustellen. 
---
= Automatisierte Boot-Medienwiederherstellung vom Partnerknoten – FAS8300 und FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
