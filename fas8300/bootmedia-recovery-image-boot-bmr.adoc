...
summary: Nach der Installation des neuen Bootmediums in Ihrem FAS8300 oder FAS8700 System kann der automatisierte Bootmedien-Wiederherstellungsprozess gestartet werden, um die Konfiguration vom Partnerknoten wiederherzustellen. 
---
= Das Wiederherstellungsimage auf dem FAS8300 oder FAS8700 System wird mithilfe des automatisierten Boot-Recovery-Prozesses gestartet.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
