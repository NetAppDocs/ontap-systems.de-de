...
---
= Wichtigste Spezifikationen für ein FAS8700 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ausgewählte Spezifikationen für das FAS8700 Speichersystem in einem einzelnen Hochverfügbarkeitspaar (HA) sind aufgeführt, und im NetApp Hardware Universe (HWU) finden sich die vollständigen Spezifikationen für dieses System.
