...
summary: Nachdem Sie den FRU-Austausch in einer Zwei-Knoten-MetroCluster-Konfiguration abgeschlossen haben, können Sie die MetroCluster-Rückschaltung durchführen. Dadurch wird die Konfiguration in ihren normalen Betriebszustand zurückversetzt, wobei die Sync-Source Storage Virtual Machines am zuvor beeinträchtigten Standort nun aktiv sind und Daten aus den lokalen Festplattenpools bereitstellen. 
---
= Switch-Back-Aggregate in einer Zwei-Node-Cluster MetroCluster Konfiguration in einem FAS8300 oder FAS8700 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
