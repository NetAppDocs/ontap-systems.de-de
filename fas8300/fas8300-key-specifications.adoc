...
---
= Wichtigste Spezifikationen für ein FAS8300 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ausgewählte Spezifikationen für das FAS8300 Speichersystem in einem einzelnen Hochverfügbarkeitspaar (HA) sowie die vollständigen Spezifikationen für dieses System sind im NetApp Hardware Universe (HWU) verfügbar.
