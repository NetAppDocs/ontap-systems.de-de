...
summary: Die Kontrolle über die Speicherressourcen wird an den Ersatzcontroller zurückgegeben, sodass Ihr FAS8300 oder FAS8700 System den normalen Betrieb fortsetzen kann. 
---
= Den Controller in einem FAS8300 oder FAS8700 System zurückgeben, damit der normale Betrieb fortgesetzt werden kann
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Kontrolle über die Speicherressourcen wird an den Ersatzcontroller zurückgegeben, sodass Ihr FAS8300 oder FAS8700 System den normalen Betrieb fortsetzen kann.
