...
. Rufen Sie die clusterweite Passphrase vom fehlerfreien Controller ab und überprüfen Sie sie.
+
.. Führen Sie den folgenden Befehl aus, um die clusterweite Passphrase abzurufen:
+
`security key-manager onboard show-backup`

.. Überprüfen Sie die clusterweite Passphrase mit folgendem Befehl:
+
