...
summary: Übergeben Sie die Kontrolle über die Speicherressourcen wieder an den Ersatzcontroller, damit Ihr FAS8300 und FAS8700-System den normalen Betrieb wieder aufnehmen kann. 
---
= Geben Sie den Controller - FAS8300 und FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Übergeben Sie die Kontrolle über die Speicherressourcen wieder an den Ersatzcontroller, damit Ihr FAS8300 und FAS8700-System den normalen Betrieb wieder aufnehmen kann.
