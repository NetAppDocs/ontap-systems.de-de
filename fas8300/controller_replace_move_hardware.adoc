...
+
https://["Entfernen der leeren Riser aus dem Ersatzcontroller-Modul"]
...
Sie können die folgenden Animationen, Illustrationen verwenden. Oder die schriftlichen Schritte, um die PCIe Riser und Mezzanine-Karte vom beeinträchtigten Controller-Modul auf das Ersatzcontrollermodul zu verschieben.
