...
---
= Wiederherstellung der Verschlüsselung auf dem Bootmedium in einem FAS8300 oder FAS8700 System nach dem manuellen Boot-Wiederherstellungsprozess
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nachdem das Bootmedium in Ihrem FAS8300 oder FAS8700 System ausgetauscht wurde, kann die Verschlüsselung wiederhergestellt werden, indem die Schritte für den jeweiligen Schlüsselmanagertyp, wie zum Beispiel den Onboard Key Manager (OKM), abgeschlossen werden.
