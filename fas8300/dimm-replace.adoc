...
summary: Das DIMM im Controller ist auszutauschen, wenn im Speichersystem Fehler wie übermäßige korrigierbare ECC-Speicherfehler oder nicht korrigierbare ECC-Fehler auftreten, die typischerweise durch einen einzelnen DIMM-Ausfall verursacht werden und das Speichersystem daran hindern, ONTAP zu booten. 
---
= Ein DIMM in einem FAS8300 oder FAS8700 System ersetzen, um Speicherfehler zu beheben
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das DIMM im Controller ist auszutauschen, wenn das Speichersystem Fehler wie übermäßige korrigierbare ECC-Speicherfehler (basierend auf Health Monitor-Warnmeldungen) oder nicht korrigierbare ECC-Fehler aufweist. Solche Fehler werden typischerweise durch einen einzelnen DIMM-Ausfall verursacht, der das Booten von ONTAP im Speichersystem verhindert.
