...
---
= Austausch einer PCIe- oder Mezzanine-Karte in einem FAS8300 oder FAS8700 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Den Ständer gerade nach oben anheben und auf eine stabile, ebene Fläche stellen.
...
. Die Ersatz-PCIe-Karte wird in die Riser-Karte eingesetzt, indem die Karte am Sockel ausgerichtet, in den Sockel gedrückt und anschließend die Seitenabdeckung der Riser-Karte, sofern vorhanden, geschlossen wird.
+
...
== Schritt 7: Stellen Sie das Controller-Modul wieder in Betrieb
