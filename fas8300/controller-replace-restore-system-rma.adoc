...
summary: 'Der Controller-Austausch für Ihr FAS8300 oder FAS8700 System wird abgeschlossen. Die Lizenzen für den Ersatzcontroller werden installiert, es wird bestätigt, dass die logischen Schnittstellen (LIFs) an ihren Home-Ports melden, und eine Cluster-Integritätsprüfung wird durchgeführt. Abschließend wird das defekte Bauteil an NetApp zurückgesendet.' 
---
= Den Controller-Austausch für ein FAS8300 oder FAS8700 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller-Austausch für Ihr FAS8300 oder FAS8700 System wird abgeschlossen. Die Lizenzen für den Ersatzcontroller werden installiert, es wird bestätigt, dass die logischen Schnittstellen (LIFs) an ihren Home-Ports melden, und eine Cluster-Integritätsprüfung wird durchgeführt. Abschließend wird das defekte Bauteil an NetApp zurückgesendet.
