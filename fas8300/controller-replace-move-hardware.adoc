...
summary: Tauschen Sie den Controller in Ihrem FAS8300 oder FAS8700-System aus, wenn ein Hardwaredefekt dies erfordert. Entfernen Sie den defekten Controller, übertragen Sie dessen Komponenten auf den Ersatzcontroller, installieren Sie den neuen Controller und starten Sie ihn neu. 
---
= Den Controller in Ihrem FAS8300 oder FAS8700 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Tauschen Sie den Controller in Ihrem FAS8300 oder FAS8700-System aus, wenn ein Hardwaredefekt dies erfordert. Entfernen Sie den defekten Controller, übertragen Sie dessen Komponenten auf den Ersatzcontroller, installieren Sie den neuen Controller und starten Sie ihn neu.


NOTE: Das Ver2 Controllermodul verfügt im FAS8300 nur über einen Caching-Modul-Sockel (Slot 6). FAS8700 besitzt kein Ver2 Controllermodul. Die Funktionalität des Caching-Moduls wird durch die Entfernung des Sockels nicht beeinträchtigt.
...
Verlegen Sie die PCIe-Riserkarten und die Mezzanine-Karte auf das Ersatz-Controllermodul.
...
== Schritt 6: Verschieben Sie das Cache-Modul

Verschieben Sie das Cache-Modul auf das Ersatz-Controller-Modul.
...
Nachdem Sie den defekten FAS8300 oder FAS8700 Controller ausgetauscht haben, müssen Sie link:controller-replace-system-config-restore-and-verify.html["Stellen Sie die Systemkonfiguration wieder her"].
