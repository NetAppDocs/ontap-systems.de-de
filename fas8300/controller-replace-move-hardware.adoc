...
image::../media/drw_8300_empty_riser_remove.png[Entfernen Sie den leeren Riser]
...
image::../media/drw_A400_Replace-mezz-card.png[Entfernen Sie die Zusatzkarte]
...
image::../media/drw_A400_Replace-flashcache.png[Entfernen Sie das Caching-Modul, und ersetzen Sie es]
