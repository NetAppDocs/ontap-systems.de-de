...
---
= Prüfen Sie die Unterstützung und den Status der Verschlüsselungsschlüssel – AFF FAS8300 und FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Wählen Sie je nachdem, ob das System den External Key Manager oder den Onboard Key Manager verwendet, eine der folgenden Optionen aus.
+
[role="tabbed-block"]
====
