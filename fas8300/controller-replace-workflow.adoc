...
summary: Tauschen Sie den Controller in Ihrem FAS8300 oder FAS8700 Storage-System aus, indem Sie den ausgefallenen Controller herunterfahren, den Controller entfernen und ersetzen, die Systemkonfiguration wiederherstellen und die Kontrolle über die Speicherressourcen an den Ersatzcontroller zurückgeben. 
---
= Arbeitsablauf zum Austausch von Controllern – FAS8300 und FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Tauschen Sie den Controller in Ihrem FAS8300 oder FAS8700 Storage-System aus, indem Sie den ausgefallenen Controller herunterfahren, den Controller entfernen und ersetzen, die Systemkonfiguration wiederherstellen und die Kontrolle über die Speicherressourcen an den Ersatzcontroller zurückgeben.
