...
---
= Arbeitsablauf zum Austausch des Bootmediums für ein FAS8300 oder FAS8700 System mit dem automatisierten Boot-Wiederherstellungsprozess
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Austausch des Bootmediums in Ihrem FAS8300 oder FAS8700 Storage-System kann mit dem automatisierten Boot-Recovery-Prozess begonnen werden. Das System identifiziert und wählt automatisch die passende Bootmenüoption aus und verwendet anschließend das Boot-Image auf dem Partner-Node, um ONTAP auf dem Ersatz-Bootmedium zu installieren. Für den Abschluss des Austauschs werden die Anforderungen überprüft, der Controller heruntergefahren, das Bootmedium ersetzt, das System stellt das Image wieder her und die Systemfunktionalität wird verifiziert.
