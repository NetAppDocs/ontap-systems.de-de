...
summary: Fahren Sie den beeinträchtigten Controller in Ihrem FAS8300 oder FAS8700 Speichersystem herunter, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Startmediums sicherzustellen. 
---
= Den defekten Controller in Ihrem FAS8300 oder FAS8700 System während des automatisierten Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den beeinträchtigten Controller in Ihrem FAS8300 oder FAS8700 Speichersystem herunter, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Startmediums sicherzustellen.
