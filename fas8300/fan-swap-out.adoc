...
---
= Ein Lüftermodul kann im laufenden Betrieb in einem FAS8300 oder FAS8700 System ausgetauscht werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können das Lüftermodul Ihres FAS8300 oder FAS8700 Systems im laufenden Betrieb austauschen. Um eine Überhitzung zu vermeiden, muss das Lüftermodul innerhalb von zwei Minuten nach der Entfernung aus dem Gehäuse ersetzt werden.
...
+
Verwenden Sie die BMC-Meldung oder die Attention-LED, um das auszutauschende Fan-Modul zu identifizieren. BMC ordnet Fan-Module dem Format Fan#_# zu, wobei die erste Zahl den Slot und die zweite die Row angibt (1=top, 2=bottom); zum Beispiel Slot 1, zweite Row = Fan1_2.
...
+
Die Aufmerksamkeits-LED erlischt, sobald der Lüfter richtig positioniert ist und seine Betriebsdrehzahl erreicht hat.
