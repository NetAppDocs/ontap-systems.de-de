...
summary: Der Austausch des Bootmediums in Ihrem FAS8300 oder FAS8700 Storage-System erfolgt durch Überprüfung der Austauschvoraussetzungen, Kontrolle des Verschlüsselungsstatus, Herunterfahren des Controllers, Austausch des Bootmediums, Starten des Wiederherstellungsabbilds, Wiederherstellung der Verschlüsselung und Überprüfung der Systemfunktionalität. 
---
= Ablauf für den Austausch des Bootmediums bei einem FAS8300 oder FAS8700 System unter Verwendung des manuellen Boot-Wiederherstellungsprozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Austausch des Bootmediums in Ihrem FAS8300 oder FAS8700 Storage-System erfolgt durch Überprüfung der Austauschvoraussetzungen, Kontrolle des Verschlüsselungsstatus, Herunterfahren des Controllers, Austausch des Bootmediums, Starten des Wiederherstellungsabbilds, Wiederherstellung der Verschlüsselung und Überprüfung der Systemfunktionalität.
