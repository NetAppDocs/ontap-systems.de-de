...
summary: Zum Austauschen des Startmediums müssen Sie das beeinträchtigte Controller-Modul entfernen, das Ersatzstartmedium installieren und das Boot-Image auf ein USB-Flash-Laufwerk übertragen. 
---
= Das Bootmedium in Ihrem FAS8300 oder FAS8700 System wird mithilfe des manuellen Boot-Wiederherstellungsprozesses ersetzt.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_A400_open-air-duct.png[Öffnen des Luftkanals]
