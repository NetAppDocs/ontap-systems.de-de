...
---
= Ersetzen Sie ein NVDIMM – FAS8300 und FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Um das NVDIMM auszutauschen, müssen Sie es im Controller-Modul mithilfe der FRU-Karte oben im Luftkanal der FRU-Karte oben am Steckplatz 1-Riser suchen.
...
* Obwohl der Inhalt des NVDIMM verschlüsselt ist, empfiehlt es sich, den Inhalt des NVDIMM vor dem Ersetzen zu löschen. Weitere Informationen finden Sie im https://["Angaben zu flüchtigem Speicher"] Auf der NetApp Support Site
+
...
** Wenn der Test keine Fehler gemeldet hat, wählen Sie `Reboot` Über das Menü, um das System neu zu starten.
