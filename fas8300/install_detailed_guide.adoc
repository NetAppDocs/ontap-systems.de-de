...
+
In der folgenden Tabelle sind die Kabeltypen aufgeführt, die Sie möglicherweise erhalten können. Wenn Sie ein Kabel erhalten, das nicht in der Tabelle aufgeführt ist, lesen Sie die https://["NetApp Hardware Universe"^] Um das Kabel zu lokalisieren und dessen Verwendung zu identifizieren.
...
+
image::../media/drw_fas8300_TNSC_network_cabling.png[drw fas8300 TNSC-Netzwerkverkabelung]
...
+
image::../media/drw_fas8300_switched_network_cabling.png[drw fas8300-geschaltete Netzwerkverkabelung]
...
+
image::../media/drw_fas8300_three-ds224c_shelves.png[drw, fas8300, drei ds224c Shelfs]
