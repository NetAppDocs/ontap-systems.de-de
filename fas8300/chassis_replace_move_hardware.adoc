...
Nachdem Sie die Controller-Module im neuen Gehäuse installiert haben, müssen Sie es in einen Status booten, in dem Sie den Diagnosetest ausführen können.
