...
---
= Ein FAS8300 oder FAS8700 System mit detaillierten Schritt-für-Schritt-Anleitungen installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Diese detaillierte Schritt-für-Schritt-Anleitung führt Sie durch die Installation Ihres FAS8300 oder FAS8700 Systems, von der Montage und Verkabelung bis zur Ersteinrichtung. Diese Schritte bieten eine ausführlichere Installationsanleitung als die Kurzanleitung.
...
image:../media/oie_cable_fiber_lc_connector.png["LC-Glasfaseranschluss"]
 a| 
16 Gb FC- oder 25 GbE-Kabel für Mezzanine-Karten (bestellabhängig)
...
NOTE: Sind die Portbezeichnungen auf der Karte nicht sichtbar, sollte die Einbaurichtung der Karte überprüft werden (der PCIe-Anschluss befindet sich bei den Modellen A400 und FAS8300/8700 links im Kartensteckplatz). Anschließend kann anhand der Teilenummer in der  https://hwu.netapp.com["NetApp Hardware Universe"^]Abbildung der Blende, die die Portbezeichnungen zeigt, nach der Karte gesucht werden. Die Teilenummer der Karte kann mit dem  `sysconfig -a`Befehl oder auf der Systemlieferliste gefunden werden.
...
NOTE: In diesem Beispiel steht XXXXX für die Systemseriennummer des Zielknotens.
