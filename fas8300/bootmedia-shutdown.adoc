...
---
= Den defekten Controller in Ihrem FAS8300 oder FAS8700 System während des manuellen Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss der NVE- oder NSE-Aufgaben sollte der betroffene Controller entsprechend der für die jeweilige Konfiguration geeigneten Vorgehensweise heruntergefahren oder übernommen werden.
...
Nach Abschluss der NVE- oder NSE-Aufgaben den betroffenen Controller herunterfahren.
