...
summary: Sie müssen das NVDIMM im Controllermodul austauschen, wenn Ihr System erkennt, dass die Lebensdauer des Flash-Speichers fast abgelaufen ist oder dass das identifizierte NVDIMM generell nicht in einwandfreiem Zustand ist. 
---
= Das NVDIMM in einem FAS8300 oder FAS8700 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Alle anderen Systemkomponenten müssen einwandfrei funktionieren. Falls dies nicht der Fall ist, ist der technische Support zu kontaktieren.
...
Um das NVDIMM auszutauschen, muss es im Controller-Modul mithilfe der FRU-Karte auf der Oberseite des Steckplatz-1-Risers lokalisiert werden.
...
* Obwohl der Inhalt des NVDIMM verschlüsselt ist, ist es eine bewährte Methode, den Inhalt des NVDIMM vor dem Austausch zu löschen. Weitere Informationen sind im  https://mysupport.netapp.com/info/web/ECMP1132988.html["Angaben zu flüchtigem Speicher"] auf der NetApp Support Site verfügbar.
+
...
+
Das NVDIMM sitzt stramm im Steckplatz, sollte sich aber leicht einsetzen lassen. Falls dies nicht der Fall ist, das NVDIMM erneut am Steckplatz ausrichten und wieder einsetzen.
