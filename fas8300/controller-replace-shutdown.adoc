...
summary: Schalten Sie den Controller in Ihrem FAS8300 und FAS8700-Speichersystem ab, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers zu gewährleisten. 
---
= Fahren Sie den beeinträchtigten Controller – FAS8300 und FAS8700 – herunter
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie den Controller in Ihrem FAS8300 und FAS8700-Speichersystem ab, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers zu gewährleisten.
