...
summary: Der Controller in Ihrem FAS8300 oder FAS8700 Speichersystem sollte heruntergefahren werden, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers zu gewährleisten. 
---
= Vor dem Austausch muss der defekte Controller in einem FAS8300 oder FAS8700 System abgeschaltet werden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller in Ihrem FAS8300 oder FAS8700 Speichersystem sollte heruntergefahren werden, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers zu gewährleisten.
...
Nachdem Sie die FAS8300 und FAS8700 Controller heruntergefahren haben, müssen Sie link:controller-replace-move-hardware.html["Ersetzen Sie den Controller"].
