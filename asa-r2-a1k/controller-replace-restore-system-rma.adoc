...
summary: Um den Controller-Austausch Ihres ASA A1K-Systems abzuschließen, stellen Sie zunächst die NetApp Storage Encryption-Konfiguration wieder her, falls erforderlich. Überprüfen Sie anschließend, ob die logischen Schnittstellen an ihren Home-Ports melden, und führen Sie eine Cluster-Integritätsprüfung durch. Senden Sie abschließend das defekte Bauteil an NetApp zurück. 
---
= Den Controller-Austausch für Ihr ASA A1K System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
