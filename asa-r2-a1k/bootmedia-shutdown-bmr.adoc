...
summary: Fahren Sie den außer Betrieb genommenen Controller in Ihrem ASA A1K-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch der Startmedien sicherzustellen. 
---
= Der Controller im ASA A1K System wird während des automatisierten Boot-Wiederherstellungsprozesses heruntergefahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den außer Betrieb genommenen Controller in Ihrem ASA A1K-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch der Startmedien sicherzustellen.
