...
summary: Fahren Sie den Controller in Ihrem ASA A1K Storage-System herunter, um Datenverluste zu vermeiden und die Systemstabilität beim Austausch des Controllers zu gewährleisten. 
---
= Vor dem Austausch muss der defekte Controller in einem ASA A1K System abgeschaltet werden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den Controller in Ihrem ASA A1K Storage-System herunter, um Datenverluste zu vermeiden und die Systemstabilität beim Austausch des Controllers zu gewährleisten.
