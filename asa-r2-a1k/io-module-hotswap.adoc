...
summary: Sie können ein Ethernet-E/A-Modul in Ihrem ASA A1K-Speichersystem per Hot-Swap austauschen, wenn ein Modul ausfällt und Ihr Speichersystem alle ONTAP-Versionanforderungen erfüllt. 
---
= Ein E/A-Modul kann in Ihrem ASA A1K System Hot-Swap-fähig ausgetauscht werden, ohne dass ein Herunterfahren erforderlich ist.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können ein Ethernet-E/A-Modul in Ihrem ASA A1K-Speichersystem per Hot-Swap austauschen, wenn ein Modul ausfällt und Ihr Speichersystem alle ONTAP-Versionanforderungen erfüllt.
...
Ersetzen Sie das ausgefallene E/A-Modul durch ein gleichwertiges E/A-Modul.
