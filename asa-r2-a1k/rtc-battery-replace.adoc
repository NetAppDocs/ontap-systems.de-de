...
summary: 'Ersetzen Sie in Ihrem ASA A1K-System die Echtzeituhr (RTC)-Batterie, die allgemein als Knopfzellenbatterie bezeichnet wird, um sicherzustellen, dass Dienste und Anwendungen, die auf eine genaue Zeitsynchronisierung angewiesen sind, weiterhin funktionsfähig bleiben.' 
---
= Ersetzen Sie den Echtzeitakku ASA A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
