...
Die Dokumentation der ONTAP Hardwaresysteme enthält jetzt Spezifikationen, die auch inlink:https://hwu.netapp.com["Hardware Universe"] .  Zum Beispiel,link:https://docs.netapp.com/us-en/ontap-systems_hotfix-main/a1k/overview.html["Wichtige Spezifikationen für AFF A1K"] .
