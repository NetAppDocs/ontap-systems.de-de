...
summary: Das ONTAP Image wird auf dem Ersatz-Bootmedium in Ihrem FAS2820 System wiederhergestellt. Dabei wird der Boot-Wiederherstellungsprozess über die LOADER-Eingabeaufforderung gestartet und der Wiederherstellungsprozess bis zum Abschluss und dem Neustart des Knotens überwacht. 
---
= Das Startabbild auf Ihrem FAS2820 System kann mit dem automatisierten Boot-Wiederherstellungsprozess wiederhergestellt werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach dem Einbau des neuen Bootmediums in Ihr FAS2820-System können Sie den automatischen Bootmedien-Wiederherstellungsprozess starten, um die Konfiguration vom Partnerknoten wiederherzustellen. Während des Wiederherstellungsprozesses prüft das System, ob die Verschlüsselung aktiviert ist und ermittelt den verwendeten Typ der Schlüsselverschlüsselung. Wenn die Schlüsselverschlüsselung aktiviert ist, führt das System durch die entsprechenden Schritte zur Wiederherstellung.
