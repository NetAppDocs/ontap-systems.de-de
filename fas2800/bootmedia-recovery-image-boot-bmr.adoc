...
summary: Stellen Sie das ONTAP Image auf dem Ersatz-Bootmedium in Ihrem fas2800-System wieder her.  Der Vorgang umfasst das Starten des Boot-Wiederherstellungsprozesses von der LOADER-Eingabeaufforderung aus und das Überwachen des Wiederherstellungsprozesses, bis dieser abgeschlossen ist und der Knoten neu gestartet wird. 
---
