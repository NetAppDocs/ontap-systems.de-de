...
summary: Wichtigste Spezifikationen für die FAS2820 Plattformgruppe 
---
= Wichtige Spezifikationen für ein FAS2820 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dies sind ausgewählte Spezifikationen für das FAS2820 Speichersystem in einer einzelnen Hochverfügbarkeits-Paar-Konfiguration. Die vollständigen Spezifikationen für dieses Speichersystem sind unter  https://hwu.netapp.com["NetApp Hardware Universe"^] verfügbar.
...
* Mindestversion von ONTAP : ONTAP 9.13.1RC1
