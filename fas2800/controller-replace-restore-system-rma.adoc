...
summary: 'Das FAS2820-System kann wieder vollständig in Betrieb genommen werden, indem die NetApp Storage Encryption- oder Volume Encryption-Konfigurationen (falls erforderlich) wiederhergestellt, Lizenzen für den Ersatzcontroller installiert und das defekte Teil an NetApp zurückgesendet werden, wie in den mit dem Kit gelieferten RMA-Anweisungen beschrieben.' 
---
= Den Controller-Austausch für ein FAS2820 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das FAS2820-System kann wieder vollständig in Betrieb genommen werden, indem die NetApp Storage Encryption- oder Volume Encryption-Konfigurationen (falls erforderlich) wiederhergestellt, Lizenzen für den Ersatzcontroller installiert und das defekte Teil an NetApp zurückgesendet werden, wie in den mit dem Kit gelieferten RMA-Anweisungen beschrieben.
