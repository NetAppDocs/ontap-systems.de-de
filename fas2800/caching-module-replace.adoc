...
summary: Das Caching-Modul im Controller-Modul Ihres FAS2820-Systems ist auszutauschen, wenn eine einzelne AutoSupport-Meldung registriert wird, dass das Modul offline gegangen ist. Wenn das defekte Modul nicht ersetzt wird, kommt es zu einer Leistungsverschlechterung des Speichersystems. 
---
= Das Caching-Modul in einem FAS2820 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Caching-Modul im Controller-Modul Ihres FAS2820-Systems muss ausgetauscht werden, wenn eine einzelne AutoSupport (ASUP)-Meldung registriert wird, dass das Modul offline gegangen ist. Wenn das ausgefallene Modul nicht ersetzt wird, kommt es zu einer Leistungsverschlechterung Ihres Speichersystems.
