...
summary: Sie müssen das Caching-Modul im Controller-Modul austauschen, wenn Ihr System eine einzelne AutoSupport ASUP-Meldung registriert, dass das Modul offline gegangen ist. Wenn Sie das ausgefallene Modul nicht ersetzen, wird die Leistung Ihres Speichersystems beeinträchtigt. 
---
