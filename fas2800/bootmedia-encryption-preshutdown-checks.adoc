...
summary: Um die Datensicherheit auf Ihrem FAS2820 Storage-System zu gewährleisten, muss die Unterstützung und der Status des Verschlüsselungsschlüssels auf Ihrem Boot-Medium überprüft werden. Es sollte geprüft werden, ob Ihre ONTAP Version NetApp Volume Encryption unterstützt, und vor dem Herunterfahren des Controllers sollte überprüft werden, ob der Key Manager aktiv ist. 
---
= Die Verschlüsselungsunterstützung auf dem Bootmedium eines FAS2820 Systems mithilfe des manuellen Boot-Wiederherstellungsprozesses prüfen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um die Datensicherheit auf Ihrem FAS2820-Speichersystem zu gewährleisten, die Unterstützung und den Status des Verschlüsselungsschlüssels auf Ihrem Boot-Medium überprüfen. Es ist zu prüfen, ob Ihre ONTAP Version NetApp Volume Encryption (NVE) unterstützt. Vor dem Herunterfahren des Controllers ist zu prüfen, ob der Schlüsselmanager aktiv ist.
