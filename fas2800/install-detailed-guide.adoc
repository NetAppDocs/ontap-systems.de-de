...
summary: Dieses Verfahren enthält detaillierte Schritt-für-Schritt-Anweisungen zur Installation Ihres FAS2820 Storage-Systems. 
---
= Das FAS2820 System kann anhand detaillierter Anweisungen installiert werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dieses Verfahren enthält detaillierte Schritt-für-Schritt-Anweisungen zur Vorbereitung, Installation, Verkabelung und Inbetriebnahme Ihres FAS2820 Storage-Systems. Diese Schritte sind geeignet, wenn ausführliche Erklärungen der Kurzanleitung vorgezogen werden.
...
+
.. Die Anforderungen und Verfahrensschritte werden überprüft.
.. Informationen über Ihr Speichersystem werden durch das Ausfüllen des Einrichtungsarbeitsblatts gesammelt.
...
NOTE: Falls Ihr System keine externen Regale besitzt, siehe link:../sas3/install-cabling-worksheets-examples-fas2600.html#fas2820-platform-in-a-multipath-ha-configuration-with-no-external-shelves["Verkabelungsanleitung für FAS2820 in einer Multipath-HA-Konfiguration ohne externe Shelves"].
...
Die Einrichtung und Konfiguration des Speichersystems kann entweder mit Option 1 abgeschlossen werden, wenn die Netzwerkerkennung aktiviert ist, oder mit Option 2, wenn die Netzwerkerkennung nicht aktiviert ist.
...
--
Wenn die Netzwerkerkennung auf Ihrem Laptop aktiviert ist, kann die Einrichtung und Konfiguration des Speichersystems mithilfe der automatischen Clustererkennung abgeschlossen werden.

.Schritte
. Die Stromversorgung des Regals wird eingeschaltet und die Regal-IDs mithilfe der Animation am Anfang dieses Schritts festgelegt.
...
NOTE: Der erste Startvorgang kann bis zu acht Minuten dauern.
...
. Die Grafik oder die Schritte geben Aufschluss darüber, welcher Speichersystemknoten zu konfigurieren ist:
+
image::../media/drw_autodiscovery_controler_select_ieops-1849.svg[Automatische Erkennung des Systems]

+
.. Öffnen Sie Den Datei-Explorer.
.. Mit der rechten Maustaste auf *Netzwerk* im linken Bereich klicken und *Aktualisieren* auswählen.
...
+
.. Wählen https://mysupport.netapp.com["mysupport.netapp.com"]
.. „Konto erstellen“ auswählen, falls ein Konto erstellt oder in das eigene Konto eingeloggt werden muss.
...
.. Das Speichersystem wird mit den Daten konfiguriert, die in <<Schritt 1: Installation vorbereiten>> gesammelt wurden.
