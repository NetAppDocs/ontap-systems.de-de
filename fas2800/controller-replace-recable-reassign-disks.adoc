...
summary: 'Um den Controller-Austausch abzuschließen und Ihr FAS2820 System wieder voll funktionsfähig zu machen, müssen der Speicher neu verkabelt, die Neuzuordnung der Festplatten bestätigt, die NetApp Storage Encryption Konfiguration wiederhergestellt (falls erforderlich) und Lizenzen für den neuen Controller installiert werden.' 
---
= Der Controller in Ihrem FAS2820 System wird zurückgegeben, damit der normale Betrieb fortgesetzt werden kann.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um den Austauschvorgang abzuschließen und Ihr FAS2820 System wieder voll funktionsfähig zu machen, müssen der Speicher neu verkabelt, die Neuzuordnung der Festplatten bestätigt, die NetApp Storage Encryption Konfiguration (falls erforderlich) wiederhergestellt und Lizenzen für den neuen Controller installiert werden.
