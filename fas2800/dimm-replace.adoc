...
summary: Das DIMM im Controller Ihres FAS2820 Systems ist auszutauschen, wenn Fehler wie übermäßige korrigierbare ECC-Speicherfehler gemäß Health Monitor-Warnungen oder nicht korrigierbare ECC-Fehler auftreten, was typischerweise durch einen einzelnen DIMM-Ausfall verursacht wird, der das Speichersystem am Starten von ONTAP hindert. 
---
= Ein DIMM in einem FAS2820 System ersetzen, um Speicherfehler zu beheben.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das DIMM im Controller Ihres FAS2820 Systems ist auszutauschen, wenn Fehler wie übermäßige korrigierbare ECC-Speicherfehler gemäß Health Monitor-Warnungen oder nicht korrigierbare ECC-Fehler auftreten, was typischerweise durch einen einzelnen DIMM-Ausfall verursacht wird, der das Speichersystem am Starten von ONTAP hindert.
