...
summary: Sie müssen ein DIMM im Controller austauschen, wenn in Ihrem Speichersystem Fehler auftreten, wie z. B. übermäßig viele korrigierbare ECC-Fehler basierend auf Health Monitor-Warnungen oder nicht korrigierbare ECC-Fehler, die das Booten von ONTAP im Speichersystem verhindern. 
---
