...
summary: Die Verschlüsselung auf dem Ersatz-Bootmedium in Ihrem FAS2820 System wird wiederhergestellt. 
---
= Wiederherstellung der Verschlüsselung auf dem Bootmedium in einem FAS2820-System nach dem manuellen Boot-Wiederherstellungsprozess
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nachdem das Bootmedium in Ihrem FAS2820 System ausgetauscht wurde, sollte die Verschlüsselung auf dem neuen Gerät wiederhergestellt werden, um die Datensicherheit zu gewährleisten und das System auf seine ursprüngliche Konfiguration zurückzusetzen.
