...
[role="lead"]
Das Bootmedium Ihres FAS2820-Systems speichert wichtige Firmware- und Konfigurationsdaten. Der Austauschvorgang umfasst das Entfernen und Öffnen des Controllermoduls, das Entfernen des beschädigten Bootmediums, das Einsetzen des Ersatz-Bootmediums in das Controllermodul und anschließend das Wiedereinsetzen des Controllermoduls.
