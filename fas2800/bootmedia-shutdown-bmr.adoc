...
summary: Der Controller im FAS2820-Speichersystem wird heruntergefahren, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Bootmediums zu gewährleisten. 
---
= Den Controller in Ihrem FAS2820 System während des automatisierten Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller im FAS2820-Speichersystem wird heruntergefahren, um Datenverlust zu vermeiden und die Systemstabilität während des automatisierten Wiederherstellungsprozesses des Bootmediums zu gewährleisten.
