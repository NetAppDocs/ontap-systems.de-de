...
summary: Der defekte Controller im FAS2820-Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Bootmediums zu gewährleisten. 
---
= Den defekten Controller in Ihrem FAS2820 System während des automatisierten Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie den defekten Controller in Ihrem FAS2820-Speichersystem ab, um Datenverlust zu verhindern und die Systemstabilität während des automatisierten Wiederherstellungsprozesses des Bootmediums aufrechtzuerhalten.
