...
summary: Der Austausch des Bootmediums im FAS2820-Speichersystem erfolgt durch Überprüfung der Austauschvoraussetzungen, Herunterfahren der Controller, Austausch des Bootmediums, Wiederherstellung des Images auf dem Bootmedium und Überprüfung der Systemfunktionalität. 
---
= Arbeitsablauf zum Austausch des Bootmediums für ein FAS2820 System unter Verwendung des automatisierten Boot-Wiederherstellungsprozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die automatische Wiederherstellung des Startabbilds beinhaltet das automatische Erkennen und Auswählen der passenden Startmenüoption durch das System. Es verwendet das Startabbild auf dem Partnerknoten, um ONTAP auf dem Ersatzstartmedium in Ihrem FAS2820 Storage-System neu zu installieren.
