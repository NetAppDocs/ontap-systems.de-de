...
summary: Nach Abschluss des Hardwareaustauschs und dem Start des Ersatzcontrollers in Ihrem FAS2820 System sollte die Systemkonfiguration auf niedriger Ebene des Ersatzcontrollers überprüft und die Systemeinstellungen bei Bedarf neu konfiguriert werden. 
---
= Wiederherstellen und Überprüfen der Controller-Konfiguration in einem FAS2820 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss des Hardwareaustauschs und dem Start des Ersatzcontrollers in Ihrem FAS2820 System sollte die Systemkonfiguration auf niedriger Ebene des Ersatzcontrollers überprüft und die Systemeinstellungen bei Bedarf neu konfiguriert werden.
