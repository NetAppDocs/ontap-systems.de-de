...
summary: Vor dem Austausch ist der defekte Controller in Ihrem FAS2820 System herunterzufahren. Das verwendete Verfahren hängt von der Hardwarekonfiguration Ihres Speichersystems ab. 
---
= Vor dem Austausch muss der defekte Controller in einem FAS2820 System abgeschaltet werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vor dem Austausch ist der defekte Controller in Ihrem FAS2820 System herunterzufahren. Das verwendete Verfahren hängt von der Hardwarekonfiguration Ihres Speichersystems ab.
