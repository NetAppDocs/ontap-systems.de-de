...
summary: In Ihrem FAS2820 System wird die defekte Controller-Modul-Hardware ersetzt, indem der defekte Controller entfernt, die FRU-Komponenten in das Ersatz-Controller-Modul übertragen, das Ersatz-Controller-Modul im Chassis installiert und anschließend das Ersatz-Controller-Modul gebootet wird. 
---
= Den Controller in einem FAS2820 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
In Ihrem FAS2820 System wird die defekte Controller-Modul-Hardware ersetzt, indem der defekte Controller entfernt, die FRU-Komponenten in das Ersatz-Controller-Modul übertragen, das Ersatz-Controller-Modul im Chassis installiert und anschließend das Ersatz-Controller-Modul gebootet wird.
...
NOTE: Schließen Sie den Akku noch nicht an. Der Akku wird erst angeschlossen, nachdem die übrigen Komponenten in das Ersatz-Steuergerätemodul eingebaut wurden.
...
. Das Bootmedium auf dem Ersatz-Controllermodul installieren:
+
...
Das Caching-Modul ist aus dem defekten Steuergerätemodul zu entnehmen und in das Ersatzsteuergerätemodul einzusetzen.
