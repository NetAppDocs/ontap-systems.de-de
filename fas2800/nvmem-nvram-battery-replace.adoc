...
summary: Um eine NVMEM Batterie in Ihrem FAS2820 System zu ersetzen, ist es erforderlich, das Controller-Modul zu entfernen, es zu öffnen, die Batterie zu ersetzen und anschließend das Controller-Modul wieder zu schließen und einzubauen. 
---
= Die NVMEM Batterie in einem FAS2820 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um eine NVMEM Batterie in Ihrem FAS2820 System zu ersetzen, ist es erforderlich, das Controller-Modul zu entfernen, es zu öffnen, die Batterie zu ersetzen und anschließend das Controller-Modul wieder zu schließen und einzubauen.

Falls andere Komponenten im System nicht ordnungsgemäß funktionieren, kontaktieren Sie  https://mysupport.netapp.com/site/global/dashboard["NetApp Support"].
...
NOTE: Die grüne NV-LED auf der Frontplatte beginnt zu blinken, wenn die Stromversorgung des Controllers entfernt wird, falls sich das System im Zustand „Warten auf Rückgabe“ befand oder das System nicht ordnungsgemäß übernommen oder angehalten wurde (nicht übertragene Daten). Falls das betroffene Controller-Modul nicht erfolgreich vom Partner-Controller-Modul übernommen wurde, kontaktieren Sie https://mysupport.netapp.com/site/global/dashboard["NetApp Support"]

+
** Wenn die grüne NV-Status-LED zu blinken beginnt, wenn das Controller-Modul aus dem Gehäuse entfernt wird:
+
*** Bestätigen Sie, dass das Controller-Modul vom Partner-Controller-Modul ordnungsgemäß übernommen wurde oder dass der beeinträchtigte Controller _waiting for giveback_ anzeigt. Ist dies der Fall, kann die blinkende LED ignoriert und der beeinträchtigte Controller aus dem Chassis entfernt werden.


** Wenn die grüne NV-LED aus ist, lässt sich der defekte Controller vollständig aus dem Gehäuse entfernen.
...
.Schritte
. Wenn Sie nicht bereits geerdet sind, sollten Sie sich richtig Erden.
. Das Steuergerät wird aus dem Gehäuse entfernt.
