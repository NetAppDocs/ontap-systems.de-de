...
summary: Sie müssen ein Laufwerk in Ihrem FAS2820-System austauschen, wenn die Plattform eine Warnmeldung auf der Systemkonsole ausgibt, die auf einen Laufwerksausfall hinweist. Sowohl die Fehler-LED auf dem Bedienerdisplay als auch die Fehler-LED am ausgefallenen Laufwerk leuchten. 
---
= Ein Laufwerk im FAS2820 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie müssen ein Laufwerk in Ihrem FAS2820-System austauschen, wenn die Plattform eine Warnmeldung auf der Systemkonsole ausgibt, die auf einen Laufwerksausfall hinweist. Sowohl die Fehler-LED auf dem Bedienerdisplay als auch die Fehler-LED am ausgefallenen Laufwerk leuchten.
