...
summary: Ein Laufwerk in Ihrem FAS2820-System ist im laufenden Betrieb auszutauschen, wenn die Plattform eine Warnmeldung auf der Systemkonsole protokolliert, die auf einen Laufwerksausfall hinweist. Sowohl die Fehler-LED auf dem Bedienerdisplay als auch die Fehler-LED am ausgefallenen Laufwerk leuchten. 
---
...
[role="lead"]
Ein ausgefallenes Laufwerk in Ihrem FAS2820 System kann im laufenden Betrieb ausgetauscht werden, während I/O aktiv ist, um Speicherkapazität und Leistung wiederherzustellen.
