...
summary: 'Ein Laufwerk in einem FAS2820-System kann im laufenden Betrieb ausgetauscht werden, wenn die Plattform eine Warnmeldung an die Systemkonsole protokolliert und die Fehler-LEDs am Bedienerdisplay sowie am ausgefallenen Laufwerk aufleuchten. Das Laufwerk kann ohne Unterbrechung der E/A ersetzt werden, wobei sich die Schritte je nach Laufwerkstyp (SSD oder HDD) geringfügig unterscheiden.' 
---
= Laufwerk im laufenden Betrieb in einem FAS2820 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein Laufwerk in einem FAS2820-System kann im laufenden Betrieb ausgetauscht werden, wenn die Plattform eine Warnmeldung an die Systemkonsole protokolliert und die Fehler-LEDs am Bedienerdisplay sowie am ausgefallenen Laufwerk aufleuchten. Das Laufwerk kann ohne Unterbrechung der E/A ersetzt werden, wobei sich die Schritte je nach Laufwerkstyp (SSD oder HDD) geringfügig unterscheiden.
