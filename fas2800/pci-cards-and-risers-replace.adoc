...
summary: Die Mezzanine-Karte im FAS2820 System ist bei einem Defekt auszutauschen oder für ein anderes Protokoll durch die Installation einer neuen Karte aufzurüsten. 
---
= Eine Mezzanine-Karte in einem FAS2820 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Mezzanine-Karte im FAS2820 System ist bei einem Defekt auszutauschen oder für ein anderes Protokoll durch die Installation einer neuen Karte aufzurüsten.
