...
summary: Bevor das Chassis in Ihrem FAS2820 System ausgetauscht wird, müssen die Controller ordnungsgemäß heruntergefahren werden, um Datenverlust zu verhindern und die Systemstabilität zu gewährleisten. 
---
= Die FAS2820 Controller werden heruntergefahren, um das Chassis auszutauschen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bevor das Chassis in Ihrem FAS2820 System ausgetauscht wird, müssen die Controller ordnungsgemäß heruntergefahren werden, um Datenverlust zu verhindern und die Systemstabilität zu gewährleisten.
