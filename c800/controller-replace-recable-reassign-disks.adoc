...
---
= Das System wird neu verkabelt und die Datenträger in Ihrem AFF C800 System werden neu zugewiesen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Übergeben Sie die Kontrolle über die Speicherressourcen wieder an den Ersatzcontroller, damit Ihr AFF C800 -System den normalen Betrieb wieder aufnehmen kann.  Das Rückgabeverfahren variiert je nach Art der von Ihrem System verwendeten Verschlüsselung: keine Verschlüsselung oder Onboard Key Manager (OKM)-Verschlüsselung.
