...
summary: Fahren Sie den beeinträchtigten Controller in Ihrem AFF C800 Speichersystem herunter, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Bootmediums sicherzustellen. 
---
= Der Controller im AFF C800 System wird während des automatisierten Boot-Wiederherstellungsprozesses heruntergefahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den beschädigten Controller in Ihrem AFF C800 Speichersystem herunter, um Datenverlust zu verhindern und die Systemstabilität während des automatischen Boot-Medienwiederherstellungsprozesses aufrechtzuerhalten.
