...
Im AFF C800 befindet sich ein Startmediengerät. Sie müssen ihn von der beeinträchtigten Steuerung verschieben und in den Controller _Replacement_ installieren.
