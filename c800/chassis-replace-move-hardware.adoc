...
---
= Das Chassis in Ihrem AFF C800 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nachdem Sie das defekte AFF C800 Gehäuse ausgetauscht und die Komponenten wieder eingebaut haben, müssen Sie Folgendes tun:link:chassis-replace-complete-system-restore-rma.html["Schließen Sie den Austausch des Gehäuses ab"]
