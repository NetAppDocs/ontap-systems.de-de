...
---
= Wichtigste Spezifikationen für ein AFF C800 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Akustische Geräusche: Angegebene Schallleistung (LwAd): 8,0; Schalldruck (LpAm) (Positionen von Umstehenden): 62,8 dB
