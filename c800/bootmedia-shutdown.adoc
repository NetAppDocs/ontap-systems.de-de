...
[role="lead"]
Fahren Sie den beeinträchtigten Controller in Ihrem AFF C800 Speichersystem herunter, um Datenverlust zu verhindern und die Systemstabilität während des automatischen Wiederherstellungsprozesses des Bootmediums aufrechtzuerhalten.
