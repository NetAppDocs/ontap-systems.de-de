...
summary: Tauschen Sie das NVDIMM in Ihrem AFF C800-System aus, wenn Ihr System erkennt, dass die Lebensdauer des Flash-Speichers fast erschöpft ist oder dass das identifizierte NVDIMM generell nicht in einwandfreiem Zustand ist. 
---
= Ein NVDIMM in einem AFF C800 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Tauschen Sie das NVDIMM in Ihrem AFF C800 -System aus, wenn Ihr System erkennt, dass die Lebensdauer des Flash-Speichers fast erreicht ist oder dass das identifizierte NVDIMM generell nicht in Ordnung ist; andernfalls kommt es zu einem Systemabsturz.

.Bevor Sie beginnen
* Stellen Sie sicher, dass Sie das von NetApp erhaltene Ersatz-NVDIMM-Modul besitzen und dass es mit Ihrem AFF C800 -System kompatibel ist.
