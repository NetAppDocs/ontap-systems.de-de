...
---
= Vor dem Austausch muss der defekte Controller in einem AFF C800 System abgeschaltet werden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie den Controller Ihres AFF C800 -Speichersystems ab, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Controllers zu gewährleisten.
