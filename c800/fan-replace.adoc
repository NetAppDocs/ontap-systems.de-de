...
---
= Einen Lüfter in einem AFF C800 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Tauschen Sie ein Lüftermodul in Ihrem AFF C800 -System aus, wenn ein Lüfter ausfällt oder nicht effizient arbeitet, da dies die Systemkühlung und die Gesamtleistung beeinträchtigen kann.  Der Austauschprozess umfasst das Abschalten des defekten Controllers, dessen Ausbau, den Austausch des Lüftermoduls, den Wiedereinbau des Controllers und die anschließende Rücksendung des defekten Teils an NetApp.
...
Das Controllermodul ist aus dem Gehäuse zu entnehmen, wenn das Controllermodul ersetzt oder eine Komponente innerhalb des Controllermoduls ausgetauscht wird.
...
Suchen Sie das defekte Lüftermodul und ersetzen Sie es durch ein neues Lüftermodul.
