...
---
= Den Chassis-Austausch für ein AFF A150 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Mit diesem Vorgang wird der Chassis-Austausch für Ihr AFF A150 System abgeschlossen, indem der HA-Status überprüft, die Aggregate zurückgeschaltet und das defekte Chassis an NetApp zurückgesendet wird.
