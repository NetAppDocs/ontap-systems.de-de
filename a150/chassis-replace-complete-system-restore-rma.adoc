...
[role="lead"]
Der HA-Status des Chassis wird überprüft, die Aggregate werden zurückgeschaltet, und das defekte Teil wird an NetApp zurückgesendet, um den Chassis-Austausch für Ihr AFF A150 System abzuschließen.
