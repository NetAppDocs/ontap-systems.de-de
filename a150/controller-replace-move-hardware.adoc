...
---
= Den Controller in Ihrem AFF A150 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller in Ihrem AFF A150 System wird ersetzt, wenn ein Hardwarefehler dies erforderlich macht. Der Austauschprozess umfasst das Entfernen des defekten Controller-Moduls, das Übertragen der FRU-Komponenten auf den Ersatzcontroller, das Installieren des Ersatzcontroller-Moduls im Gehäuse sowie das Starten des Systems im Wartungsmodus.
