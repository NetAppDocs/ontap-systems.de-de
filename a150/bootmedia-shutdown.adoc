...
[role="lead"]
Der defekte Controller in Ihrem AFF A150-Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität während des manuellen Boot-Wiederherstellungsprozesses aufrechtzuerhalten.
