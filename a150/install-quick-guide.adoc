...
---
= Installation eines AFF A150 Systems mithilfe der kurzen grafischen Anleitung
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das AFF A150 Speichersystem kann mithilfe der kurzen grafischen Anleitung installiert und verkabelt werden.
