...
---
= Das Chassis in Ihrem AFF A150 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Chassis Ihres AFF A150 Systems wird ersetzt, wenn ein Hardwarefehler dies erforderlich macht. Beim Austausch werden die Netzteile, Laufwerke und Controller-Module vom defekten Chassis in das Ersatzchassis umgesetzt.
