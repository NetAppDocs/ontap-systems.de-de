...
---
= Die Anforderungen für den Austausch eines Controllers in einem AFF A150 System werden dargestellt.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bevor der Controller in Ihrem AFF A150 System ersetzt wird, sollte sichergestellt sein, dass die notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sind. Es sollte überprüft werden, ob alle Laufwerksshelfs ordnungsgemäß funktionieren, ob der funktionsfähige Controller den beeinträchtigten Controller übernehmen kann und ob das korrekte Austauschverfahren für Ihre Version von ONTAP ausgewählt wurde.
