...
---
= Die Anforderungen für den Austausch des Controllers in Ihrem AFF A150 System werden hier aufgeführt.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bevor der Controller in Ihrem AFF A150 System ersetzt wird, sollten die notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sein. Dazu zählt die Überprüfung, dass alle Laufwerksshelfs ordnungsgemäß funktionieren, der funktionsfähige Controller den beeinträchtigten Controller übernehmen kann und das korrekte Austauschverfahren für Ihre Version von ONTAP ausgewählt wird.
