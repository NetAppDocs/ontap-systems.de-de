...
---
= Die Batterie der Echtzeituhr in einem AFF A150 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Echtzeit-Batterie (RTC) in Ihrem AFF A150 System sollte ersetzt werden, damit Dienste und Anwendungen, die auf eine präzise Zeitsynchronisation angewiesen sind, weiterhin funktionieren.
