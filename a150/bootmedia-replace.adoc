...
---
= Das Bootmedium in einem AFF A150 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Bootmedium in Ihrem AFF A150 System speichert wichtige Firmware- und Konfigurationsdaten. Der Austauschvorgang umfasst das Entfernen des Controllermoduls, das Entfernen des defekten Bootmediums, das Einsetzen des Ersatz-Bootmediums und anschließend die Übertragung des ONTAP Image auf das Ersatz-Bootmedium mithilfe eines USB-Flash-Laufwerks.
