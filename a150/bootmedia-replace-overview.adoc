...
[role="lead"]
Bevor das Bootmedium in Ihrem AFF A150 System ausgetauscht wird, sollten die notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sein. Dazu gehört ein mit FAT32 formatierter USB-Stick mit ausreichend Speicherplatz für das ONTAP Recovery Image sowie die Kenntnis darüber, ob ein unterbrechungsfreier oder unterbrechender Austausch durchgeführt wird.
