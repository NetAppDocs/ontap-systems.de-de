...
---
= Das Wiederherstellungsimage auf Ihrem AFF A150 System wird mithilfe des manuellen Boot-Wiederherstellungsprozesses gestartet.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach der Installation des neuen Bootmediums in Ihrem AFF A150 System wird das ONTAP Wiederherstellungsimage von einem USB-Laufwerk gebootet, um das Dateisystem wiederherzustellen und die Umgebungsvariablen zu überprüfen.
