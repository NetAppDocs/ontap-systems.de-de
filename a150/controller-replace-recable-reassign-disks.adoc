...
---
= Das System neu verkabeln und die Datenträger im AFF A150 System neu zuweisen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Den Speicher neu verkabeln, die Neuzuordnung der Festplatten bestätigen und NetApp Storage Encryption wiederherstellen, damit das AFF A150 System wieder vollständig betriebsbereit ist.
