...
---
= Laufwerk im laufenden Betrieb in einem AFF A150 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes Laufwerk in Ihrem AFF A150 System kann während laufender I/O-Vorgänge unterbrechungsfrei ausgetauscht werden, um die Speicherkapazität und Leistung wiederherzustellen.
