...
---
= Ein Laufwerk in Ihrem AFF A150 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes Laufwerk in Ihrem AFF A150 System kann unterbrechungsfrei während laufender E/A-Vorgänge ersetzt werden, um die Speicherkapazität und Leistung wiederherzustellen.
