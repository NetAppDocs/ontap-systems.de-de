...
---
= Die Verschlüsselungsunterstützung auf dem Bootmedium im AFF A150 System überprüfen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um die Datensicherheit auf Ihrem AFF A150 Storage-System zu gewährleisten, muss die Unterstützung und der Status des Verschlüsselungsschlüssels auf Ihrem Boot-Medium überprüft werden. Es sollte geprüft werden, ob Ihre ONTAP Version NetApp Volume Encryption (NVE) unterstützt und ob der Schlüsselmanager vor dem Herunterfahren des Controllers aktiv ist.
