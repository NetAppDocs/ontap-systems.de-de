...
---
= Wiederherstellung der Verschlüsselung auf dem Bootmedium in einem AFF A150 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Stellen Sie die Verschlüsselung auf dem Ersatz-Bootmedium in Ihrem AFF A150 System wieder her, um den fortlaufenden Datenschutz zu gewährleisten. Der Austauschvorgang umfasst die Überprüfung der Schlüsselverfügbarkeit, die erneute Anwendung der Verschlüsselungseinstellungen und die Bestätigung des sicheren Zugriffs auf Ihre Daten.
