...
---
= Vor dem Austausch muss der defekte Controller in einem AFF A150 System abgeschaltet werden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Herunterfahren des defekten Controllers in Ihrem AFF A150-Speichersystem verhindert Datenverlust und gewährleistet die Systemstabilität beim Austausch des Controllers.
