...
---
= Das AFF A150 System kann anhand detaillierter Schritt-für-Schritt-Anleitungen installiert werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das AFF A150 Speichersystem kann mit diesen detaillierten Schritt-für-Schritt-Anweisungen installiert werden, von der Vorbereitung des Standorts bis zur Inbetriebnahme des ONTAP Clusters.
...
*Warnung:* Wenn ONTAP 9.13.1P8 bis 9.13.1P11, ONTAP 9.14.1P1 bis 9.14.1P7 oder ONTAP 9.15.1 bis 9.15.1P2 installiert wird und das System 10 oder mehr interne Solid-State-Laufwerke enthält, sind zusätzliche Schritte zur Vorbereitung des Systems auf die Installation erforderlich. Siehe Problem  https://mysupport.netapp.com/site/bugs-online/product/ONTAP/JiraNgage/CONTAP-285173["CONTAP-285173 - ADP hinterlässt keine freie Root-Partition auf einer AFF A150 mit 10 oder mehr internen Laufwerken"^].
...
** Zusätzliche Netzwerkkabel zum Verbinden Ihres Systems mit Ihrem Netzwerk-Switch und Laptop oder Konsole mit Webbrowser
** Ein Laptop oder eine Konsole mit RJ-45-Anschluss und Zugriff auf einen Webbrowser
...
Das System wird in einem Vier-Pfosten-Rack oder, falls zutreffend, in einem NetApp Systemschrank installiert.
...
Cluster Interconnect
 ...
 a| 
image::../media/icon_square_2_orange.png[Legende Nummer 2]
 a| 
...
--
Ethernet-Netzwerkkonfigurationen:: Das Cat 6 RJ45-Kabel dient dazu, die Ports e0c bis e0f mit Ihrem Host-Netzwerk zu verbinden, wie in der folgenden Abbildung dargestellt.
+
--
...
** Controller 2 Port 0b zu IOM B-Port 3 auf dem letzten Laufwerk-Shelf im Stack. + image:../media/oie_cable_mini_sas_hd_to_mini_sas_hd.png["Mini-SAS-zu-Mini-SAS-Anschluss"] Mini-SAS HD auf Mini-SAS HD Kabel
...
.. Im linken Bereich *Network* auswählen, mit der rechten Maustaste klicken und *refresh* auswählen.
