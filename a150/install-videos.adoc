...
---
= Installation eines AFF A150 Systems mithilfe von Videoanleitungen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das AFF A150 Speichersystem kann anhand der Schritt-für-Schritt-Videoanleitungen installiert und verkabelt werden.
