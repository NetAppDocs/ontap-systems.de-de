...
summary: Das Netzteil im AFF A150 System sollte ersetzt werden, wenn es ausfällt oder defekt ist. Die Netzteile sind redundant und Hot-Swap-fähig, daher ist ein Herunterfahren des Controllers für diesen Austausch nicht erforderlich. 
---
= Netzteil im laufenden Betrieb in einem AFF A150 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Netzteil im AFF A150 System sollte ersetzt werden, wenn es ausfällt oder defekt ist. Die Netzteile sind redundant und Hot-Swap-fähig, daher ist ein Herunterfahren des Controllers für diesen Austausch nicht erforderlich.
