...
---
= Ersetzen Sie das Startmedium – AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
+ das USB-Flash-Laufwerk sollte den efi-Ordner und die gleiche Service Image (BIOS)-Version von dem haben, was der beeinträchtigte Controller läuft.
