...
summary: Nach der Installation des neuen Bootmediums in Ihrem AFF C250-System können Sie den automatisierten Bootmedien-Wiederherstellungsprozess starten, um die Konfiguration vom Partner-Node wiederherzustellen. 
---
= Das Boot-Image auf dem AFF C250-Speichersystem wird mithilfe des automatisierten Boot-Wiederherstellungsprozesses wiederhergestellt.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
