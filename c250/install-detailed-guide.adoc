...
---
= Das AFF C250 Storage-System kann mithilfe der detaillierten Anleitung installiert und eingerichtet werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dieses Verfahren enthält detaillierte Schritt-für-Schritt-Anweisungen zur Installation eines AFF C250-Speichersystems.
