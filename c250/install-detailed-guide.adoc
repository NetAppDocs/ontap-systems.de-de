...
.Schritte
. Verkabeln Sie die Cluster Interconnect-Ports e0c mit e0c und e0d mit e0d mit den 25-GbE-Cluster Interconnect-Kabeln.
+
...
+
image::../media/drw_affa250_switched_clust_cabling.png[drw affa250 geschaltete Klistendelverkabelung]
