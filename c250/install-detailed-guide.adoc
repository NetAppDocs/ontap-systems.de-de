...
---
= Ein AFF C250 Storage-System mit detaillierten Schritten installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein AFF C250 Speichersystem kann mit detaillierten Schritt-für-Schritt-Anleitungen installiert werden, die die Montage, Verkabelung und die erste Inbetriebnahme des Systems abdecken.
...
.Schritte
. Verbinden Sie die Cluster-Interconnect-Ports e0c mit e0c und e0d mit e0d mit den 25-GbE-Cluster-Interconnect-Kabeln.
+
...
--
.Option 2: Kabelverbindung zu einem 25 GbE-Daten- oder Hostnetzwerk
--
