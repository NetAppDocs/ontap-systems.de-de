...
summary: Um den Controller-Austausch für Ihr AFF C250-System vollständig abzuschließen, müssen Sie die NetApp Storage Encryption-Konfiguration wiederherstellen, Lizenzen für den neuen Controller installieren und das defekte Teil an NetApp zurücksenden. 
---
= Den Controller-Austausch für ein AFF C250 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um den Controller-Austausch für Ihr AFF C250-System vollständig abzuschließen, müssen Sie die NetApp Storage Encryption-Konfiguration (falls erforderlich) wiederherstellen, Lizenzen für den neuen Controller installieren und das defekte Teil an NetApp zurücksenden, wie in den mit dem Kit gelieferten RMA-Anweisungen beschrieben.
