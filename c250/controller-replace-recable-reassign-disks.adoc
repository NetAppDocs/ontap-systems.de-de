...
---
= Das AFF C250 Storage-System neu verkabeln und Festplatten neu zuweisen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss der Wiederherstellung und Überprüfung der Systemkonfiguration des AFF C250 Systems müssen Sie das System neu verkabeln und die Festplatten neu zuweisen.
