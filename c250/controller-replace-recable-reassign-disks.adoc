...
---
= Ein AFF C250 System neu verkabeln und Festplatten neu zuweisen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss der Wiederherstellungs- und Überprüfungsschritte für die AFF C250 Systemkonfiguration ist das System neu zu verkabeln und die Festplatten sind neu zuzuweisen.
