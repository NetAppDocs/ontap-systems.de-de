...
---
= Die RTC-Batterie in einem AFF C250 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die RTC-Batterie in einem AFF C250 System wird ersetzt, damit Dienste und Anwendungen, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin funktionieren.
