...
---
= Die NVMEM-Batterie in einem AFF C250 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Eine defekte NVMEM Batterie in einem AFF C250 System kann ersetzt werden, indem das Controller-Modul entfernt, die Batterie ausgetauscht und das Controller-Modul wieder eingesetzt wird.
