...
---
= Austausch eines SSD-Laufwerks in einem AFF C250 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes SSD-Laufwerk in einem AFF C250 System kann ohne Unterbrechung ersetzt werden, während E/A-Vorgänge laufen.
