...
---
= Laufwerk im laufenden Betrieb in einem AFF C250 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes SSD-Laufwerk in einem AFF C250 System kann im laufenden Betrieb ohne Unterbrechung während eines E/A-Vorgangs ausgetauscht werden.
