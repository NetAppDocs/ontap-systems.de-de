...
---
= Eine Mezzanine-Karte in einem AFF C250 System ersetzen oder installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Eine defekte Mezzanine-Karte kann in einem AFF C250 System ersetzt oder eine neue installiert werden, indem die Kabel und alle SFP- oder QSFP-Module entfernt, die Karte ersetzt und die Verkabelung wiederhergestellt werden.
