...
summary: Zum Herunterfahren des beeinträchtigten Controller-Moduls müssen Sie den Status des Controllers bestimmen und ggf. den Controller übernehmen, damit der gesunde Controller weiterhin Daten aus dem beeinträchtigten Reglerspeicher bereitstellen kann. 
---
= Vor dem Austausch ist der defekte Controller in Ihrem AFF C250-Speichersystem herunterzufahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie den Controller in Ihrem AFF C250-Speichersystem aus, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers zu gewährleisten.
