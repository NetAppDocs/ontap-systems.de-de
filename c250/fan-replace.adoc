...
---
= Einen Lüfter in einem AFF C250 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes Lüftermodul in einem AFF C250 System wird ersetzt, indem es entfernt und ein neues Lüftermodul installiert wird.
