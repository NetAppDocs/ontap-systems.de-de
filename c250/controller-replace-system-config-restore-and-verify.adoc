...
---
= Die Controller-Konfiguration im AFF C250-Speichersystem wiederherstellen und überprüfen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss des Hardwareaustauschs und dem Hochfahren Ihres AFF C250 Systems in den Wartungsmodus müssen Sie die Low-Level-Systemkonfiguration des Ersatzcontrollers überprüfen und die Systemeinstellungen bei Bedarf neu konfigurieren.
