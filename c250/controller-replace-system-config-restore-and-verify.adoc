...
---
= Wiederherstellung und Überprüfung der Controller-Konfiguration in einem AFF C250 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss des Hardwareaustauschs und dem Hochfahren des AFF C250 Systems in den Wartungsmodus ist die Systemkonfiguration auf niedriger Ebene des Ersatzcontrollers zu überprüfen und die Systemeinstellungen gegebenenfalls neu zu konfigurieren.
