...
---
= Ein DIMM in einem AFF C250 System ersetzen, um Speicherfehler zu beheben
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein DIMM in einem AFF C250 System sollte ersetzt werden, wenn das System eine zunehmende Anzahl korrigierbarer Fehlerkorrekturcodes registriert, um einen Systemabsturz zu verhindern.
