...
[role="lead"]
Im AFF C250 befindet sich ein Boot-Medium unter dem Luftkanal im Controller-Modul. Sie müssen es vom beeinträchtigten Controller-Modul auf das Ersatzcontrollermodul verschieben.
