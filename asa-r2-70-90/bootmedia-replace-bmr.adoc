...
[role="lead"]
Ersetzen Sie die Startmedien, indem Sie das System Management-Modul von der Rückseite des Systems entfernen, das gestörte Startmedium entfernen, das Ersatz-Startmedium im System Management-Modul installieren und dann das System Management-Modul neu installieren.
