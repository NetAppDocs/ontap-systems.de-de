...
[role="lead"]
Starten Sie die Controller neu, überprüfen Sie den Systemzustand und senden Sie das fehlerhafte Teil an NetApp zurück, um den letzten Schritt im ASA A70 und ASA A90 Chassis Replacement Workflow abzuschließen.
