...
summary: Tauschen Sie das Gehäuse in Ihrem ASA A70 oder ASA A90-System aus, wenn es durch einen Hardwarefehler erforderlich ist. Bei diesem Vorgang wird das System heruntergefahren, das vorhandene Gehäuse entfernt, das neue installiert und Komponenten neu konfiguriert, um einen ordnungsgemäßen Systembetrieb zu gewährleisten. 
---
