...
summary: Tauschen Sie das Gehäuse Ihres ASA A70 oder ASA A90 Systems aus, wenn ein Hardwaredefekt dies erfordert. Der Austauschvorgang umfasst das Entfernen der Controller und Netzteile, das Entfernen der Laufwerke, den Einbau des Ersatzgehäuses und das Wiedereinsetzen der Gehäusekomponenten. 
---
= Das Chassis in Ihrem ASA A70 oder ASA A90 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Tauschen Sie das Chassis Ihrer ASA A70 und ASA A90 aus, wenn ein Hardwaredefekt dies erfordert.  Die Controller und Netzteile (PSUs) entfernen, die Laufwerke ausbauen, das Ersatzgehäuse einbauen und alle Komponenten wieder einbauen.
...
== Schritt 3: Ersetzen Sie das Chassis und installieren Sie die Komponenten.

Das beschädigte Chassis entfernen, das Ersatzchassis einbauen und alle Komponenten wieder einbauen.
...
Nach dem Austausch des beschädigten Chassis und dem Wiedereinbau der Komponenten,link:chassis-replace-complete-system-restore-rma.html["Schließen Sie den Austausch des Gehäuses ab"] Die
