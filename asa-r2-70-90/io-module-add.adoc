...
summary: Fügen Sie Ihrem ASA A70 oder ASA A90 System ein I/O-Modul hinzu, um die Netzwerkkonnektivität zu verbessern und die Fähigkeit Ihres Systems, den Datenverkehr zu bewältigen, zu erweitern. 
---
= Ein E/A-Modul zu einem ASA A70 oder ASA A90 System hinzufügen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fügen Sie Ihrem ASA A70 oder ASA A90 System ein I/O-Modul hinzu, um die Netzwerkkonnektivität zu verbessern und die Fähigkeit Ihres Systems, den Datenverkehr zu bewältigen, zu erweitern.

Sie können Ihrem ASA A70- und ASA A90-Speichersystem ein E/A-Modul hinzufügen, wenn leere Steckplätze verfügbar sind oder alle Steckplätze vollständig belegt sind.
