...
summary: Sie können ein Ethernet-E/A-Modul in Ihrem ASA A70 oder ASA A90-Speichersystem per Hot-Swap austauschen, wenn ein Modul ausfällt und Ihr Speichersystem alle ONTAP-Versionserfordernisse erfüllt. 
---
= Ein I/O-Modul kann in Ihrem ASA A70 oder ASA A90 System Hot-Swap-fähig entfernt werden, ohne dass ein Herunterfahren erforderlich ist.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können ein Ethernet-E/A-Modul in Ihrem ASA A70 oder ASA A90-Speichersystem per Hot-Swap austauschen, wenn ein Modul ausfällt und Ihr Speichersystem alle ONTAP-Versionserfordernisse erfüllt.
