...
---
= Schalten Sie die außer Betrieb genommene Steuerung – ASA A70 und ASA A90 aus
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den außer Betrieb genommenen Controller herunter oder übernehmen Sie ihn, damit Sie Wartungsarbeiten an den Startmedien durchführen können.
