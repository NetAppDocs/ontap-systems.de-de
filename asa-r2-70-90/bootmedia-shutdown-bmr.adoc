...
summary: Der Controller im ASA A70 oder ASA A90 Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Bootmediums sicherzustellen. 
---
= Den Controller in einem ASA A70 oder ASA A90 System während des automatisierten Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller im ASA A70 oder ASA A90 Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Bootmediums sicherzustellen.
