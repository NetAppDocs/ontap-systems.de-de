...
summary: Fahren Sie die Controller im ASA A70 oder ASA A90 Storage-System herunter, wenn Sie das Chassis austauschen müssen. Es ist wichtig, die Controller sicher herunterzufahren, um Datenverlust zu vermeiden und die Systemstabilität sicherzustellen. 
---
= Fahren Sie die Controller ASA A70 und ASA A90 herunter
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie die Controller im ASA A70 oder ASA A90 Storage-System herunter, wenn Sie das Chassis austauschen müssen. Es ist wichtig, die Controller sicher herunterzufahren, um Datenverlust zu vermeiden und die Systemstabilität sicherzustellen.
