...
[role="lead"]
Nach Abschluss der NVE oder NSE-Aufgaben müssen Sie den Shutdown des beeinträchtigten Controllers durchführen. Schalten Sie den außer Betrieb genommenen Controller aus oder übernehmen Sie ihn.
