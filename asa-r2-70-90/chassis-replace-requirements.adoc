...
summary: Stellen Sie vor dem Austausch des Gehäuses in Ihrem ASA A70- oder ASA A90-System sicher, dass Sie die erforderlichen Voraussetzungen für einen erfolgreichen Austausch erfüllen. Dazu gehört die Überprüfung, ob alle anderen Komponenten im System ordnungsgemäß funktionieren, ob Sie über lokale Administratoranmeldedaten für ONTAP, das richtige Ersatzgehäuse und die erforderlichen Tools verfügen. 
---
...
[role="lead"]
Stellen Sie vor dem Austausch des Gehäuses in Ihrem ASA A70- oder ASA A90-System sicher, dass Sie die erforderlichen Voraussetzungen für einen erfolgreichen Austausch erfüllen. Dazu gehört die Überprüfung, ob alle anderen Komponenten im System ordnungsgemäß funktionieren, ob Sie über lokale Administratoranmeldedaten für ONTAP, das richtige Ersatzgehäuse und die erforderlichen Tools verfügen.
