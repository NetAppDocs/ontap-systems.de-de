...
|===
 ...
 a| 
link:bootmedia-overview-bmr.html["Boot-Medien"]
 a| 
Sie können ein ausgefallenes Boot-Medium vom Partner-Node für das Boot-Image ersetzen.

Boot Media Replace verwendet das Boot-Image vom Partner-Node und führt automatisch die entsprechende Boot-Menüoption aus, um das Boot-Image auf den Ersatz-Boot-Medien zu installieren.
