...
summary: Fahren Sie den Controller Ihres ASA A70 oder ASA A90 Storage-Systems herunter, um Datenverlust zu vermeiden und beim Austausch des Controllers die Systemstabilität zu gewährleisten. 
---
= Den beeinträchtigten Controller in einem ASA A70 oder ASA A90 System in einer nicht-MetroCluster Konfiguration herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den Controller Ihres ASA A70 oder ASA A90 Storage-Systems herunter, um Datenverlust zu vermeiden und beim Austausch des Controllers die Systemstabilität zu gewährleisten.
