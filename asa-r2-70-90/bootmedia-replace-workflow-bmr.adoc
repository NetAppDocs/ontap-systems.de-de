...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["Zwei"]link:bootmedia-shutdown-asa-r2.html["Schalten Sie den beeinträchtigten Regler aus"]
[role="quick-margin-para"]
