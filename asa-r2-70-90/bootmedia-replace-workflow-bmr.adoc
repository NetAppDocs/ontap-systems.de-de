...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Vier"]link:bootmedia-recovery-image-boot-bmr.html["Image auf Boot-Medien wiederherstellen (automatische Boot-Wiederherstellung)"]
[role="quick-margin-para"]
