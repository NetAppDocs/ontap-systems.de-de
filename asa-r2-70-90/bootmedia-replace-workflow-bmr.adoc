...
summary: Beginnen Sie mit dem Austausch der Boot-Medien in Ihrem ASA A70 und ASA A90 Storage-System, indem Sie die Austauschanforderungen überprüfen, den Controller herunterfahren, die Boot-Medien austauschen, das Image auf dem Boot-Medium wiederherstellen und die Systemfunktionalität überprüfen. 
---
= Workflow zum Austausch des Bootmediums für ein ASA A70 oder ASA A90 System unter Verwendung des automatisierten Boot Recovery Prozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Beginnen Sie mit dem Austausch der Boot-Medien in Ihrem ASA A70 und ASA A90 Storage-System, indem Sie die Austauschanforderungen überprüfen, den Controller herunterfahren, die Boot-Medien austauschen, das Image auf dem Boot-Medium wiederherstellen und die Systemfunktionalität überprüfen.
