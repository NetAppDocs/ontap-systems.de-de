...
summary: Um Ihr AFF A700s-System wieder voll funktionsfähig zu machen, stellen Sie die NetApp Storage Encryption-Konfiguration gegebenenfalls wieder her, installieren Sie Lizenzen für den neuen Controller und senden Sie das defekte Teil an NetApp zurück. 
---
= Den Controller-Austausch für ein AFF A700s System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Austausch des Controllers für Ihr AFF A700s System wird abgeschlossen, indem die NetApp Storage Encryption Konfiguration (falls erforderlich) wiederhergestellt, Lizenzen für den neuen Controller installiert und das defekte Teil an NetApp zurückgesendet werden.
