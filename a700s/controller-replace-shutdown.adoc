...
---
= Vor dem Austausch muss der defekte Controller in einem AFF A700s System abgeschaltet werden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der defekte Controller in Ihrem AFF A700s System wird vor dem Austausch heruntergefahren, indem er übernommen und bis zur LOADER-Eingabeaufforderung angehalten wird.
