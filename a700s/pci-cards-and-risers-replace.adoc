...
---
= Austausch einer PCIe-Karte in Ihrem AFF A700s System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Eine PCIe-Karte in Ihrem AFF A700s System kann ersetzt werden, indem die Kabel getrennt, der Riser entfernt, die Karte ausgetauscht und die Kabel wieder angeschlossen werden.
