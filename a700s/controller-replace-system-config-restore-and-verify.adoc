...
---
= Die Controller-Konfiguration in Ihrem AFF A700s System wird wiederhergestellt und überprüft.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Controller-Konfiguration im AFF A700s System wird nach Abschluss des Hardware-Austauschs und dem Starten in den Wartungsmodus wiederhergestellt und überprüft.
