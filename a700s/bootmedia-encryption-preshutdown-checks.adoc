...
summary: Überprüfen Sie die Unterstützung und den Status des Verschlüsselungsschlüssels, bevor Sie den beeinträchtigten Controller auf einem AFF A700s -System herunterfahren. Das AFF A700s -System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. Die automatische Wiederherstellung über Bootmedien wird nicht unterstützt. 
---
= Verschlüsselungsunterstützung auf dem Bootmedium in einem AFF A700s System prüfen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
