...
---
= Das System wird neu verkabelt und die Datenträger in Ihrem AFF A700s System werden neu zugewiesen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller-Austausch für Ihr AFF A700s System wird abgeschlossen, indem der Speicher neu verkabelt, die NetApp Storage Encryption Konfiguration (falls erforderlich) wiederhergestellt und Lizenzen für den neuen Controller installiert werden.
