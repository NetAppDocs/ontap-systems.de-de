...
---
= Das Chassis in einem AFF A700s System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Chassis im AFF A700s System wird ersetzt, indem die Netzteile, Festplatten und Controller-Module vom defekten Chassis in das Ersatzchassis umgesetzt werden.
...
Nachdem Sie das Controller-Modul in das neue Chassis installiert haben, booten Sie es.
