...
---
= Das NVRAM Modul und die NVRAM DIMMs in Ihrem AFF A700s System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das NVRAM Modul und die NVRAM DIMMs in Ihrem AFF A700s System werden ersetzt, indem der NVRAM Riser entfernt, die defekte Karte ausgetauscht und der Riser wieder eingesetzt wird.
