...
---
= Laufwerk im laufenden Betrieb in einem AFF A700s System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes Laufwerk in Ihrem AFF A700s System kann im laufenden Betrieb ausgetauscht werden, ohne die I/O zu unterbrechen.
