...
---
= Ein Laufwerk in Ihrem AFF A700s System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein defektes Laufwerk in Ihrem AFF A700s System kann ausgetauscht werden, ohne dass die I/O unterbrochen wird.
