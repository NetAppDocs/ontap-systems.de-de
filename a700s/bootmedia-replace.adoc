...
summary: Ersetzen Sie das defekte Bootmedium auf einem AFF A700s Controller-Modul. Das AFF A700s -System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. Die automatische Wiederherstellung über Bootmedien wird nicht unterstützt. 
---
= Das Bootmedium in einem AFF A700s System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
