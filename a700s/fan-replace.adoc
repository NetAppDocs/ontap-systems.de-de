...
---
= Einen Lüfter in Ihrem AFF A700s System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein Lüfter in Ihrem AFF A700s System wird ersetzt, indem das ausgefallene Lüftermodul entfernt und das Ersatzmodul installiert wird.
