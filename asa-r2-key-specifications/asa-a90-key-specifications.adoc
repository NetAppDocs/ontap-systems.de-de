...
summary: Wichtige Spezifikationen für ASA A90 
---
= Wichtigste Spezifikationen für ein ASA A90 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Im Folgenden finden Sie ausgewählte Spezifikationen für das ASA A90-Speichersystem in einem einzelnen Hochverfügbarkeitspaar.  Die vollständigen Spezifikationen für dieses Speichersystem finden Sie im NetApp Hardware Universe (HWU).
...
* Plattformkonfiguration: ASA A90 Single Chassis HA-Paar
...
* Mindestversion von ONTAP : ONTAP 9.16.0
