...
---
= Das AFF A700 Storage-System mit detaillierten Schritten installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das AFF A700 Speichersystem lässt sich anhand detaillierter Schritt-für-Schritt-Anleitungen installieren, von der Montage und Verkabelung bis zur ersten Inbetriebnahme des Systems.
...
+
image::../media/drw_9000_lifting_icon.png[Hinweise zum Hebegewicht]
...
+
image::../media/drw_9000_cable_management_arms.png[Anschließen von Kabelverwaltungsgeräten]
...
+
image::../media/drw_9000_TNSC_composite_cabling.png[Composite-Verkabelung mit zwei Nodes ohne Switch]
...
+
image:../media/drw_9000_switched_cluster_cabling.png["Switched Cluster Composite-Verkabelung"]
