...
summary: Um den betroffenen Knoten herunterzufahren, müssen Sie den Status des Knotens bestimmen und gegebenenfalls den Knoten übernehmen, damit der gesunde Node weiterhin Daten vom beeinträchtigten Knotenspeicher bereitstellen kann. 
---
= Vor dem Austausch muss der defekte Controller in einem AFF A700 System abgeschaltet werden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vor dem Austausch ist der defekte Controller in Ihrem AFF A700 System mithilfe der für Ihre Konfiguration geeigneten Vorgehensweise herunterzufahren.
