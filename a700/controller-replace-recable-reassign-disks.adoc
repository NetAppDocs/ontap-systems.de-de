...
---
= Das System wird neu verkabelt und die Datenträger in Ihrem AFF A700 System werden neu zugewiesen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller-Austausch für Ihr AFF A700 System wird abgeschlossen, indem der Speicher neu verkabelt, NetApp Storage Encryption (falls erforderlich) wiederhergestellt und Lizenzen für den neuen Controller installiert werden.
