...
summary: Um Ihr AFF A700-System wieder voll funktionsfähig zu machen, verkabeln Sie den Speicher neu, stellen Sie gegebenenfalls die NetApp Storage Encryption-Konfiguration wieder her und installieren Sie Lizenzen für den neuen Controller. 
---
= Den Controller-Austausch für ein AFF A700 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller-Austausch für Ihr AFF A700 System wird abgeschlossen, indem der Speicher neu verkabelt, die NetApp Storage Encryption-Konfiguration (falls erforderlich) wiederhergestellt und Lizenzen für den neuen Controller installiert werden.
