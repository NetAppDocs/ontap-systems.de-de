...
---
= Anforderungen sollten vor dem Austausch des Controllers in einem AFF A700 System überprüft werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bevor der Controller in Ihrem AFF A700 System ausgetauscht wird, sollten die Voraussetzungen für das Austauschverfahren geprüft und das passende Verfahren für Ihre Version von ONTAP ausgewählt werden.
