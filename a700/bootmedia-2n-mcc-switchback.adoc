...
summary: Nach dem Austausch des Bootmediums führen Sie die MetroCluster-Rückschaltung durch, um die Konfiguration in den normalen Betriebszustand zurückzusetzen. Das AFF A700 System unterstützt ausschließlich manuelle Bootmedium-Wiederherstellungsverfahren. 
---
= Aggregate in einer Zwei-Knoten MetroCluster Konfiguration für Ihr AFF A700 System zurückwechseln
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
