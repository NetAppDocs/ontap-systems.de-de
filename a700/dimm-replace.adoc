...
summary: Tauschen Sie ein DIMM in Ihrem AFF A700 Controller-Modul aus, wenn das System eine zunehmende Anzahl korrigierbarer Fehlerkorrekturcodes oder nicht korrigierbarer ECC-Fehler registriert. Wenn ein fehlerhaftes DIMM nicht ersetzt wird, kann dies zu einem System-Panic führen. 
---
= Austausch eines DIMM in einem AFF A700 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein DIMM in Ihrem AFF A700 System ist auszutauschen, wenn das Speichersystem zu viele korrigierbare ECC-Fehler oder einen nicht korrigierbaren ECC-Fehler feststellt.
