...
---
= Ein X91148A Modul kann über einen freien Steckplatz zu Ihrem AFF A700 System hinzugefügt werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein X91148A Modul kann dem AFF A700 System über einen verfügbaren freien Steckplatz im Gehäuse hinzugefügt werden.
