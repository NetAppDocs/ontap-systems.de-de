...
---
= Die Controller-Konfiguration in Ihrem AFF A700 System wird wiederhergestellt und überprüft.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss des Hardwareaustauschs und dem Booten in den Wartungsmodus wird die Controller-Konfiguration in Ihrem AFF A700-System wiederhergestellt und überprüft.
