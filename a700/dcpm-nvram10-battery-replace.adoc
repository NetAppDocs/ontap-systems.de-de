...
summary: Zum Hot-Swapping eines De-Stage-Controller-Power-Moduls, das die NVRAM10-Batterie enthält, suchen Sie das defekte DCPM-Modul, entfernen Sie es aus dem Gehäuse und installieren Sie das Ersatz-DCPM-Modul. 
---
= Das DCPM-Modul kann im laufenden Betrieb in einem AFF A700 System ausgetauscht werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein De-Stage-Controller-Leistungsmodul (DCPM) kann in Ihrem AFF A700 System im laufenden Betrieb ausgetauscht werden, um das ausgefallene Modul zu ersetzen, ohne den Service zu unterbrechen.
