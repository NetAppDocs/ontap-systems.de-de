...
summary: Der Controller im AFF A700-Speichersystem wird heruntergefahren, um Datenverlust zu vermeiden und die Systemstabilität während des manuellen Boot-Medien-Wiederherstellungsprozesses zu gewährleisten. 
---
= Den Controller in einem AFF A700 System während des manuellen Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller im AFF A700-Speichersystem wird heruntergefahren, um Datenverlust zu vermeiden und die Systemstabilität während des manuellen Boot-Medien-Wiederherstellungsprozesses zu gewährleisten.
...
Nach Abschluss der NVE- oder NSE-Aufgaben muss der Knoten heruntergefahren werden. HINWEIS: Dieses Verfahren ist nicht zu verwenden, wenn das System in einer Zwei-Knoten MetroCluster Konfiguration betrieben wird.
...
Nach Abschluss der NVE- oder NSE-Aufgaben ist das Herunterfahren des Knotens abzuschließen.
