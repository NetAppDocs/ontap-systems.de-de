...
---
= Austausch eines E/A-Moduls in einem AFF A700 System oder einem FAS9000 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein E/A-Modul in Ihrem AFF A700 oder FAS9000 System kann ersetzt werden, indem die Kabel getrennt, die Steigleitung entfernt, das Modul ausgetauscht und die Kabel wieder angeschlossen werden.
