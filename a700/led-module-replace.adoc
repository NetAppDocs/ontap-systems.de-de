...
---
= Ein LED-USB-Modul in einem AFF A700 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein LED-USB-Modul im AFF A700-System ersetzt, sodass die Statusanzeige-LED und die USB-Funktionalität wiederhergestellt werden.
