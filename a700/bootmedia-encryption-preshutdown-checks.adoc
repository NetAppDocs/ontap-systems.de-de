...
summary: Bevor Sie den beeinträchtigten Knoten herunterfahren und den Status der Onboard-Verschlüsselungsschlüssel überprüfen, müssen Sie den Status des beeinträchtigten Knotens überprüfen, die automatische Rückgabe deaktivieren und überprüfen, welche Version von ONTAP auf dem System ausgeführt wird. Das AFF A700 -System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. 
---
= Prüfen Sie die Unterstützung und den Status der Verschlüsselungsschlüssel - AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
