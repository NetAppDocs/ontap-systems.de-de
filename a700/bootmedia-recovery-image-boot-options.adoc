...
summary: Starten Sie das ONTAP Wiederherstellungsimage vom USB-Laufwerk auf einem AFF A700 -System, um die Startmedien wiederherzustellen. Das AFF A700 -System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. Die automatische Wiederherstellung über Bootmedien wird nicht unterstützt. 
---
= Das Wiederherstellungsimage auf Ihrem AFF A700 System starten
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
