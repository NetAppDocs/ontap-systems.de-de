...
---
= Installation und Einrichtung eines AFF A700 Speichersystems
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das AFF A700 Speichersystem kann installiert und eingerichtet werden, indem je nach Präferenz aus verschiedenen Inhaltsformaten gewählt wird.
