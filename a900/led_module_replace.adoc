...
---
= Das LED-USB-Modul in einem AFF A900 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das LED-USB-Modul in Ihrem AFF A900 System wird ersetzt, um die Konnektivität zu den Konsolenports und den Systemstatus wiederherzustellen. Der Austausch erfordert kein Werkzeug und unterbricht den Betrieb nicht.
...
+
image::../media/drw_a900_remove_replace_LED_mod.svg[Entfernen Sie ein LED-USB-Modul]
