...
---
= Den Controller in Ihrem AFF A900 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller in Ihrem AFF A900 System wird ersetzt, wenn ein Hardwarefehler dies erfordert. Der Austauschprozess umfasst das Entfernen des defekten Controller-Moduls, das Umsetzen der FRU-Komponenten in den Ersatzcontroller, das Installieren des Ersatzcontroller-Moduls im Gehäuse und das Booten des Systems in den Wartungsmodus.
...
+
image::../media/drw_a900_remove_boot_dev.svg[Entfernen Sie das Startmedium]
