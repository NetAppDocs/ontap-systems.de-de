...
[role="lead"]
Ein Netzteil im AFF A900 System sollte ersetzt werden, wenn es ausfällt oder fehlerhaft wird. Die Netzteile sind redundant und Hot-Swap-fähig, daher ist ein Herunterfahren des Controllers für diesen Austausch nicht erforderlich.
