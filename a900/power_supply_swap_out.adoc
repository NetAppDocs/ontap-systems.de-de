...
---
= Netzteil im laufenden Betrieb in einem AFF A900 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein Netzteil in Ihrem AFF A900 System kann im laufenden Betrieb ausgetauscht werden, wenn es ausfällt oder defekt ist. Die Netzteile sind redundant und Hot-Swap-fähig, daher ist ein Herunterfahren des Controllers für diesen Austausch nicht erforderlich.
