...
---
= Arbeitsablauf zum Austausch des AFF A900 Controllers
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Austausch des Controllers in Ihrem AFF A900 System beginnt mit der Überprüfung der Voraussetzungen, dem Herunterfahren des defekten Controllers, dem Umbau der Hardware auf den Ersatzcontroller und der Wiederherstellung der Systemkonfiguration.
