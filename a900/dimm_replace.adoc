...
summary: Tauschen Sie ein DIMM in Ihrem AFF A900 Controller-Modul aus, wenn das System eine zunehmende Anzahl von korrigierbaren Fehlerkorrekturcodes oder nicht korrigierbaren ECC-Fehlern registriert. Wenn ein fehlerhaftes DIMM nicht ersetzt wird, kann dies zu einem Systemabsturz führen. 
---
= Ein DIMM in einem AFF A900 System ersetzen, um Speicherfehler zu beheben
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein DIMM in Ihrem AFF A900 System sollte ersetzt werden, wenn das Speichersystem eine übermäßige Anzahl korrigierbarer (CECC) oder nicht korrigierbarer Speicherfehler feststellt. Solche Fehler können verhindern, dass das Speichersystem ONTAP startet.
...
+
image::../media/drw_a900_remove_PCM.svg[Lassen Sie den Controller los]
...
+
image::../media/drw_a900_PCM_open.svg[Heben Sie die Abdeckung vom Controller-Modul ab]
...
+
image::../media/drw_a900_replace_PCM_dimms.svg[Entfernen Sie ein DIMM]
