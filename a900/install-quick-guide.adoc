...
---
= Installation eines AFF A900 Systems mithilfe der kurzen grafischen Anleitung
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das AFF A900 Speichersystem lässt sich mithilfe der kurzen grafischen Anleitung installieren und verkabeln.
