...
---
= Das AFF A900 System kann anhand detaillierter Schritt-für-Schritt-Anleitungen installiert werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das AFF A900 Speichersystem kann mit diesen detaillierten Schritt-für-Schritt-Anweisungen installiert werden, von der Vorbereitung des Standorts bis zur Inbetriebnahme des ONTAP Clusters.
...
+
Die NS224-Einschübe sind standardmäßig auf die Einschub-IDs 00 und 01 voreingestellt. Wenn die Einschub-IDs geändert werden sollen, ist ein Werkzeug anzufertigen, das in die Öffnung eingesetzt wird, in der sich der Knopf befindet. Siehe link:../ns224/change-shelf-id.html["Shelf-ID ändern – NS224-Einschübe"] für detaillierte Anweisungen.
...
.. Im linken Bereich *Network* auswählen, mit der rechten Maustaste klicken und anschließend *refresh* auswählen.
