...
---
= Austausch eines E/A-Moduls in einem AFF A900 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein E/A-Modul in Ihrem AFF A900 System wird ersetzt, wenn es ausgefallen ist oder ein Upgrade erforderlich ist. Für den Austausch ist eine bestimmte Abfolge von Arbeitsschritten erforderlich, um eine Unterbrechung des Betriebs zu vermeiden.
