...
summary: Stellen Sie die Verschlüsselung auf dem Ersatz-Bootmedium wieder her. Führen Sie die spezifischen Schritte für Systeme durch, bei denen Onboard Key Manager, NetApp Storage Encryption oder NetApp Volume Encryption aktiviert ist. 
---
= Die Verschlüsselung auf dem Bootmedium Ihres AFF A900 Systems kann mithilfe des manuellen Boot-Wiederherstellungsprozesses wiederhergestellt werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Stellen Sie die Verschlüsselung auf dem Ersatz-Bootmedium in Ihrem AFF A900 System wieder her, um den fortlaufenden Datenschutz zu gewährleisten. Der Austauschvorgang umfasst die Überprüfung der Schlüsselverfügbarkeit, die erneute Anwendung der Verschlüsselungseinstellungen und die Bestätigung des sicheren Zugriffs auf Ihre Daten.
