...
summary: Beginnen Sie mit dem Austausch des Gehäuses Ihres AFF A900 Systems. Das Verfahren erfordert das Entfernen und die erneute Installation der Netzteile, Lüfter, Controller-Module, I/O-Module, DCPM-Module und des USB-LED-Moduls. Alle anderen Komponenten im System müssen ordnungsgemäß funktionieren. 
---
= Das Chassis in einem AFF A900 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Chassis Ihres AFF A900 Systems wird ersetzt, wenn ein Hardwarefehler dies erfordert. Beim Austausch werden die Netzteile, Lüfter, Controller-Module und I/O-Module aus dem defekten Chassis entfernt und in das Ersatzchassis eingesetzt.
...
+
image::../media/drw_a900_remove_install_PSU_module.svg[Entfernen oder Installieren eines Netzteilmoduls]
...
+
image::../media/drw_a900_remove_install_fan.svg[Entfernen oder Installieren des Lüfters]
...
+
image::../media/drw_a900_remove_PCM.svg[Entfernen Sie den Controller]
...
+
image:../media/drw_a900_remove_PCIe_module.svg["Entfernen Sie ein PCIe-Modul"]
...
+
image::../media/drw_a900_remove_NV_battery.svg[Entfernen Sie eine NV-Batterie]
...
image::../media/drw_a900_remove_replace_LED_mod.svg[Entfernen oder ersetzen Sie ein USB-LED-Modul]
