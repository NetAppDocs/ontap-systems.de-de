...
---
= Das Bootmedium in Ihrem AFF A900 System kann mithilfe des manuellen Boot-Wiederherstellungsprozesses ersetzt werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Bootmedium Ihres AFF A900 speichert wichtige Firmware- und Konfigurationsdaten. Der Austauschvorgang umfasst das Entfernen des Controller-Moduls, das Entfernen des defekten Bootmediums, das Einsetzen des Ersatz-Bootmediums und anschließend die Übertragung des ONTAP Image auf das Ersatz-Bootmedium mithilfe eines USB-Flash-Laufwerks.
...
+
image::../media/drw_a900_remove_boot_dev.svg[Startmedien entfernen]
