...
---
= Anforderungen für den Austausch des Bootmediums in einem AFF A900 System prüfen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bevor das Bootmedium in Ihrem AFF A900 System ausgetauscht wird, sollten die notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllt sein. Dazu gehört ein mit FAT32 formatierter USB-Stick mit ausreichend Speicherplatz für das ONTAP Recovery Image sowie das Verständnis, ob ein unterbrechungsfreier oder unterbrechender Austausch erfolgt.
