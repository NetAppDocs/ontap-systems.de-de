...
summary: Das NVRAM Modul besteht aus dem NVRAM11 und DIMMs sowie bis zu zwei NVMe SSD Flash Cache Modulen pro NVRAM Modul. 
---
= Das NVRAM Modul oder die NVRAM DIMMs in Ihrem AFF A900 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das NVRAM Modul oder die NVRAM DIMMs in Ihrem AFF A900 System werden ersetzt, wenn das Modul ausfällt oder ein DIMM fehlerhaft ist. Der Austauschprozess umfasst die Entfernung des NVRAM Moduls aus dem Gehäuse, den Austausch der defekten Komponente und das Wiedereinsetzen des Moduls.
...
+
image::../media/drw_a900_move-remove_NVRAM_module.svg[Entfernen Sie das NVRAM-Modul]
...
+
image::../media/drw_a900_remove_NVRAM_module_contents.svg[Entfernen Sie den Inhalt des NVRAM-Moduls]
