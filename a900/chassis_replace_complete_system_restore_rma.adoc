...
---
= Den Chassis-Austausch für ein AFF A900 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der HA-Status des Chassis sollte überprüft werden, und das defekte Teil ist an NetApp zurückzusenden, um den Chassis-Austausch für Ihr AFF A900 System abzuschließen.
