...
summary: Nach der Installation des neuen Bootmediums in Ihrem AFF A900 System kann der automatisierte Bootmedien-Wiederherstellungsprozess gestartet werden, um die Konfiguration vom Partnerknoten wiederherzustellen. 
---
= Das Startabbild Ihres AFF A900 Systems kann mithilfe des automatisierten Startwiederherstellungsprozesses wiederhergestellt werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
