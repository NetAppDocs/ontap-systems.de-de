...
sidebar: sidebar 
keywords: AFF A900 
summary: Zum Hot-Swapping eines De-Stage-Controller-Power-Moduls, das die NVRAM11-Batterie enthält, suchen Sie das defekte DCPM-Modul, entfernen Sie es aus dem Gehäuse und installieren Sie das Ersatz-DCPM-Modul. 
---
= Das DCPM-Modul kann im laufenden Betrieb in einem AFF A900 System ausgetauscht werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Destage Controller Power Module (DCPM) im AFF A900 System ist Hot-Swap-fähig und kann bei Ausfall im laufenden Betrieb ausgetauscht werden. Das DCPM enthält die NVRAM11-Batterie und muss innerhalb von fünf Minuten nach der Entfernung ersetzt werden, um Datenverlust zu verhindern.
...
+
image::../media/drw_a900_remove_NV_battery.svg[Entfernen Sie die NV-Batterie]
