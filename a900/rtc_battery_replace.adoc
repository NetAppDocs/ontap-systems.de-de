...
---
= Die Batterie der Echtzeituhr in einem AFF A900 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Echtzeit-Batterie (RTC) in Ihrem AFF A900-System wird ersetzt, damit Dienste und Anwendungen, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin funktionieren.
