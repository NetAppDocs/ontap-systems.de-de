...
summary: Beginnen Sie mit dem Austausch des Bootmediums in Ihrem AFF A900 Storage System. Der Workflow umfasst die Überprüfung der Austauschvoraussetzungen, die Kontrolle des Verschlüsselungsstatus, das Herunterfahren des Controllers, den Austausch des Bootmediums, das Booten des Recovery-Images, die Wiederherstellung der Verschlüsselung und die Überprüfung der Systemfunktionalität. 
---
= Arbeitsablauf zum Austausch des Bootmediums für ein AFF A900 System unter Verwendung des manuellen Boot-Wiederherstellungsprozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Beginnen Sie mit dem Austausch des Bootmediums in Ihrem AFF A900 Storage System. Der Workflow umfasst die Überprüfung der Austauschvoraussetzungen, die Kontrolle des Verschlüsselungsstatus, das Herunterfahren des Controllers, den Austausch des Bootmediums, das Booten des Recovery-Images, die Wiederherstellung der Verschlüsselung und die Überprüfung der Systemfunktionalität.
