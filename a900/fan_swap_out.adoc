...
---
= Lüftermodul im laufenden Betrieb in einem AFF A900 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ein Lüftermodul in Ihrem AFF A900 System kann Hot-Swap-fähig ausgetauscht werden, um eine ordnungsgemäße Kühlung aufrechtzuerhalten. Lüftermodule müssen ohne Unterbrechung des Betriebs durch Ausführen einer bestimmten Aufgabenreihenfolge ersetzt werden.
