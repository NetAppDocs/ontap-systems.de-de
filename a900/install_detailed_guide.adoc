...
X66240A-5 (112-00600), 5 m
 a| 
image::../media/oie_cable_sfp_gbe_copper.svg[GbE Kupfer SFP]
 a| 
Netzwerkkabel
...
X66100-5 (112-00544), 5 m
 a| 
image::../media/oie_cable100_gbe_qsfp28.svg[GbE Kupfer SFP]
 a| 
...
X66033A (112-00438), 3 m
 a| 
image::../media/oie_cable_fiber_lc_connector.svg[LC-Glasfaseranschluss]
 a| 
...
X6562-R6 (112-00196), 5 m
 a| 
image::../media/oie_cable_rj45.svg[RJ-45-Kabelanschluss]
 a| 
...
Keine Angabe
 a| 
image::../media/oie_cable_micro_usb.svg[Micro-USB-Anschluss]
 a| 
...
Keine Angabe
 a| 
image::../media/oie_cable_power.svg[Netzkabelanschluss]
 a| 
System einschalten
...
| Schritt | Führen Sie an jedem Controller aus 
 ...
 a| 
image::../media/oie_legend_icon_1_lg.svg[Legende Symbol eins]
 a| 
...
image::../media/oie_cable100_gbe_qsfp28.svg[100-GB-Anschluss]



 a| 
image::../media/oie_legend_icon_2_lp.svg[Legende Symbol zwei]
 a| 
...
image::../media/oie_cable_rj45.svg[RJ-45-Kabelanschluss]
 ...
 a| 
image::../media/oie_legend_icon_3_o.svg[Legende Symbol drei]
 a| 
...
image::../media/oie_cable100_gbe_qsfp28.svg[Anschluss für 100-GbE-Kabel]



 a| 
image:../media/oie_legend_icon_4_dr.svg["Legende Symbol vier"]
 a| 
...
image:../media/oie_cable_sfp_gbe_copper.svg["GbE Kupfer SFP"]
 ...
 a| 
image::../media/oie_legend_icon_5_lp.png[Callout-Symbol 5]
 a| 
...
image:../media/oie_cable_power.svg["Netzkabel"]
...
image:../media/oie_cable100_gbe_qsfp28.svg["100-GbE-Kabel"]



 a| 
image:../media/oie_legend_icon_2_lo.svg["Legende Symbol zwei"]
 a| 
Controller-Management-Ports (Schraubenschlüssel) verkabeln.
...
image::../media/drw_a900fas9500_power_icon_IEOPS-1142.svg[drw a900fas9500 Leistungssymbol IEOPS 1142]
...
image::../media/oie_cable_pull_tab_down.svg[Richtung der Zuglasche des Kabels]
...
| Schritt | Führen Sie an jedem Controller aus 
 ...
 a| 
image::../media/oie_legend_icon_1_mb.svg[Legende Nummer eins]
 a| 
...
image::../media/oie_cable100_gbe_qsfp28.svg[100 GbE QSFP-Anschluss]
...
100-GbE-Kabel
 ...
 a| 
image::../media/oie_legend_icon_2_lo.svg[Beschriftung Nummer zwei]
 a| 
...
| Schritt | Führen Sie an jedem Controller aus 
 ...
 a| 
image::../media/oie_legend_icon_1_mb.svg[Legende Symbol eins]
 a| 
...
Einlegeboden-Endkappe
 ...
 a| 
image::../media/legend_icon_02.png[Legende Symbol zwei]
 a| 
Ablagefaceplate
 ...
 a| 
image::../media/legend_icon_03.png[Legende Symbol drei]
 a| 
Shelf-ID-LED
 ...
 a| 
image::../media/legend_icon_04.png[Legende Symbol vier]
 a| 
