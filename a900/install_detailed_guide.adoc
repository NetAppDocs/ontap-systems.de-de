...
Die folgende Abbildung zeigt, wie ein typisches System aussieht und wo sich die Hauptkomponenten am Lesevorgang des Systems befinden:
...
+
image::../media/drw_9000_cable_console_switch_controller_IEOPS-953.svg[drw 9000-Kabelkonsolenschalter-Controller IEOPS 953]
