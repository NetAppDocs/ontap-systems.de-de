...
. Wenn Sie ein Speicher-I/O-Modul installiert haben, installieren und verkabeln Sie die NS224-Shelves, wie in beschrieben https://["Hot-Adding eines NS224-Laufwerk-Shelfs"^].
...
Speichermodul
 a| 
Installieren und verkabeln Sie die NS224-Regale, wie in beschriebenhttps://["Hot-Adding eines NS224-Laufwerk-Shelfs"^].
