...
---
= Ein E/A-Modul zu einem AFF A900 System hinzufügen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können dem AFF A900 Storage-System ein I/O-Modul hinzufügen, wenn leere Steckplätze verfügbar sind oder wenn alle Steckplätze voll belegt sind.
...
.Bevor Sie beginnen
* Überprüfung des  https://hwu.netapp.com["NetApp Hardware Universe"^], um sicherzustellen, dass das neue E/A-Modul mit Ihrem System und der von Ihnen verwendeten ONTAP-Version kompatibel ist.
