...
---
= Vor dem Austausch muss der defekte Controller in einem AFF A900 System abgeschaltet werden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der defekte Controller in Ihrem AFF A900-Speichersystem wird heruntergefahren, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers zu gewährleisten.
