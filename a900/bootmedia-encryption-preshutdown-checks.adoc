...
---
= Die Verschlüsselungsunterstützung auf dem Bootmedium im AFF A900 System prüfen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um die Datensicherheit auf Ihrem AFF A900-Speichersystem zu gewährleisten, muss die Unterstützung und der Status des Verschlüsselungsschlüssels auf Ihrem Boot-Medium überprüft werden. Es sollte geprüft werden, ob Ihre ONTAP Version NetApp Volume Encryption (NVE) unterstützt, und vor dem Herunterfahren des Controllers sollte überprüft werden, ob der Schlüsselmanager aktiv ist.
