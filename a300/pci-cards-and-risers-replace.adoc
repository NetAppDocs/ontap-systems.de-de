...
---
= Austausch einer PCIe-Karte in Ihrem AFF A300 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Eine PCIe-Karte in Ihrem AFF A300 System wird ersetzt, indem die Kabel getrennt, die Karte entfernt, die Ersatzkarte eingesetzt und die Kabel wieder angeschlossen werden.
