...
---
= Das System wird neu verkabelt und die Datenträger in Ihrem AFF A300 System werden neu zugewiesen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Den Controller-Austausch für Ihr AFF A300 System abschließen, indem der Speicher neu verkabelt und die Neuzuordnung der Festplatten bestätigt wird.
