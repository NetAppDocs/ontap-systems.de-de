...
summary: Zum Austausch des Chassis müssen Sie den Controller herunterfahren. Dieser Vorgang ist störend. Für ein Cluster mit zwei Nodes tritt ein vollständiger Service-Ausfall und ein teilweiser Ausfall in einem Cluster mit mehreren Nodes auf. 
---
...
[role="lead"]
Sie müssen die Controller herunterfahren, bevor Sie das Chassis ersetzen.
...
== Option 2: Controller befinden sich in einem MetroCluster mit zwei Nodes
