...
---
= Die NVMEM-Batterie in Ihrem AFF A300 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die NVMEM Batterie in Ihrem AFF A300 System wird ersetzt, indem das Controller-Modul entfernt, geöffnet, die Batterie ausgetauscht und das Controller-Modul wieder eingesetzt wird.
