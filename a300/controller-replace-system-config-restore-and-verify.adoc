...
---
= Die Controller-Konfiguration in Ihrem AFF A300 System wird wiederhergestellt und überprüft.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nach Abschluss des Hardwareaustauschs und dem Booten in den Wartungsmodus die Controller-Konfiguration in Ihrem AFF A300-System wiederherstellen und überprüfen.
