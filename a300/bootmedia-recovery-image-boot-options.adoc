...
summary: Das Verfahren zum Starten des beeinträchtigten Controllers aus dem Wiederherstellungsabbild hängt davon ab, ob sich das System in einer Zwei-Knoten MetroCluster Konfiguration befindet. Das AFF A300 -System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. 
---
= Das Wiederherstellungsimage auf Ihrem AFF A300 System starten
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Das Verfahren zum Hochfahren des betroffenen Controllers aus dem Wiederherstellungsabbild hängt davon ab, ob sich das System in einer Zwei-Controller- MetroCluster -Konfiguration befindet. Das AFF A300 -System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. Die automatische Wiederherstellung über Bootmedien wird nicht unterstützt.
