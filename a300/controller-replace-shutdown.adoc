...
---
= Vor dem Austausch ist der defekte Controller in Ihrem AFF A300 System herunterzufahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vor dem Austausch ist der defekte Controller in Ihrem AFF A300 System mithilfe der für Ihre Konfiguration geeigneten Vorgehensweise herunterzufahren.
