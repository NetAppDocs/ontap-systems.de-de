...
summary: Stellen Sie die Verschlüsselung auf dem Ersatz-Bootmedium wieder her. Führen Sie die spezifischen Schritte für Systeme durch, bei denen Onboard Key Manager, NetApp Storage Encryption oder NetApp Volume Encryption aktiviert ist. Das AFF A300 System unterstützt ausschließlich manuelle Bootmedien-Wiederherstellungsverfahren. 
---
= Wiederherstellung der Verschlüsselung auf dem Bootmedium in einem AFF A300 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Verschlüsselung auf dem Ersatz-Bootmedium wiederherstellen. Das AFF A300 -System unterstützt ausschließlich manuelle Wiederherstellungsverfahren über Bootmedien. Die automatische Wiederherstellung über Bootmedien wird nicht unterstützt.
