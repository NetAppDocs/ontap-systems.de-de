...
---
= Den Chassis-Austausch für Ihr AFF A300 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Chassis-Austausch für Ihr AFF A300 System wird abgeschlossen, indem der HA-Status des Chassis überprüft, Aggregate bei Bedarf zurückgeschaltet und die defekte Komponente an NetApp zurückgesendet wird.
...
.. Gehen Sie zu <<Schritt 3: Senden Sie das fehlgeschlagene Teil an NetApp zurück>>.
