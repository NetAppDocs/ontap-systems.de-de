...
---
= Die Anforderungen für den Austausch eines Controllers in einem AFF A300 System werden hier aufgeführt
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vor dem Austausch des Controllers in Ihrem AFF A300 System sollten die Voraussetzungen für das Austauschverfahren geprüft und das passende Verfahren für Ihre Version von ONTAP ausgewählt werden.
