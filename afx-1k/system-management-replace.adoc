...
summary: Ersetzen Sie das Systemverwaltungsmodul in Ihrem AFX 1K-Speichersystem, wenn es defekt ist oder seine Firmware beschädigt ist.  Der Austauschvorgang umfasst das Herunterfahren des Controllers, das Ersetzen des ausgefallenen Systemverwaltungsmoduls, den Neustart des Controllers, die Aktualisierung der Lizenzschlüssel und die Rücksendung des ausgefallenen Teils an NetApp. 
---
= Das Systemverwaltungsmodul in einem AFX 1K System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ersetzen Sie das Systemverwaltungsmodul in Ihrem AFX 1K-Speichersystem, wenn es defekt ist oder seine Firmware beschädigt ist.  Der Austauschvorgang umfasst das Herunterfahren des Controllers, das Ersetzen des ausgefallenen Systemverwaltungsmoduls, den Neustart des Controllers, die Aktualisierung der Lizenzschlüssel und die Rücksendung des ausgefallenen Teils an NetApp.
