...
summary: Fahren Sie den Controller in Ihrem AFX 1K-Speichersystem herunter, wenn er beeinträchtigt ist.  Vor der Durchführung von Wartungsarbeiten oder dem Austausch von Komponenten ist es wichtig, den Controller sicher herunterzufahren, um Datenverlust zu vermeiden und die Systemstabilität sicherzustellen. 
---
= Vor dem Austausch ist der defekte Controller in Ihrem AFX 1K-Speichersystem herunterzufahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den beschädigten Controller in Ihrem AFX 1K-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Controllers sicherzustellen.
