...
summary: Tauschen Sie die Echtzeituhr-Batterie in Ihrem AFX 1K-Speichersystem aus, um sicherzustellen, dass Dienste und Anwendungen, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin betriebsbereit bleiben. 
---
= Die Echtzeit-Uhr-Batterie im AFX 1K Storage System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
