...
summary: 'Ersetzen Sie die Echtzeituhrbatterie (RTC), allgemein als Knopfzellenbatterie bekannt, in Ihrem AFX 1K-Speichersystem, um sicherzustellen, dass Dienste und Anwendungen, die auf eine genaue Zeitsynchronisierung angewiesen sind, weiterhin betriebsbereit bleiben.' 
---
= Ersetzen der Echtzeituhrbatterie - AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ersetzen Sie die Echtzeituhrbatterie (RTC), allgemein als Knopfzellenbatterie bekannt, in Ihrem AFX 1K-Speichersystem, um sicherzustellen, dass Dienste und Anwendungen, die auf eine genaue Zeitsynchronisierung angewiesen sind, weiterhin betriebsbereit bleiben.
