...
summary: Bereiten Sie den Austausch des beschädigten Gehäuses in Ihrem AFX 1K-Speichersystem vor, indem Sie das beschädigte Gehäuse identifizieren, die Ersatzkomponenten überprüfen und die Kabel und Controllermodule beschriften. 
---
= Vorbereitung auf den Austausch des Chassis in einem AFX 1K System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bereiten Sie den Austausch des beschädigten Gehäuses in Ihrem AFX 1K-Speichersystem vor, indem Sie das beschädigte Gehäuse identifizieren, die Ersatzkomponenten überprüfen und die Kabel und das Controllermodul beschriften.
...
Nachdem Sie den Austausch Ihrer AFX 1K-Gehäusehardware vorbereitet haben, müssen Sielink:chassis-replace-shutdown.html["Fahren Sie den Controller herunter"] .
