...
summary: Tauschen Sie das Gehäuse Ihres AFX 1K-Speichersystems aus, wenn ein Hardwaredefekt dies erfordert. Der Austauschvorgang umfasst das Entfernen des Controllers von der Vorderseite des Gehäuses, das Entfernen der Netzteile, des NVRAM12, der E/A-Module und -Blenden sowie des Systemmanagement-Moduls und dann das Einbauen des Ersatzgehäuses und das Wiedereinbauen der Gehäusekomponenten. 
---
= Das Gehäuse im AFX 1K Speichersystem ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nach dem Austausch des defekten AFX 1K-Gehäuses und dem Wiedereinbau der Komponenten schließen Sie die link:chassis-replace-complete-system-restore-rma.html["Chassis-Ersatz"] ab.
