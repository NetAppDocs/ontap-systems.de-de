...
summary: Fahren Sie den Controller in Ihrem AFX 1K-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Gehäuses sicherzustellen. 
---
= Fahren Sie den Controller herunter, um das Gehäuse auszutauschen – AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Fahren Sie den Controller in Ihrem AFX 1K-Speichersystem herunter, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Gehäuses sicherzustellen.
