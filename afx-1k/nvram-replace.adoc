...
summary: Ersetzen Sie den NVRAM in Ihrem AFX 1K-Speichersystem, wenn der nichtflüchtige Speicher fehlerhaft wird oder ein Upgrade erforderlich ist. 
---
= Den NVRAM in Ihrem AFX 1K Speichersystem ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ersetzen Sie den NVRAM in Ihrem AFX 1K-Speichersystem, wenn der nichtflüchtige Speicher fehlerhaft wird oder ein Upgrade erforderlich ist.  Der Austauschvorgang umfasst das Herunterfahren des beschädigten Controllers, das Ersetzen des NVRAM Moduls oder des NVRAM -DIMM und die Rücksendung des ausgefallenen Teils an NetApp.
