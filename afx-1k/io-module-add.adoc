...
---
= Ein E/A-Modul kann zu einem AFX 1K System hinzugefügt werden, um die Netzwerk-Konnektivität zu erweitern.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Bevor Sie beginnen
* Die  https://hwu.netapp.com["NetApp Hardware Universe"^] sollte geprüft werden, um sicherzustellen, dass das neue E/A-Modul mit Ihrem Speichersystem und der ONTAP Version kompatibel ist.
