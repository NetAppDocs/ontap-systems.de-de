...
summary: Nachdem Sie das neue Boot-Mediengerät in Ihrem AFX 1K-Speichersystem installiert haben, können Sie den automatisierten Boot-Medienwiederherstellungsprozess starten, um die Konfiguration vom Partnerknoten wiederherzustellen. 
---
= Das Wiederherstellungsimage auf dem AFX 1K Speichersystem wird mithilfe des automatisierten Startwiederherstellungsprozesses gebootet.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
