...
summary: Nach der Installation des neuen Bootmediums in Ihrem ASA C800 System kann der automatisierte Bootmedien-Wiederherstellungsprozess gestartet werden, um die Konfiguration vom Partnerknoten wiederherzustellen. 
---
= Das Startabbild Ihres ASA C800 Systems kann mithilfe des automatisierten Startwiederherstellungsprozesses wiederhergestellt werden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
