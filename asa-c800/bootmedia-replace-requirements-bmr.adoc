...
summary: Stellen Sie vor dem Austausch des Bootmediums in Ihrem ASA C800 System sicher, dass Sie die notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllen. 
---
