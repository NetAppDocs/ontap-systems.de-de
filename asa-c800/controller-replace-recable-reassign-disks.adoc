...
---
= Der Controller in einem ASA C800 System wird zurückgegeben, damit der normale Betrieb fortgesetzt werden kann.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Übergeben Sie die Kontrolle über die Speicherressourcen an den Ersatzcontroller, damit Ihr ASA C800 -System den normalen Betrieb wieder aufnehmen kann.  Das Rückgabeverfahren variiert je nach Art der von Ihrem System verwendeten Verschlüsselung: keine Verschlüsselung oder Onboard Key Manager (OKM)-Verschlüsselung.
