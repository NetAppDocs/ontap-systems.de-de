...
---
= Die NVDIMM-Batterie in einem ASA C800 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die NVDIMM-Batterie im ASA C800 System sollte ersetzt werden, wenn die Batterie an Ladung verliert oder ausfällt, da sie für die Sicherung kritischer Systemdaten bei Stromausfällen verantwortlich ist. Der Austauschprozess umfasst das Herunterfahren des beeinträchtigten Controllers, das Entfernen des Controller-Moduls, den Austausch der NVDIMM-Batterie, das Wiedereinsetzen des Controller-Moduls und die Rücksendung des defekten Teils an NetApp.
