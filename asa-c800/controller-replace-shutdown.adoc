...
---
= Vor dem Austausch muss der defekte Controller in einem ASA C800 System abgeschaltet werden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie den Controller in Ihrem ASA C800 -Speichersystem ab, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Controllers zu gewährleisten.
