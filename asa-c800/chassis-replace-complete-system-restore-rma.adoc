...
---
= Schließen Sie den Wiederherstellungs- und Austauschprozess ab – ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Starten Sie die Controller neu, überprüfen Sie den Systemzustand und senden Sie das defekte Teil an NetApp zurück, um den letzten Schritt im Austauschverfahren des ASA C800 -Chassis abzuschließen.
