...
---
= Austausch oder Hinzufügen einer PCIe-Karte in einem ASA C800 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Eine PCIe-Karte in Ihrem ASA C800 System wird ersetzt, wenn sie ausfällt, oder eine Karte wird hinzugefügt oder aufgerüstet, um höhere Leistung oder zusätzliche Funktionen zu unterstützen. Der Austauschprozess umfasst das Herunterfahren des Controllers, das Ersetzen der ausgefallenen PCIe-Karte, das Neustarten des Controllers und die Rücksendung des defekten Teils an NetApp.
