...
summary: Das Herunterfahren des Controllers im ASA C800-Speichersystem verhindert Datenverlust und sorgt für Systemstabilität beim Austausch des Bootmediums. 
---
...
[role="lead"]
Der Controller im ASA C800 Storage-System sollte heruntergefahren werden, um Datenverlust zu verhindern und die Systemstabilität während des automatisierten Boot-Medien-Wiederherstellungsprozesses zu gewährleisten.
