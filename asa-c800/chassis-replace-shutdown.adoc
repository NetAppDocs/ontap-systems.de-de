...
---
= Die ASA C800 Controller werden heruntergefahren, um das Chassis auszutauschen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie die Controller Ihres ASA C800 Speichersystems ab, um Datenverlust zu vermeiden und die Systemstabilität beim Austausch des Gehäuses zu gewährleisten.
