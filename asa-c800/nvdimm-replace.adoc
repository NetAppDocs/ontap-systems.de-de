...
summary: Sie müssen das NVDIMM im Controllermodul austauschen, sobald Ihr System erkennt, dass die Lebensdauer des Flash-Speichers fast abgelaufen ist oder das identifizierte NVDIMM nicht gesund ist. Wenn Sie dies nicht tun, verursacht dies eine Systempanik. 
---
= Ein NVDIMM in einem ASA C800 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Tauschen Sie das NVDIMM in Ihrem ASA C800 -System aus, wenn Ihr System erkennt, dass die Lebensdauer des Flash-Speichers fast erreicht ist oder dass das identifizierte NVDIMM generell nicht in Ordnung ist; andernfalls kommt es zu einem Systemabsturz.

.Bevor Sie beginnen
* Stellen Sie sicher, dass Sie das von NetApp erhaltene Ersatz-NVDIMM-Modul besitzen und dass es mit Ihrem ASA C800 -System kompatibel ist.
