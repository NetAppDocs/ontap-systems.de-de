...
summary: Sie müssen das NVDIMM im Controllermodul austauschen, wenn Ihr System registriert, dass die Lebensdauer des Flash-Speichers fast abgelaufen ist oder dass das identifizierte NVDIMM generell nicht in Ordnung ist, um einen Systemabsturz zu vermeiden. 
---
= Ein NVDIMM in einem ASA A400 System austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
