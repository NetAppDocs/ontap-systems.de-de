...
summary: Beginnen Sie mit dem Ersetzen des Startmediums in Ihrem ASA A400 Speichersystem, indem Sie die Anforderungen für den Austausch überprüfen, den Verschlüsselungsstatus prüfen, den Controller herunterfahren, das Startmedium ersetzen, das Wiederherstellungsimage starten, die Verschlüsselung wiederherstellen und die Systemfunktionalität überprüfen. 
---
= Ablauf für den Austausch des Bootmediums bei einem ASA A400 System unter Verwendung des manuellen Boot-Wiederherstellungsprozesses
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Beginnen Sie mit dem Ersetzen des Startmediums in Ihrem ASA A400 Speichersystem, indem Sie die Anforderungen für den Austausch überprüfen, den Verschlüsselungsstatus prüfen, den Controller herunterfahren, das Startmedium ersetzen, das Wiederherstellungsimage starten, die Verschlüsselung wiederherstellen und die Systemfunktionalität überprüfen.
