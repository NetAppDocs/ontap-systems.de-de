...
summary: Schalten Sie den Controller in Ihrem ASA A400-Speichersystem ab, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers zu gewährleisten. 
---
= Vor dem Austausch ist der defekte Controller in einem ASA A400-System herunterzufahren.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Schalten Sie den Controller in Ihrem ASA A400-Speichersystem ab, um Datenverlust zu verhindern und die Systemstabilität beim Austausch des Controllers zu gewährleisten.
...
Nachdem Sie den ASA A400 Controller heruntergefahren haben, müssen Sie link:controller-replace-move-hardware.html["Ersetzen Sie den Controller"].
