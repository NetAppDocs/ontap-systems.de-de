...
summary: 'Sie tauschen die Echtzeit-Batterie (RTC) im Controller-Modul aus, damit die Dienste und Anwendungen Ihres Systems, die auf eine genaue Zeitsynchronisation angewiesen sind, weiterhin funktionieren.' 
---
= Die Batterie der Echtzeituhr in einem ASA A400 System ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
