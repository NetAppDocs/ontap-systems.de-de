...
---
= Den Chassis-Austausch für ein ASA A400 System abschließen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Den Chassis-Austausch für ein ASA A400 System abschließen, indem der HA-Status überprüft wird, Aggregate zurückgeschaltet werden, falls sich das System in einer Zwei-Knoten MetroCluster Konfiguration befindet, und das defekte Chassis an NetApp zurückgesendet wird.
