...
summary: 'Sie müssen ein DIMM im Controllermodul austauschen, wenn Ihr System eine zunehmende Anzahl korrigierbarer Fehlerkorrekturcodes (ECC) registriert, um einen Systemabsturz zu vermeiden.' 
---
= Austausch eines DIMM in einem ASA A400 System
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
