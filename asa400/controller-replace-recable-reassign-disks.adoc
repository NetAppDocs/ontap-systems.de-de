...
summary: Übergeben Sie die Kontrolle über die Speicherressourcen an den Ersatzcontroller, damit Ihr ASA A400 System den normalen Betrieb wiederaufnehmen kann. 
---
= Den Controller in einem ASA A400 System zurückgeben, damit der normale Betrieb fortgesetzt werden kann.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Übergeben Sie die Kontrolle über die Speicherressourcen an den Ersatzcontroller, damit Ihr ASA A400 System den normalen Betrieb wiederaufnehmen kann.
