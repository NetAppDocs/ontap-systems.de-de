...
summary: Stellen Sie vor dem Austausch des Bootmediums in Ihrem ASA A400 -System sicher, dass Sie die notwendigen Voraussetzungen für einen erfolgreichen Austausch erfüllen. 
---
= Anforderungen für die automatisierte Wiederherstellung von Bootmedien in einem ASA A400 System prüfen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
