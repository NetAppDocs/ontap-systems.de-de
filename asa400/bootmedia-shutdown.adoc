...
summary: Der Controller im ASA A400-Speichersystem wird heruntergefahren, um Datenverlust zu vermeiden und die Systemstabilität während des manuellen Bootmedien-Wiederherstellungsprozesses zu gewährleisten. 
---
= Den Controller in einem ASA A400 System während des manuellen Boot-Wiederherstellungsprozesses herunterfahren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der Controller im ASA A400-Speichersystem wird heruntergefahren, um Datenverlust zu vermeiden und die Systemstabilität während des manuellen Bootmedien-Wiederherstellungsprozesses zu gewährleisten.
